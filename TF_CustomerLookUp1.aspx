<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_CustomerLookUp1.aspx.cs"
    Inherits="TF_CustomerLookUp1" %>
                        ...
                        <td  colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CUST_ID" HeaderText="CUST ID" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="left">
                                        <ItemStyle HorizontalAlign="left" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CUST_NAME" HeaderText="CUSTOMER NAME" ItemStyle-Width="300px">
