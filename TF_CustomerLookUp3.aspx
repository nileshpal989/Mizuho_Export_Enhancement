<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_CustomerLookUp3.aspx.cs" Inherits="TF_CustomerLookUp3" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    Width="95%" AllowPaging="false" OnRowCommand="GridViewCustAcList_RowCommand"
                                    OnRowDataBound="GridViewCustAcList_RowDataBound" 
                                    onrowcreated="GridViewCustAcList_RowCreated" PageSize=15  
