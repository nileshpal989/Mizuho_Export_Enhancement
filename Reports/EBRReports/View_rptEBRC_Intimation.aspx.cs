...
public partial class Reports_EBRReports_View_rptEBRC_Intimation : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                if (Request.QueryString["rptCode"] == "1")
                {
                    ...
                    todocno = ("All");
                    //pur.Values.Add("0");
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/EBRC_Report_Intimation";
                    //serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/EBRC_Report_Intimation";
                }
                ...
                new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, Frdocno, Todocno, Branch });
            }
        }
    }
}