<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEBR_DataValidationReports.aspx.cs" Inherits="Reports_EBRReports_rptEBR_DataValidationReports" %>
    ...
    <script type="text/javascript">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function Generate() {
                ...
                var winname = window.open('View_rptEBR_DataValidationReports.aspx?frm=' + txtfromDate.value + '&to=' + txtToDate.value + '&Branch=' + ddlBranch +  '&Report=' + Report, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
