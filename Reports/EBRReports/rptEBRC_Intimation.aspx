<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEBRC_Intimation.aspx.cs" Inherits="Reports_EBRReports_rptEBRC_Intimation" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            if (Report == "EBRC Intimation") {
                popup = window.open('../EXPReports/HelpDocNo_ExportBillDocument.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&Branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            }
        ...
        function validateGenerate() {
            ...
            var winname = window.open('View_rptEBRC_Intimation.aspx?frm=' + from + '&rptType=' + rptType + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Branch=' + Branch + '&Report=' + Report, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
