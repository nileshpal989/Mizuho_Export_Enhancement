<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_BOE_ACK_LETTER.aspx.cs"
    Inherits="Reports_IDPMSReports_TF_BOE_ACK_LETTER" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdbAllDoc').checked == true) {
                ...
                if (document.getElementById('rdbAllCust').checked == true) {
                    var winame = window.open('VIEW_TF_BOE_ACK_LETTER.aspx?branchname=' + brname.value + '&type=all&doc=all' + '&fromdate=' + fromdate.value + '&todate=' + todate.value + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
                else {
                    var cust = document.getElementById('txtCust').value;
                    var winame = window.open('VIEW_TF_BOE_ACK_LETTER.aspx?branchname=' + brname.value + '&type=' + cust + '&doc=all' + '&fromdate=' + fromdate.value + '&todate=' + todate.value + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
            }
                ...
                if (document.getElementById('rdbAllCust').checked == true) {
                    var winame = window.open('VIEW_TF_BOE_ACK_LETTER.aspx?branchname=' + brname.value + '&type=all&doc=' + doc + '&fromdate=' + fromdate.value + '&todate=' + todate.value + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
                else {
                    var cust = document.getElementById('txtCust').value;
                    var winame = window.open('VIEW_TF_BOE_ACK_LETTER.aspx?branchname=' + brname.value + '&type=' + cust + '&doc=' + doc + '&fromdate=' + fromdate.value + '&todate=' + todate.value + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
            }
        ...
        //                var e = document.getElementById("ddlBranch");
        //                var branch = e.options[e.selectedIndex].value;
        //                open_popup('../../TF_Document_No_Help.aspx?adcode=' + branch + '&cust=all' + '&fromdate=' + fromdate.value + '&todate=' + todate.value, 450, 550, 'CustList');
        //                return false;
        //            }
        //            else {
        //                var e = document.getElementById("ddlBranch");
        //                var branch = e.options[e.selectedIndex].value;
        //                var cust = document.getElementById('txtCust').value;
        //                open_popup('../../TF_Document_No_Help.aspx?adcode=' + branch + '&cust=' + cust + '&fromdate=' + fromdate.value + '&todate=' + todate.value, 450, 550, 'CustList');
        //                return false;
        //            }
        ...
        function Dump_Help() {
            ...
            open_popup('../../IDPMS/Dump_Help_New.aspx?branch=' + branch + '&acno=' + cust, 450, 400, 'DocList');
            return false;
        }
        function selectDump(acno, date) {
            document.getElementById('txtDoc').value = acno;
        }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><strong>BOE ACKNOWLEDGEMENT LETTER</strong> </span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="line-height: 150%">
                                    ...
                                    <table visible="false" id="SelectDoc" runat="server" width="100%">
                                        <tr>
                                            <td align="right" style="width: 15%">
                                                <span class="mandatoryField">&nbsp; *</span><span class="elementLabel">Document No.
                                                    :</span>
                                            </td>
                                            <td width="7%" nowrap>
