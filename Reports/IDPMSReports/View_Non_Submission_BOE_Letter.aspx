<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_Non_Submission_BOE_Letter.aspx.cs" Inherits="Reports_IDPMSReports_View_Non_Submission_BOE_Letter" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="580px" ShowParameterPrompts="False"
                ShowPrintButton="true" ShowRefreshButton="true" ShowExportControls="true" Width="100%"
