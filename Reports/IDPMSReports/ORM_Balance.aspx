<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ORM_Balance.aspx.cs" Inherits="Reports_EDPMS_Reports_ORM_Balance" %>
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdball').checked == true) {
                if (document.getElementById('rdballcust').checked == true) {
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=all&type=all' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
                else {
                    var cust = document.getElementById('txtCust').value;
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=all&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
            }
                ...
                if (document.getElementById('rdballcust').checked == true) {
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=os&type=all' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
                else {
                    var cust = document.getElementById('txtCust').value;
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=os&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
            }
                ...
                if (document.getElementById('rdballcust').checked == true) {
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=closed&type=all' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
                else {
                    var cust = document.getElementById('txtCust').value;
                    var winame = window.open('View_ORM_Balance.aspx?branchname=' + brname.value + '&from=' + from + '&to=' + to + '&mode=closed&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                    winame.focus();
                    return false;
                }
            }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><strong>Outward Remittance Balance Report</strong> </span>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" nowrap>
                                            ...
                                            &nbsp;<asp:RadioButton ID="rdbclosed" runat="server" GroupName="rdbgroup1" CssClass="elementLabel"
                                                Text="Closed ORM" AutoPostBack="True" OnCheckedChanged="rdbclosed_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="7%" nowrap>
                                            <asp:TextBox ID="txtCust" runat="server" Width="100" TabIndex="2" MaxLength="20"
                                                AutoPostBack="true" CssClass="textBox" ToolTip="Press F2 for Help" OnTextChanged="txtCust_TextChanged"></asp:TextBox>
                                        </td>
                                        <td width="2%" nowrap>
