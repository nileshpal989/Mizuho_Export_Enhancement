<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Export_Report_XOS_Nil_Statement.aspx.cs" Inherits="Reports_EXPReports_Export_Report_XOS_Nil_Statement" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">XOS NIL STATEMENT</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="800px" style="line-height: 150%">
                                    ...
                                    <td>
                                       &nbsp;<asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" MaxLength="250" Width="500px"></asp:TextBox>
                                    </td>
                                    </tr>
                                </table>
                                <table>
