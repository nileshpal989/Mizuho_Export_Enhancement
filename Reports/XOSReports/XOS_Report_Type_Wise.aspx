<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XOS_Report_Type_Wise.aspx.cs"
    Inherits="Reports_XOSReports_XOS_Report_Type_Wise" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('XOS_ViewReport_Type_Wise.aspx?frm=' + from + '&Branch=' + Branch.value, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">XOS STATEMENT EXPORTER TYPE WISE - SUMMARY</span>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" valign="bottom" style="width: 700px; padding-top: 10px; padding-bottom: 10px">
                                            ...
                                            <asp:Button ID="btnCreate" runat="server" CssClass="buttonDefault" OnClick="btnCreate_Click"
                                                TabIndex="42" Text="Generate" ToolTip="Generate Report" Width="104px" />
                                            <td>
                                                &nbsp;
                                            </td>
