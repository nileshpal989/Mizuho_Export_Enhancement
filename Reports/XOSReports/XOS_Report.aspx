<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XOS_Report.aspx.cs" Inherits="Reports_XOSReports_XOS_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('XOS_ViewReport.aspx?frm=' + from + '&Branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">XO STATEMENT REPORT</span></td>
                        </tr>
                        <tr>
