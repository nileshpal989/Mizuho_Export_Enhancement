...
public partial class Reports_EXPReports_EXP_CreateSWIFT__MT754_REIMBURSEMENT_STATEMENT_DETAIL : System.Web.UI.Page
{
    ...
    protected void btnCreateFile_Click(object sender, EventArgs e)
    {
        ...
        string _qry2 = "TF_Create_EXP_SWIFT__MT754_REIMBURSEMENT_STATEMENT";
        ...
        if (dt2.Rows.Count > 0)
        {
            ...
            {
                string _filePath1 = "";
                _filePath1 = _directoryPath + "/" + "MT-754-" + dt2.Rows[j]["DOC_NO"].ToString().Replace("/", "-") + ".txt";
                StreamWriter sw1;
                ...
                sw1.WriteLine((char)(1) + "{1:F01" + dt2.Rows[j]["Branch_Swift_Code"].ToString().Trim() + W_COUNT_TEMP + "}{2:I754" + dt2.Rows[j]["W_SWIFT_CODE"].ToString().Trim() + "}{4:");
                ...
                if (BankCode != "")
                {
                    ...
                    if (OB_SwiftCode != "")
                    {
                        ...
                        {
                            sw1.WriteLine(":53A:" + OB_SwiftCode);
                        }
                        else
                        {
                            string _str53DB = "";
                            _str53DB = dt2.Rows[j]["BankName"].ToString().Trim();
                            if (_str53DB != "")
                            {
                                if (_str53DB.Length <= 35)
                                {
                                    sw1.WriteLine(":53D:" + _str53DB);
                                }

                                if (_str53DB.Length > 35 && _str53DB.Length <= 70)
                                {
                                    sw1.WriteLine(":53D:" + _str53DB.Substring(0, 35));
                            ...
                            string _str53DC = "";
                            _str53DC = dt2.Rows[j]["BankAddress"].ToString().Trim();
                            _str53DC = _str53DC.Replace("/", "-");
                            _str53DC = _str53DC.Replace("(", "");
                            _str53DC = _str53DC.Replace(")", "");

                            if (_str53DC != "")
                            {
                                if (_str53DC.Length <= 35)
                                {
                                    sw1.WriteLine(_str53DC);
                                }

                                if (_str53DC.Length > 35 && _str53DC.Length <= 70)
                                {
                                    sw1.WriteLine(_str53DC.Substring(0, 35));

                                    if (_str53DC.Substring(35) != "")
                                    {
                                        sw1.WriteLine(_str53DC.Substring(35));
                                    }
                                }
                                if (_str53DC.Length > 70 && _str53DC.Length <= 105)
                                {
                                    sw1.WriteLine(_str53DC.Substring(0, 35));
                                    sw1.WriteLine(_str53DC.Substring(35, 35));

                                    if (_str53DC.Substring(70) != "")
                                    {
                                        sw1.WriteLine(_str53DC.Substring(70));
                                    }
                                }
                                if (_str53DC.Length > 105)
                                {
                                    sw1.WriteLine(_str53DC.Substring(0, 35));
                                    sw1.WriteLine(_str53DC.Substring(35, 35));
                                    sw1.WriteLine(_str53DC.Substring(70, 35));
                                }
                            }
                        }
                ...
                {
                    string _str53D = "";
                    _str53D = dt2.Rows[j]["LC_ISSUED_BY"].ToString().Trim();
                    if (_str53D != "")
                    {
                        if (_str53D.Length <= 34)
                        {
                            sw1.WriteLine(":53D:" + _str53D);
                        }

                        if (_str53D.Length > 34 && _str53D.Length <= 70)
                        {
                            sw1.WriteLine(":53D:" + _str53D.Substring(0, 35));
