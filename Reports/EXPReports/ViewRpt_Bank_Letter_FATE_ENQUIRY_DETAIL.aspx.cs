...
public partial class Reports_EXPReports_ViewRpt_Bank_Letter_FATE_ENQUIRY_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptEXP_BANK_FATE_ENQUIRY_LETTER";
                frdocno = "";
                todocno = "";
            ...
            ReportViewer1.ServerReport.SetParameters(
               new Microsoft.Reporting.WebForms.ReportParameter[] { docno, Frdocno, Todocno, Remark1, Remark2, Remark3, user, Branch});
            //}
        }
    }
}