<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_Voucher_Export.aspx.cs" Inherits="Reports_EXPReports_Help_Voucher_Export" %>
                    ...
                    <tr>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                OnRowCreated="grdsearch_RowCreated" Width="500px" Height="70px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Currency" HeaderText="CUR" ItemStyle-Width="30px" HeaderStyle-HorizontalAlign="Center" >
                                    <ItemStyle HorizontalAlign="Center" Width="30px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Amount" HeaderText="AMOUNT" ItemStyle-Width="60px"  HeaderStyle-HorizontalAlign="Center">
                                     <ItemStyle HorizontalAlign="Right" Width="60px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CUST_NAME" HeaderText="CUST NAME" ItemStyle-Width="180px">
