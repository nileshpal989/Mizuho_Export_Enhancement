...
public partial class Reports_EXPReports_ViewRptREIMBURSEMENT_STATEMENT_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                docno.Name = "docno";
                Microsoft.Reporting.WebForms.ReportParameter Remark = new Microsoft.Reporting.WebForms.ReportParameter();
                Remark.Name = "Remark";
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_REIMBURSEMENT_STATEMENT";
                    frdocno = "";
                    todocno = "";
                ...
                Remark.Values.Add(remark);
                Remark1.Values.Add(remark1);
                Remark2.Values.Add(remark2);

                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { DocDate, docno, Frdocno, Todocno, Remark, Remark1, Remark2, user });
            }
        }
    }
}