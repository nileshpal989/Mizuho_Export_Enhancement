<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_IntimationLetter.aspx.cs" Inherits="Reports_EXPReports_EXP_IntimationLetter" %>
   ...
   <%-- <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            popup = window.open('HelpDocNoLookUp_EXP_IntimationLetter.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&Branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewrptEXPIntimationLetter.aspx?frm=' + from + '&rptType=' + rptType + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Branch=' + Branch + '&check=' + check, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel">INTIMATION LETTER  (LBD - Buyers)</span>
                                </td>
                                        ...
                                        <tr valign="bottom">
                                            <td align="right" style="width: 120px">
                                              ...
                                              <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                                &nbsp;
                                                 <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate" Width = "135px"
