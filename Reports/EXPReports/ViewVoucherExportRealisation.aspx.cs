...
public partial class Reports_EXPReports_ViewVoucherExportRealisation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Microsoft.Reporting.WebForms.ReportParameter Original = new Microsoft.Reporting.WebForms.ReportParameter();
            ...
            if (Request.QueryString["from"] != null)
            {
                ...
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/VoucherRealisation";
                ...
                string Original1 = Request.QueryString["Original"];
                Original.Values.Add(Original1);

                User.Values.Add(Session["userName"].ToString());

                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { from, Doc_No_Type, Branch, FDoc, TDoc, Original, User });
            }
        }
    }
}