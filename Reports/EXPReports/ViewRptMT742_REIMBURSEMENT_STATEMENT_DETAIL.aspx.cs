...
public partial class Reports_EXPReports_ViewRptMT742_REIMBURSEMENT_STATEMENT_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_MT742_REIMBURSEMENT_STATEMENT";
                    frdocno = "";
                    todocno = "";
