...
public partial class Reports_EXPReports_View_rptExportBillRegister_Unaccepted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["frm"] != null && Request.QueryString["to"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptEXPBillRegisterUnaccepted_DocNo";
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptEXPBillRegisterUnaccepted_Customerwise";
                    doctypevalue = Request.QueryString["rptDocType"].ToString();
                    Loanvalue = Request.QueryString["rptLoan"].ToString();
                    CSvalue = Request.QueryString["rptCS"].ToString();
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptEXPBillRegisterUnaccepted_OverseasBankwise";
                    doctypevalue = Request.QueryString["rptDocType"].ToString();
                    Loanvalue = Request.QueryString["rptLoan"].ToString();
                    CSvalue = Request.QueryString["rptCS"].ToString();
                ...
                if (Request.QueryString["rptCode"] == "1")
                {
                    ReportViewer1.ServerReport.SetParameters(
                       new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, user, doctype, Loan, CS });
                }
                else if (Request.QueryString["rptCode"] == "2")
                {
                    ReportViewer1.ServerReport.SetParameters(
                  new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, user, CustAcNo, doctype, Loan, CS });
                }

                //else if (Request.QueryString["rptCode"] == "3")
                //{
                //    ReportViewer1.ServerReport.SetParameters(
                //  new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, user, OVP, doctype, Loan, CS });
                //}
                else if (Request.QueryString["rptCode"] == "4")
                {
                    ReportViewer1.ServerReport.SetParameters(
                  new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, user, OVB, doctype, Loan, CS });
                }
                //else if (Request.QueryString["rptCode"] == "5")
                //{
                //    ReportViewer1.ServerReport.SetParameters(
                //  new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, user, Country, doctype, Loan, CS });
                //}
