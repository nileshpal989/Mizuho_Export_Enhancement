<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_Export_Nonsubmission_Export_Doc_followup.aspx.cs" Inherits="Reports_EXPORTReports_TF_Export_Nonsubmission_Export_Doc_followup" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winame = window.open('View_TF_Export_Nonsubmission_Export_Doc_followup.aspx?Branch=' + ddlBranch.value + '&FromDate=' + txtFromDate.value + '&ToDate=' + txtToDate.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
            winame.focus();
            return false;
        }
                ...
                <table cellspacing="1" cellpadding="1" border="0" width="100%">
                    <tr>
                        <td colspan="4" align="left" nowrap>
                            <span class="pageLabel"><strong>Non Submission of Export Document -Follow Up</strong></span>
                            <hr />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" nowrap class="style3">
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="left" nowrap class="style1">
                    ...
                    <tr id="trCustAcNo" style="display:none;" runat="server">
                        ...
                        <td  colspan="2" align="left" nowrap class="style2">
