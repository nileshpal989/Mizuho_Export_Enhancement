...
public partial class Reports_EXPReports_EXP_CreateSWIFT__REIMBURSEMENT_STATEMENT_DETAIL : System.Web.UI.Page
{
    ...
    protected void btnCreateFile_Click(object sender, EventArgs e)
    {
        ...
        string _qry2 = "TF_Create_EXP_SWIFT_REIMBURSEMENT_STATEMENT";
        ...
        if (dt2.Rows.Count > 0)
        {
            for (int j = 0; j < dt2.Rows.Count; j++)
            {
                ...
                {
                    _strCHECK1 = lblValue.Text;
                    if (_strCHECK1 != "")
                    {
                        if (_strCHECK1.Length <= 45)
                        {
                            sw1.WriteLine(_strCHECK1);
                        }

                        if (_strCHECK1.Length > 45)
                        {
                            sw1.WriteLine(_strCHECK1.Substring(0, 45));
                            if (_strCHECK1.Substring(45) != "")
                            {
                                sw1.WriteLine(_strCHECK1.Substring(45));
                            }
                        }
                      sw1.WriteLine(".");
                    }
