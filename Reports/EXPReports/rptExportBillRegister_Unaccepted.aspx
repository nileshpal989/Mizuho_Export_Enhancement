<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptExportBillRegister_Unaccepted.aspx.cs"
    Inherits="Reports_EXPReports_rptExportBillRegister_Unaccepted" %>
...
//            }
            ...
            var winname = window.open('View_rptExportBillRegister_Unaccepted.aspx?frm=' + from + '&to=' + to + '&rptDocType=' + rptDocType + '&rptLoan=' + rptLoan + '&rptCS=' + rptCS + '&rptType=' + encodeURIComponent(rptType) + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Export Bill Register (Unaccepted)</strong></span>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <%--<td>
                                            <asp:RadioButton ID="rdbAllOverseasParty" runat="server" AutoPostBack="true" CssClass="elementLabel"
                                                GroupName="Data1" OnCheckedChanged="rdbAllOverseasParty_CheckedChanged" TabIndex="6"
                                            ...
                                            <asp:RadioButton ID="rdbSelectedOverseasParty" runat="server" AutoPostBack="true"
                                                ...
                                                TabIndex="6" Text="Selected Overseas Party" />
                                        </td>--%>
                                        <td>
                                        ...
                                        <%--<td>
                                            <asp:RadioButton ID="rdbAllCountry" runat="server" AutoPostBack="true" CssClass="elementLabel"
                                                GroupName="Data3" OnCheckedChanged="rdbAllCountry_CheckedChanged" TabIndex="6"
                                                Text="All Country" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <br />
                                            <asp:RadioButton ID="rdbSelectedCountry" runat="server" AutoPostBack="true"
                                                CssClass="elementLabel" GroupName="Data3" OnCheckedChanged="rdbSelectedCountry_CheckedChanged"
                                                TabIndex="6" Text="Selected Country" />
                                        </td>--%>
                                    </tr>
                                </table>
                                ...
                                <%--  <fieldset id="OVPartylist" runat="server" style="width: 900px" visible="false">
                                    ...
                                    <table id="Table2" runat="server">
                                        <tr>
                                            ...
                                            <td align="left" width="0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOVPID" runat="server" CssClass="textBox" MaxLength="40" TabIndex="8"
                                                    Visible="false" Width="100px" OnTextChanged="txtOVPID_TextChanged" AutoPostBack="True"></asp:TextBox>
                                                &nbsp;
                                                <asp:Button ID="btnOVPList" runat="server" CssClass="btnHelp_enabled" 
                                ...
                                <fieldset id="OVBanklist" runat="server" style="width: 900px" visible="false">
                                    ...
                                    <table id="Table3" runat="server">
                                        <tr>
                                            ...
                                            <td align="left" width="0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOVBank" runat="server" CssClass="textBox" MaxLength="40" TabIndex="9"
                                ...
                                <%-- <fieldset id="CountryList" runat="server" style="width: 900px" visible="false">
                                    ...
                                    <table id="Table4" runat="server">
                                        <tr>
                                            ...
                                            <td align="left" width="0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtCountry" runat="server" CssClass="textBox" MaxLength="40" TabIndex="10"
