...
public partial class Reports_EXPReports_HelpDocNoLookUp_EXP_Letter_FateEnquiry : System.Web.UI.Page
{
    ...
    public void grdDataBind()
    {
        ...
        query = "HelpDocumentNO_EXP_LETTER_FATE_ENQUIRY";
        ...
        SqlParameter p4 = new SqlParameter("@Branch", SqlDbType.VarChar);
        p4.Value = Branch;

        TF_DATA objData = new TF_DATA();

        DataTable dt = objData.getData(query, p2, p3, p4);
    ...
    protected void txtsearch_TextChanged(object sender, EventArgs e)
    {
        if (txtsearch.Text != "")
        {
            query = "HelpDocumentNO_EXP_FATE_ENQUIRY_Search";
            //System.Globalization.DateTimeFormatInfo dateInfo = new System.Globalization.DateTimeFormatInfo();
            //dateInfo.ShortDatePattern = "dd/MM/yyyy";
            //string date = Request.QueryString["frdate"].ToString();
            ...
            TF_DATA objData = new TF_DATA();
            DataTable dt = objData.getData(query, p2);
