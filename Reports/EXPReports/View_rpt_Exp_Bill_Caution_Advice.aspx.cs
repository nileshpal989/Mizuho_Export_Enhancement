...
public partial class Reports_EXPReports_View_rpt_Exp_Bill_Caution_Advice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rpt_Caution_Advice_Export_Bill";
            ...
            Microsoft.Reporting.WebForms.ReportParameter custname = new Microsoft.Reporting.WebForms.ReportParameter();
            custname.Name = "cust";
            custname.Values.Add(Request.QueryString["CustID"].ToString());
            ...
            ReportViewer1.ServerReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { Branch, fromDate, toDate, custname, user });
        }
    }
}