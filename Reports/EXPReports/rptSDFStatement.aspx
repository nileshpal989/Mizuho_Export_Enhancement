<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSDFStatement.aspx.cs"
    Inherits="Reports_EXPReports_rptSDFStatement" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            open_popup('HelpExportReportSDFStatement.aspx?fromDate=' + fromDate + '&Branch=' + Branch + '&toDate=' + txtToDate, 400, 600, "DocFile");
            return false;
        }
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewExportReportSDFStatement.aspx?fromDate=' + fromDate.value + '&toDate=' + txtToDate.value + '&documentNo=' + DocumentNo + '&Branch=' + Branch, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Export Bill SDF Statement</strong></span>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="800px" style="line-height: 150%">
                                    ...
                                    <tr>
                                        <td align="left" nowrap>
                                            <span class="mandatoryField">*</span><span class="elementLabel">From Realisation Date
                                                :</span>
                                        </td>
