<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CreateSWIFT__MT799_REIMBURSEMENT_DETAIL.aspx.cs" Inherits="Reports_EXPReports_EXP_CreateSWIFT__MT799_REIMBURSEMENT_DETAIL" %>
...
//            }
            ...
            var winname = window.open('ViewRpt_MT799_REIMBURSEMENT_STATEMENT.aspx?frm=' + from + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark1=' + Remark1 + '&Remark2=' + Remark2, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">SWIFT MESSAGE (MT 799)</span>
                            </td>
                                    ...
                                    <tr valign="bottom">
                                        <td align="right" style="width: 220px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnCreateFile" runat="server" CssClass="buttonDefault" Text="Generate Swift File"
                                                ToolTip="Generate" TabIndex="7" Width="135px" OnClick="btnCreateFile_Click" />
                                        </td>
