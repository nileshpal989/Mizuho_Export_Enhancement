<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CreateSWIFT_MT999_FATE_ENQUIRY_DETAIL.aspx.cs" Inherits="Reports_EXPReports_EXP_CreateSWIFT_MT999_FATE_ENQUIRY_DETAIL" %>
...
//            var from = document.getElementById('txtFromDate').value;
            ...
            var winname = window.open('ViewRptFATE_ENQUIRY_DETAIL.aspx?rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark1=' + Remark1 + '&Remark2=' + Remark2, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">FATE ENQUIRY (MT 999)</span>
                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 700px">
                                            &nbsp;<asp:TextBox ID="txtRemark2" runat="server" CssClass="textBox" MaxLength="600"
                                                Width="650px" TabIndex="5" Text = "WE REQUEST YOU TO INFORM US THE FATE OF THE ABOVE DOCUMENTS SENT TO YOU."></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <%--<table>
