<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpExportOverdueStatement.aspx.cs" Inherits="Reports_EXPReports_HelpExportOverdueStatement" %>
                            ...
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer Account Number" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
