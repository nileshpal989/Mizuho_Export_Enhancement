...
public partial class Reports_EXPReports_ViewRealisationAdvice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["from"] != null)
            {
                ...
                if (Request.QueryString["Realised"] == "Full")
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportFullRealisation";
                    ...
                    ReportViewer1.ServerReport.SetParameters(
                       new Microsoft.Reporting.WebForms.ReportParameter[] { from, Doc_No_Type, Branch, FDoc, TDoc, User , Cust });

                }

                else if (Request.QueryString["Realised"] == "Part")
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportPartRealisation";
