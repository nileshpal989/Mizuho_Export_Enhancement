<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CreateSWIFT_FATE_ENQUIRY_UNDER_LC_DETAIL.aspx.cs" Inherits="Reports_EXPReports_EXP_CreateSWIFT_FATE_ENQUIRY_UNDER_LC_DETAIL" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewRpt_UNDER_LC_FATE_ENQUIRY_DETAIL.aspx?rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark1=' + Remark1 + '&Remark2=' + Remark2, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">FATE ENQUIRY OF DOCUMENTS SENT UNDER L/C</span>
                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 700px">
                                            &nbsp;<asp:TextBox ID="txtRemark2" runat="server" CssClass="textBox" MaxLength="600"
                                                Width="650px" TabIndex="5" Text = "WE REQUEST YOU TO ADVISE THE FATE OF THE ABOVE DOCUMENTS."></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>                           
                                <table>
