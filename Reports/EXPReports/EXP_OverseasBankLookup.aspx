<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_OverseasBankLookup.aspx.cs"
    Inherits="Reports_EXPReports_EXP_OverseasBankLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Overseas Bank Help</title>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 200px;">
                            <asp:Label ID="lblCustName" runat="server">Enter Bank Name : &nbsp;</asp:Label>
                        </td>
                        <td style="width: 200px">
                    ...
                    <tr>
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                OnRowCreated="grdsearch_RowCreated" Width="470px" Height="70px" CellPadding="4"
                                ...
                                <HeaderStyle ForeColor="White" VerticalAlign="Top" CssClass="gridHeader" BackColor="#990000"
                                    Font-Bold="True" />
                                <AlternatingRowStyle HorizontalAlign="Left" Height="18px" VerticalAlign="Middle"
                                    CssClass="gridAlternateItem" BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="BankCode" HeaderText="BANK ID" ItemStyle-Width="60px"
                                        ItemStyle-HorizontalAlign="left">
                                        <ItemStyle HorizontalAlign="left" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="BankName" HeaderText="BANK NAME" ItemStyle-Width="300px">
