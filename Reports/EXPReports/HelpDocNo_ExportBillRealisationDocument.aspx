<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpDocNo_ExportBillRealisationDocument.aspx.cs" Inherits="Reports_EXPReports_HelpDocNo_ExportBillRealisationDocument" %>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Bill_Amount" HeaderText="AMOUNT" ItemStyle-Width="60px" 
