...
public partial class Reports_EXPReports_ViewRpt_UNDER_LC_FATE_ENQUIRY_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_UNDER_LC_FATE_ENQUIRY";
                frdocno = "";
                todocno = "";
            ...
            ReportViewer1.ServerReport.SetParameters(
               new Microsoft.Reporting.WebForms.ReportParameter[] { docno, Frdocno, Todocno, Remark1, Remark2, user });
            //}
        }
    }
