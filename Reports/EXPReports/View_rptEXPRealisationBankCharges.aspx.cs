...
public partial class Reports_EXPReports_View_rptEXPRealisationBankCharges : System.Web.UI.Page
{
 ...
 if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null && Request.QueryString["to"] != null)
            {
                ...
                Microsoft.Reporting.WebForms.ReportParameter Cur = new Microsoft.Reporting.WebForms.ReportParameter();
                Cur.Name = "Cur";
                ...
                if (Request.QueryString["Cur"] == "ALLCUR")
                {
                    // Set the report server URL and report path
                    if (Request.QueryString["rptCode"] == "1")
                    {
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExpOtherBankChargesList";
                        Cur.Values.Add("ALLCUR");
                ...
                else
                {
                    if (Request.QueryString["rptCode"] == "3")
                    {
                        ...
                        Cur.Values.Add(Request.QueryString["Cur"]);
                        CustAcNo.Values.Add("AllCUST");
                    }
                    ...
                    else if (Request.QueryString["rptCode"] == "4")
                    {
                        ...
                        Cur.Values.Add(Request.QueryString["Cur"]);
                        CustAcNo.Values.Add(Request.QueryString["CustAcNo"].ToString());
                ...
                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, enddate, branch, CustAcNo, Cur, user });
            }
        }
    }
}