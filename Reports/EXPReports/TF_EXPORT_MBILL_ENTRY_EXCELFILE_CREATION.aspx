<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXPORT_MBILL_ENTRY_EXCELFILE_CREATION.aspx.cs" Inherits="Reports_EXPReports_TF_EXPORT_MBILL_ENTRY_EXCELFILE_CREATION" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Custhelp() {
            ...
            popup = window.open('Customerhelp1aspx.aspx?fromDate=' + from + '&toDate=' + from1 + '&Branch=' + Branch + '&cust=' + cust, 'helpCustId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpCustId";
            return false;
                    ...
                    <table cellspacing="0" border="0" width="100%">
                       <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"> Export MBILL CSV File</span>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="800px" style="line-height: 150%">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 20%">
                                            ...
                                            <span class="elementLabel">From MBILL Date  :</span>
                                        </td>
                                        <td align="left" style="width: 700px">
                                            ...
                                            &nbsp; <span class="mandatoryField">*</span><span class="elementLabel">To MBILL Date :</span>
                                            &nbsp;
