<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_rptCustomer_Letter_FATE_ENQUIRY.aspx.cs" Inherits="Reports_EXPReports_EXP_rptCustomer_Letter_FATE_ENQUIRY" %>
   ...
   <%-- <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewRpt_Customer_Letter_FATE_ENQUIRY_DETAIL.aspx?rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark1=' + Remark1 + '&Branch=' + Branch, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel">FATE LETTER TO CUSTOMER</span>
                                </td>
