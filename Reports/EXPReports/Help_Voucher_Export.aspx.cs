...
public partial class Reports_EXPReports_Help_Voucher_Export : System.Web.UI.Page
{
    string query;
    ...
    public void grdDataBind()
    {
        ...
        query = "HelpDocumentNO_ExportVoucher";
        ...
        p4.Value = Branch;
        SqlParameter p5 = new SqlParameter("@PageHeader", SqlDbType.VarChar);
        p5.Value = Request.QueryString["voucher"].ToString();
        ...
        DataTable dt = objData.getData(query, p2, p1, p3, p4,p5,p6);
    ...
    protected void txtsearch_TextChanged(object sender, EventArgs e)
    {
        if (txtsearch.Text != "")
        {
            query = "HelpDocumentNOSearch_EmportVoucher";
            System.Globalization.DateTimeFormatInfo dateInfo = new System.Globalization.DateTimeFormatInfo();
            dateInfo.ShortDatePattern = "dd/MM/yyyy";
            string date = Request.QueryString["frdate"].ToString();
            ...
            TF_DATA objData = new TF_DATA();
            SqlParameter p3 = new SqlParameter("@PageHeader", SqlDbType.VarChar);
            p3.Value = Request.QueryString["voucher"].ToString();
            DataTable dt = objData.getData(query, p2, p1,p3);
