    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        if (dt1.Rows.Count > 0)
        {
            ...
            if (flag == true)
            {
                ...
                _directoryPath = Server.MapPath("~/GeneratedFiles/EXPORT/XOS/" + _directoryPath);
                ...
                int cnt = 0;
                string _qry = "TF_Export_Report_XOS_19112013";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        string path = "file://" + _serverName + "/GeneratedFiles/EXPORT/XOS";
                        string link = "/GeneratedFiles/EXPORT/XOS";
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.Page, Page.GetType(), "message", "alert('Please Add Currency Rate Master for a "+ txtFromDate.Text.ToString() + "' );", true);
        }
    }
}