...
public partial class Reports_EXPReports_HelpCovLettDocNo : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        SqlParameter p6 = new SqlParameter("@Cust", SqlDbType.VarChar);
        p6.Value = Cust;


        string _query = "HelpDocumentNo_Export_Cov_Lett";
