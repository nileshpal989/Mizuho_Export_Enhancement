<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_rpt_AdvanceRemittanceReceived_CustHelp.aspx.cs" Inherits="EDPMS_EDPMS_rpt_AdvanceRemittanceReceived_CustHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridCustomer.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
            return false;
        }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="90%">
                        ...
                        <%--OnRowCommand="GridViewUserList_RowCommand" OnRowDataBound="GridViewUserList_RowDataBound"
                                    OnRowCreated="GridViewUserList_RowCreated"--%>
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridCustomer" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="false" PageSize="15" OnRowCreated="GridCustomer_RowCreated" OnRowDataBound="GridCustomer_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Cust A/c No." HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustAccNo" runat="server" Text='<%# Eval("CustAccNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
