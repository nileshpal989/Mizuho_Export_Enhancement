...
public partial class Reports_EXPReports_ViewExportBillDocument : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    // serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportBillDocument";
                    frdocno = "";
                    todocno = "";
                    pur.Values.Add("0");
                }
                ...
                switch (Request.QueryString["Report"])
                {
                    ...
                    case "Export Bill lodgement":
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportBillDocument";
                        break;
                    case "Export Bill Document Realisation":
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportBillRealisationDocument";
                        break;
                    case "Export Bill Document Delinking":
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportBillDelinkingDocument";
                        break;
                    //case "Negotiation Advice to Customer":
                    //    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExportBillDocument_Negotiation";
                    //    break;
                }
                ...
                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { startdate, pur, Frdocno, Todocno, user, Branch });
            }
        }
    }
}