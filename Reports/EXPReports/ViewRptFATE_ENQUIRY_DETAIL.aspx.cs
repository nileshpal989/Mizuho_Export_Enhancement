...
public partial class Reports_EXPReports_ViewRptFATE_ENQUIRY_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //{
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_MT999_FATE_ENQUIRY";
                    frdocno = "";
                    todocno = "";
