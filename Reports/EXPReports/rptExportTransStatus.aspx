<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptExportTransStatus.aspx.cs"
    Inherits="Reports_EXPReports_rptExportTransStatus" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewEXP_TransStatus.aspx?frm=' + from + '&to=' + to, '', 'scrollbars=yes,left=0,top=50,maximizeButton=yes,menubar=0,width=820,height=375');
            winname.focus();
                    ...
                    <table border="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" width="50%" valign="bottom">
                                <span class="pageLabel"><strong>TRADE FINANCE TRANSACTIONS DATA STATUS</strong></span>
                            </td>
                        </tr>
                        <tr>
