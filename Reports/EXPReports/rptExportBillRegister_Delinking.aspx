<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptExportBillRegister_Delinking.aspx.cs" Inherits="Reports_EXPReports_rptExportBillRegister_Delinking" %>
...
//            var Report = document.getElementById('PageHeader').innerHTML;
        ...
        function validateSave() {
            ...
            var winname = window.open('View_rptExportBillRegister_Delinking.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch + '&Report=' + Report, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
