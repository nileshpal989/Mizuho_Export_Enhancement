<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CreateSWIFT__MT754_REIMBURSEMENT_STATEMENT_DETAIL.aspx.cs" Inherits="Reports_EXPReports_EXP_CreateSWIFT__MT754_REIMBURSEMENT_STATEMENT_DETAIL" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewRptMT754_REIMBURSEMENT_STATEMENT_DETAIL.aspx?frm=' + from + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark2=' + Remark2, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">ADVICE OF NEGOTIATION (MT 754)</span>
                            </td>
