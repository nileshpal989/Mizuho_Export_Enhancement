<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Export_CrossBorderWire.aspx.cs" Inherits="Reports_EXPReports_Export_CrossBorderWire" %>
   ...
   <title></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var from = document.getElementById('txtFromDate').value;
            var to = document.getElementById('txtToDate').value;
            var Amt = document.getElementById('txtAmtinINR').value;
            ...
            if (document.getElementById('rdbAllCustomer').checked == true) {
                ...
                rptType = 'All';
                Amt = document.getElementById('txtAmtinINR').value;
            }
            ...
            var winname = window.open('Export_ViewCrossborderWire.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&branch=' + Branch + '&Amt=' + Amt, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
            return false;
        }
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Cross Border Wire Transfer > INR 5,00,000 &nbsp; </span>
                            &nbsp;</td>
                    ...
                    <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 700px">
                                            &nbsp;<asp:TextBox ID="txtFromDate" runat="server" CssClass="textBox" MaxLength="10"
                                                ValidationGroup="dtVal" Width="70" TabIndex="2" AutoPostBack="True" ontextchanged="txtFromDate_TextChanged" 
                                                ></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButton ID="rdbAllCustomer" runat="server" AutoPostBack="true" 
                                                ...
                                                OnCheckedChanged="rdbAllCustomer_CheckedChanged" TabIndex="4" 
                                                Text="All Customer" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                ...
                                                <asp:TextBox ID="txtCustomer" runat="server" CssClass="textBox" 
                                                    ...
                                                    Width="100px" ontextchanged="txtCustomer_TextChanged" 
                                ...
                                <td align="right" style="font-weight: bold; color: #000000; font-size: medium;" width="200px">
                                                </span><span class="elementLabel">Amount in INR. : &gt;</span>&nbsp;
                                            </td>
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtAmtinINR" runat="server" CssClass="textBox" 
                                                    MaxLength="40"  TabIndex="7"  
                                                    Width="100px" >500000</asp:TextBox>
                                </td>
                                </tr>
                                </table>                    
                                <table>
