<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advice_Exports.aspx.cs" Inherits="Reports_EXPReports_Advice_Exports" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            var Doc = '';
            popup = window.open('Help_Voucher_Export.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch + '&custACNo=' + custACNo + '&voucher=' + voucher, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function Todochelp() {
            ...
            popup = window.open('Help_Voucher_Export.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch + '&custACNo=' + custACNo + '&voucher=' + voucher, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpDocId1";
            return false;
        ...
        function validateSave() {
            ...
            var winname = window.open('Advice_Export_View.aspx?frm=' + from + '&rptType=' + rptType + '&rptTypeTo=' + rptTypeTo + '&rptCode=' + rptCode + '&branch=' + Branch + '&custACNo=' + custACNo + '&voucher=' + voucher, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
            return false;
        }
