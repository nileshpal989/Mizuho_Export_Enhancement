...
public partial class Reports_EXPReports_ViewRpt_MT799_REIMBURSEMENT_STATEMENT : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_MT799_REIMBURSEMENT";
                    frdocno = "";
                    todocno = "";
                ...
                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { DocDate, docno, Frdocno, Todocno, Remark1, Remark2, user });
            }
        }
    }
}