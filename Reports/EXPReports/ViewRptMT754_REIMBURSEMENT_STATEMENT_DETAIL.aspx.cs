...
public partial class Reports_EXPReports_ViewRptMT754_REIMBURSEMENT_STATEMENT_DETAIL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExp_SWIFT_MT754_REIMBURSEMENT_STATEMENT";
                    frdocno = "";
                    todocno = "";
                ...
                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { DocDate, docno, Frdocno, Todocno, Remark2, user });
            }
        }
    }
}