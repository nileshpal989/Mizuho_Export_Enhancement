<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_Transactionaudittrail.aspx.cs" Inherits="Reports_EXPReports_EXP_Transactionaudittrail" %>
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong> Export Transaction Audit Trail</strong></span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                                <span class="mandatoryField">*<span class="elementLabel">Transaction : </span>
                            </td>
                            <td align="left">       
                                    <asp:DropDownList ID="ddlCheckList" runat="server" CssClass="dropdownList"
                                     TabIndex="35" Height="19px">
                                    <asp:ListItem Value="">--Select--</asp:ListItem>  
                                        <asp:ListItem Value="Lodgement">Lodgement</asp:ListItem> 
                                        <asp:ListItem Value="Inward">Inward</asp:ListItem>  
                                </asp:DropDownList>
                            </td>
                        </tr>
                                </table>                      
