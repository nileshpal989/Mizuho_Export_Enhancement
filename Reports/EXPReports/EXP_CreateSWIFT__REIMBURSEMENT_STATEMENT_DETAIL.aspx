<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CreateSWIFT__REIMBURSEMENT_STATEMENT_DETAIL.aspx.cs" Inherits="Reports_EXPReports_EXP_CreateSWIFT__REIMBURSEMENT_STATEMENT_DETAIL" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            var Doc = '';
            popup = window.open('HelpDocNoLookUp_EXP_ReimbursementStatement.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function Todochelp() {
            ...
            popup = window.open('HelpDocNoLookUp_EXP_ReimbursementStatement.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function validateGenerate() {
            ...
            if (document.getElementById('Check1').checked == true) {
                Remark = document.getElementById('lblValue').innerText;                
            }
            else {
                Remark = "";
            }
            ...
            var winname = window.open('ViewRptREIMBURSEMENT_STATEMENT_DETAIL.aspx?frm=' + from + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark=' + Remark + '&Remark1=' + Remark1 + '&Remark2=' + Remark2, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">REIMBURSEMENT STATEMENT (MT 999)</span>
                            </td>
                                ...
                                <table>
                                    <tr>
                                        <td align="right" style="width: 120px">
                                            <span class="elementLabel">Message :</span>
                                        </td>
                                        <td align="left" style="width: 700px">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 120px">
                                            <span class="elementLabel">Tested Between :</span>
                                        </td>
                                        <td align="left" style="width: 700px">
                                            &nbsp;<asp:TextBox ID="txtRemark2" runat="server" CssClass="textBox" MaxLength="128"
                                                Width="650px" TabIndex="6"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table>
                                    ...
                                    <tr valign="bottom">
                                        <td align="right" style="width: 220px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnCreateFile" runat="server" CssClass="buttonDefault" Text="Generate Swift File"
                                                ToolTip="Generate" TabIndex="8" Width="135px" OnClick="btnCreateFile_Click" />
                                        </td>
                                        <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate Report"
                                                Width="135px" ToolTip="Generate" TabIndex="9" />
