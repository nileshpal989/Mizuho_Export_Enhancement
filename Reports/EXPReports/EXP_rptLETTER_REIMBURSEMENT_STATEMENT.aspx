<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_rptLETTER_REIMBURSEMENT_STATEMENT.aspx.cs" Inherits="Reports_EXPReports_EXP_rptLETTER_REIMBURSEMENT_STATEMENT" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewRptLETTER_REIMBURSEMENT_STATEMENT.aspx?frm=' + from + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Remark2=' + Remark2 + '&Branch=' + Branch, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 60%" valign="bottom">
                                <span class="pageLabel">REIMBURSEMENT CLAIM (LETTER)</span>
                            </td>
                            ...
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top" colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td height="30px" width="10%" nowrap>
                                            ...
                                            <asp:TextBox ID="txtDocumentNo" runat="server" CssClass="textBox" MaxLength="40"
                                                TabIndex="4" Width="159px" Visible="false" OnTextChanged="txtDocumentNo_TextChanged"></asp:TextBox>
                                ...
                                <table>                                    
                                    <tr>
                                        ...
                                        <td align="left" style="width: 700px">
                                            &nbsp;<asp:TextBox ID="txtRemark2" runat="server" CssClass="textBox" MaxLength="200" Text = "We certify all conditions of the above credit have been complied with."
