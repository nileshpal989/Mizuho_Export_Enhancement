<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpDocNo_ExportBillRealisationReport1.aspx.cs" Inherits="Reports_EXPReports_HelpDocNo_ExportBillRealisationReport1" %>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Bill_Amount" HeaderText="Bill Amt" ItemStyle-Width="40px" 
