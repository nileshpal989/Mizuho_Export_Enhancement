<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpRealisedCust.aspx.cs" Inherits="Reports_EXPReports_HelpRealisedCust" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document Number" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("CUST_ACCOUNT_NO") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
