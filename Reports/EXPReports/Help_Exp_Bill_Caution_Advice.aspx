<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_Exp_Bill_Caution_Advice.aspx.cs" Inherits="Reports_EXPReports_Help_Exp_Bill_Caution_Advice" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustAC" runat="server" Text='<%# Eval("CUST_ACCOUNT_NO") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
