<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptExportBillDocument.aspx.cs"
    Inherits="Reports_EXPReports_rptExportBillDocument" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            if (Report == "Export Bill lodgement") {
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewExportBillDocument.aspx?frm=' + from + '&rptType=' + rptType + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode + '&Branch=' + Branch + '&Report=' + Report, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
