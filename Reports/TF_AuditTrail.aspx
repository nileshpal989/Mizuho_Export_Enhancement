<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_AuditTrail.aspx.cs" Inherits="Reports_TF_AuditTrail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Generate() {
            ...
            var winname = window.open('View_rptAuditTrail.aspx?frm=' + txtFromDate.value + '&to=' + txtToDate.value + '&Branch=' + ddlBranch.value + '&User=' + User + '&Type=' + Type + '&Report=' + Report + '&Module=' + Module, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
    </script>
