...
public partial class Reports_EXPORTReports_ViewVoucherLCExpoertAdvice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    if (Request.QueryString["check"] == "false")
                    {
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/VoucherExportLCustnNon";
                    }
                    else
                    {
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/VoucherExportLCust";
                    }
                    docno = "";
                    todocno = "";
                    pur.Values.Add("0");
