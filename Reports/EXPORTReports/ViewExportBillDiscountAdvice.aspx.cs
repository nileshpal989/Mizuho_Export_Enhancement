...
public partial class Reports_EXPReports_ViewExportBillDiscountAdvice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (abc == "BCA" || abc == "BCU")
            {
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/ExportBillLodgementAdviceBCABCU";
            }
            else
            {
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/ExportBillDiscountAdvice";
            }
            ...
            ReportViewer1.ServerReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { DocumentNo, BranchCode });
    ...
    public void FillDatails()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            DocumentDate = dt.Rows[0]["Date_Received"].ToString().Replace("/", "").Replace("_", "");
        }
    }
    //---------------------------End-----------------------------------------------
}
