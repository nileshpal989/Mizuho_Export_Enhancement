...
public partial class Reports_EXPReports_TF_Export_Report_BillDetails : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rdbDocumnetwise.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails";
                reporttype = "Document_wise";
            }
            if (rdbCustomerwise.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails_Cust";
                reporttype = "Customer_wise";
            }
            if (rdbOVPartywise.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails_Ovseasrparty";
                reporttype = "OverseasParty_wise";
            }
            if (rdbOVBankwise.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails_OverseasBank";
                reporttype = "OverseasBank_wise";
            }
            if (rdbCountrywise.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails_Currency";
                reporttype = "Currency_wise";
            }
            if (rdbConsignee.Checked == true)
            {
                script = "TF_Export_Report_ExportBillDetails_Consignee";
            ...
            string _directoryPath = Server.MapPath("~/TF_GeneratedFiles/Export/ExcelReports/Export Bill Outstanding/" + adcode + "/" + dateInfo + "/" + reporttype + "/");
            string FileName = "TF_Export_Bill_Outstanding" + date + ".xlsx";
            ViewState["_directoryPath"] = ("~/TF_GeneratedFiles/Export/ExcelReports/Export Bill Outstanding/" + adcode + "/" + dateInfo + "/" + reporttype + "/");
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "CallMyJQueryFunction", "alert('No Record Found.');", true);
    ...
    private void LogError(Exception ex)
    {
        ...
        message += Environment.NewLine;
        message += "Method " + ViewState["Method"].ToString();
        message += "-----------------------------------------------------------";
        message += Environment.NewLine;

        string FileName = "ErrorLog.txt";
        string dateInfo = DateTime.Now.ToString("ddMMyyyy").Trim();
        string _directoryPath = Server.MapPath("~/TF_GeneratedFiles/Export/ExcelReports/Export Bill Outstanding/" + dateInfo + "/");
        if (!Directory.Exists(_directoryPath))
        {
            Directory.CreateDirectory(_directoryPath);
        }
