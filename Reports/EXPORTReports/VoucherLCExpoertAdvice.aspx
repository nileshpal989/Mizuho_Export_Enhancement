<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoucherLCExpoertAdvice.aspx.cs" Inherits="Reports_EXPORTReports_VoucherLCExpoertAdvice" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            if (document.getElementById('rdbCustomerNon').checked == true)
            {
            popup = window.open(' DocumentLookUpForNonCustomer.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            }
            else if (document.getElementById('rdbCustomer').checked == true)
            {
                popup = window.open('DocumentLookUpExportLC.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            }
        ...
        function Todochelp() {
            ...
            if (document.getElementById('rdbCustomerNon').checked == true) {
                popup = window.open('DocumentLookUpForNonCustomer.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            }
            else if (document.getElementById('rdbCustomer').checked == true) {
                popup = window.open('DocumentLookUpExportLC.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            }
            common = "helpDocId1";
            return false;
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewVoucherLCExpoertAdvice.aspx?frm=' + from + '&rptType=' + rptType + '&rptTypeTo=' + rptTypeTo + '&rptCode=' + rptCode + '&branch=' + Branch + '&check=' + check, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Export L.C. Voucher</span></td>
                               ...
                               <table cellspacing="0" border="0" width="550px">
                                    <tr>
                                        ...
                                        GroupName="cust" 
                                                ...
                                                TabIndex="3" oncheckedchanged="rdbCustomer_CheckedChanged" />
                                            &nbsp;
                                        </td>
                                        ...
                                        GroupName="cust" Text="Non Customer" TabIndex="4" 
                                                 oncheckedchanged="rdbCustomerNon_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr width="550px">
                                        <td class="style8"/> 
