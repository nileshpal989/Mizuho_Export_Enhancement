<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXPORT_rptListofExportLCExpiring.aspx.cs" Inherits="Reports_EXPORTReport_EXPORT_rptListofExportLCExpiring" %>
   ...
   <title></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Benfhelp() {
            ...
            popup = window.open('../../TF_BeneficiaryLookUp_ExpDate.aspx?Doc_no=0' + '&frdate=' + from + '&todate=' + to, 'helpBenfId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpBenfId"
            return false;
        ...
        function IssuingBankhelp() {
            ...
            popup = window.open('../../TF_IssuingBankLookup_ExpDate.aspx?Doc_no=0' + '&frdate=' + from + '&todate=' + to, 'helpIssuingBankId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function validateSave() {
            ...
            var winname = window.open('EXPORT_ViewListofExportLCExpiring.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">List of Export L.C.Expiring</span>
                            </td>
