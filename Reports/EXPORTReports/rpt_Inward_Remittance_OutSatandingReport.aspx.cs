...
public partial class Reports_EXPORTReports_rpt_Inward_Remittance_OutSatandingReport : System.Web.UI.Page
{
    ...
    //public void rdbShippingBillwise_CheckedChanged(object sender, EventArgs e)
    //{
    //    if (rdbShippingBillwise.Checked == true)
    //    {
    //        ShippingList.Visible = true;
    //        txtShippingBill.Text = "";
    //        txtShippingBill.Visible = true;
    //        CustList.Visible = false;
    //    }
    //}
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //else if (rdbShippingBillwise.Checked == true && txtShippingBill.Text.ToString() == "")
        //{
        //    ScriptManager.RegisterClientScriptBlock(this.Page, Page.GetType(), "message", "alert('Enter Shipping Bill No.');", true);
        //}
        else
        {
            string Type = "";
            ...
            //else if (rdbShippingBillwise.Checked == true)
            //{
            //    Type = txtShippingBill.Text;
            //}
            else
            {
                Type = "ADV";
            ...
            string script = "TF_IRMOSReport";
            DataTable dt = objdata.getData(script, p1, p2, p4);
            if (dt.Rows.Count > 0)
            {
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=TF_IRMOSReport" + Convert.ToDateTime(CurrentDate) + ".xlsx");
