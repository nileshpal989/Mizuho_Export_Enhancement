...
public partial class Reports_EXPORTReports_ViewExp_TransactionStatus : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            try
            {
                ...
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptEXPORTTransStatus";
