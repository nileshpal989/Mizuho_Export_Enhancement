<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXP_ExportBillReport.aspx.cs" Inherits="Reports_EXPORTReports_TF_EXP_ExportBillReport" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OVPartyId(event) {
            var key = event.keyCode;
            if (key == 113 && key != 13) {
                document.getElementById('btnOverseasPartyList').click();
            }
        }
        ...
        function OVBankId(event) {
            var key = event.keyCode;
            if (key == 113 && key != 13) {
                document.getElementById('btnOverseasBankList').click();
            }
        }
        ...
        function Currencyhelp() {
            ...
            popup = window.open('../../TF_CurrencyLookUp2.aspx', 'helpCurrencyId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpCurrencyId"
            return false;

        }

        function CurrencyId(event) {
            var key = event.keyCode;
            if (key == 113 && key != 13) {
                document.getElementById('btnCurrencyList').click();
            }
        }
        ...
        function Consigneehelp() {
            ...
            popup = window.open('TF_EXP_ConsigneePARTY_Helpform_RPT.aspx', 'helpConsigneeId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function sss() {
            ...
            if (common == "helpOVPartyId") {
                document.getElementById('txtOverseasPartyID').value = s;
            }
            if (common == "helpOVBankId") {
                document.getElementById('txtOverseasBankID').value = s;
            }
            if (common == "helpCurrencyId") {
                document.getElementById('txtCurrency').value = s;
            }
            if (common == "helpConsigneeId") {
                document.getElementById('txtConsigneePartyID').value = s;
            }
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>EXPORT Bill Receipt</strong></span>
                            </td>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="800px" style="line-height: 150%">
                                   <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                            <asp:RadioButton ID="rdbDocumentWise" runat="server" AutoPostBack="true" 
                                                CssClass="elementLabel" GroupName="Data1" 
                                                OnCheckedChanged="rdbDocumentWise_CheckedChanged" TabIndex="5" 
                                                Text="Document Wise" Checked="true" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <asp:RadioButton ID="rdbSelectedCustomer" runat="server" AutoPostBack="true" 
                                                ...
                                                CssClass="elementLabel" GroupName="Data1" 
                                                OnCheckedChanged="rdbSelectedOverseasParty_CheckedChanged" TabIndex="5" 
                                                Text="Overseas Party Wise" />
                                        </td>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                            <asp:RadioButton ID="rdbOverseasBankWise" runat="server" AutoPostBack="true" 
                                                CssClass="elementLabel" GroupName="Data1" 
                                                OnCheckedChanged="rdbOverseasBankWise_CheckedChanged" TabIndex="5" 
                                                Text="Overseas BanK Wise"/>
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                            <asp:RadioButton ID="rdbSelectedConsigneeParty" runat="server" AutoPostBack="true" 
                                                CssClass="elementLabel" GroupName="Data1" 
                                                OnCheckedChanged="rdbSelectedConsigneeParty_CheckedChanged" TabIndex="5" 
                                                Text="Consignee Party Wise" />
                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                 <asp:RadioButton ID="rdbSelectedCurrency" runat="server" AutoPostBack="true" 
                                                CssClass="elementLabel" GroupName="Data1" 
                                                OnCheckedChanged="rdbSelectedCurrency_CheckedChanged" TabIndex="5" 
                                                Text="Currency Wise" />
                                        </td>
                                 ...
                                 <fieldset ID="OverseasPartylist" runat="server" style="width: 800px"  visible="false" >
                                    <legend>Select Overseas Party Name</legend>
                                    <table ID="Table3" runat="server">
                                        <tr>
                                     
                                            <td align="right" style="font-weight: bold; color: #000000; font-size: medium;" width="200px">
                                                <span style="color: Red">*</span>Overseas Party ID :&nbsp;
                                            </td>
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOverseasPartyID" runat="server" CssClass="textBox" 
                                                    MaxLength="40"  TabIndex="6" Visible="false" 
                                                    Width="100px" ontextchanged="txtOverseasPartyID_TextChanged" 
                                                    AutoPostBack="True"></asp:TextBox>
                                                &nbsp;
                                                <asp:Button ID="btnOverseasPartyList" runat="server" CssClass="btnHelp_enabled" 
                                                    Visible="false" />
                                                &nbsp;
                                                <asp:Label ID="lblOverseasPartyName" runat="server" CssClass="elementLabel" 
                                                    Visible="false" Width="400px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                           ...
                                           <fieldset ID="OverseasBanklist" runat="server" style="width: 800px"  visible="false" >
                                    <legend>Select Overseas Bank  Name</legend>
                                    <table ID="Table4" runat="server">
                                        <tr>
                                     
                                            <td align="right" style="font-weight: bold; color: #000000; font-size: medium;" width="200px">
                                                <span style="color: Red">*</span>Overseas Bank ID :&nbsp;
                                            </td>
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOverseasBankID" runat="server" CssClass="textBox" 
                                                    MaxLength="40"  TabIndex="6" Visible="false" 
                                                    Width="100px" ontextchanged="txtOverseasBankID_TextChanged" 
                                                    AutoPostBack="True"></asp:TextBox>
                                                &nbsp;
                                                <asp:Button ID="btnOverseasBankList" runat="server" CssClass="btnHelp_enabled" 
                                                    Visible="false" />
                                                &nbsp;
                                                <asp:Label ID="lblOverseasBankName" runat="server" CssClass="elementLabel" 
                                                    Visible="false" Width="400px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                   ...
                                   <fieldset ID="ConsigneePartylist" runat="server" style="width: 800px"  visible="false" >
                                    <legend>Select Consignee Party  Name</legend>
                                    <table ID="Table5" runat="server">
                                        <tr>
                                     
                                            <td align="right" style="font-weight: bold; color: #000000; font-size: medium;" width="200px">
                                                <span style="color: Red">*</span>Consignee Party ID :&nbsp;
                                            </td>
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtConsigneePartyID" runat="server" CssClass="textBox" 
                                                    MaxLength="40"  TabIndex="6" Visible="false" 
                                                    Width="100px" ontextchanged="txtConsigneePartyID_TextChanged" 
                                                    AutoPostBack="True"></asp:TextBox>
                                                &nbsp;
                                                <asp:Button ID="btnConsigneePartyList" runat="server" CssClass="btnHelp_enabled" 
                                                    Visible="false" />
                                                &nbsp;
                                                <asp:Label ID="lblConsigneePartyName" runat="server" CssClass="elementLabel" 
                                                    Visible="false" Width="400px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                 ...
                                 <fieldset ID="Currencylist" runat="server" style="width: 800px"  visible="false" >
                                    <legend>Select Currency</legend>
                                    <table ID="Table6" runat="server">
                                        <tr>
                                     
                                            <td align="right" style="font-weight: bold; color: #000000; font-size: medium;" width="200px">
                                                <span style="color: Red">*</span>Currency ID :&nbsp;
                                            </td>
                                            <td align="left" width = "0px" style="font-weight: bold; color: #000000;">
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="txtCurrency" runat="server" CssClass="textBox" 
                                                    MaxLength="40"  TabIndex="6" Visible="false" 
                                                    Width="100px" ontextchanged="txtCurrency_TextChanged" 
                                                    AutoPostBack="True"></asp:TextBox>
                                                &nbsp;
                                                <asp:Button ID="btnCurrencyList" runat="server" CssClass="btnHelp_enabled" 
                                                    Visible="false" />
                                                &nbsp;
                                                <asp:Label ID="lblCurrency" runat="server" CssClass="elementLabel" 
                                                    Visible="false" Width="400px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
