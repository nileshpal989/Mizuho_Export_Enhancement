...
public partial class Reports_EXPORTReports_ViewExp_rptLCPayNotReceived : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExpLCPayNotReceived";
                    BeneCode.Values.Add("");
                    pur.Values.Add("0");
