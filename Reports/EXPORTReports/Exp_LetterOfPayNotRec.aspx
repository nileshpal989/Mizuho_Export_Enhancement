<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exp_LetterOfPayNotRec.aspx.cs" Inherits="Reports_EXPORTReports_Exp_LetterOfPayNotRec" %>
...
//            var from = document.getElementById('txtFromDate').value;
            ...
            popup = window.open('../../TF_BeneficiaryLookUp2.aspx?Doc_no=0' , 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpDocId"
            return false;
...
//            var from = document.getElementById('txtFromDate').value;
            ...
            var winname = window.open('ViewExp_LetterOfPayNotRec.aspx?rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel">NON PAYMENT OF ADVISING CHARGES LETTER </span>
                                </td>
