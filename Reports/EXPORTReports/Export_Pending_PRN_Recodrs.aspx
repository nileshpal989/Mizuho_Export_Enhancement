<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Export_Pending_PRN_Recodrs.aspx.cs" Inherits="Reports_EXPORTReports_Export_Pending_PRN_Recodrs" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong> Pending PRN Report</strong></span>
                            </td>
                    ...
                    <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top" colspan="2">
                               ...
                               <%-- <asp:RadioButton ID="rdbSelectedCountry" runat="server" AutoPostBack="true" CssClass="elementLabel"
                                    ...
                                    <legend><span class="elementLabel">Select Customer Name</span></legend>
                                ...
                                <table>
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            &nbsp;
                                            <asp:Button runat="server" ID="btnGenerate" CssClass="buttonDefault" 
                                                Text="Download" ToolTip="Download" TabIndex="7" onclick="btnGenerate_Click" />
