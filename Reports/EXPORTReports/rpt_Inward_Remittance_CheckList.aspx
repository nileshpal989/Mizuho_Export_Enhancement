<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Inward_Remittance_CheckList.aspx.cs" Inherits="Reports_EXPORTReports_rpt_Inward_Remittance_CheckList" %>
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong> Inward Remittance CheckList</strong></span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                                <span class="mandatoryField">*<span class="elementLabel">CheckList : </span>
                            </td>
                            <td align="left">       
                                    <asp:DropDownList ID="ddlCheckList" runat="server" CssClass="dropdownList"
                                     TabIndex="35" Height="19px">
                                    <asp:ListItem Value="">--Select--</asp:ListItem>  
                                        <asp:ListItem Value="IRM">IRM</asp:ListItem> 
