...
public partial class Reports_EXPORTReports_ViewVoucherLCExpoertCustAdvice : System.Web.UI.Page
{
     protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/VoucherExportLCustAdvice";
                    docno = "";
                    todocno = "";
                    pur.Values.Add("0");
                }
