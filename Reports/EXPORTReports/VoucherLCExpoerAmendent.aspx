<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoucherLCExpoerAmendent.aspx.cs" Inherits="Reports_EXPORTReports_VoucherLCExpoerAmendent" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewVoucherLCExpoerAmendent.aspx?frm=' + from + '&rptType=' + rptType + '&rptTypeTo=' + rptTypeTo + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Export L.C. Amendment Voucher</span></td>
