<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoucherContingMentConmermationAmendment.aspx.cs" Inherits="Reports_EXPORTReports_VoucherContingMentConmermationAmendment" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            var Doc = '';
            popup = window.open('DocumentLookUpContingmentConfirAmendment.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function Todochelp() {
            ...
            popup = window.open('DocumentLookUpContingmentConfirAmendment.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "helpDocId1";
            return false;
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewVoucherContingMentConmermationAmendment.aspx?frm=' + from + '&rptType=' + rptType + '&rptTypeTo=' + rptTypeTo + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">&nbsp;Contingent Export L.C. Amendment Confirmation</span></td>
