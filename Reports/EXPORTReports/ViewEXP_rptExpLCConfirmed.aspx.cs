...
public partial class Reports_EXPORTReports_ViewEXP_rptExpLCConfirmed : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["branch"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExpLCConfirmed";
                    docno = "";
                    pur.Values.Add("0");
                }
