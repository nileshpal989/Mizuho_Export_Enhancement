...
public partial class Reports_EXPORTReports_EXPORT_DocNoLookup_Amtd : System.Web.UI.Page
{
    string query;
    ...
    public void grdDataBind()
    {
        ...
        query = "HelpDocumentNO_ExportLC_Amtd";
        ...
        p4.Value = Request.QueryString["Branch"].ToString();
        ...
        DataTable dt = objData.getData(query, p2, p1, p3,p4,p5);
