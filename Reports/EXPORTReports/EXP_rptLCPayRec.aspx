<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_rptLCPayRec.aspx.cs" Inherits="Reports_EXPORTReports_EXP_rptLCPayRec" %>
...
//        }
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewEXP_rptLCPayRec.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">List of Payment Received</span>&nbsp;</td>
