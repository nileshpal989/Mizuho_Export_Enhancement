...
public partial class Reports_EXPORTReports_rpt_Export_DiscountAdvice : System.Web.UI.Page
{
    ...
    public void fillddlDocument()
    {
        ...
        SqlParameter p3 = new SqlParameter("@BillType", SqlDbType.VarChar);
        p3.Value = BillType;
        string _query = "TF_EXP_GetDocumentno";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ddlDocumentno.SelectedValue == "")
        {
        ...
        else
        {
            ...
            string url = "~/Reports/EXPORTReports/ViewExportBillDiscountAdvice.aspx?DocSrNo=" + docno + "&BranchName=" + branchcode;
