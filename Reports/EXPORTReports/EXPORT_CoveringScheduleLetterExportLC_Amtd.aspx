<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXPORT_CoveringScheduleLetterExportLC_Amtd.aspx.cs" Inherits="Reports_EXPORTReports_EXPORT_CoveringScheduleLetterExportLC_Amtd" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dochelp() {
            ...
            popup = window.open('EXPORT_DocNoLookup_Amtd.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function Todochelp() {
            ...
            var Branch = document.getElementById('ddlBranch').value;
            popup = window.open('EXPORT_DocNoLookup_Amtd.aspx?Doc_no=0' + '&frdate=' + from + '&Doc=' + Doc + '&rptType=' + rptType + '&branch=' + Branch, 'helpDocId1', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function validateSave() {
            ...
            var winname = window.open('EXPORT_ViewCoveringScheduleLetterExportLC_Amtd.aspx?frm=' + from + '&rptType=' + rptType + '&rptCode=' + rptCode + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&branch=' + Branch + '&Print1=' + Print1 + '&Print2=' + Print2 + '&Copy=' + Copy, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1050,height=550');
            winname.focus();
            return false;
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Covering Schedule Letter - Amendment</span>
                            </td>
