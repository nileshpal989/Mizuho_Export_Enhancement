<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXPORT_rptLCAdvisedAmendment.aspx.cs" Inherits="Reports_EXPORTReports_EXPORT_rptLCAdvisedAmendment" %>
   ...
   <title></title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('EXPORT_ViewLCAdvisedAmendment.aspx?frm=' + from + '&to=' + to + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Export L.C.Advised - Amendment</span>
                            </td>
