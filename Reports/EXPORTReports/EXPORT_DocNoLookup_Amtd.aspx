<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXPORT_DocNoLookup_Amtd.aspx.cs" Inherits="Reports_EXPORTReports_EXPORT_DocNoLookup_Amtd" %>
                    ...
                    <tr>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Our_Ref_No" HeaderText="Doc No." ItemStyle-Width="40%"
                                        ItemStyle-HorizontalAlign="Left" >
                                    <ItemStyle HorizontalAlign="Left" Width="40%" />
                                    </asp:BoundField>
                                    <%--<asp:BoundField DataField="Our_Ref_Date" HeaderText="Doc Date" />--%>
                                     <asp:BoundField DataField="Our_Ref_Date" HeaderText="Doc Date." ItemStyle-Width="40%"
                                        ItemStyle-HorizontalAlign="Left" DataFormatString="{0:dd/MM/yyyy}" >
                                    <ItemStyle HorizontalAlign="Left" Width="50px" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="LC_NO" HeaderText="LC No." ItemStyle-Width="120px" 
                                        ItemStyle-HorizontalAlign="Left" >
