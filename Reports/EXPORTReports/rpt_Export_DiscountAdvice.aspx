<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Export_DiscountAdvice.aspx.cs"
    Inherits="Reports_EXPORTReports_rpt_Export_DiscountAdvice" %>
                    ...
                    <table cellspacing="10" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%;" valign="top" colspan="2">
                                <span class="pageLabel">EXPORT BILL DISCOUNT/NEGOTIATION ADVICE </span>
                        ...
                        <tr style="height: 30px;" valign="bottom">
                            <td style="text-align: left; width: 5%; white-space: nowrap;">
                                ...
                                <asp:RadioButton ID="rbAll" runat="server" TabIndex="3" CssClass="elementLabel" Checked="true"
                                    Text="All" GroupName="TransType" OnCheckedChanged="All_CheckedChanged" AutoPostBack="true" />&nbsp;
                                <asp:RadioButton ID="rbBLA" runat="server" TabIndex="4" CssClass="elementLabel" Text="BLA"
                                    GroupName="TransType" OnCheckedChanged="rbBLA_CheckedChanged" AutoPostBack="true" />&nbsp;
                                <asp:RadioButton ID="rbBLU" runat="server" TabIndex="5" CssClass="elementLabel" Text="BLU"
                                    GroupName="TransType" OnCheckedChanged="rbBLU_CheckedChanged" AutoPostBack="true" />&nbsp;
                                <asp:RadioButton ID="rbBBA" runat="server" TabIndex="6" CssClass="elementLabel" Text="BBA"
                                    GroupName="TransType" OnCheckedChanged="rbBBA_CheckedChanged" AutoPostBack="true" />&nbsp;
                                <asp:RadioButton ID="rbBBU" runat="server" TabIndex="7" CssClass="elementLabel" Text="BBU"
                                    GroupName="TransType" AutoPostBack="true" OnCheckedChanged="rbBBU_CheckedChanged" />&nbsp;
                                <asp:RadioButton ID="rbBCA" runat="server" TabIndex="8" CssClass="elementLabel" Text="BCA"
                                    GroupName="TransType" AutoPostBack="true" OnCheckedChanged="rbBCA_CheckedChanged" />&nbsp;
                                <asp:RadioButton ID="rbBCU" runat="server" TabIndex="9" CssClass="elementLabel" Text="BCU"
                        ...
                        <tr>
                            <td align="left" nowrap>
                                <span class="mandatoryField">*</span> <span class="elementLabel" runat="server">Document
                                    No: </span>&nbsp;<asp:DropDownList ID="ddlDocumentno" CssClass="dropdownList" TabIndex="10"
                        ...
                        <tr valign="bottom">
                            <td align="left" style="width: 700px; padding-top: 10px; padding-left: 80px" valign="bottom">
                                ...
                                <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate"
                                    Width="135px" ToolTip="Generate" TabIndex="11" OnClick="btnSave_Click" />
                            </td>
                        </tr>
                    </table>
                    </td>
