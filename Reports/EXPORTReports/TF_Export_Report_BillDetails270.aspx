<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_Export_Report_BillDetails270.aspx.cs"
    Inherits="Reports_EXPReports_TF_Export_Report_BillDetails270" %>
...
<head id="Head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ClickAnotherButton() {
            document.getElementById('btndwnldreport').click();
            ...
            if (fromDate.value == '') {
               ...
               var progressbar= setTimeout(function () {
                ...
                if (document.getElementById('rdbConsignee').checked == true) {
                    ...
                    if (document.getElementById('rdbAllConsignee').checked == true) {
                        rptType = 'All';
                    }
                    else if (document.getElementById('rdbSelectedConsignee').checked == true) {
                        ...
                        rptType = document.getElementById('txtConsignee').value;
                    }
                }
...
<body>
    <form id="form2" runat="server" autocomplete="off">
        ...
        <div class="loading" align="center">
            Please wait while the Report are Generating..<br />
            <br />
            ...
            <center>
                ...
                <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                    <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="btndwnldreport" />
                    </Triggers>
                    <ContentTemplate>
                        <input type="hidden" id="hdnrptCode" runat="server" />
                                    ...
                                    <table cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td align="left" style="width: 50%" valign="bottom">
                                                <span class="pageLabel"><strong>Export Bill Outstanding Statement More Than 270 Days</strong></span>
                                            </td>
                            ...
                            <tr>
                                ...
                                <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate Report" OnClick="btnSave_Click"
                                    ToolTip="Generate Report" TabIndex="41" />
                                                <asp:Button ID="btndwnldreport" runat="server" Style="visibility: hidden" OnClick="lnkDownload_Click"/>
                                                <td>&nbsp;
                                                </td>
