...
public partial class Reports_EXPORTReports_rpt_Inward_Remittance_UtilizationReport : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string script = "TF_IRMUtilizationReport";
            ...
            if (dt.Rows.Count > 0)
            {
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=TF_IRMUtilizationReport" + Convert.ToDateTime(CurrentDate) + ".xlsx");
