<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentLookUpContingmentConfirAmendment.aspx.cs" Inherits="Reports_EXPORTReports_DocumentLookUpContingmentConfirAmendment" %>
                    ...
                    <tr>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Our_Ref_No" HeaderText="DOC NO." ItemStyle-Width="60px"
                                        ItemStyle-HorizontalAlign="Left" >
                                    <ItemStyle HorizontalAlign="Left" Width="60px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LC_Currency" HeaderText="CUR" />
