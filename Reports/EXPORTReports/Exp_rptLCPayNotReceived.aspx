<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exp_rptLCPayNotReceived.aspx.cs" Inherits="Reports_EXPORTReports_Exp_rptLCPayNotReceived" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('ViewExp_rptLCPayNotReceived.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=950,height=550');
            winname.focus();
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">List of Payment Not Received</span>&nbsp;</td>
