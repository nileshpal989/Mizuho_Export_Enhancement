<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_rptPrinting.aspx.cs" Inherits="Reports_EXPORTReports_EXP_rptPrinting" %>
   ...
   <%-- <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateGenerate() {
            ...
            var winname = window.open('ViewEXPrptPrinting.aspx?frm=' + from + '&rptType=' + rptType + '&rptFrdocno=' + rptFrdocno + '&rptTodocno=' + rptTodocno + '&rptCode=' + rptCode, '', 'scrollbars=yes,status=0,menubar=0,left=0,top=50,width=950,height=550');
            winname.focus();
            return false;
        }
    </script>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel">L.C Swift / Telex / Mail Message </span>
                                </td>
