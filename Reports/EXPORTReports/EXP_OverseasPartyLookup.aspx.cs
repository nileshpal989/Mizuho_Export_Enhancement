...
public partial class Reports_EXPReports_EXP_OverseasPartyLookup : System.Web.UI.Page
{
    ...
    public void grdDataBind()
    {
        ...
        query = "HelpOverseasPartyMstr_Export";
    ...
    protected void txtsearch_TextChanged(object sender, EventArgs e)
    {
        ...
        else if (txtsearch.Text == "")
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "message", "alert('Please Enter Party  Name');", true);
            grdDataBind();
            txtsearch.Focus();
        }
    }
