...
public partial class Reports_EXPORTReports_ViewExp_rptLCConfirmCharges : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Microsoft.Reporting.WebForms.ReportParameter BeneCode = new Microsoft.Reporting.WebForms.ReportParameter();
            BeneCode.Name = "BeneCode";
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                {
                    serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/rptExpLCConfirmedReport";
                    BeneCode.Values.Add("");
                    pur.Values.Add("0");
                ...
                else if (Request.QueryString["rptCode"] == "2")
                {
                    ...
                    //custid.Name = "custid";
                    BeneCode.Values.Add(Request.QueryString["rptType"].ToString());
                    //ReportViewer1.ServerReport.SetParameters(
                    //new Microsoft.Reporting.WebForms.ReportParameter[] { BeneCode });
                    pur.Values.Add("1");
                }
                ...
                ReportViewer1.ServerReport.SetParameters(
                   new Microsoft.Reporting.WebForms.ReportParameter[] { frmDate, enddate, sessiontrue, branch, pur, BeneCode, user });
            }
        }
