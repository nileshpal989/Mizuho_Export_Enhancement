<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_Datachecklist_Docreceived.aspx.cs" Inherits="Reports_EDPMS_Reports_EDPMS_Datachecklist_Docreceived" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            var winame = window.open('View_EDPMS_Checklist_DocReceived.aspx?branchname=' + brname.value + '&fromdate=' + frmdate.value + '&todate=' + todate.value, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1080,height=600');
            winame.focus();
            return false;
            //return true;
        }
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                         ...
                         <tr>
                        <td align=left><span class=pageLabel>Data Checklist Receipt Of Document</span></td>
                        </tr>
                        <tr>
