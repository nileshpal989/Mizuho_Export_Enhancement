<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_Receipt_Doc_Ack.aspx.cs" Inherits="Reports_EDPMS_Reports_EDPMS_Receipt_Doc_Ack" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (rdball.checked == true) {
              ...
              var winame = window.open('View_Reciept_Doc_Ack.aspx?branchname=' + brname.value + '&ErrorCode=' + ErrorCode, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
            winame.focus();
            return false;
            //return true;
        }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                         ...
                         <tr>
                        <td align=left><span class=pageLabel>Receipt Of Document (Acknowledgement)</span></td>
                        </tr>
                        <tr>
