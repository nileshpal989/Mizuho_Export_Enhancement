...
public partial class Reports_EDPMS_Reports_VIEW_EDPMS_CHECKLIST : System.Web.UI.Page
{
            ...
            if (Request.QueryString["branchname"]!= null)
            {
                 string url = WebConfigurationManager.ConnectionStrings["urlrpt"].ConnectionString;
                    ...
                    serverReport.ReportServerUrl = new Uri(url);
                     ...
                     serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_EDPMS_EXPORT_DOCUMENTS_RECEIVED";
