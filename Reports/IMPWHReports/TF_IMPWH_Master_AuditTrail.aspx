<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMPWH_Master_AuditTrail.aspx.cs" Inherits="Reports_IMPWHReports_TF_IMPWH_Master_AuditTrail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Generate() {
            ...
            var Report = "Audit Trail";
            var Module = document.getElementById("hdnModule").value;
            var Type = "";
            var User = "";
            ...
            var winname = window.open('TF_IMPWH_ViewMasters.aspx?frm=' + txtFromDate.value + '&to=' + txtToDate.value + '&Branch=' + ddlBranch.value + '&User=' + User + '&Type=' + Type + '&Report=' + Report + '&Module=' + Module, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
    </script>
