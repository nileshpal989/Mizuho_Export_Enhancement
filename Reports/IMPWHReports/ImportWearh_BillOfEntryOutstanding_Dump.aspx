<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportWearh_BillOfEntryOutstanding_Dump.aspx.cs"
    Inherits="Reports_ImportWearh_BillOfEntryOutstanding_Dump" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('ViewImport_OutstandingDump.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('ViewImport_OutstandingDump.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                &nbsp;<span class="pageLabel"><strong>Import Bill of Entry Outstanding Report </strong>
                                </span>
                            </td>
                        </tr>
                        <tr>
