<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMPWH_FileUpload_AuditTrail.aspx.cs" Inherits="Reports_IMPWHReports_TF_IMPWH_FileUpload_AuditTrail" %>
    ...
    <script type="text/javascript">
        ...
        function Generate() {
            ...
            if (document.getElementById('rdbAllCustomer').checked == true) {
                var winame = window.open('TF_IMPWH_View_FileUpload.aspx?from=' + frmdate.value + '&to=' + todate.value + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtUserName').value;
                var winame = window.open('TF_IMPWH_View_FileUpload.aspx?from=' + frmdate.value + '&to=' + todate.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
        }
