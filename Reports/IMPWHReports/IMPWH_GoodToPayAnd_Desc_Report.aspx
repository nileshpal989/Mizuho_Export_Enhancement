<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IMPWH_GoodToPayAnd_Desc_Report.aspx.cs"
    Inherits="Reports_IMPWH_GoodToPayAnd_Desc_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            else if (document.getElementById('rdbG').checked == true) {
                status = 'G';
            }
            else if (document.getElementById('rdbD').checked == true) {
                status = 'D';
            }

            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('View_GoodToPayandisc_rpt.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&stat=' + status + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('View_GoodToPayandisc_rpt.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&stat=' + status + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                &nbsp;<span class="pageLabel"><strong>Good To Pay and Discripancy Report </strong></span>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" nowrap>
                                            <asp:RadioButton ID="rdball" runat="server" Checked="True" GroupName="rdbgroup1"
                                                CssClass="elementLabel" Text="All" OnCheckedChanged="rdball_CheckedChanged" />
                                            &nbsp;<asp:RadioButton ID="rdbG" runat="server" GroupName="rdbgroup1" CssClass="elementLabel"
                                                Text="G" OnCheckedChanged="rdbG_CheckedChanged" />
                                            &nbsp;<asp:RadioButton ID="rdbD" runat="server" GroupName="rdbgroup1" CssClass="elementLabel"
                                                Text="D" OnCheckedChanged="rdbD_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
