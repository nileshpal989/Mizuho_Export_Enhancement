<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMPWH_ImportBillPaid_Report.aspx.cs" Inherits="Reports_IMPWHReports_TF_IMPWH_ImportBillPaid_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CustHelp() {
            ...
            popup = window.open('../../ImportWareHousing/HelpForms/TF_IMPWH_ImportCustomer.aspx', 'CustHelp', 'height=500,  width=450,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
            common = "CustHelp";
        ...
        function generateReport() {
            ...
            var fromAmount = document.getElementById('txtfromAmt');
            var ToAmount = document.getElementById('txttoAmt');
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('TF_View_IMPWH_ImportBillPaid.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&FrmAmt=' + fromAmount.value + '&ToAmt=' + ToAmount.value + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('TF_View_IMPWH_ImportBillPaid.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&FrmAmt=' + fromAmount.value + '&ToAmt=' + ToAmount.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Import Bill Paid Report</strong></span>
                        ...
                        <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="1300px" style="line-height: 150%">
                                   ...
                                   <tr>
                                       <td width="10%" align="center" nowrap>
                                            <span class="mandatoryField">&nbsp; *</span><span class="elementLabel">From Amount :
                                                </span>
                                        </td>
                                        <td align="left" nowrap>
                                            <asp:TextBox ID="txtfromAmt" runat="server" Width="70px" TabIndex="2" MaxLength="20"
                                                CssClass="textBox" Text="1" ToolTip="Press F2 for Help"></asp:TextBox>
                                        </td>
                                       
                                    </tr>
                                    <%-- <tr>
                                       <td width="10%" align="center" nowrap>
                                            <span class="mandatoryField">&nbsp; *</span><span class="elementLabel">Currency :
                                                </span>
                                        </td>
                                        <td align="left" nowrap>
                                         <span class="mandatoryField">&nbsp; </span><span class="elementLabel">USD
                                                </span>
                                        </td>
                                    ...
                                    <tr>
                                       <td width="10%" align="center" nowrap>
                                           &nbsp; &nbsp;<span class="mandatoryField">&nbsp; *</span><span class="elementLabel">To Amount :
                                                </span>
                                        </td>
                                          <td align="left" nowrap>
                                            <asp:TextBox ID="txttoAmt" runat="server" Width="70px" TabIndex="2" MaxLength="20"
                                                CssClass="textBox" ToolTip="Press F2 for Help" Text="9999999"></asp:TextBox>
                                        </td>
                                ...
                                <table id="selectedcust" visible="false" runat="server" cellspacing="0" border="0"
                                    ...
                                    <tr>
                                     ...
                                     <%--<tr>
                                        ...
                                        <td width="7%" nowrap>
                                            <asp:TextBox ID="txtfromAmt" runat="server" Width="100" TabIndex="2" MaxLength="20"
                                                CssClass="textBox" ToolTip="Press F2 for Help"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="7%" nowrap>
                                            <asp:TextBox ID="txttoAmt" runat="server" Width="100" TabIndex="2" MaxLength="20"
                                                CssClass="textBox" ToolTip="Press F2 for Help"></asp:TextBox>
                                        </td>
