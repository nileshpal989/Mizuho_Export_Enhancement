...
public partial class Reports_IMPWHReports_TF_IMPWH_ViewMasters : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Request.QueryString["frm"] != null && Request.QueryString["to"] != null)
            {
                ...
                {
                    case "Audit Trail":
                        serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IMPWH_MasterReport";
                        break;
                }
