...
public partial class Reports_IMPWHReports_View_IMPWH_StatusUpdationAuditTrail_Report : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IMPWH_InvoiceStatusUpdation";
           ...
           // string modu = Request.QueryString["ModuleType"].ToString();
            ...
            ReportViewer1.ServerReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { FROMDT, TODT, branch1, Cust, user, module });
        }
    }
}