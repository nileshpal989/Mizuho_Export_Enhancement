<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMPWH_OverDueImportBillReport.aspx.cs" Inherits="Reports_IMPWHReports_TF_IMPWH_OverDueImportBillReport" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('TF_IMPWH_View_OverdueImportReport.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('TF_IMPWH_View_OverdueImportReport.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                &nbsp;<span class="pageLabel"><strong>Overdue Import Bills Report</strong>
                                </span>
                            </td>
                        </tr>
                        <tr>
