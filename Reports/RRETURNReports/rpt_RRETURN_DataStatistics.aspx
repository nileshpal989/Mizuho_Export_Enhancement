<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_RRETURN_DataStatistics.aspx.cs" Inherits="Reports_RRETURNReports_rpt_RRETURN_DataStatistics" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateSave() {
            ...
            var winname = window.open('View_rpt_RRETURN_DataStatistics.aspx?frm=' + from + '&to=' + to + '&rptType=' + rptType + '&rptCode=' + rptCode + '&branch=' + Branch + '&Report=' + Report, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1100,height=550');
            winname.focus();
            return false;
        }
    </script>
