<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_RRETURN_CurrencyHelp_Nostro.aspx.cs" Inherits="Reports_RRETURNReports_TF_RRETURN_CurrencyHelp_Nostro" %>
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewCurrList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewCurrList_RowCommand"
                                    OnRowDataBound="GridViewCurrList_RowDataBound" 
                                    onrowcreated="GridViewCurrList_RowCreated" PageSize=15  
                                    onblur="GiveFocus='FALSE';CheckFocus();" Height="130px">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Currency ID" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCurrID" runat="server" Text='<%# Eval("C_Code") %>' style="text-align:center" CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
