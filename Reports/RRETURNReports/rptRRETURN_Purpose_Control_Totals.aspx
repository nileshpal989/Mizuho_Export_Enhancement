<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRRETURN_Purpose_Control_Totals.aspx.cs"
    Inherits="Reports_RRETURNReports_rptRRETURN_Purpose_Control_Totals" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function validateSave() {
            ...
            var winname = window.open('ViewrptRRETURN_Purpose_Control_Totals.aspx?frm=' + from + '&to=' + to + '&branch=' + Branch + '&Report=' + Report, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1300,height=550');
            winname.focus();
            return false;
        }
    </script>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 220px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate Report"
                                                ToolTip="Generate" TabIndex="4" Width="135px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
