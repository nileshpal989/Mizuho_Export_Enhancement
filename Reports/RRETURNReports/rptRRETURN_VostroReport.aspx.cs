...
using System.Data;
using System.IO;
public partial class Reports_RRETURNReports_rptRRETURN_VostroReport : System.Web.UI.Page
{
        ...
        else
        {
            if (!IsPostBack)
            {
              //  fillCurrency();
               ...
               // ddlCurrency.Attributes.Add("onchange", "return changeCurrencyDesc();");
            }
            txtfromDate.Focus();
    ...
    private void fillAuthCodeDescription()
    {
        if (txtAuthSign.Text != "")
        {
            ...
            {
                txtAuthSign.Text = "";
                lblAuthSignName.Text = "<font style=color:red>"+"Invalid Id"+"</fonts>";
                txtAuthSign.Focus();
            }
        }
        else
    ...
    //    p1.Value = "";
    //    string _query = "TF_rptRRETURN_GetCurrencyList";
    //    DataTable dt = objData.getData(_query, p1);
    ...
    protected void fillCurrency()
    {
        ...
        lio.Value = "0";
        lio.Text = "INR";
        ddlCurrency.Items.Add(lio);
        ListItem li1 = new ListItem();
        li1.Value = "1";
        li1.Text = "ACD";
        ddlCurrency.Items.Add(li1);
    }
    protected void btnCurr_Click(object sender, EventArgs e)
    {
        if (hdnCurId.Value != "")
        {
            ...
            {
                case "6":
                    ddlCurrency.Text = hdnCurId.Value;
                    ddlCurrency.Text = hdnCurName.Value;
                    ddlCurrency.Focus();
                    break;
            }
        }
    ...
    protected void dropDownListCurrency_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        else if (ddlCurrency.SelectedIndex == 1)
        {
            txtCurrencyDescription.Text = "ASIAN CURRENCY DOLLAR";
            hdnCurrency.Value = "ACD";
        }
        ddlCurrency.Focus();
    }
}