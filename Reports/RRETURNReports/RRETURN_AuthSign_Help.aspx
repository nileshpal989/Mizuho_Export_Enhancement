<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRETURN_AuthSign_Help.aspx.cs"
    Inherits="Reports_RRETURNReports_RRETURN_AuthSign_Help" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    OnRowDataBound="GridViewCustAcList_RowDataBound" 
                                    onrowcreated="GridViewCustAcList_RowCreated" PageSize=15  onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("Authorised_Signatory") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Designation" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="25%" ItemStyle-Width="25%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDesignation" runat="server" Text='<%# Eval("Designation") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
