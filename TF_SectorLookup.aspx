<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_SectorLookup.aspx.cs" Inherits="TF_SectorLookup" %>
                    ...
                    <table cellspacing="0" cellpadding="2" border="0" width="50%" style="padding-top: 10px">
                                    ...
                                    <tr>
                                        <td nowrap>
                                            <asp:RadioButtonList ID="rbtnType" AutoPostBack="true" runat="server" OnSelectedIndexChanged="rbtnType_SelectedIndexChanged">
                                                <asp:ListItem Text="Sector ID" Value="1" Selected="true"></asp:ListItem>
                                                <asp:ListItem Text="Sector Name" Value="2"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td align="left" style="width: 15%;" valign="top" colspan="2">
                                &nbsp;<asp:ListBox ID="lstSectList" runat="server" Height="335px" Width="320px" CssClass="labelcss"
