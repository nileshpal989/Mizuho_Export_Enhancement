<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_PortCodeLookup.aspx.cs"
    Inherits="RBI_PortCodeLookup" %>
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Port Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankCode" runat="server" Text='<%# Eval("port_Code") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
