<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_BusinessSourceLookup.aspx.cs" Inherits="TF_BusinessSourceLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
   <head id="Head1" runat="server">
    <title>Business Source Master List</title>
...
<body bgcolor="#CDDAE4" topmargin="0" bottommargin="0" rightmargin="0" leftmargin="0"
    ...
    <form id="form1" autocomplete="off" runat="server" defaultbutton="btnSubmit">
                    ...
                    <table cellspacing="0" cellpadding="2" border="0" width="50%" style="padding-top: 10px">
                                    ...
                                    <tr>
                                        <td nowrap>
                                            <asp:RadioButtonList ID="rbtnType" AutoPostBack="true" runat="server" OnSelectedIndexChanged="rbtnType_SelectedIndexChanged">
                                                <asp:ListItem Text="Business Source ID" Value="1" Selected="true"></asp:ListItem>
                                                <asp:ListItem Text="Business Source Name" Value="2"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td align="left" style="width: 15%;" valign="top" colspan="2">
                                &nbsp;<asp:ListBox ID="lstBusSourceList" runat="server" Height="335px" 
