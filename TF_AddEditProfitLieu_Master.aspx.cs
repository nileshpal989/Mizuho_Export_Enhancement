...
public partial class TF_AddEditProfitLieu_Master : System.Web.UI.Page
{
...
private void fillDetails(string commissionid, string custacno)
    {
        ...
        string _query = "Tf_getprofitleiudetails";
    ...
    {
        Response.Redirect("TF_View_ProfitinLeo_Master.aspx", true);
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string _query = "AddUpdateProfitinLieu";
        ...
        if (_result == "added")
        {
            _script = "window.location='TF_View_ProfitinLeo_Master.aspx?result=" + _result + "'";
