<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_Outward_Remittance_Closure.aspx.cs"
    Inherits="IDPMS_View_Outward_Remittance_Closure" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>ORM Adjustment Closure View</strong></span>
                            </td>
                                            ...
                                            <tr id="rowGrid" runat="server">
                                                <td align="left">
                                                    <asp:GridView ID="GridViewinwardclosure" runat="server" AutoGenerateColumns="false"
                                                        Width="50%" GridLines="Both" AllowPaging="true" PageSize="20" OnRowDataBound="GridViewinwardclosure_RowDataBound"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                HeaderStyle-Width="15%" ItemStyle-Width="15%">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldocno" runat="server" Text='<%# Eval("adjustmentSeqNumber") %>'
                                                                        CssClass="elementLabel"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                                <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Doc Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldocdate" runat="server" Text='<%# Eval("adjustedDate","{0:dd/MM/yyyy}") %>'
                                                                        CssClass="elementLabel"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                            ...
                                                            <%--<asp:TemplateField HeaderText="Adjustment Date" HeaderStyle-HorizontalAlign="Left"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbladjdate" runat="server" Text='<%# Eval("adjustedDate","{0:dd/MM/yyyy}") %>'
                                                                        CssClass="elementLabel"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                            </asp:TemplateField>--%>
                                                            <asp:TemplateField HeaderText="Adjustment Amt" HeaderStyle-HorizontalAlign="Left"
                                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbladjamt" runat="server" Text='<%# Eval("adjustedAmount","{0:#0.00}") %>'
                                                                        CssClass="elementLabel"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("outwardReferenceNumber")+";"+Eval("adjustmentSeqNumber")+";"+Eval("adjustedDate","{0:dd/MM/yyyy}")+";"+Eval("IECode")  %>'
