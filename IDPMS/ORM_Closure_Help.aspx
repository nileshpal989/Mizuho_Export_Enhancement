<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ORM_Closure_Help.aspx.cs"
    Inherits="IDPMS_ORM_Closure_Help" %>
                ...
                <contenttemplate>
                    <table align="left" cellspacing="0" border="0" width="80%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewOTTList" runat="server" AutoGenerateColumns="False"
                                    Width="90%" AllowPaging="false" OnRowCommand="GridViewOTTList_RowCommand"
                                    OnRowDataBound="GridViewOTTList_RowDataBound" OnRowCreated="GridViewOTTList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="ORM No." HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblormno" runat="server" Text='<%# Eval("Ref_No") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Amount" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblamount" runat="server" Text='<%# Eval("Closure_Amt") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="20%" />
                                            <ItemStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:TemplateField>
