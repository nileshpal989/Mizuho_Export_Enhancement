<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dump_Help.aspx.cs" Inherits="IDPMS_Dump_Help" %>
                    ...
                    <tr>
                        <td align="left" style="width: 2%;" valign="middle" nowrap>
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="textBox" MaxLength="40" onblur="GiveFocus='FALSE';CheckFocus();"
                                onclick="Change(this);" TabIndex="1"></asp:TextBox>
                            &nbsp;
                            ...
                            <asp:GridView ID="GridViewDumpList" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Port Code">
                                        <ItemTemplate>
                                            <asp:Label ID="lblprtcode" runat="server" Text='<%# Eval("PortCode") %>' CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="15%" />
                                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Currency">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCur" runat="server" Text='<%# Eval("Invoice_Currency") %>' CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="15%" />
                                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                                    </asp:TemplateField>
