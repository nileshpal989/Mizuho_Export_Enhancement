...
public partial class IDPMS_IDPMS_BOE_Setlement_view : System.Web.UI.Page
{
    string hdnUserRole = "";
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_IDPMS_ImportlBill_GetDetails";
    ...
    protected void GridViewInwData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                //string pageurl = "window.location='IDPMS_BOEAddEdit.aspx?mode=edit&Docno=" + lblDocNo.Text.Trim() + "'";
                //if (i != 9)
