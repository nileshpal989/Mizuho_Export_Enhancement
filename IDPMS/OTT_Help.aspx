<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OTT_Help.aspx.cs" Inherits="IDPMS_OTT_Help" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewOTTList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
...
<body onload="disable_parent();EndRequest();" onunload="enable_parent();" style="width: 100%;
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
            <ContentTemplate>
                <table style="width: 100%; text-align: left;" cellspacing="0" border="0">
                    <tr>
                    ...
                    <tr>
                        <td align="left" style="width: 2%;" valign="middle" nowrap>
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="textBox" MaxLength="40" Width="200px" TabIndex="1"
                                onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);"></asp:TextBox>
                            &nbsp;
                            <asp:Button ID="btngo" runat="server" ToolTip="Search" CssClass="btnGO" OnClick="btngo_Click" TabIndex="2"/>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top">
                            <asp:GridView ID="GridViewOTTList" runat="server" AutoGenerateColumns="False" Width="100%"
                                AllowPaging="true" OnRowCommand="GridViewOTTList_RowCommand" OnRowDataBound="GridViewOTTList_RowDataBound"
                                OnRowCreated="GridViewOTTList_RowCreated" PageSize="20" onblur="GiveFocus='FALSE';CheckFocus();"
                                CssClass="GridView">
                                <PagerSettings Visible="false" />
                                <Columns>
                                    <asp:TemplateField HeaderText="OTT No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblottno" runat="server" Text='<%# Eval("Ref_No") %>' CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" Width="15%" />
                                        <ItemStyle HorizontalAlign="Left" Width="15%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="OTT Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lblottdate" runat="server" Text='<%# Eval("Payment_Date") %>' CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Cur.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCur" runat="server" Text='<%# Eval("Currency") %>' CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Total Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTamount" runat="server" Text='<%# Eval("TAmount","{0:0.00}") %>'
                                                CssClass="elementLabel"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" Width="20%" />
                                        <ItemStyle HorizontalAlign="Right" Width="20%" />
