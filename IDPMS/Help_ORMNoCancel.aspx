<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_ORMNoCancel.aspx.cs"
    Inherits="IDPMS_Help_ORMNoCancel" %>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td align="left" style="width: 20%;" valign="middle" nowrap>
                                &nbsp;
                                <asp:Label ID="lblSatetNames" runat="server" Font-Bold="true">Search : </asp:Label>
                                &nbsp; &nbsp;
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="50" Width="150px"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 90%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="true" OnRowCommand="GridViewUserList_RowCommand" OnRowDataBound="GridViewUserList_RowDataBound"
                                    OnRowCreated="GridViewUserList_RowCreated" PageSize="20" CssClass="GridView">
                                    <PagerSettings Visible="false" />
                                    
                                    <Columns>
                                        <asp:TemplateField HeaderText="Doc No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblORMNo" runat="server" Text='<%#  Eval("ORC_DOC_NO")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ORM No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="15%" ItemStyle-Width="15%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOutRefNo" runat="server" Text='<%#  Eval("outwardReferenceNumber")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <%--<asp:TemplateField HeaderText="ORM Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPaymentDate" runat="server" Text='<%#  Eval("Payment_Date")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>--%>
                                        <asp:TemplateField HeaderText="Currency" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcurrency" runat="server" Text='<%#  Eval("remittanceCurrency")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldate" runat="server" Text='<%#  Eval("adjustedDate")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <%--<asp:TemplateField HeaderText="Bal Amt" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSeqNo" runat="server" Text='<%#  Eval("bal")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>--%>
                                        <%--<asp:TemplateField HeaderText="Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAmount" runat="server" Text='<%#  Eval("TAmount")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>        --%>                             
                                        
                                       <%-- <asp:TemplateField HeaderText="Account Name " HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="15%" ItemStyle-Width="15%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAccountName" runat="server" Text='<%#  Eval("Name") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>--%>
                                    </Columns>
                                </asp:GridView>
