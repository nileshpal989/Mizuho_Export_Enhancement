...
public partial class IDPMS_TF_IDPMS_Rpt_DataValidation_BOE_Closure : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IDPMS_DataValidation_BOE_Closure";

            Microsoft.Reporting.WebForms.ReportParameter ADCODE = new Microsoft.Reporting.WebForms.ReportParameter();
            ADCODE.Name = "AddedADCODE";
