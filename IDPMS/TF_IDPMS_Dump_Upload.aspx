<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/IDPMS/TF_IDPMS_Dump_Upload.aspx.cs"
    Inherits="IDPMS_TF_IDPMS_Dump_Upload" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <span class="pageLabel"><strong>XML File upload - IDPMS DUMP</strong></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="btnupload" CssClass="buttonDefault" Text="Upload" runat="server"
                        OnClientClick="return validate();" OnClick="btnupload_Click" />
                </td>
            </tr>
