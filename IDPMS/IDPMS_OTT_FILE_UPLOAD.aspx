<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/IDPMS/IDPMS_OTT_FILE_UPLOAD.aspx.cs"
    Inherits="IDPMS_IDPMS_OTT_FILE_UPLOAD" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <span class="pageLabel"><strong>Excel File Upload - Outward Remittance</strong></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:ListItem Text="All Branches" Value="All"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
