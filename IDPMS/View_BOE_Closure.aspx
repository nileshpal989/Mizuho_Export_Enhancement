<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_BOE_Closure.aspx.cs" Inherits="IDPMS_View_BOE_Closure" %>
...
<body>
    ...
    <center>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Bill Of Entry Closure View</span>
                            </td>
                            ...
                            <td width="10%" nowrap align="left">
                               ...
                               <%-- <asp:TextBox ID="txtDocPrFx" runat="server" CssClass="textBox" Width="20px" ReadOnly="True"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtYear" runat="server" CssClass="textBox" Width="50px" 
                                    AutoPostBack="true" TabIndex="4" MaxLength="4" 
     ...
     <asp:GridView ID="GridViewBOEclosure" runat="server" AutoGenerateColumns="false"
         Width="100%" GridLines="Both" AllowPaging="true" PageSize="20" OnRowDataBound="GridViewBOEclosure_RowDataBound"
         OnRowCommand="GridViewBOEclosure_RowCommand">
         ...
         <Columns>
             ...
             <asp:TemplateField HeaderText="BOE No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                 HeaderStyle-Width="15%" ItemStyle-Width="7%">
                 <ItemTemplate>
                     <asp:Label ID="lblirmno" runat="server" Text='<%# Eval("billOfEntryNumber") %>' CssClass="elementLabel"></asp:Label>
                 </ItemTemplate>
                 <HeaderStyle HorizontalAlign="Left" Width="7%" />
                 <ItemStyle HorizontalAlign="Left" Width="7%" />
             </asp:TemplateField>

             <asp:TemplateField HeaderText="Adjustment Reference No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
               ...
               <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                 HeaderStyle-Width="15%" ItemStyle-Width="15%">
                 <ItemTemplate>
                     <asp:Label ID="lbldocno" runat="server" Text='<%# Eval("documentNumber") %>' CssClass="elementLabel"></asp:Label>
                 </ItemTemplate>
                 <HeaderStyle HorizontalAlign="Left" Width="15%" />
                 <ItemStyle HorizontalAlign="Left" Width="15%" />
             </asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="Doc Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                 ...
                 <ItemTemplate>
                     <asp:Label ID="lbldocdate" runat="server" Text='<%# Eval("documentDate","{0:dd/MM/yyyy}") %>'
             ...
             <asp:TemplateField HeaderText="Adjustment Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                 HeaderStyle-Width="10%" ItemStyle-Width="10%">
                 <ItemTemplate>
                     <asp:Label ID="lbladjdate" runat="server" Text='<%# Eval("adjustmentDate","{0:dd/MM/yyyy}") %>' CssClass="elementLabel"></asp:Label>
                 </ItemTemplate>
                 <HeaderStyle HorizontalAlign="Center" Width="10%" />
                 <ItemStyle HorizontalAlign="Center" Width="10%" />
             </asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="Adjustment Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                 ...
                 <ItemStyle HorizontalAlign="right" Width="10%"/>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("billOfEntryNumber") +","+ Eval("adjustmentReferenceNumber") %>'
