<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OTT_Help_New.aspx.cs" Inherits="IDPMS_OTT_Help_New" %>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top">
                            <asp:GridView ID="GridViewOTTList" runat="server" AutoGenerateColumns="False" Width="100%"
                                AllowPaging="false" OnRowCommand="GridViewOTTList_RowCommand" OnRowDataBound="GridViewOTTList_RowDataBound"
                                OnRowCreated="GridViewOTTList_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();"
                                CssClass="GridView">
