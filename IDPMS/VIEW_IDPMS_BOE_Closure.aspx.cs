...
public partial class IDPMS_VIEW_IDPMS_BOE_Closure : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Request.QueryString["branchname"] != null)
            {
                ...
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IDPMS_BOE_Closure_DataCheckList_rpt";
                ...
                ReportViewer1.ServerReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { branchname, fromdate, todate, Cust, user });
