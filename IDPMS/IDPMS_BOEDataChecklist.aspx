<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_BOEDataChecklist.aspx.cs"
    Inherits="IDPMS_IDPMS_BOEDataChecklist" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('View_IDPMS_BOEDataChecklist.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=All' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('View_IDPMS_BOEDataChecklist.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Bill of Entry - Settlement Report</strong></span>
