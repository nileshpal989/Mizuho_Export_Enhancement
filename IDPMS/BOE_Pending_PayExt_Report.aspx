<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOE_Pending_PayExt_Report.aspx.cs" Inherits="IDPMS_BOE_Pending_PayExt_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            var winame = window.open('View_BOE_PenPayExt.aspx?branch=' + brname.value + '&fromdate=' + frmdate.value + '&todate=' + todate.value, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1080,height=600');
            winame.focus();
            return false;
            //return true;
        }
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                         ...
                         <tr>
                        <td align=left><span class=pageLabel>BOE Pending For Payment Extension</span></td>
                        </tr>
                        <tr>
