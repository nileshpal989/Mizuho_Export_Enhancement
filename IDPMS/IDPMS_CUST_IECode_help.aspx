<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_CUST_IECode_help.aspx.cs"
    Inherits="IDPMS_IDPMS_CUST_IECode_help" %>
                        ...
                        <td align="left" style="width: 100%" valign="top">
                            <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Cust IECode">
                                        <ItemTemplate>
