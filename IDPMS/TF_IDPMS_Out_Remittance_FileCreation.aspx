<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IDPMS_Out_Remittance_FileCreation.aspx.cs" Inherits="IDPMS_TF_IDPMS_Out_Remittance_FileCreation" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>IDPMS XML File Generation-Outward Remittance</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
