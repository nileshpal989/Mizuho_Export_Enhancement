<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_Datachecklist_OutwardRemitance.aspx.cs"
    Inherits="IDPMS_IDPMS_Datachecklist_OutwardRemitance" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('View_IDPMS_Checklist_OutwardRemitance.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=All' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('View_IDPMS_Checklist_OutwardRemitance.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><strong>Data Checklist - Outward Remittance</strong></span>
                            </td>
                        </tr>
                        <tr>
