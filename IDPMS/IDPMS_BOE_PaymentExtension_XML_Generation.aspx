<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_BOE_PaymentExtension_XML_Generation.aspx.cs"
    Inherits="IDPMS_IDPMS_BOE_PaymentExtension_XML_Generation" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>IDPMS XML File Generation-BOE Payment Extension</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
