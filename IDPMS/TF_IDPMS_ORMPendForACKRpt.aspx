<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IDPMS_ORMPendForACKRpt.aspx.cs" Inherits="IDPMS_TF_IDPMS_ORMPendForACKRpt" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('TF_IDPMS_ORMPendForACKRpt_View.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=all', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('TF_IDPMS_ORMPendForACKRpt_View.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&Cust=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>List Of ORM's For Which RBI Acknowledgement Not Uploaded to LMCC Server</strong></span>
                            </td>
                        </tr>
                        <tr>
