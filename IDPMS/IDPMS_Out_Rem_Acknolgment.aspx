<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_Out_Rem_Acknolgment.aspx.cs" Inherits="IDPMS_IDPMS_Out_Rem_Acknolgment" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <span class="pageLabel"><strong>XML File Upload - Outward Remittance (Acknowledgement)</strong></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
