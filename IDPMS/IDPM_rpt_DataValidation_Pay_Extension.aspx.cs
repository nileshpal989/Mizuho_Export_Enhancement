...
public partial class IDPMS_IDPM_rpt_DataValidation_Pay_Extension : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IDPMS_DataValidation_Pay_Extension";
            ...
            new Microsoft.Reporting.WebForms.ReportParameter[] { user, ADCode });
        }
    }
}