<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IDPMS_Payment_Settlement_RBI_Ack.aspx.cs" Inherits="IDPMS_TF_IDPMS_Payment_Settlement_RBI_Ack" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <span class="pageLabel"><strong>XML File Upload - Paymant Settlement (Acknowledgement)</strong></span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
