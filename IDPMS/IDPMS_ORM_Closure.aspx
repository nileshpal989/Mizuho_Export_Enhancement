<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_ORM_Closure.aspx.cs"
    Inherits="IDPMS_IDPMS_ORM_Closure" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('VIEW_IDPMS_ORM_Closure.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=All' + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('VIEW_IDPMS_ORM_Closure.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=' + cust + '&ormtype=' + ormtype, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
        }

        //            var winame = window.open('View_IDPMS_Checklist_OutwardRemitance.aspx?branch=' + brname.value + '&fromdate=' + frmdate.value + '&todate=' + todate.value, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1080,height=600');
        //            winame.focus();
        //            return false;
        //            //return true;
        //        }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><strong>ORM Closure Report</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="1300px" style="line-height: 150%">
                                    ...
                                    <tr>
                                        <td align="center" style="width: 150px; white-space: nowrap">
                                            <span class="mandatoryField">&nbsp; *</span><span class="elementLabel">From Date :</span>
                                        </td>
                                        <td align="left" style="width: 800px; white-space: nowrap">
