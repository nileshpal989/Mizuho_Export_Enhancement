<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_BOE_CLOSURE.aspx.cs"
    Inherits="IDPMS_IDPMS_BOE_CLOSURE" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            if (document.getElementById('rdballcust').checked == true) {
                var winame = window.open('VIEW_IDPMS_BOE_Closure.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=All', '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            else {
                var cust = document.getElementById('txtCust').value;
                var winame = window.open('VIEW_IDPMS_BOE_Closure.aspx?branchname=' + brname.value + '&from=' + frmdate.value + '&to=' + todate.value + '&type=' + cust, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
                winame.focus();
                return false;
            }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><b>BOE Closure Report</b></span>
                            </td>
                        </tr>
                        <tr>
