<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IDPMS_ORM_Clousure_XML_Generation.aspx.cs" Inherits="IDPMS_IDPMS_ORM_Clousure_XML_Generation" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>IDPMS XML(Outward Remittance Closure)File Generation</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="line-height: 150%">
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 10%; padding-top: 10px; padding-bottom: 10px" valign="bottom"
                                         ...
                                         <td align="left" style="width: 10%; padding-top: 10px; padding-bottom: 10px" valign="bottom"
                                            nowrap>
                                            <asp:Button ID="btnsavcan" runat="server" CssClass="buttonDefault" Text="Genarate Cancel XML File"
                                                ToolTip="Genarate XML File" TabIndex="9" Width="140px"  
                                                 onclick="btnsavcan_Click"/>
                                            </td>
                                        <td width="75%">
                                        </td>
                                    </tr>
