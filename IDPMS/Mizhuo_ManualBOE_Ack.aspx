<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mizhuo_ManualBOE_Ack.aspx.cs"
    Inherits="IDPMS_Mizhuo_ManualBOE_Ack" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function generateReport() {
            ...
            var rdbBOEsettlement = document.getElementById('rdbBOEsettlement');
            ...
            if (rdbBOEsettlement.checked == true) {
                type = 'settlement';
            }
            else {
                type = 'closure';
            ...
            var winame = window.open('View_ManualBillOfEntry_Ack.aspx?branchname=' + brname.value + '&ErrorCode=' + ErrorCode + '&from=' + from + '&to=' + to + '&type=' + type, '', 'scrollbars=yes,top=50,left=0,status=0,menubar=0,width=1200,height=600');
            winame.focus();
            return false;
            //return true;
        }
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left">
                                <span class="pageLabel"><strong> Bill Of Entry (RBI-Acknowledgement)</strong></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="line-height: 150%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" nowrap>
                                            <asp:RadioButton ID="rdbBOEsettlement" runat="server" Text="BOE Settlement" CssClass="elementLabel"
                                                Checked="true" GroupName="type" />
                                            <asp:RadioButton ID="rdbBOEClosure" runat="server" CssClass="elementLabel" Text="BOE Closure"
                                                GroupName="type" />
                                        </td>
                                    </tr>
                                    <tr>
