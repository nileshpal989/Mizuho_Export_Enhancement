...
public partial class TF_View_ProfitinLeo_Master : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("TF_AddEditProfitLieu_Master.aspx?mode=add", true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_GetProfitmasterList";
        TF_DATA objData = new TF_DATA();
    ...
    protected void GridViewCommission_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        string _query = "TF_DeleteProfitLieumaster";
    ...
    protected void GridViewCommission_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.location='TF_AddEditProfitLieu_Master.aspx?mode=edit&CommissionID=" + lblCommissionID.Text.Trim() + "&custacno=" + lblcustacno.Text + "'";
                if (i != 7)
