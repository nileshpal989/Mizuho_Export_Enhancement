<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_AddEditOverSeasPartyMaster.aspx.cs"
    Inherits="TF_AddEditOverSeasPartyMaster" %>
...
//        }
         ...
         //Allow only text box in number validation
        ...
        function validateSave() {
            ...
            if (trimAll(PartyName.value) == '') {
                ...
                if (confirm("Do you want to save data Consignee Party Master?")) {
                ...
                <table cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel">Overseas Party Master Details</span>
                        </td>
                        <td align="right" style="width: 50%">
                            <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="buttonDefault" ToolTip="Back"
                                TabIndex="19" OnClick="btnBack_Click" />
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" width="400px" style="line-height: 150%">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPartyName" runat="server" CssClass="textBox" MaxLength="100"
                                                Width="300" TabIndex="2" AutoPostBack="True" OnTextChanged="txtPartyName_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr height="70px">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtaddress" runat="server" CssClass="textBox" MaxLength="100" Width="300px"
                                                TextMode="MultiLine" Height="65px" TabIndex="3"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 400px">
                                            <asp:TextBox ID="txtcountry" runat="server" CssClass="textBox" MaxLength="2" Width="50px"
                                                 Enabled="false" TabIndex="6" AutoPostBack="True" OnTextChanged="txtcountry_TextChanged"></asp:TextBox>
                                            <asp:Button ID="btnCountryList" runat="server" TabIndex="7" CssClass="btnHelp_enabled" Width="16px" />
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 400px">
                                            ...
                                            <asp:Button ID="btncalendar_DocDate" runat="server" TabIndex="16" CssClass="btncalendar_enabled" />
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 220px">
                                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="buttonDefault" ToolTip="Save"
                                                OnClick="btnSave_Click" TabIndex="17" />&nbsp
