<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewPurposeCode.aspx.cs"
    Inherits="TF_ViewPurposeCode" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><b>Purpose Codes Master View<b></span>
                            </td>
                        ...
                        <tr align="right">
                            <td align="left">
                                &nbsp;&nbsp;
                                <asp:RadioButton ID="rdball" runat="server" GroupName="RDB" AutoPostBack="true" CssClas="elementLabel"
                                    Text="All" oncheckedchanged="rdball_CheckedChanged" />
                                &nbsp;
                                <asp:RadioButton ID="rdbpurchase" runat="server" GroupName="RDB" Text="Purchase" CssClas="elementLabel"
                                    AutoPostBack="true" oncheckedchanged="rdbpurchase_CheckedChanged" />
                                &nbsp;
                                <asp:RadioButton ID="rdbsell" runat="server" GroupName="RDB" AutoPostBack="true" CssClas="elementLabel"
                                    Text="Sell" oncheckedchanged="rdbsell_CheckedChanged" />
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewPurposeCodes" runat="server" AutoGenerateColumns="False"
                                    Width="50%" GridLines="Both" AllowPaging="true" OnRowCommand="GridViewPurposeCodes_RowCommand"
                                    OnRowDataBound="GridViewPurposeCodes_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Purpose Code" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblPurposeID" runat="server" Text='<%#Eval("purposeID")%>' CssClass="elementLabel"></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%#Eval("purposeID")%>' Text="Delete" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
