<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerDataDump.aspx.cs" Inherits="IMP_FileCreation_CustomerDataDump" %>
                    ...
                    <table cellspacing="2" cellpadding="2" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Customer Master In Excel Format</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                             <td align="left">
                             <asp:RadioButton ID="rdbIMPCust" runat="server" CssClass="elementLabel" GroupName="Data1"
                                            TabIndex="4" Text="Import customers" Checked="true" AutoPostBack="true" /><asp:RadioButton
                                                ID="rdbotherCust" runat="server" CssClass="elementLabel" GroupName="Data1"
                                                TabIndex="4" AutoPostBack="true" Text="Other than import customers" />
                             </td>
