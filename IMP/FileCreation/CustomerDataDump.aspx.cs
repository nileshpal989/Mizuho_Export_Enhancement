...
public partial class IMP_FileCreation_CustomerDataDump : System.Web.UI.Page
{
    string s = "";
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = objData1.getData("TF_CustomerDataDump", P1);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (rdbIMPCust.Checked == true)
            {
                filename = "Import customers_" + Date + ".xlsx";
            }
            else if (rdbotherCust.Checked == true)
            {
                filename = "Other than import customers_" + Date + ".xlsx";
            }
