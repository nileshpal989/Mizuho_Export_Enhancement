...
public partial class Lodgmentmakers : System.Web.UI.Page
{
    string s = "";
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = objData1.getData("TF_IMP_BOEACCFileCreation", P1, P2, P3, P4, P5, P6);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                filename = "Lodgement_Report_Approved_" + _fromdate + "_TO_" + _todate + "_AT_" + Todaytime + ".xlsx";
            }
            else if (ddlStatus.SelectedValue.ToString() == "R")
            {
                filename = "Lodgement_Report_Rejected_" + _fromdate + "_TO_" + _todate + "_AT_" + Todaytime + ".xlsx";
            }
            else if (ddlStatus.SelectedValue.ToString() == "C")
            {
                filename = "Lodgement_Report_Pending_" + _fromdate + "_TO_" + _todate + "_AT_" + Todaytime + ".xlsx";
            }
