<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_imp_Transactions_LogDetails.aspx.cs" Inherits="IMP_TF_imp_LogActivity" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateSave() {
            ...
            var txtTransRefNo = document.getElementById('txtTransefNo');
                      if (txtTransRefNo.value == '') 
                          {
                              VAlert('Select TranRefNo.', '#txtTransefNo');
                                // txtCustomer_ID.focus();
                                return false;
                            }
//            var txtCustomer_ID = document.getElementById('txtCustomer_ID');
                    ...
                    <table cellspacing="2" cellpadding="2" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Transactions Log Details</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" width="10%" >
                                <span class="elementLabel">TransRefNo:</span>
                            </td>
                            <td align="left">
                              <asp:TextBox ID="txtTransefNo" runat="server"
                                    CssClass="textBox" MaxLength="18" Width="120px" TabIndex="1"></asp:TextBox>
                                    <asp:Label ID="lblrefno" runat="server" Text="Example -: ICU-792-100018" CssClass="mandatoryField"></asp:Label>
                            </td>
                            <%--<td align="left">
