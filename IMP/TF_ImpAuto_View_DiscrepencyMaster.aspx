<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ImpAuto_View_DiscrepencyMaster.aspx.cs" Inherits="TF_ImpAuto_View_DiscrepencyMaster" %>
                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel"><b>Discrepency Charges Master View</b></span>
                        </td>
                        <td align="right" style="width: 50%">
                            <input type="hidden" id="hdnCur" runat="server" />
                             <input type="hidden" id="hdnAmt" runat="server" />
                             <%--<input type="hidden" id="hdnINR" runat="server" />--%>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top" colspan="2">
                            <asp:GridView ID="GridViewCommission" runat="server" AutoGenerateColumns="False"
                                Width="25%" AllowPaging="True" OnRowCommand="GridViewCommission_RowCommand"
                             ...
                             <%--   <RowStyle Wrap="False" HorizontalAlign="Left" Height="18px" VerticalAlign="top" CssClass="gridItem" />
                                ...
                                <Columns>
                                 <asp:TemplateField HeaderText="CUR" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblCUR" runat="server" CssClass="elementLabel" Text='<%# Eval("CUR") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="3%" />
                                        <ItemStyle HorizontalAlign="Center" Width="3%" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="FC Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmount" runat="server" CssClass="elementLabel" Text='<%# Eval("Amount","{0:0,0.00}") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="center" Width="6%" />
                                        <ItemStyle HorizontalAlign="right" Width="6%" />
                                    </asp:TemplateField>
                                    <%--<asp:TemplateField HeaderText="INR" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblINR" runat="server" CssClass="elementLabel" Text='<%# Eval("INR") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                        ...
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("CUR")+";"+ Eval("Amount")%>'
