<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Audit_trial_Transaction.aspx.cs" Inherits="IMP_IMPReports_TF_IMP_Audit_trial_Transaction" %>
...
<script type="text/javascript">
    function Generate() {
       ...
       // else if (rdbDelete.checked == true)
        ...
        open_popup('Mizho_IMP_TransactionReport.aspx?frm=' + txtfromDate.value + '&to=' + txtToDate.value + '&Branch=' + ddlBranch.value + '&User=' + User + '&menu=' + DropDownMenu.value + '&Type=' + Type + ' ', 500, 1000, 'custid_help');
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            ...
                            <br />
                                <span class="pageLabel"><strong>Audit trail For Transaction</strong></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="1300px" style="line-height: 150%">
                                    ...
                                    <caption>
                                        ...
                                        <tr>
                                                  <td width="10%" align="right" nowrap>
                                            <span class="mandatoryField">*</span><span class="elementLabel">All Transactions :</span>
                                        </td>
                                                ...
                                                <asp:ListItem>Imports Bill Lodgment - Maker</asp:ListItem>
                                                <asp:ListItem>Import Bill Acceptance - Maker</asp:ListItem>
                                                <asp:ListItem>Import Bill Settlement - Maker</asp:ListItem>
                                            </asp:DropDownList>
                                            </td>
                                            </tr>
                                        <caption>
