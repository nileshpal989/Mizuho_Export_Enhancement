<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BROREGISTERINEXCELFORMAT.aspx.cs" Inherits="IMP_IMPReports_BROREGISTERINEXCELFORMAT" %>
    ...
    <div>
          <center>
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
             <Triggers>
                    <asp:PostBackTrigger ControlID="Generate" />
                </Triggers>
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>BRO REGISTER IN EXCEL FORMAT</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top">
                                <table cellspacing="0" cellpadding="0" border="0" width="1300px" style="line-height: 150%">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 100px">
                                            <span class="mandatoryField">&nbsp; *</span><span class="elementLabel">From BRO Val Date :</span>
                                        </td>
                                        <td align="left" style="width: 800px">
                                            ...
                                            &nbsp; <span class="mandatoryField">*</span><span class="elementLabel">To BRO Val Date :</span>
                                            &nbsp;
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="Generate" runat="server" CssClass="buttonDefault" Text="Generate"
                                                ToolTip="Genarate" TabIndex="4" OnClick="Generate_Click"  />
                                        </td>
                                    </tr>
                                </table>
                    </table>
