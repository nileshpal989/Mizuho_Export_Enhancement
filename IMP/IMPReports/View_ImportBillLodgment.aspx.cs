...
public partial class Reports_ImportReport_View_ImportBillLodgment : System.Web.UI.Page
{
    ...
    {  
        ...
        {  
            ...
            serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/Checker_Rejected_Report";
            ...
            ReportViewer1.ServerReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { Document_Type,UserName, Status, startdate, enddate, Branch });
        }
