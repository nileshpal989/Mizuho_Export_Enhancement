...
public partial class IMP_IMPReports_Mizho_IMP_TransactionReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null)
            {
                ...
                serverReport.ReportPath = "/Mizuho_TF_UAT_Reports/TF_IMP_AuditTrailForTransaction";
