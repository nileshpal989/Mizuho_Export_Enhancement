<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ImportBillAcceptance_ExcelReport.aspx.cs" Inherits="IMP_IMPReports_TF_IMP_ImportBillAcceptance_ExcelReport" %>
                    ...
                    <table cellspacing="2" cellpadding="2" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Import Bill Acceptance (Approved and Selected Fields)</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" nowrap class="style1">
                                <span class="elementLabel">From Acceptance Date :</span>
                            </td>
                            <td align="left">
                                ...
                                &nbsp;&nbsp; <span class="elementLabel">To Acceptance Date :</span>
