...
public partial class IMP_IMPReports_TF_IMP_ImportBillAcceptance_ExcelReport : System.Web.UI.Page
{
    string s = "";
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = objData1.getData("TF_IMP_Bill_Acceptance_report", P1, P2, P3, P4, P5);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string filename = "";
            filename = "Imp_Bill_Acceptance_Report-" + Todaytime + ".xlsx";
