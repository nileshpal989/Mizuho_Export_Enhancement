<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Acceptance_Bills_LodgReport.aspx.cs" Inherits="IMP_IMPReports_Acceptance_Bills_LodgReport" %>
   ...
   <script src="../../../Scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function generateReport() {
            ...
            open_popup('TF_IMP_ForAcceptance.aspx?User=' + User + '&Type=' + Type + '&Branch=' + Branch + '&fromdate=' + frmdate + '&toDate=' + todate + '&Status=' + Status + '&Acceptance=' + Accptance + ' ', 1000, 1300, 'custid_help');
            winname.focus();
            return false;
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Import Acceptance Bill Checklist</strong></span>
                            </td>
                        </tr>
                        <tr>
                        </tr>
