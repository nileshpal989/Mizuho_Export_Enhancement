function R42_Amt_Calculation() {
    ...
    if ($("#TabContainerMain_tbDocumentDetails_Intapp").is(':checked')) {
        totalamt = parseFloat(_txtDraftAmt);
    }
    if ($("#TabContainerMain_tbDocumentDetails_Intbeni").is(':checked')) {
...
function ONINTERESTAMT() {
    ...
    if ($("#TabContainerMain_tbDocumentAccounting_txtInterest_matu").val() == '1') {
        $("#TabContainerMain_tbDocumentAccounting_txt_DR_Cur_Acc_amt").val(txtInterestAmt);
        R42_Amt_Calculation();
    }
}
...
function Validate(index) {
    ...
    if ($("#TabContainerMain_tbDocumentDetails_Intapp").is(':checked') || $("#TabContainerMain_tbDocumentDetails_Intbeni").is(':checked')) {
        return true;
    }
    else {
...
function SaveUpdateData() {
    ...
    else if ($("#TabContainerMain_tbDocumentDetails_Intbeni").is(':checked')) {
    ...
    var _ddl_Settl_ForBank_Abbr = '';
    if (_BranchName == 'Mumbai' && _Document_Curr == 'INR') {
        _ddl_Settl_ForBank_Abbr = $("#TabContainerMain_tbDocumentDetails_txtSettl_ForBank_Abbr").val();
    }
    else {
        _ddl_Settl_ForBank_Abbr = $("#TabContainerMain_tbDocumentDetails_txtSettl_ForBank_Abbr").val();
    }
    ...
    var _cb_GOBranch_Bill_Handling_Flag = 'N',
    _txt_GOBR_Ref_No = '',
    ...
    _txt_GOBR_Scheme_no = '', _txt_GOBR_Debit_Code = '', _txt_GOBR_Debit_Curr = '', _txt_GOBR_Debit_Amt = 0,
     _txt_GOBR_Debit_Cust = '', _txt_GOBR_Debit_Cust_Name = '',
    _txt_GOBR_Debit_Cust_AcCode = '', _txt_GOBR_Debit_Cust_AcCode_Name = '', _txt_GOBR_Debit_Cust_AccNo = '',
    _txt_GOBR_Debit_Exch_Rate = '', _txt_GOBR_Debit_Exch_CCY = '',
     ...
     _txt_GOBR_Credit_Cust = '', _txt_GOBR_Credit_Cust_Name = '',
     _txt_GOBR_Credit_Cust_AcCode = '', _txt_GOBR_Credit_Cust_AcCode_Name = '', _txt_GOBR_Credit_Cust_AccNo = '',
    ...
    if (_BranchName != 'Mumbai') {
        if ($("#TabContainerMain_tbDocumentGOBranch_cb_GOBranch_Bill_Handling_Flag").is(':checked')) {
            ...
            _txt_GOBR_Debit_Cust_Name = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Debit_Cust_Name").val();
            _txt_GOBR_Debit_Cust_AcCode = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Debit_Cust_AcCode").val();
            _txt_GOBR_Debit_Cust_AcCode_Name = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Debit_Cust_AcCode_Name").val();
            ...
            _txt_GOBR_Credit_Cust_Name = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Credit_Cust_Name").val();
            _txt_GOBR_Credit_Cust_AcCode = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Credit_Cust_AcCode").val();
            _txt_GOBR_Credit_Cust_AcCode_Name = $("#TabContainerMain_tbDocumentGOBranch_txt_GOBR_Credit_Cust_AcCode_Name").val();
    ...
    if (_txtDocNo != '' && _txtIBDDocNo != '') {
        $.ajax({
            type: "POST",
            url: "TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker.aspx/AddUpdateONLCDiscount",
        ...
        '", _txt_GOBR_Debit_Amt: "' + _txt_GOBR_Debit_Amt + '", _txt_GOBR_Debit_Cust: "' + _txt_GOBR_Debit_Cust + '", _txt_GOBR_Debit_Cust_Name: "' + _txt_GOBR_Debit_Cust_Name + '", _txt_GOBR_Debit_Cust_AcCode: "' + _txt_GOBR_Debit_Cust_AcCode + '", _txt_GOBR_Debit_Cust_AccNo: "' + _txt_GOBR_Debit_Cust_AccNo +
        '", _txt_GOBR_Debit_Cust_AcCode_Name: "' + _txt_GOBR_Debit_Cust_AcCode_Name + '", _txt_GOBR_Debit_Exch_Rate: "' + _txt_GOBR_Debit_Exch_Rate + '", _txt_GOBR_Debit_Exch_CCY: "' + _txt_GOBR_Debit_Exch_CCY + '", _txt_GOBR_Debit_FUND: "' + _txt_GOBR_Debit_FUND + '", _txt_GOBR_Debit_Check_No: "' + _txt_GOBR_Debit_Check_No +
        ...
        '", _txt_GOBR_Credit_Code: "' + _txt_GOBR_Credit_Code + '", _txt_GOBR_Credit_Curr: "' + _txt_GOBR_Credit_Curr + '", _txt_GOBR_Credit_Amt: "' + _txt_GOBR_Credit_Amt + '", _txt_GOBR_Credit_Cust: "' + _txt_GOBR_Credit_Cust + '", _txt_GOBR_Credit_Cust_Name: "' + _txt_GOBR_Credit_Cust_Name +
        '", _txt_GOBR_Credit_Cust_AcCode: "' + _txt_GOBR_Credit_Cust_AcCode + '", _txt_GOBR_Credit_Cust_AcCode_Name: "' + _txt_GOBR_Credit_Cust_AcCode_Name + '", _txt_GOBR_Credit_Cust_AccNo: "' + _txt_GOBR_Credit_Cust_AccNo + '", _txt_GOBR_Credit_Exch_Rate: "' + _txt_GOBR_Credit_Exch_Rate + '", _txt_GOBR_Credit_Exch_Curr: "' + _txt_GOBR_Credit_Exch_Curr +
...
function Settl_CodeForBank_help(e) {
    var keycode;
    if (window.event) keycode = window.event.keyCode;
    if (keycode == 113 || e == 'mouseClick') {
...
function CustAbbr() {
    ...
    var _val11 = $("#TabContainerMain_tbDocumentDetails_txtRiskCust").val();
    $("#TabContainerMain_tbDocumentAccounting_txt_IBD_DR_Cust_abbr").val(_val11);
}
