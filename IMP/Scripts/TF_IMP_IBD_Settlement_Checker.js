function DialogAlert() {
    ...
    var _ddlApproveReject = $("#TabContainerMain_tbIBDDocumentAccounting_ddlApproveReject");
    ...
    if (_ddlApproveReject.val() == '1') {
        ...
        $("#dialog").dialog({
            ...
            },
            {
                ...
                click: function () {
                    $(this).dialog("close");
                    $("#TabContainerMain_tbIBDDocumentAccounting_ddlApproveReject").val('-Select-')
                    return false;
                }
            }
            ]
...
function OnBackClick() {
    window.location.href = "TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Checker_View.aspx";
    return false;
}