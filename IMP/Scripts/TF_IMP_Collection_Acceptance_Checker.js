function DialogAlert() {
    ...
    var _ddlApproveReject = $("#TabContainerMain_tbSwiftDetails_ddlApproveReject");
    ...
    if (_ddlApproveReject.val() == '1') {
                        ...
                        $("#dialog").dialog({
                            ...
                            buttons: [
                            {
                                ...
                                click: function () {
                                    $(this).dialog("close");
                                    document.getElementById('TabContainerMain_tbSwiftDetails_btnSave').click();
                                }
                            },
                            {
                                text: "No", //"✖"
                                ...
                                click: function () {
                                    $(this).dialog("close");
                                    $("#TabContainerMain_tbSwiftDetails_ddlApproveReject").val('-Select-')
                                    return false;
                                }
                            }
                            ]
