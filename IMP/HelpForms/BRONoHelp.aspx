<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BRONoHelp.aspx.cs" Inherits="IMP_HelpForms_BRONoHelp" %>
                    ...
                    <tr>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Delivery_Order_No" HeaderText="BRO NO." ItemStyle-Width="60px"
                                        ItemStyle-HorizontalAlign="Left" >
                                    <ItemStyle HorizontalAlign="Left" Width="60px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Applicant_Name" HeaderText="Applicant Name" ItemStyle-Width="80px"
                                        ItemStyle-HorizontalAlign="Left" >
