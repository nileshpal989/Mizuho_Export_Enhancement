<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ManualLCUpdateDocNoHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_MiscellaneousDocNoHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewMiscellaneousDocNO.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40" Width="200px"
                                    onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewMiscellaneousDocNO')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewMiscellaneousDocNO" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="false" OnRowDataBound="GridViewMiscellaneousDocNO_RowDataBound"
                                    OnRowCreated="GridViewMiscellaneousDocNO_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Current LC Flag value" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOwnLCDiscount_Type" runat="server" Text='<%# Eval("OwnLCDiscount_Type") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
