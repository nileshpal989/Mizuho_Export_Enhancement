...
<body bgcolor="#CDDAE4" onload="disable_parent();EndRequest();" onunload="enable_parent();"
    onblur="CheckFocus();" onfocus="CheckFocus();">
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="80%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewCurrList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Currency Description" HeaderStyle-HorizontalAlign="Center"
