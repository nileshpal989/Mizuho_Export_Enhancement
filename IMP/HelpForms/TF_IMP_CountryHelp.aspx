<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_CountryHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_CountryHelp" %>
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server"
                                    ...
                                    onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewCountryList')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewCountryList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    OnRowDataBound="GridViewCountryList_RowDataBound" OnRowCreated="GridViewCountryList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Country ID" HeaderStyle-HorizontalAlign="Left"
