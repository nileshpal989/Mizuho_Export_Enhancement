<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BOE_RollBack_Help.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_BOE_RollBack_Help" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewRollback.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
...
<body bgcolor="#CDDAE4" 
    onload="disable_parent();EndRequest();" onunload="enable_parent();" style="width: 100%; height: 100%;">
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40" Width="200px"
                                    onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewRollback')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewRollback" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="false" OnRowDataBound="GridViewRollback_RowDataBound"
                                    OnRowCreated="GridViewRollback_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("Document_No") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Value Date" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblLodgment_Date" runat="server" Text='<%# Eval("Lodgment_Date") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Checker Status" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30%" ItemStyle-Width="30%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblChecker_Status" runat="server" Text='<%# Eval("Checker_Status") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
