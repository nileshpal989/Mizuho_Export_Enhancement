<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_SG_CustHelp.aspx.cs"
    Inherits="IMP_HelpForms_TF_IMP_SG_CustHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridviewSG_Custlist.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40" Width="200px"
                                    onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridviewSG_Custlist')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridviewSG_Custlist" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridviewSG_Custlist_RowCommand"
                                    OnRowDataBound="GridviewSG_Custlist_RowDataBound" OnRowCreated="GridviewSG_Custlist_RowCreated"
