<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BROHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_BROHelp" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBROList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>                                        
                                        <asp:TemplateField HeaderText="BRO Ref No" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBRORefNo" runat="server" Text='<%# Eval("Delivery_Order_No") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
