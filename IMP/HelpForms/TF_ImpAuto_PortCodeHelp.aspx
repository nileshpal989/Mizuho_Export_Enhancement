<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ImpAuto_PortCodeHelp.aspx.cs" Inherits="IMP_HelpForms_TF_ImpAuto_PortCodeHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewPortCodeList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
...
<body bgcolor="#CDDAE4" onload="disable_parent();EndRequest();"  style="width: 100%; height: 100%;">
    ...
    <asp:UpdateProgress ID="updateProgress" runat="server" DynamicLayout="true">
            <ProgressTemplate>
                <div id="progressBackgroundMain" class="style1">
                ...
                <ContentTemplate>
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                ...
                                &nbsp;<asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40"
                                    Width="150px"  onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">                           
                                <asp:GridView ID="GridViewPortCodeList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewPortCodeList_RowCommand"
                                    OnRowDataBound="GridViewPortCodeList_RowDataBound" 
                                    onrowcreated="GridViewPortCodeList_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Port Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityID" runat="server" Text='<%# Eval("port_Code") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Port Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="75%" ItemStyle-Width="75%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityDesc" runat="server" Text='<%# Eval("portName") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
