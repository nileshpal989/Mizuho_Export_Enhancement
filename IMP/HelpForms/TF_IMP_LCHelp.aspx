<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LCHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_LCHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewLCList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server"
                                    ...
                                    onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewLCList')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewLCList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewLCList_RowCommand"
                                    OnRowDataBound="GridViewLCList_RowDataBound" OnRowCreated="GridViewLCList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Cust Abbr." HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustAbbr" runat="server" Text='<%# Eval("CustAbbr") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
                                        <asp:TemplateField HeaderText="LC No." HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLCNo" runat="server" Text='<%# Eval("LCNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Country Code" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCountryCode" runat="server" Text='<%# Eval("CountryCode") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Commodity Code" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityCode" runat="server" Text='<%# Eval("CommodityCode") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
