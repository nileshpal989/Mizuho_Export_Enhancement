...
public partial class IMP_HelpForms_TF_IMP_Settl_for_Bank_ForeignHelp : System.Web.UI.Page
{
    ...
    {
        string _query = "TF_IMP_Settl_For_Bank_Foreign_Help";
        SqlParameter p1 = new SqlParameter("@Document_Curr", Request.QueryString["Document_Curr"].ToString());
