...
public partial class IMP_HelpForms_TF_ReimbursingBankLookUp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_IMP_Reimbursing_BankMasterList";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                {
                    pageurl = "window.opener.selectReimbursingBank('" + lblBankCode.Text + "');window.opener.EndRequest();window.close();";
                }
