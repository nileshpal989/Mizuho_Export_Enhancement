<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Brohelpform1.aspx.cs" Inherits="IMP_HelpForms_Brohelpform1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewBROList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server"
                                    ...
                                    onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewBROList')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBROList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewBROList_RowCommand"
                                    OnRowDataBound="GridViewBROList_RowDataBound" OnRowCreated="GridViewBROList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="BRO NO" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="BRO DATE" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50%" ItemStyle-Width="50%">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblBroDate" runat="server" Text='<%# Eval("BRO_Date") %>'  CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="Applicant Name" HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Bill Amt" HeaderStyle-HorizontalAlign="right"
