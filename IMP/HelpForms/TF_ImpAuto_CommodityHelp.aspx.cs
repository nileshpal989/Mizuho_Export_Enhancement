...
public partial class IMP_HelpForms_TF_ImpAuto_CommodityHelp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_ImpAuto_GetCommodityMasterList";
    ...
    protected void GridViewUserList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                pageurl = "window.opener.selectCommodity('" + lblCommodityID.Text + "','" + lblCommodityDesc.Text + "');window.opener.EndRequest();window.close();";
