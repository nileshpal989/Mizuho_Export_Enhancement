...
public partial class IMP_HelpForms_TF_LocalBankLookUp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_IMP_OverseasBank_List_For_IFSC";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                {
                    pageurl = "window.opener.selectNego_Remit_Bank('" + lblIFSCCode.Text + "');window.opener.EndRequest();window.close();";
                }
                if (Request.QueryString["hNo"].ToString() == "IMP")
                {
                    pageurl = "window.opener.selectNego_Remit_Bank_IMP('" + lblIFSCCode.Text + "','" + lblBankCode.Text + "','" + lblBankName.Text + "','" + lblBankAddress.Text + "');window.opener.EndRequest();window.close();";
                }
