<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_NostroBankHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_NostroBankHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewNostroBankList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server"
                                    ...
                                    onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewNostroBankList')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewNostroBankList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewNostroBankList_RowCommand"
                                    OnRowDataBound="GridViewNostroBankList_RowDataBound" OnRowCreated="GridViewNostroBankList_RowCreated"
                                    ...
                                    <Columns>                                        
                                        ...
                                        <asp:TemplateField HeaderText="Swift Code" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
