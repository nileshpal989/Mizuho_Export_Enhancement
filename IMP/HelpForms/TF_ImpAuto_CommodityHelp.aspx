<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ImpAuto_CommodityHelp.aspx.cs" Inherits="IMP_HelpForms_TF_ImpAuto_CommodityHelp" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Commodity ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityID" runat="server" Text='<%# Eval("CommodityID") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityDesc" runat="server" Text='<%# Eval("CommodityDescription") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
