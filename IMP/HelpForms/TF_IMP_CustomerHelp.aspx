<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_CustomerHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_CustomerHelp" %>
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server"
                                    ...
                                    onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewCustAcList')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Cust A/c No." HeaderStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Customer Abbr" HeaderStyle-HorizontalAlign="Left"
