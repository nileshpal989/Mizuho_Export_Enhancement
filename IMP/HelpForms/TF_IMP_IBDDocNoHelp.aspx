<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_IBDDocNoHelp.aspx.cs"
    Inherits="IMP_HelpForms_TF_IMP_IBDDocNoHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewIBDDocNO.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40" Width="200px"
                                    onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);" onkeyup="Search_Gridview(this, 'GridViewIBDDocNO')"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewIBDDocNO" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="false" OnRowDataBound="GridViewIBDDocNO_RowDataBound"
                                    OnRowCreated="GridViewIBDDocNO_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Due Date" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblValueDate" runat="server" Text='<%# Eval("Interest_To_Date") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillAmount" runat="server" Text='<%# Eval("Draft_Amt") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
