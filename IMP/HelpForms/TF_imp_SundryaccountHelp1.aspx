<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_imp_SundryaccountHelp1.aspx.cs"
    Inherits="IMP_HelpForms_TF_imp_SundryaccountHelp1" %>
                                ...
                                <asp:GridView ID="GridviewSundryAccount" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="DESCRIPTION">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("GL_CODE_Description") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="CCY" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCCY" runat="server" Text='<%# Eval("GL_Curr") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
