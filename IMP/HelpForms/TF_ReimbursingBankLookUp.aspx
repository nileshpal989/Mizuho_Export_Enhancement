<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ReimbursingBankLookUp.aspx.cs" Inherits="IMP_HelpForms_TF_ReimbursingBankLookUp" %>
                        ...
                        <tr id="rowGrid" runat="server" style="white-space: nowrap">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Bank ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Bank Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankName" runat="server" Text='<%# Eval("shortName") %>' ToolTip='<%# Eval("BankName") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Branch Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBranchName" runat="server" Text='<%# Eval("BranchName") %>' ToolTip='<%# Eval("BranchName") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
