<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Settl_for_Bank_ForeignHelp.aspx.cs" Inherits="IMP_HelpForms_TF_IMP_Settl_for_Bank_ForeignHelp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridView_Settl_For_Bank_List.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridView_Settl_For_Bank_List" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridView_Settl_For_Bank_List_RowCommand"
                                    OnRowDataBound="GridView_Settl_For_Bank_List_RowDataBound" OnRowCreated="GridView_Settl_For_Bank_List_RowCreated">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Abbr" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAbbr" runat="server" Text='<%# Eval("Abbr") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Acc Code" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblAccCode" runat="server" Text='<%# Eval("AccCode") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Acc No" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblAccNo" runat="server" Text='<%# Eval("AccNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
