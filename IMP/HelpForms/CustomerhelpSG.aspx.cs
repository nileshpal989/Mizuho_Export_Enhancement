...
public partial class IMP_HelpForms_CustomerhelpSG : System.Web.UI.Page
{
    ...
    protected void GridViewCustAcList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.opener.selectCustomer1('" + lblAcNo.Text + "','" + lblcustname.Text + "');window.opener.EndRequest();window.close();";
                if (i != 2)
