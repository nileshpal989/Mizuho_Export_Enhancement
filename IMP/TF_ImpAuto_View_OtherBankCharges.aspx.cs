...
public partial class TF_ImpAuto_View_OtherBankCharges : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("TF_OtherBankCharges.aspx?mode=add", true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_IMP_GetOtherBankChargesList";
    ...
    protected void GridViewCommission_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (str != "")
        {
            ...
            hdndec.Value = values_p[1].ToString();
            hdnamount.Value = values_p[2].ToString();
    ...
    protected void GridViewCommission_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.location='TF_OtherBankCharges.aspx?mode=edit&ID=" + lblID.Text.Trim() + "&custacno=" + lblDesc.Text + "'";
                if (i != 3)
    ...
    protected void btnDeleteConfirm_Click(object sender, EventArgs e)
    {
        ...
        SqlParameter p2 = new SqlParameter("@Description", SqlDbType.VarChar);
        p2.Value = hdndec.Value;

        // string _query = "TF_DeleteCommissionMasterDetails";
        string _query = "TF_IMP_DeleteOtherBankCharges";
        ...
        if (result == "deleted")
        {
            AuditTrailDeleted(hdnid.Value, hdndec.Value, hdnamount.Value);
    ...
    protected void AuditTrailDeleted(string _id, string _Description, string _Amount)
    {

        string _userName = Session["userName"].ToString();

        TF_DATA objdata = new TF_DATA();
        string _OldValues = "ID : " + _id + " ; Description : " + _Description + " ; Amount : " + _Amount;
