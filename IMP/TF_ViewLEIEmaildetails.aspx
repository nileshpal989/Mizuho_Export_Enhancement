<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewLEIEmaildetails.aspx.cs" Inherits="IMP_Transactions_TF_ViewLEIEmaildetails" %>
                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom" colspan="2">
                            <span class="pageLabel"><strong>LEI Email Details View</strong> </span>
                        </td>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top" colspan="3">
                            <asp:GridView ID="GridViewLeiEmail" runat="server" AutoGenerateColumns="False"
                                Width="100%" AllowPaging="True" OnRowCommand="GridViewLeiEmail_RowCommand"
                                OnRowDataBound="GridViewLeiEmail_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Report Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lblReportType" runat="server" CssClass="elementLabel" Text='<%# Eval("Report_Type") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Module">
                                        <ItemTemplate>
                                            <asp:Label ID="lblModule" runat="server" CssClass="elementLabel" Text='<%# Eval("Module") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="8%" />
                                        <ItemStyle HorizontalAlign="Center" Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Next Schedule Service Time">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNxtscheduletime" runat="server" CssClass="elementLabel" Text='<%# Eval("Service_time") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="7%" />
                                        <ItemStyle HorizontalAlign="Center" Width="7%" />
                                    </asp:TemplateField>
                                   <%-- <asp:TemplateField HeaderText="Last Schedule Service Time">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLastscheduletime" runat="server" CssClass="elementLabel" Text='<%# Eval("Service_time1") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("Report_Type")+";"+
                                            Eval("Module")%>' CommandName="RemoveRecord" Text="Delete" ToolTip="Delete Record" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="5%" />
                                        <ItemStyle HorizontalAlign="Center" Width="5%" />
                                    </asp:TemplateField>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="left" style="width: 25%">
                                            &nbsp;<span class="elementLabel"> Records per page:&nbsp; </span>
                                        ...
                                        <td align="right" style="width: 25%;">
                                            &nbsp;<asp:Label ID="lblpageno" runat="server" class="textBox"></asp:Label>
                                            &nbsp;
                                            <asp:Label ID="lblrecordno" runat="server" class="textBox"></asp:Label>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
