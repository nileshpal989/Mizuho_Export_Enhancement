<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ImpAuto_View_NonLC.aspx.cs"
    Inherits="IMP_TF_ImpAuto_View_NonLC" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkYear() {
            ...
            if (docYearLen > 3) {
                ...
                if (parseFloat(docYear.value) < parseFloat(d.getFullYear())) {
                    return false;
                }
                else
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Import Bill Of Entry View</strong></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left" width="35%" nowrap>
                                <asp:RadioButton ID="rdb_C" Text="Collection" CssClass="elementLabel" runat="server" GroupName="Foreign"
                                    TabIndex="23" AutoPostBack="true" OnCheckedChanged="rdb_C_CheckedChanged" Checked="true" />
                                <asp:RadioButton ID="rdb_LC" Text="Lodgment Under LC" CssClass="elementLabel" runat="server"
                                    GroupName="Foreign" TabIndex="23" AutoPostBack="true" OnCheckedChanged="rdb_LC_CheckedChanged" />
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <td align="left" width="35%" nowrap>
                                <asp:RadioButton ID="rdb_sight" Text="Sight" CssClass="elementLabel" runat="server"
                                    ...
                                    oncheckedchanged="rdb_sight_CheckedChanged" />
                                <asp:RadioButton ID="rdb_usance" Text="Usance" CssClass="elementLabel" runat="server"
                                    ...
                                    oncheckedchanged="rdb_usance_CheckedChanged" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" width="30%" nowrap>
                                ...
                                <%--<asp:TextBox ID="txtForeignLocal" runat="server" CssClass="textBox" Width="15px"
                                    AutoPostBack="true" TabIndex="4" MaxLength="1" OnTextChanged="txtForeignLocal_TextChanged"></asp:TextBox>--%>
                                ...
                                <asp:GridView ID="GridViewImpEntryList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocumentNo" runat="server" Text='<%# Eval("Document_No") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Received Date" HeaderStyle-HorizontalAlign="Left"
