<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Shipping_Guarantee_Checker_View.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_Shipping_Guarantee_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" colspan="2">
                                <span class="pageLabel"><strong>Booking liability of Shipping Guarantee View - Checker</strong></span>
                            </td>
                            <td align="right">
                            </td>
                        </tr>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewShipGuaranteeList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="5%" HeaderText="Branch"
                                            ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBranch" runat="server" Text='<%# Eval("BranchName") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
