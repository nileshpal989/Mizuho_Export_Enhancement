<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_ACC_IBD_Checker_View.aspx.cs" Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_ACC_IBD_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Own LC Bill Discounting View (IBD,ACC)-Checker</strong></span>
                            </td>
                            <td align="right">
                        ...
                        <tr align="right">
                            ...
                            <td width="40%" align="left">
                                ...
                                <asp:TextBox ID="txtYear" runat="server" CssClass="textBox" Width="17px" OnTextChanged="txtYear_TextChanged"
                                  ...
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span class="elementLabel">IBD Acceptence Date :</span>
                                            <asp:TextBox ID="txtIBDValueDate" runat="server" CssClass="textBox" 
									MaxLength="10" ValidationGroup="dtVal"
                                    Width="70px" TabIndex="15" AutoPostBack="true" 
									ontextchanged="txtIBDValueDate_TextChanged"></asp:TextBox>
                                <ajaxToolkit:MaskedEditExtender ID="ME_IBDDate" Mask="99/99/9999" MaskType="Date"
                                    runat="server" TargetControlID="txtIBDValueDate" ErrorTooltipEnabled="True" CultureName="en-GB"
                                    CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£" CultureDateFormat="DMY"
                                    CultureDatePlaceholder="/" Enabled="True" CultureDecimalPlaceholder="." CultureThousandsPlaceholder=","
                                    CultureTimePlaceholder=":">
                                </ajaxToolkit:MaskedEditExtender>
                                <asp:Button ID="btnCal_IBDDate" runat="server" CssClass="btncalendar_enabled" />
                                <ajaxToolkit:CalendarExtender ID="CE_IBDDate" runat="server" Format="dd/MM/yyyy"
                                    TargetControlID="txtIBDValueDate" PopupButtonID="btnCal_IBDDate" Enabled="True">
                                </ajaxToolkit:CalendarExtender>

                                <ajaxToolkit:MaskedEditValidator ID="MV_IBDDate" runat="server" ControlExtender="ME_IBDDate"
                                    ValidationGroup="dtVal" ControlToValidate="txtIBDValueDate" EmptyValueMessage="Enter Date Value"
                                ...
                                <asp:RadioButton ID="rdbAll" runat="server" Text="All" AutoPostBack="true"
                                    Checked="true" GroupName="Status" Font-Bold="true" 
									oncheckedchanged="rdbAll_CheckedChanged" />
                                <asp:RadioButton ID="rdbApproved" runat="server" Text="Approved" Font-Bold="true"
                                    AutoPostBack="true" GroupName="Status" ForeColor="GreenYellow" 
									oncheckedchanged="rdbApproved_CheckedChanged"/>
                                <asp:RadioButton ID="rdbRejected" runat="server" Text="Rejected" Font-Bold="true"
                                    AutoPostBack="true" GroupName="Status"  ForeColor="Tomato" 
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewLCdescounting" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="True" OnRowCommand="GridViewLCdescounting_RowCommand"
                                    OnRowDataBound="GridViewLCdescounting_RowDataBound" CssClass="GridView">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Trans. Ref. No" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="lblBranchName" runat="server" Value='<%# Eval("BranchName") %>' />
                                                ...
                                                <asp:TemplateField HeaderText="IBD Ref. No" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIBDDocNo" runat="server"
                                                 Text='<%# Eval("IBDDocument_No") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Drawer Name" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDrawer" runat="server" Text='<%# Eval("Drawer_NAME") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Due Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                          ...
                                          <asp:TemplateField HeaderText="Document Scrutiny" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocScrutiny" runat="server" Text='<%# Eval("Document_Scrutiny") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="IBD Extn" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIBDExtn" runat="server" Text='<%# Eval("IBD_Extn_Flag") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="IBD Extn DocNo" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIBDExtnDocNo" runat="server" Text='<%# Eval("IBDDocument_No_Extn") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Swift_Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSwift_Status" runat="server" Text='<%# Eval("Swift_Status") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="SFMS_Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
