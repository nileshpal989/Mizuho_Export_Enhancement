<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Collection_Acceptance_Maker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_Collection_Acceptance_Maker" %>
...
<head runat="server">
    ...
    <script src="../Scripts/TF_IMP_Collection_Acceptance_Maker.js" type="text/javascript"></script>
                ...
                <table id="tbl_Header" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <asp:Label ID="label1" runat="server" CssClass="mandatoryField"></asp:Label>
                            <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="buttonDefault" ToolTip="Back" OnClick="btnBack_Click" OnClientClick="return SaveUpdateData();"/>
                        </td>
                    </tr>
                    <%--<tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_Maturity_Date" runat="server" CssClass="textBox" MaxLength="10" TabIndex="24"
                                                        ValidationGroup="dtVal" Width="70px" AutoPostBack="true" OnTextChanged="txt_Maturity_Date_TextChanged"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox ID="txtAttn" Width="350px" runat="server" CssClass="textBox" MaxLength="70"
                                                        TabIndex="41" onkeyup="return Uppercase('TabContainerMain_tbDocumentDetails_txtAttn');"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" width="10%">
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox ID="txt_Expected_InterestAmt" runat="server" CssClass="textBox" MaxLength="16"
                                                        TabIndex="30" Width="100px" Style="text-align: right" onBlur="return Toggel_Amt('TabContainerMain_tbDocumentDetails_txt_Expected_InterestAmt');"
                                                ...
                                                <td align="left" width="70%">
                                                    <asp:TextBox ID="txt_Received_InterestAmt" runat="server" CssClass="textBox" MaxLength="16"
                                                        TabIndex="32" Width="100px" Style="text-align: right" onBlur="return Toggel_Amt('TabContainerMain_tbDocumentDetails_txt_Received_InterestAmt');"
                                                        onkeyDown="return validate_Number(event);"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Comment" runat="server" CssClass="textBox" TabIndex="204"
                                                                onkeyup="return Uppercase('TabContainerMain_tbDocumentGO_txt_GO_Swift_SFMS_Comment');"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Cust_AccNo" runat="server" CssClass="textBox"
                                                                TabIndex="213" onkeyup="return Uppercase('TabContainerMain_tbDocumentGO_txt_GO_Swift_SFMS_Debit_Cust_AccNo');"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Exch_Curr" runat="server" CssClass="textBox"
                                                                TabIndex="214" Width="25px" MaxLength="3" onkeyup="return Uppercase('TabContainerMain_tbDocumentGO_txt_GO_Swift_SFMS_Debit_Exch_Curr');"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">EXCH RATE : </span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Cust_AccNo" runat="server" CssClass="textBox"
                                                                TabIndex="223" onkeyup="return Uppercase('TabContainerMain_tbDocumentGO_txt_GO_Swift_SFMS_Credit_Cust_AccNo');"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" align="right">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Exch_Curr" runat="server" CssClass="textBox"
                                                                MaxLength="3" TabIndex="224" Width="25px" onkeyup="return Uppercase('TabContainerMain_tbDocumentGO_txt_GO_Swift_SFMS_Credit_Exch_Curr');"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">EXCH RATE : </span>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    <asp:TextBox ID="Narrative4991" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">2.</span>
                                                                    <asp:TextBox ID="Narrative4992" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">3.</span>
                                                                    <asp:TextBox ID="Narrative4993" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">4.</span>
                                                                    <asp:TextBox ID="Narrative4994" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">5.</span>
                                                                    <asp:TextBox ID="Narrative4995" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">6.</span>
                                                                    <asp:TextBox ID="Narrative4996" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">7.</span>
                                                                    <asp:TextBox ID="Narrative4997" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">8.</span>
                                                                    <asp:TextBox ID="Narrative4998" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">9.</span>
                                                                    <asp:TextBox ID="Narrative4999" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">10.</span>
                                                                    <asp:TextBox ID="Narrative49910" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">11.</span>
                                                                    <asp:TextBox ID="Narrative49911" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">12.</span>
                                                                    <asp:TextBox ID="Narrative49912" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">13.</span>
                                                                    <asp:TextBox ID="Narrative49913" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">14.</span>
                                                                    <asp:TextBox ID="Narrative49914" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">15.</span>
                                                                    <asp:TextBox ID="Narrative49915" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">16.</span>
                                                                    <asp:TextBox ID="Narrative49916" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">17.</span>
                                                                    <asp:TextBox ID="Narrative49917" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">18.</span>
                                                                    <asp:TextBox ID="Narrative49918" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">19.</span>
                                                                    <asp:TextBox ID="Narrative49919" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">20.</span>
                                                                    <asp:TextBox ID="Narrative49920" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">21.</span>
                                                                    <asp:TextBox ID="Narrative49921" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">22.</span>
                                                                    <asp:TextBox ID="Narrative49922" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">23.</span>
                                                                    <asp:TextBox ID="Narrative49923" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">24.</span>
                                                                    <asp:TextBox ID="Narrative49924" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">25.</span>
                                                                    <asp:TextBox ID="Narrative49925" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">26.</span>
                                                                    <asp:TextBox ID="Narrative49926" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">27.</span>
                                                                    <asp:TextBox ID="Narrative49927" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">28.</span>
                                                                    <asp:TextBox ID="Narrative49928" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">29.</span>
                                                                    <asp:TextBox ID="Narrative49929" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">30.</span>
                                                                    <asp:TextBox ID="Narrative49930" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">31.</span>
                                                                    <asp:TextBox ID="Narrative49931" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">32.</span>
                                                                    <asp:TextBox ID="Narrative49932" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">33.</span>
                                                                    <asp:TextBox ID="Narrative49933" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">34.</span>
                                                                    <asp:TextBox ID="Narrative49934" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">35.</span>
                                                                    <asp:TextBox ID="Narrative49935" Width="90%" runat="server" CssClass="textBox" MaxLength="50" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                                    ...
                                                    <asp:Panel ID="panel_AddNarrative" runat="server">
                                                        <table cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">1.</span>
                                                                    <asp:TextBox ID="txt_Narrative_1" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">2.</span>
                                                                    <asp:TextBox ID="txt_Narrative_2" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">3.</span>
                                                                    <asp:TextBox ID="txt_Narrative_3" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">4.</span>
                                                                    <asp:TextBox ID="txt_Narrative_4" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <span class="elementLabel">5.</span>
                                                                    <asp:TextBox ID="txt_Narrative_5" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel">6.</span>
                                                                    <asp:TextBox ID="txt_Narrative_6" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                            ...
                                            <tr>
                                                ...
                                                <td width="90%">
                                                    ...
                                                    <asp:CheckBox ID='rdb_swift_412' Text="MT 412" CssClass="elementLabel" runat="server"
                                                        onchange="return Toggel_Swift_Type('MT412');" />
