<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ReversalOfLiability_Maker_View.aspx.cs" Inherits="IMP_Transactions_TF_IMP_ReversalOfLiability_Maker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" style="width: 50%">
                                <span class="pageLabel"><strong>Reversal Of Liability View - Maker</strong></span>
                            </td>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Branch" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="lblBranchCode" runat="server" Value='<%# Eval("Branch_Code") %>' />
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Value Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblValue" runat="server" Text='<%# Eval("Value_Date") %>'  CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Cust A/C" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustAC" runat="server" Text='<%#Eval("Cust_AccNo")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
