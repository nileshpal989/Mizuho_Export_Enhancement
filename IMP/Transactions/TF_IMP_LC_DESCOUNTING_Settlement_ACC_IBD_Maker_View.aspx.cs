...
public partial class IMP_Transactions_TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Maker_View : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        TF_DATA objData = new TF_DATA();
        DataTable dt = objData.getData("TF_IMP_IBD_settlement_GetList_Maker", p_search, p_BranchName, p_Year, p_Document_Type);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void GridViewLCdescounting_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string path = "TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Maker.aspx";
            int i = 0;
            ...
            "&DocScrutiny=" + lblDocScrutiny.Text.Trim() + "'";
                if (i != 13)
