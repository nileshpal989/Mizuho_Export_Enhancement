<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Shipping_Guarantee_Checker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_Shipping_Guarantee_Checker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TF_IMP_Shipping_Guarantee_Checker.js" type="text/javascript"></script>
                ...
                <table id="tbl_Header" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel"><strong>Booking liability of Shipping Guarantee - Checker</strong></span>
                        </td>
                ...
                <table id="tbl_Ship_Guarantee" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td width="30%" align="left">
                            ...
                            <asp:TextBox ID="txt_LC_No" Width="100px" runat="server" CssClass="textBox" TabIndex="1" MaxLength="14" Enabled="false"></asp:TextBox>
                        </td>
                        <td width="40%" align="left">
                            ...
                            <asp:DropDownList ID="ddlDoc_Curr" runat="server" CssClass="dropdownList" TabIndex="3"
                            ...
                            <asp:TextBox ID="txt_Bill_Amt" runat="server" TabIndex="4" CssClass="textBox" Width="100px"
                                Style="text-align: right" onkeyDown="return validate_Number(event);" MaxLength="16"
                                Enabled="false"></asp:TextBox>
                        </td>
                        <td align="right" width="10%">
                        </td>
                ...
                <table id="tbl_Ship_Panal" cellspacing="0" border="0" width="100%">
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtbenename" runat="server" CssClass="textBox" MaxLength="50" TabIndex="5"
                                                        Width="410px" Height="12" Enabled="false"></asp:TextBox>
                                                    <br />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtbeneadd1" runat="server" CssClass="textBox" Height="12" MaxLength="35"
                                                        TabIndex="6" Width="410px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                            ...
                                            <tr>
                                               ...
                                               <td align="left" style="width: 115px">
                                            <asp:TextBox ID="txtApplid" runat="server" CssClass="textBox" MaxLength="15" 
											TabIndex="7" Width="100px" Height="12" Enabled="false"
                                             ></asp:TextBox>
                                            ...
                                            <br />
                                                ...
                                                <td align="left" class="auto-style1" valign="top">
                                                    ...
                                                    <asp:TextBox ID="txtlcrefno" runat="server" CssClass="textBox" MaxLength="14" TabIndex="9"
                                                        Width="200px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px" valign="top">
                                                ...
                                                <td align="left" style="width: 290px">
                                                    <asp:TextBox ID="txtApplAdd" runat="server" CssClass="textBox" Height="55px" MaxLength="100"
                                                        TabIndex="8" TextMode="MultiLine" Width="410px" Enabled="false"></asp:TextBox>
                                                    <br />
                                                </td>
                                                <td align="left" class="auto-style1" valign="middle">
                                                    ...
                                                    <asp:TextBox ID="txtApplCity" runat="server" CssClass="textBox" MaxLength="20" TabIndex="10"
                                                        Width="150px" Height="12px" Enabled="false"></asp:TextBox>
                                                    <br />
                                                    <br />
                                                    <span class="elementLabel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Pincode :</span>
                                                    <asp:TextBox ID="txtApplPincode" runat="server" CssClass="textBox" MaxLength="6"
                                                        TabIndex="10" Width="70px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtShippingissued" runat="server" CssClass="textBox" MaxLength="50" TabIndex="10"
                                                        Width="410px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                                    ...
                                                    Width="50px" Height="12px" Enabled="false" ></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtShipcompname" runat="server" CssClass="textBox" MaxLength="50"
                                                        TabIndex="16" Width="410px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                                ...
                                                <td align="left" style="width: 50px">
                                                    <asp:TextBox ID="txtVesselname1" runat="server" CssClass="textBox" MaxLength="10" TabIndex="17"
                                                        Width="120px" Height="12px" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <asp:TextBox ID="txtVesseldate1" runat="server" CssClass="textBox" MaxLength="50"
                                                        TabIndex="18" Width="75px" Height="12px" ValidationGroup="dtVal" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd/MM/yyyy"
                                                        TargetControlID="txtVesseldate1" PopupButtonID="btnCal_airlineDate1" Enabled="false">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 50px">
                                                    ...
                                                    <asp:TextBox ID="txtVesseldate2" runat="server" CssClass="textBox" MaxLength="50"
                                                        TabIndex="20" Width="75px" Height="12px" ValidationGroup="dtVal" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="CEx_airlineDate2" runat="server" Format="dd/MM/yyyy"
                                                        TargetControlID="txtVesseldate2" PopupButtonID="btnCal_airlineDate2" Enabled="false">
                                                    </ajaxToolkit:CalendarExtender>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtnotifyname" runat="server" CssClass="textBox" MaxLength="50"
                                                        TabIndex="24" Width="410px" Height="11px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtdescofgoods" runat="server" CssClass="textBox" MaxLength="50"
                                                        TabIndex="25" Width="410px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                                <td align="left" class="auto-style1">
                                                    ...
                                                    <asp:TextBox ID="txtquantity" runat="server" CssClass="textBox" MaxLength="15" TabIndex="26"
                                                        Width="70px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                            ...
                                            <tr>
                                                ...
                                                TabIndex="28" Width="50px" Height="12px" Enabled="false"></asp:TextBox>
                                                <asp:Button ID="btncurrency" runat="server" CssClass="btnHelp_enabled" TabIndex="-1" Visible="false"/>
                                                    ...
                                                    <asp:TextBox ID="txtbillamt" runat="server" Style="text-align: right" CssClass="textBox"
                                                        MaxLength="15" onchange="return ccyformat();" TabIndex="29" Width="100px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                                ...
                                                <td align="left" style="width: 200px">
                                                    <asp:TextBox ID="txt_Com_InvNo" runat="server" CssClass="textBox" MaxLength="50" TabIndex="29"
                                                        Width="300px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                                ...
                                                <td align="left" style="width: 200px">
                                                    <asp:TextBox ID="txtVesselname3" runat="server" CssClass="textBox" MaxLength="50" TabIndex="29"
                                                        Width="300px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" style="width: 200px">
                                                    <asp:TextBox ID="txt_Bill_No" runat="server" CssClass="textBox" MaxLength="50" TabIndex="29"
                                                        Width="300px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" style="width: 200px">
                                                    <asp:TextBox ID="txt_Remarks_Reg" runat="server" CssClass="textBox" MaxLength="50" TabIndex="29"
                                                        Width="300px" Height="12px" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    <asp:TextBox ID="txtgoodspolicy" TextMode="MultiLine" runat="server" CssClass="textBox"
                                                        ...
                                                        Width="410px" Enabled="false"></asp:TextBox>
                                                    <br />
                                                </td>
                                                <td align="left" class="auto-style1" valign="top">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 115px">
                                                    ...
                                                    <asp:CheckBox runat="server" ID="Chk_Ahm" Text="AHM" TabIndex="32" CssClass="elementLabel"
                                                       Enabled="false" Checked="false"></asp:CheckBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 200px">
                                    ...
                                    <ContentTemplate>
                                        <table id="tbl_Ship_Doc" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="ddl_revInfoOpt" CssClass="dropdownList" runat="server" TabIndex="8" Enabled="false">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_ApplNoBranch" runat="server" TabIndex="10" CssClass="textBox"
                                                        MaxLength="7" Width="70px" Enabled="false"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_Remarks" runat="server" TabIndex="17" CssClass="textBox" MaxLength="100"
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_GO1Flag" Text="GENERAL OPERATION I" runat="server" CssClass="elementLabel" Enabled="false"/>
                                                            </td>
                                                            <td align="center" width="50%">
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="24%">
                                                                                <asp:DropDownList ID="txt_GO1_Left_Debit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="84" onchange="return TogggleDebitCreditCode('1','1');" Enabled="false">
                                                                            ...
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Curr" runat="server" CssClass="textBox" TabIndex="84"
                                                                                    Width="25px" MaxLength="3" onchange="return txt_GO1_Left_Debit_Curr_Change();"
                                                                                    Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                            ...
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    ...
                                                                                    MaxLength="16" onblur="return Toggel_Debit_Amt();" onchange="return GO1_Amt_Calculation();"
                                                                                    Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    ...
                                                                                    MaxLength="16" onchange="return txt_GO1_Left_Debit_Exch_Rate_Change();" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Exch_CCY" runat="server" CssClass="textBox" MaxLength="3"
                                                                                    TabIndex="87" Width="25px" onchange="return txt_GO1_Left_Debit_Exch_CCY_Change();"
                                                                                    Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:DropDownList ID="txt_GO1_Left_Credit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="91" onchange="return TogggleDebitCreditCode('1','2');" Enabled="false">
                                                                                    <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                                                    <asp:ListItem Value="D" Text="D"></asp:ListItem>
                                                                                    <asp:ListItem Value="C" Text="C"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" colspan="3">
                                                                                ...
                                                                                <asp:TextBox ID="txt_GO1_Right_Remarks" runat="server" CssClass="textBox" Width="300px"
                                                                                    MaxLength="30" TabIndex="102" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">MEMO:</span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    TabIndex="104" Style="text-align: right" MaxLength="16" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    TabIndex="106" Width="100px" Style="text-align: right" MaxLength="16" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Check_No" runat="server" CssClass="textBox"
                                                                                    TabIndex="107" MaxLength="6" Width="50px" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">AVAILABLE:</span>
                                                                            </td>
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelGO2" runat="server" HeaderText="GENERAL OPERATION II"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_GO2Flag" Text="GENERAL OPERATION II" runat="server" CssClass="elementLabel" Enabled="false"/>
                                                            </td>
                                                            <td align="center" width="50%">
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" colspan="3">
                                                                                ...
                                                                                <asp:TextBox ID="txt_GO2_Left_Remarks" runat="server" CssClass="textBox" Width="300px"
                                                                                    MaxLength="30" TabIndex="82" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">MEMO:</span>
                                                                            </td>
                    ...
                    <tr>
                        <td align="center" width="100%" colspan="5">
                            ...
                            <asp:DropDownList ID="ddlApproveReject" runat="server" CssClass="dropdownList" TabIndex="35" onchange="return DialogAlert();">
                                <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
