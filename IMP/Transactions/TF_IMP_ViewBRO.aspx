<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ViewBRO.aspx.cs" Inherits="IMP_Transactions_TF_IMP_ViewBRO" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><b>Bank Release Order (BRO) View - Maker<b></span>
                            </td>
                            <td align="right" style="width: 50%">
                                <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="buttonDefault" ToolTip="Add New Record" OnClick="btnAdd_Click"
                                    />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr align="right">
                         <td width="15%" align="left">
                                ...
                                <asp:DropDownList ID="ddlBranch" CssClass="dropdownList" AutoPostBack="true" runat="server" onselectedindexchanged="ddlBranch_SelectedIndexChanged" >
                                </asp:DropDownList>
                            </td>
                            ...
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewBRO" runat="server" AutoGenerateColumns="false" Width="90%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="4%" HeaderText="Delete"
                                            ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("Delivery_Order_No") %>'
