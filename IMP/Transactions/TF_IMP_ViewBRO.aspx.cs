...
public partial class IMP_Transactions_TF_IMP_ViewBRO : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("TF_IMP_BRO.aspx?mode=add", true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string query = "TF_IMP_GetBROlist";
        TF_DATA objdata = new TF_DATA();
    ...
    protected void GridViewBRO_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string url = "window.location='TF_IMP_BRO.aspx?mode=edit&Delivery_Order_No=" + lblBrono.Text.Trim() + "'";
                if (i != 9)
