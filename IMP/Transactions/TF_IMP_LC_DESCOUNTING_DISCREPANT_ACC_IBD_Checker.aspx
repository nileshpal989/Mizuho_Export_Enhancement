<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_DISCREPANT_ACC_IBD_Checker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_DISCREPANT_ACC_IBD_Checker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TF_IMP_LC_DESCOUNTING_DISCREPANT_ACC_IBD_Checker.js" type="text/javascript"></script>
                ...
                <table id="tbl_LCDiscount" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td width="30%" align="left">
                            ...
                            <%--    <ajaxToolkit:MaskedEditExtender ID="MaskIBD" runat="server"  Mask="IBD-999-999999999999"  MaskType="None" TargetControlID="txtIBDDocNo"
                             ClearMaskOnLostFocus="false" InputDirection="LeftToRight" AutoComplete="true" />--%>
                            &nbsp;
                        ...
                        <td width="40%" align="left">
                            ...
                            <ajaxToolkit:MaskedEditExtender ID="ME_Value_Date" Mask="99/99/9999" MaskType="Date"
                                ...
                                CultureDatePlaceholder="/" Enabled="false" CultureDecimalPlaceholder="." CultureThousandsPlaceholder=","
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <span class="elementLabel">
                                                        <asp:RadioButton ID="rdbIDOA" Enabled="false" runat="server" GroupName="A1" TabIndex="6"
                                                            Text="INTEREST+DISCREPANCY ON APPLICANT" AutoPostBack="True" OnCheckedChanged="rdbIDOA_CheckedChanged">
                                                        </asp:RadioButton>
                                                    </span>
                                                </td>
                                                <td colspan="2">
                                                    <span class="elementLabel">
                                                        <asp:RadioButton ID="rdbIDOB" Enabled="false" runat="server" GroupName="A1" TabIndex="7"
                                                            Text="INTEREST+DISCREPANCY ON BENEFICIARY" AutoPostBack="True"></asp:RadioButton>
                                                    </span>
                                                </td>
                                                <td colspan="2">
                                                    <span class="elementLabel">
                                                        <asp:RadioButton ID="rdbIOBDOA" Enabled="false" runat="server" GroupName="A1" TabIndex="8"
                                                            Text="INTEREST ON BENE+DISCREPANCY ON APP" AutoPostBack="True"></asp:RadioButton>
                                                    </span>
                                                </td>
                                                <td colspan="2">
                                                    <span class="elementLabel">
                                                        <asp:RadioButton ID="rdbIOADOB" Enabled="false" runat="server" GroupName="A1" TabIndex="9"
                                                            Text="INTEREST ON APPLICANT+DISCREPANCY ON BENEFICIARY" AutoPostBack="True">
                                                        </asp:RadioButton>
                                                    </span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox Enabled="false" ID="txtIBD_ACC_kind" runat="server" CssClass="textBox"
                                                        MaxLength="1" TabIndex="10" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox Enabled="false" ID="txtCommentCode" runat="server" CssClass="textBox"
                                                        MaxLength="2" TabIndex="11" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="right" width="10%">
                                                ...
                                                <td align="left" width="30%">
                                                    <asp:TextBox Enabled="false" ID="txtAutoSettlement" runat="server" CssClass="textBox"
                                                        MaxLength="1" TabIndex="12" Width="40px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" width="10%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txtContractNo" runat="server" CssClass="textBox"
                                                        MaxLength="9" TabIndex="15" Width="90px" onkeyup="return Uppercase('TabContainerMain_tbDocumentDetails_txtContractNo');"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txtExchRate" runat="server" CssClass="textBox" MaxLength="11"
                                                        TabIndex="16" Width="120px" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtIBDAmt" runat="server" CssClass="textBox" MaxLength="16"
                                                        Width="120px" TabIndex="17" Style="text-align: right"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtCountryRisk" runat="server" CssClass="textBox"
                                                        MaxLength="2" TabIndex="18" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtRiskCust" runat="server" CssClass="textBox" MaxLength="12"
                                                        TabIndex="19" Width="140px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtGradeCode" runat="server" CssClass="textBox"
                                                        MaxLength="2" TabIndex="20" Width="40px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtApplNo" runat="server" CssClass="textBox" MaxLength="7"
                                                        TabIndex="21" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtApplBR" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="22" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtPurpose" runat="server" CssClass="textBox" MaxLength="7"
                                                        TabIndex="23" Width="25px"></asp:TextBox>
                                                </td>
                                                <td colspan="2">
                                                    <span class="elementLabel">PURPOSE CODE:</span>
                                                    <asp:DropDownList ID="ddl_PurposeCode" runat="server" Enabled="false" CssClass="dropdownList"
                                                        MaxLength="3" TabIndex="24" Width="60px" AutoPostBack="True">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtsettlCodeForCust" runat="server" CssClass="textBox"
                                                        TabIndex="25" MaxLength="7" Width="50px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtsettlforCust_Abbr" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="26" Width="140px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtsettlforCust_AccCode" runat="server" CssClass="textBox"
                                                        MaxLength="5" TabIndex="27" Width="50px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtsettlforCust_AccNo" runat="server" CssClass="textBox"
                                                        MaxLength="20" TabIndex="28" Width="140px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtInterest_From" runat="server" AutoPostBack="True"
                                                        CssClass="textBox" MaxLength="10" TabIndex="29" ValidationGroup="dtVal" Width="80px"></asp:TextBox>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtInterest_To" runat="server" AutoPostBack="True"
                                                        CssClass="textBox" MaxLength="10" TabIndex="30" ValidationGroup="dtVal" Width="80px"></asp:TextBox>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txt_No_Of_Days" runat="server" CssClass="textBox"
                                                        MaxLength="3" TabIndex="31" Width="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txt_INT_Rate" runat="server" CssClass="textBox"
                                                        MaxLength="10" Style="text-align: right" TabIndex="32" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtBaseRate" runat="server" CssClass="textBox" MaxLength="2"
                                                        Style="text-align: right" TabIndex="33" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txtSpread" runat="server" CssClass="textBox" MaxLength="9"
                                                        Style="text-align: right" TabIndex="34" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtInterestAmt" runat="server" AutoPostBack="True"
                                                        CssClass="textBox" MaxLength="16" Style="text-align: right" TabIndex="35" Width="120px"
                                                        onchange="return ONINTERESTAMT();"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtFundType" runat="server" CssClass="textBox" MaxLength="1"
                                                        onkeyDown="return validate_Number(event);" TabIndex="36" Width="20px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtSettl_CodeForBank" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="38" Width="50px"></asp:TextBox>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtSettl_ForBank_Abbr" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="39" Width="140px"></asp:TextBox>
                                                    <asp:DropDownList ID="ddl_Settl_ForBank_Abbr" runat="server" AutoPostBack="True"
                                                        CssClass="dropdownList" TabIndex="40" Width="80px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td align="right">
                                                    <span class="elementLabel">A/C CODE :</span>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtSettl_ForBank_AccCode" runat="server" CssClass="textBox"
                                                        MaxLength="5" TabIndex="41" Width="50px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                    <span class="elementLabel">A/C NO :</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="7">
                                                    ...
                                                    <asp:TextBox Enabled="false" ID="txtNego_Remit_Bank" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="43" Width="100px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="7">
                                                    <asp:TextBox Enabled="false" ID="txtAcwithInstitution" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="44" Width="100px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="7">
                                                    <asp:TextBox Enabled="false" ID="txtReimbursingbank" runat="server" CssClass="textBox"
                                                        MaxLength="12" TabIndex="45" Width="100px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txtREM_EUC" runat="server" CssClass="textBox" MaxLength="20"
                                                        ...
                                                        TabIndex="46" Width="200px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox Enabled="false" ID="txtAttn" runat="server" CssClass="textBox" MaxLength="70"
                                                        onkeyup="return Uppercase('TabContainerMain_tbDocumentDetails_txtAttn');" TabIndex="47"
                                    ...
                                    <ContentTemplate>
                                        <table cellpadding="0" cellspacing="2" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <asp:DropDownList ID="ddlTenor" Enabled="false" runat="server" CssClass="dropdownList"
                                                        TabIndex="47">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox Enabled="false" ID="txtCommission_Ex_rate" runat="server" CssClass="textBox"
                                                        MaxLength="9" TabIndex="89" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox Enabled="false" ID="txt_CR_AC_ShortName" runat="server" CssClass="textBox"
                                                                    MaxLength="20" TabIndex="98" Width="90px"></asp:TextBox>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox Enabled="false" ID="txt_CR_Acceptance_payer" runat="server" CssClass="textBox"
                                                                    MaxLength="1" TabIndex="103" Width="50px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox Enabled="false" ID="txt_CR_Interest_payer" runat="server" CssClass="textBox"
                                                                    MaxLength="1" TabIndex="106" Width="50px" onkeyup="return Uppercase('TabContainerMain_tbDocumentAccounting_txt_CR_Interest_payer');"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <caption>
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox Enabled="false" ID="txt_CR_Accept_Commission_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" onkeyup="return Uppercase('TabContainerMain_tbDocumentAccounting_txt_CR_Accept_Commission_Payer');"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox Enabled="false" ID="txt_CR_Pay_Handle_Commission_Payer" runat="server"
                                                                        CssClass="textBox" MaxLength="1" onkeyup="return Uppercase('TabContainerMain_tbDocumentAccounting_txt_CR_Pay_Handle_Commission_Payer');"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox Enabled="false" ID="txt_CR_Others_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" onkeyup="return Uppercase('TabContainerMain_tbDocumentAccounting_txt_CR_Others_Payer');"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox Enabled="false" ID="txt_CR_Their_Commission_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" onkeyup="return Uppercase('TabContainerMain_tbDocumentAccounting_txt_CR_Their_Commission_Payer');"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox Enabled="false" ID="txt_GO1_Debit_Cust_Name" runat="server" CssClass="textBox"
                                                            MaxLength="40" TabIndex="88" Width="150px" Visible="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <asp:TextBox Enabled="false" ID="txt_GO1_Debit_Cust_AcCode_Name" MaxLength="40" runat="server"
                                                            CssClass="textBox" TabIndex="89" Width="150px" Visible="false"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">A/C No : </span>
                                                    </td>
                                        ...
                                        <table width="80%">
                                            ...
                                            <asp:Panel ID="Panel_GO2" runat="server" Visible="False">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Comment" runat="server" CssClass="textBox"
                                                            MaxLength="20" TabIndex="80"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_SectionNo" runat="server" MaxLength="2"
                                                            CssClass="textBox" TabIndex="81" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right" width="15%">
                                                        <span class="elementLabel">Remarks : </span>
                                                    ...
                                                    <td width="10%">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Memo" runat="server" MaxLength="20" CssClass="textBox"
                                                            Width="50px" TabIndex="83"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Scheme_no" runat="server" MaxLength="20"
                                                            CssClass="textBox" TabIndex="84"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <br />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Code" MaxLength="1" runat="server"
                                                            CssClass="textBox" TabIndex="85" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">CCY : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Curr" runat="server" MaxLength="3"
                                                            CssClass="textBox" TabIndex="86" Width="45px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">AMOUNT : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Amt" runat="server" CssClass="textBox"
                                                            Width="90px" TabIndex="87" Style="text-align: right" MaxLength="16"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Cust" runat="server" CssClass="textBox"
                                                            MaxLength="20" TabIndex="88" Width="90px"></asp:TextBox>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Cust_Name" runat="server" CssClass="textBox"
                                                            MaxLength="40" TabIndex="88" Width="150px" Visible="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Cust_AcCode" MaxLength="20" runat="server"
                                                            CssClass="textBox" TabIndex="89" Width="90px"></asp:TextBox>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Cust_AcCode_Name" MaxLength="40" runat="server"
                                                            CssClass="textBox" TabIndex="89" Width="150px" Visible="false"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">A/C No : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Cust_AccNo" runat="server" MaxLength="20"
                                                            CssClass="textBox" TabIndex="90"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Exch_CCY" runat="server" CssClass="textBox"
                                                            MaxLength="3" TabIndex="92" Width="35px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_FUND" runat="server" MaxLength="1"
                                                            CssClass="textBox" TabIndex="93" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">CHECK No. : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Check_No" runat="server" CssClass="textBox"
                                                            TabIndex="94"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">AVAILABLE : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Available" MaxLength="20" runat="server"
                                                            CssClass="textBox" TabIndex="95" Width="90px" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_AdPrint" runat="server" CssClass="textBox"
                                                            TabIndex="96" Width="30px" MaxLength="1"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">DETAILS : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Details" runat="server" MaxLength="30"
                                                            CssClass="textBox" Width="260px" TabIndex="97"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">ENTITY : </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Division" runat="server" CssClass="textBox"
                                                            TabIndex="99" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">INTER-AMOUNT : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Inter_Amount" runat="server" CssClass="textBox"
                                                            TabIndex="100"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">INTER-RATE : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Debit_Inter_Rate" runat="server" CssClass="textBox"
                                                            TabIndex="101" Width="90px" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Code" MaxLength="1" runat="server"
                                                            CssClass="textBox" TabIndex="102" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">CCY : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Curr" runat="server" CssClass="textBox"
                                                            TabIndex="103" Width="45px" MaxLength="3"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">AMOUNT : </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Cust" runat="server" CssClass="textBox"
                                                            MaxLength="20" TabIndex="105" Width="90px"></asp:TextBox>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Cust_Name" MaxLength="40" runat="server"
                                                            CssClass="textBox" TabIndex="105" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Cust_AcCode" runat="server" CssClass="textBox"
                                                            TabIndex="106" Width="90px"></asp:TextBox>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Cust_AcCode_Name" runat="server"
                                                            CssClass="textBox" TabIndex="106" Width="150px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">A/C No : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Cust_AccNo" MaxLength="20" runat="server"
                                                            CssClass="textBox" TabIndex="107"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Exch_Curr" runat="server" CssClass="textBox"
                                                            MaxLength="3" TabIndex="109" Width="35px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_FUND" MaxLength="1" runat="server"
                                                            CssClass="textBox" TabIndex="110" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">CHECK No. : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Check_No" runat="server" CssClass="textBox"
                                                            TabIndex="111"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">AVAILABLE : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Available" runat="server" MaxLength="20"
                                                            CssClass="textBox" TabIndex="112" Width="90px" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_AdPrint" runat="server" CssClass="textBox"
                                                            TabIndex="113" Width="30px" MaxLength="1"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">DETAILS : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Details" runat="server" MaxLength="30"
                                                            CssClass="textBox" Width="260px" TabIndex="114"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">ENTITY : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Entity" runat="server" CssClass="textBox"
                                                            onkeydown="return validate_Number(event);" TabIndex="115" Width="90px" Style="text-align: right"
                                                            MaxLength="3"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Division" runat="server" CssClass="textBox"
                                                            TabIndex="116" Width="30px"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">INTER-AMOUNT : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Inter_Amount" runat="server" CssClass="textBox"
                                                            TabIndex="117"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">INTER-RATE : </span>
                                                    ...
                                                    <td>
                                                        <asp:TextBox Enabled="false" ID="txt_GO2_Credit_Inter_Rate" runat="server" CssClass="textBox"
                                                            TabIndex="118" Width="90px" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </asp:Panel>
                                                ...
                                                <td>
                                                    <td align="left" colspan="6">
                                                        ...
                                                        <asp:Button ID="btnGO2_Next" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(5);"
                                                            TabIndex="119" Text="Next &gt;&gt;" ToolTip="Next to GENRAL OPERATION Branch" />
                                                    </td>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <asp:CheckBox ID="cb_GOBranch_Bill_Handling_Flag" Text="GENERAL OPERATION BR" runat="server"
                                                        Enabled="false" CssClass="elementLabel" AutoPostBack="True" />
                                                </td>
                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <asp:TextBox Enabled="false" ID="txt_GOBR_Debit_Cust_AcCode_Name" MaxLength="40"
                                                            runat="server" CssClass="textBox" TabIndex="89" Width="150px" Visible="false"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                        <span class="elementLabel">A/C No : </span>
                                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox Enabled="false" ID="txt_R42_AddInfo_7495" runat="server" CssClass="textBox"
                                                        MaxLength="40" TabIndex="309" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
