...
public partial class IMP_Transactions_TF_IMP_ReversalOfLiability_Checker_View : System.Web.UI.Page
{
    ...
    protected void GridViewBRO_checker_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string url = "window.location='TF_IMP_ReversalOfLiability_Checker.aspx?mode=edit&DocNo=" + lblDocNo.Text.Trim() + "&Status=" + Status.Text + "'";
    ...
    protected void fillGrid()
    {
        ...
        SqlParameter p_BroDate = new SqlParameter("@ValueDate", SqlDbType.VarChar);
        ...
        TF_DATA objData = new TF_DATA();
        DataTable dt = objData.getData("TF_IMP_GetRevOfLib_ForChecker", p_search, p_BranchName, p_BroDate, p_Status);
