<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Maker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Maker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TF_IMP_IBD_Settlement_Maker.js" type="text/javascript"></script>
                ...
                <table id="tbl_Header" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel"><strong>Own LC Bill Discounting Settlement- Maker</strong></span>
                        </td>
                ...
                <table id="tbl_LCDiscount" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td width="30%" align="left">
                            <asp:TextBox ID="txtIBDDocNo" Width="110px" runat="server" CssClass="textBox" TabIndex="1"></asp:TextBox>
                        ...
                        <td align="left" width="20%">
                            <asp:TextBox ID="txtDocNo" Width="110px" runat="server" CssClass="textBox" TabIndex="3"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <ajaxToolkit:TabContainer ID="TabContainerMain" runat="server" ActiveTabIndex="3"
                                ...
                                <ajaxToolkit:TabPanel ID="tbDocumentDetails" runat="server" HeaderText="ACC DOCUMENT DETAILS"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <tr>
                                                <td align="left">
                                                    <asp:CheckBox ID="chk_AccDocDetails" Text="ACC DOCUMENT DETAILS" runat="server" CssClass="elementLabel"
                                                        AutoPostBack="True" OnCheckedChanged="chk_AccDocDetails_CheckedChanged"/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtMaturityDate" runat="server" AutoPostBack="True" CssClass="textBox"
                                                        MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="5" ValidationGroup="dtVal"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtsettlCodeForCust" runat="server" CssClass="textBox" TabIndex="7"
                                                ...
                                                <td align="right">
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtInterest_From" runat="server" AutoPostBack="True" CssClass="textBox"
                                                            MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="8" ValidationGroup="dtVal"
                                                            Width="80px"></asp:TextBox>
                                                    ...
                                                    <td align="left" width="10%">
                                                        <asp:TextBox ID="txtDiscount" runat="server" CssClass="textBox" MaxLength="16" Width="120px"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_To" runat="server" AutoPostBack="True" CssClass="textBox"
                                                        MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="9" ValidationGroup="dtVal"
                                                        Width="80px"></asp:TextBox>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox ID="txt_No_Of_Days" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="10" Width="50px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_INT_Rate" runat="server" CssClass="textBox" MaxLength="10" 
                                                        TabIndex="11" Width="70px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterestAmt" AutoPostBack="true" runat="server" CssClass="textBox"
                                                        MaxLength="16" TabIndex="14" Width="100px" onchange="return ONINTERESTAMT();"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtOverinterestRate" runat="server" CssClass="textBox" MaxLength="10" TabIndex="28" Width="70px"
                                                    onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                    <span class="elementLabel">NO. OF DAYS :</span>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtOverNoOfDays" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="27" Width="50px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtOverAmount" AutoPostBack="true" runat="server" CssClass="textBox"
                                                        MaxLength="16" TabIndex="14" Width="100px" onchange="return ONINTERESTAMT();"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtAttn" runat="server" CssClass="textBox" MaxLength="70" TabIndex="18"
                                ...
                                <ajaxToolkit:TabPanel ID="tbDocumentAccounting" runat="server" HeaderText="ACC IMPORT ACCOUNTING"
                                    ...
                                    <ContentTemplate>
                                        <table width="80%">
                                         <tr>
                                                <td align="left">
                                                    <asp:CheckBox ID="chk_AccImpAccounting" Text="ACC IMPORT ACCOUNTING" runat="server" CssClass="elementLabel"
                                                        AutoPostBack="True" OnCheckedChanged="chk_AccImpAccounting_CheckedChanged" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    <span class="elementLabel">AMOUNT :</span><asp:TextBox ID="txt_DiscAmt" runat="server"
                                                        CssClass="textBox" TabIndex="72" MaxLength="16" Width="100px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                                <td align="left" colspan="2">
                                                    <span class="elementLabel">EXCH RATE :</span><asp:TextBox ID="txt_IMP_ACC_ExchRate"
                                                        runat="server" CssClass="textBox" TabIndex="73" MaxLength="9" Width="70px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtprinc_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="78" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtprinc_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="79" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_matu" runat="server" CssClass="textBox"
                                                        MaxLength="1" onkeydown="return validate_Commission_MATU_Code(event);" 
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="84" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="85" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="89" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="90" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="95" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_Intnl_Ex_rate" runat="server" CssClass="textBox"
                                                        TabIndex="96" onkeydown="return validate_Number(event);" Style="text-align: right" MaxLength="9" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td width="10%" align="left">
                                                                ...
                                                                &nbsp;<asp:Button ID="btn_CR_Code_help" runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC1','Credit');" />
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <asp:TextBox ID="txt_CR_Code" runat="server" CssClass="textBox" MaxLength="5" TabIndex="97" Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Acceptance_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="102" Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <caption>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    &nbsp;<asp:Button ID="btn_DR_Code_help" runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC1','Debit');" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_DR_Cust_abbr" runat="server" CssClass="textBox"  MaxLength="12" TabIndex="126" Width="100px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                        ...
                                        <table width="80%">
                                            ...
                                            <asp:Panel ID="Panel_GO1" runat="server" Visible="False">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:TextBox ID="txt_GO1_Remarks" runat="server" MaxLength="30" CssClass="textBox"
                                                            Width="260px" TabIndex="82" onkeyup="return CustRem('GO1');"></asp:TextBox>
                                                    </td>
                                                    <td align="right" width="15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GO1_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                            ...
                                                            MaxLength="16" onkeyup="return Toggle_GO_Amt('GO1');"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox ID="txt_GO1_Debit_Cust" runat="server" CssClass="textBox" MaxLength="20"
                                                            TabIndex="88" Width="90px"></asp:TextBox>
                                                        <asp:TextBox ID="txt_GO1_Debit_Cust_Name" runat="server" CssClass="textBox" MaxLength="40"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GO1_Debit_Check_No" runat="server" CssClass="textBox" TabIndex="94" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GO1_Debit_Available" MaxLength="20" runat="server" CssClass="textBox"
                                                            TabIndex="95" Width="90px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txt_GO1_Credit_Cust_Name" MaxLength="40" runat="server" CssClass="textBox"
                                                    ...
                                                    <td align="left">
                                                        <asp:Button ID="btnGO1_Prev" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(1);"
                                                            TabIndex="119" Text="&lt;&lt; Prev" ToolTip="Back to IMPORT ACCOUNTING" />
                                                             <asp:Button ID="btnGO1_Next" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(3);"
                                            ...
                                            <asp:Panel ID="Panel_GO2" runat="server" Visible="False">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:TextBox ID="txt_GO2_Remarks" runat="server" MaxLength="30" CssClass="textBox"
                                                            Width="260px" TabIndex="82" onkeyup="return CustRem('GO2');"></asp:TextBox>
                                                    </td>
                                                    <td align="right" width="15%">
                                                        <span class="elementLabel">MEMO : </span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox ID="txt_GO2_Debit_Cust" runat="server" CssClass="textBox" MaxLength="20"
                                                            TabIndex="88" Width="90px"></asp:TextBox>
                                                        <asp:TextBox ID="txt_GO2_Debit_Cust_Name" runat="server" CssClass="textBox" MaxLength="40"
                                                            TabIndex="88" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;
                                                        <asp:Button ID="btn_GO2_Credit_AccCode_Help" runat="server" ToolTip="Press for AcCode list."
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox ID="txt_GO2_Credit_Cust" runat="server" CssClass="textBox" MaxLength="20"
                                                            TabIndex="105" Width="90px"></asp:TextBox>
                                                        <asp:TextBox ID="txt_GO2_Credit_Cust_Name" MaxLength="40" runat="server" CssClass="textBox"
                                                            TabIndex="105" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox ID="txt_IBD_CustName" runat="server" CssClass="textBox"
                                                        TabIndex="1" MaxLength="40" Width="350px"></asp:TextBox>
                                                </td>
                                                <td align="left" colspan="2">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox ID="txt_IBD_CommentCode" runat="server" CssClass="textBox" MaxLength="2"
                                                        TabIndex="4" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="right" width="10%">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_MaturityDate" runat="server" AutoPostBack="True" CssClass="textBox"
                                                        MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="5" ValidationGroup="dtVal"
                                                        Width="80px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_settlCodeForCust" runat="server" CssClass="textBox" TabIndex="7"
                                                        MaxLength="7" Width="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Settl_CodeForBank" runat="server" CssClass="textBox" MaxLength="12"
                                                        TabIndex="17" Width="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <span class="elementLabel">INTEREST FROM :</span>
                                                    <td align="left">
                                                        <asp:TextBox ID="txt_IBD_Interest_From" runat="server" AutoPostBack="True" CssClass="textBox"
                                                            MaxLength="10" OnTextChanged="Get_IBD_Date_Diff" TabIndex="8" ValidationGroup="dtVal"
                                                            Width="80px"></asp:TextBox>
                                                    ...
                                                    <td align="left" width="10%">
                                                        <asp:TextBox ID="txt_IBD_Discount" runat="server" CssClass="textBox" MaxLength="16"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Interest_To" runat="server" AutoPostBack="True" CssClass="textBox"
                                                        MaxLength="10" OnTextChanged="Get_IBD_Date_Diff" TabIndex="9" ValidationGroup="dtVal"
                                                        Width="80px"></asp:TextBox>
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox ID="txt_IBD__No_Of_Days" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="10" Width="50px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD__INT_Rate" runat="server" CssClass="textBox" MaxLength="10"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="11" Width="70px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_InterestAmt" AutoPostBack="true" runat="server" CssClass="textBox"
                                                        MaxLength="16" TabIndex="14" Width="100px" onchange="return ONINTERESTAMT();"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_OverinterestRate" runat="server" CssClass="textBox" MaxLength="10"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="28" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                    <span class="elementLabel">NO. OF DAYS :</span>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_OverNoOfDays" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="27" Width="50px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_OverAmount" AutoPostBack="true" runat="server" CssClass="textBox"
                                                        MaxLength="16" TabIndex="14" Width="100px" onchange="return ONINTERESTAMT();"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Attn" runat="server" CssClass="textBox" MaxLength="70" TabIndex="18"
                                                        Width="350px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <asp:Button ID="Button4" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(3);"
                                                        TabIndex="19" Text="<< PREV" ToolTip="Go to GENERAL OPERATION" />
                                                    <asp:Button ID="Button1" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(5);"
                                                        TabIndex="19" Text="Next >>" ToolTip="Go to IBD IMPORT ACCOUNTING" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                    ...
                                    <ContentTemplate>
                                        <table width="80%">
                                            <tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    <span class="elementLabel">AMOUNT :</span><asp:TextBox ID="txt_IBD_DiscAmt" runat="server"
                                                        CssClass="textBox" TabIndex="72" MaxLength="16" Width="100px" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                                <td align="left" colspan="2">
                                                    <span class="elementLabel">EXCH RATE :</span><asp:TextBox ID="txt_IBD_IMP_ACC_ExchRate"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDPrinc_matu" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="74" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDPrinc_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="75" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDprinc_Contract_no" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="76" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Princ_Ex_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="77" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDprinc_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="78" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDprinc_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="79" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDInterest_matu" runat="server" CssClass="textBox"
                                                        MaxLength="1"  TabIndex="80" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDInterest_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        onkeydown="return validate_Commission_LUMP_Code(event);" TabIndex="81" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDInterest_Contract_no" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="82" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_interest_Ex_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="83" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDInterest_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="84" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDInterest_Intnl_Ex_rate" runat="server" CssClass="textBox"
                                                        MaxLength="9" onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="85" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDCommission_matu" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="86" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"
                                                        onkeyup="return Commission_Toggel();"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDCommission_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="87" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDCommission_Contract_no" runat="server" CssClass="textBox"
                                                        MaxLength="9" TabIndex="88" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Commission_Ex_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                        TabIndex="89" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDCommission_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="89" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDCommission_Intnl_Ex_rate" runat="server" CssClass="textBox"
                                                        MaxLength="9" TabIndex="90" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDTheir_Commission_matu" runat="server" CssClass="textBox"
                                                        MaxLength="1" TabIndex="91" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDTheir_Commission_lump" runat="server" CssClass="textBox"
                                                        MaxLength="1" TabIndex="92" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDTheir_Commission_Contract_no" runat="server" CssClass="textBox"
                                                        TabIndex="93" MaxLength="9" Width="90px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBD_Their_Commission_Ex_Curr" runat="server" CssClass="textBox"
                                                        TabIndex="94" MaxLength="3" Width="40px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDTheir_Commission_Ex_rate" runat="server" CssClass="textBox"
                                                        MaxLength="9" TabIndex="95" onkeydown="return validate_Number(event);" Style="text-align: right" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txt_IBDTheir_Commission_Intnl_Ex_rate" runat="server" CssClass="textBox"
                                                        TabIndex="96" onkeydown="return validate_Number(event);" Style="text-align: right" MaxLength="9" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="7">
                                                    <table width="100%">
                                                        <tr>
                                                            <td width="10%" align="left">
                                                                <span class="elementLabel"><b>/CR/</b> CODE :</span>
                                                                &nbsp;<asp:Button ID="btn_IBD_CR_Code_help"
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <asp:TextBox ID="txt_IBD_CR_Code" runat="server" CssClass="textBox" MaxLength="5"
                                                                    onkeydown="return validate_Number(event);" TabIndex="97" Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_AC_ShortName" runat="server" CssClass="textBox" MaxLength="20"
                                                                    TabIndex="98" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Cust_abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                                    TabIndex="99" Width="100px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Cust_Acc" runat="server" CssClass="textBox" MaxLength="20"
                                                                    TabIndex="100" Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="center">
                                                                <asp:TextBox ID="txt_IBD_CR_Acceptance_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                                    TabIndex="101" Width="40px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Acceptance_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="102" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Acceptance_payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="103" Width="50px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <asp:TextBox ID="txt_IBD_CR_Interest_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                                    TabIndex="104" Width="40px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Interest_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="105" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_IBD_CR_Interest_payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="106" Width="50px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <caption>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_CR_Accept_Commission_Curr" runat="server" CssClass="textBox"
                                                                        MaxLength="3" TabIndex="107" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Accept_Commission_amt" runat="server" CssClass="textBox"
                                                                        MaxLength="9" onkeydown="return validate_Number(event);" onkeyup="return Toggel_IMP_ACC_Coll_Comm();"
                                                                        Style="text-align: right" TabIndex="108" Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Accept_Commission_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" TabIndex="109" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_CR_Pay_Handle_Commission_Curr" runat="server" CssClass="textBox"
                                                                        MaxLength="3" TabIndex="110" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Pay_Handle_Commission_amt" runat="server" CssClass="textBox"
                                                                        MaxLength="9" onkeydown="return validate_Number(event);" Style="text-align: right"
                                                                        TabIndex="111" Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Pay_Handle_Commission_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" TabIndex="112" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_CR_Others_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                                        TabIndex="113" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Others_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="114"
                                                                        Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Others_Payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                        TabIndex="115" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_CR_Their_Commission_Curr" runat="server" CssClass="textBox"
                                                                        MaxLength="3" TabIndex="116" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Their_Commission_amt" runat="server" CssClass="textBox"
                                                                        MaxLength="9" onkeydown="return validate_Number(event);" Style="text-align: right"
                                                                        TabIndex="117" Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_CR_Their_Commission_Payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" TabIndex="118" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <span class="elementLabel"><b>/DR/</b> CODE:</span>
                                                                    &nbsp;<asp:Button ID="btn_IBD_DR_Code_help"
                                                            ...
                                                            <tr>
                                                                <td align="right">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Code" runat="server" CssClass="textBox" MaxLength="5"
                                                                        TabIndex="119" Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <%--<asp:TextBox ID="txt_IBD_IBD_DR_AC_ShortName" runat="server" CssClass="textBox" 
                                                                        MaxLength="20" TabIndex="119" Width="90px"></asp:TextBox>--%>
                                                                    <span class="elementLabel">CURRENT ACCOUNT</span>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Cust_abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                                        TabIndex="120" Width="100px" ></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Cust_Acc" runat="server" CssClass="textBox" MaxLength="20"
                                                                        TabIndex="121" Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Cur_Acc_Curr" runat="server" CssClass="textBox" MaxLength="3"
                                                                        TabIndex="122" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Cur_Acc_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="123"
                                                                        Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_IBD_DR_Cur_Acc_payer" runat="server" CssClass="textBox"
                                                                        MaxLength="1" onkeydown="return validate_Commission_PAYER_Code(event);" TabIndex="124" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <asp:Panel ID="panal_IBD_DRdetails" runat="server" Visible="false">
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txt_IBD_DR_Code" runat="server" CssClass="textBox" MaxLength="5" TabIndex="125"
                                                                            Width="90px"></asp:TextBox>
                                                                    </td>
                                                                    <td align="left">
                                                                        <span class="elementLabel">CURRENT ACCOUNT</span>
                                                                    ...
                                                                    <td align="left">
                                                                        <asp:TextBox ID="txt_IBD_DR_Cust_abbr" runat="server" CssClass="textBox"  MaxLength="12" TabIndex="126" Width="100px"></asp:TextBox>
                                                                    </td>
                                                                    <td align="left">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_Curr2" runat="server" CssClass="textBox" MaxLength="3"
                                                                         TabIndex="131" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_amt2" runat="server" CssClass="textBox" MaxLength="9"
                                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="132"
                                                                        Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_payer2" runat="server" CssClass="textBox" MaxLength="1"
                                                                        onkeydown="return validate_Commission_PAYER_Code(event);" TabIndex="133" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_Curr3" runat="server" CssClass="textBox" MaxLength="3"
                                                                        TabIndex="134" Width="40px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_amt3" runat="server" CssClass="textBox" MaxLength="9"
                                                                        onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="135"
                                                                        Width="90px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cur_Acc_payer3" runat="server" CssClass="textBox" MaxLength="1"
                                                                        onkeydown="return validate_Commission_PAYER_Code(event);" TabIndex="136" Width="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </caption>
                                            ...
                                            <tr>
                                                <td align="left" colspan="7">
                                                    <asp:Button ID="Button2" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(4);"
                                                        TabIndex="159" Text="&lt;&lt; Prev" ToolTip="Back to Document Details" />
                                                    &nbsp;
                                                    <asp:CheckBox ID="chk_IBDExtn_Flag" Text="IBD Extn Flag" runat="server" CssClass="elementLabel"/>
                                                    <asp:Button ID="btn_IBDExtn" runat="server" CssClass="buttonDefault" OnClientClick="return SubmitCheck();" OnClick="btnIBD_EXTENSION_Click"
                                                        TabIndex="137" Text="IBD Extn / Submit" ToolTip="IBD EXTENSION Or Submit to Checker"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
