<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker.js" type="text/javascript"></script>
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                <td colspan="8">
                                                    <span class="elementLabel">
                                                        <asp:RadioButton ID="Intapp" runat="server" GroupName="A1" TabIndex="3" Text="Interest on Applicant"
                                                            AutoPostBack="True" OnCheckedChanged="Intapp_CheckedChanged"></asp:RadioButton>
                                                    </span>&nbsp; <span class="elementLabel">
                                                        <asp:RadioButton ID="Intbeni" runat="server" GroupName="A1" Text="Interest on Beneficiary"
                                                            AutoPostBack="True" TabIndex="3" OnCheckedChanged="Intbeni_CheckedChanged"></asp:RadioButton>
                                                        <span class="elementLabel">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtHO_Apl" runat="server" CssClass="textBox" MaxLength="9" TabIndex="5"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtvalueDate1" runat="server" CssClass="textBox" MaxLength="10"
                                                        TabIndex="104" ValidationGroup="dtVal" Width="80px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox ID="txtDraftAmt" runat="server" CssClass="textBox" MaxLength="16" Width="120px"
                                                        TabIndex="9" Style="text-align: right" onkeydown="return validate_Number(event);"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtIBDAmt" runat="server" CssClass="textBox" MaxLength="16" Width="120px"
                                                        TabIndex="13" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtsettlCodeForCust" runat="server" CssClass="textBox" TabIndex="21"
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtsettlforCust_Abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                        TabIndex="22" Width="140px" onkeyup="return DebitCredit_For_IMP_ACC();"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtsettlforCust_AccCode" runat="server" CssClass="textBox" MaxLength="5"
                                                        TabIndex="23" Width="50px" onkeyup="return DebitCredit_For_IMP_ACC();"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtsettlforCust_AccNo" runat="server" CssClass="textBox" MaxLength="20"
                                                        TabIndex="24" Width="160px" onkeyup="return DebitCredit_For_IMP_ACC();"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtInterest_From" runat="server" AutoPostBack="True" CssClass="textBox"
                                                            MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="25"
                                                            ValidationGroup="dtVal" Width="80px"></asp:TextBox>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtInterest_To" runat="server" AutoPostBack="True" CssClass="textBox"
                                                            MaxLength="10" OnTextChanged="Get_LCDescounting_Get_Date_Diff" TabIndex="26"
                                                            ValidationGroup="dtVal" Width="80px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txt_INT_Rate" runat="server" CssClass="textBox" MaxLength="10" Style="text-align: right"
                                                                TabIndex="28" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">BASE RATE :</span>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtBaseRate" runat="server" CssClass="textBox" MaxLength="2" Style="text-align: right"
                                                                TabIndex="29" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">SPREAD(%) :</span>
                                                        </td>
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtSpread" runat="server" CssClass="textBox" MaxLength="9" Style="text-align: right"
                                                                TabIndex="30" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtInterestAmt" AutoPostBack="true" runat="server" CssClass="textBox"
                                                                onkeydown="return validate_Number(event);" MaxLength="16" Style="text-align: right"
                                                                TabIndex="31" Width="120px" onchange="return ONINTERESTAMT();"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">FUND TYPE :</span>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtFundType" runat="server" CssClass="textBox" MaxLength="1" onkeyDown="return validate_Number(event);"
                                                                TabIndex="32" Width="20px"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtInternalRate" runat="server" CssClass="textBox" MaxLength="10"
                                                                onkeyDown="return validate_Number(event);" Style="text-align: right" TabIndex="33"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtSettl_CodeForBank" runat="server" CssClass="textBox" MaxLength="12"
                                                                TabIndex="34" Width="50px"></asp:TextBox>
                                                            <asp:Button ID="btnCR_Code_help" runat="server" ToolTip="Press for AcCode list."
                                                                CssClass="btnHelp_enabled" OnClientClick="return Settl_CodeForBank_help('mouseClick');" />
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtSettl_ForBank_Abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                                TabIndex="35" Width="140px" onkeyup="return DebitCredit_For_IMP_ACC();"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C CODE :</span>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtSettl_ForBank_AccCode" runat="server" CssClass="textBox" MaxLength="5"
                                                                TabIndex="37" Width="50px" onkeyup="return DebitCredit_For_IMP_ACC();"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C NO :</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="7">
                                                            <asp:TextBox ID="txtNego_Remit_Bank_Type" runat="server" CssClass="textBox" MaxLength="12"
                                                                TabIndex="39" Width="100px"></asp:TextBox>
                                                            ...
                                                            <asp:TextBox ID="txtNego_Remit_Bank" runat="server" CssClass="textBox" MaxLength="12"
                                                                TabIndex="40" Width="100px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtREM_EUC" runat="server" CssClass="textBox" MaxLength="20" TabIndex="43"
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtAttn" runat="server" CssClass="textBox" MaxLength="70" TabIndex="44"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    <span class="elementLabel">AMOUNT :</span><asp:TextBox ID="txt_DiscAmt" runat="server"
                                                        onkeydown="return validate_Number(event);" CssClass="textBox" TabIndex="72" MaxLength="16"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Acceptance_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="102"
                                                                    Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Interest_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" Style="text-align: right" TabIndex="105"
                                                                    Width="90px"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_IBD_DR_Cust_abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                                        TabIndex="130" Width="100px"></asp:TextBox>
                                                                </td>
                                                                <td align="left">
                                        ...
                                        <table width="80%">
                                            ...
                                            <asp:Panel ID="Panel_GO1" runat="server" Visible="False">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GO1_Credit_Entity" runat="server" CssClass="textBox" TabIndex="115"
                                                            Width="90px" MaxLength="3" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table width="80%">
                                            ...
                                            <asp:Panel ID="PanelGOBR_Bill_Handling" runat="server" Visible="False">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <asp:TextBox ID="txt_GOBR_Memo" runat="server" MaxLength="30" CssClass="textBox"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox ID="txt_GOBR_Debit_Cust" runat="server" CssClass="textBox" MaxLength="20"
                                                            TabIndex="88" Width="90px"></asp:TextBox>
                                                        <asp:TextBox ID="txt_GOBR_Debit_Cust_Name" runat="server" CssClass="textBox" MaxLength="40"
                                                            TabIndex="88" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GOBR_Debit_Entity" runat="server" CssClass="textBox" TabIndex="98"
                                                            Width="90px" MaxLength="3" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:TextBox ID="txt_GOBR_Credit_Cust" runat="server" CssClass="textBox" MaxLength="20"
                                                            TabIndex="105" Width="90px"></asp:TextBox>
                                                        <asp:TextBox ID="txt_GOBR_Credit_Cust_Name" MaxLength="40" runat="server" CssClass="textBox"
                                                            TabIndex="105" Width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txt_GOBR_Credit_Entity" runat="server" CssClass="textBox" TabIndex="115"
                                                            Width="90px" MaxLength="3" onkeydown="return validate_Number(event);" Style="text-align: right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <ajaxToolkit:TabPanel ID="tblR42format" runat="server" HeaderText="R42 FORMAT FOR IBD"
                                    ...
                                    <ContentTemplate>
                                        <table width="50%">
                                            ...
                                            <tr>
                                                <td align="center" colspan="2">
                                                    <asp:Button ID="btn_R42_Prev" runat="server" CssClass="buttonDefault" OnClientClick="return OnDocNextClick(4);"
