...
public partial class IMP_Transactions_TF_IMP_Ledger_Modification_ICA_ICU_IBA_Checker_View : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        TF_DATA objData = new TF_DATA();
        DataTable dt = objData.getData("TF_IMP_Ledger_modification_ICA_ICU_IBA_GetList_Checker", p_search, p_BranchName, p_Year, p_Document_Type);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void GridViewLedgerModification_ICA_ICU_IBA_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string path = "TF_IMP_Ledger_Modification_ICA_ICU_IBA_Checker.aspx";
            ...
            "&BranchName=" + ddlBranch.SelectedItem.Text.Trim() + "&Status=" + Status.Text.Trim() + "'";
                if (i != 7)
