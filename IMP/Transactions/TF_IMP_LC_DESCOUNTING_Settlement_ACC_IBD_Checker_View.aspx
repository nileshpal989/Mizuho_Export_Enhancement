<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Checker_View.aspx.cs" Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_Settlement_ACC_IBD_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Own LC Bill Discounting Settlement View (IBD,ACC)-Checker</strong></span>
                            </td>
                            <td align="right">
                        ...
                        <tr align="right">
                            ...
                            <td width="60%" align="left">
                                ...
                                <asp:TextBox ID="txtYear" runat="server" CssClass="textBox" Width="17px" OnTextChanged="txtYear_TextChanged"
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span class="elementLabel">IBD Settlement Date :</span>
                                ...
                                <asp:GridView ID="GridViewLCdescounting" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Drawer Name" HeaderStyle-HorizontalAlign="Center"
                                         ...
                                         <asp:TemplateField HeaderText="Cur" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
