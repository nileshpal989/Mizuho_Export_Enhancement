...
public partial class IMP_Transactions_TF_IMP_ReversalofGO_Checker_View : System.Web.UI.Page
{
    ...
    protected void GridViewBRO_checker_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string url = "window.location='TF_IMP_ReversalofGO_Checker.aspx?mode=edit&Delivery_Order_No=" + lblBrono.Text.Trim() + "&Status=" + Status.Text + "&Applicant_Name=" + lblApplicantName.Text.Trim() +
    ...
    protected void fillGrid()
    {
        ...
        TF_DATA objData = new TF_DATA();
        DataTable dt = objData.getData("TF_IMP_GetBROWITHGenOprtn_ForChecker", p_search, p_BranchName, p_BroDate, p_Status);
