<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker_View.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Import Bill Acceptance View - Maker</strong></span>
                            </td>
                            <td align="right">
                            </td>
                        </tr>
                        ...
                        <tr align="right">
                            ...
                            <td width="50%" align="left">
                                ...
                                <asp:RadioButton ID="rbd_ACC" Text="ACC" CssClass="elementLabel" Checked="true" runat="server"
                                    AutoPostBack="true" GroupName="Doc_Type" OnCheckedChanged="rbd_ACC_CheckedChanged" />
                                <asp:RadioButton ID="rbd_IBD" Text="IBD" CssClass="elementLabel" runat="server" AutoPostBack="true"
                                    GroupName="Doc_Type" OnCheckedChanged="rbd_IBD_CheckedChanged" Visible="false" />
                                <asp:RadioButton ID="rdb_ICU" Text="ICU" CssClass="elementLabel" runat="server" AutoPostBack="true"
                                    GroupName="Doc_Type" OnCheckedChanged="rbd_ICU_CheckedChanged" />
                            </td>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBooking_IBD_ACC_List" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="True" OnRowCommand="GridViewBooking_IBD_ACC_List_RowCommand"
                                    OnRowDataBound="GridViewBooking_IBD_ACC_List_RowDataBound" CssClass="GridView">
