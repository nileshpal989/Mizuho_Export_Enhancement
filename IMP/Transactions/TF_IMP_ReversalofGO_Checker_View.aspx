<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ReversalofGO_Checker_View.aspx.cs" Inherits="IMP_Transactions_TF_IMP_ReversalofGO_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2" >
                                <span class="pageLabel"><strong>BRO Margin Reversal View - Checker</strong></span>
                            </td>
                                ...
                                <asp:GridView ID="GridViewBRO_checker" runat="server" AutoGenerateColumns="false" Width="80%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Bro Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                         ...
                                         <asp:TemplateField HeaderText="Applicant Name" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                        ...
                                        <asp:TemplateField HeaderText="Shipping Company" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                            HeaderStyle-Width="12%" ItemStyle-Width="12%">
                                            <ItemTemplate>
