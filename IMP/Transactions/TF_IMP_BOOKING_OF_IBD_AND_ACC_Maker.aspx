<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker" %>
...
<head runat="server">
    ...
    <script src="../Scripts/TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker.js" type="text/javascript"></script>
...
//        function SearchText() {
//            $("#TabContainerMain_tbDocumentAccounting_txt_CR_Code").autocomplete({
//                source: function (request, response) {
//                    $.ajax({
//                        type: "POST",
//                        contentType: "application/json; charset=utf-8",
//                                url: "TF_IMP_BOOKING_OF_IBD_AND_ACC_Maker.aspx/GetACcode",
//                                data: "{'Acocde':'" + $("#TabContainerMain_tbDocumentAccounting_txt_CR_Code").val() + "'}",
//                        dataType: "json",
                ...
                <table id="tbl_Header" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel"><strong>Import Bill Acceptance - Maker</strong></span>
                        </td>
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="left" colspan="6">
                                                    <asp:CheckBox ID="chk_Ledger_Modify" Text="LEDGER FILE" runat="server" CssClass="elementLabel"
                                                        TabIndex="1" OnCheckedChanged="chk_Ledger_Modify_OnCheckedChanged" AutoPostBack="true"/>
                                                </td>
                                            </tr>
                                            ...
                                            <td align="right" width="10%">
                                                ...
                                                <td align="left" >
                                                    <asp:TextBox ID="txtLedger_Modify_amt" runat="server" CssClass="textBox" MaxLength="16" AutoPostBack="true"
                                                        TabIndex="7"  onkeydown="return validate_Number(event);" onblur="return Toggel_Ledger_Amt();"
                                                        Width="100px" Style="text-align: right" OnTextChanged="txtLedger_Modify_amt_TextChanged"></asp:TextBox>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td align="right" >
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" >
                                                    ...
                                                    <asp:Button ID="btnCal_txtLedgerMaturity" runat="server" Enabled="false" CssClass="btncalendar_enabled"/>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtLedgerStatusCode" runat="server" CssClass="textBox" MaxLength="12"
                                                        TabIndex="21" Width="140px" AutoPostBack="true" ontextchanged="TextBox1_TextChanged"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <asp:Button ID="btnLedgerNext" runat="server" Text="Next >>" CssClass="buttonDefault"
                                                        TabIndex="50" ToolTip="Go to DOCUMENT DETAILS" OnClientClick="return SaveUpdateData();"
                                                        OnClick="btnLedgerNext_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                    ...
                                    <ContentTemplate>
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    ...
                                                    <asp:DropDownList ID="ddl_PurposeCode" runat="server" CssClass="dropdownList" MaxLength="3"
                                                        TabIndex="19" Width="70px" AutoPostBack="True" OnSelectedIndexChanged="ddl_PurposeCode_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_From" runat="server" CssClass="textBox" MaxLength="10" AutoPostBack ="true"
                                                        TabIndex="24" ValidationGroup="dtVal" Width="70px" OnTextChanged="Get_Acceptance_Get_Date_Diff"></asp:TextBox>
                                                    ...
                                                    <asp:Button ID="btnCal_txtInterest_From" runat="server" CssClass="btncalendar_enabled"
                                                        />
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtendertxtInterest_From" runat="server" Format="dd/MM/yyyy"
                                                        TargetControlID="txtInterest_From" PopupButtonID="btnCal_txtInterest_From" Enabled="True">
                                                    </ajaxToolkit:CalendarExtender>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_To" runat="server" CssClass="textBox" MaxLength="10" AutoPostBack ="true"
                                                        TabIndex="25" ValidationGroup="dtVal" Width="70px" OnTextChanged="Get_Acceptance_Get_Date_Diff"></asp:TextBox>
                                                    ...
                                                    <asp:Button ID="btnCal_txtInterest_To" runat="server" CssClass="btncalendar_enabled"
                                                        />
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtendertxtInterest_To" runat="server" Format="dd/MM/yyyy"
                                                        TargetControlID="txtInterest_To" PopupButtonID="btnCal_txtInterest_To" Enabled="True">
                                                    </ajaxToolkit:CalendarExtender>
                                                </td>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtFundType" runat="server" CssClass="textBox" MaxLength="1" Width="20px"
                                                        TabIndex="31" onkeyDown="return validate_Number(event);"></asp:TextBox>
                                                </td>
                                                <td align="right">
                                                ...
                                                <td align="left" colspan="3">
                                                    <asp:TextBox ID="txtInternalRate" runat="server" CssClass="textBox" MaxLength="10"
                                                        TabIndex="32" Width="70px" Style="text-align: right" onkeyDown="return validate_Number(event);"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    ...
                                                    &nbsp;
                                                    <asp:Button ID="btnSettl_CodeForBank_help" runat="server" ToolTip="Press for SETTL FOR BANK list." CssClass="btnHelp_enabled" OnClientClick= "return OpenSettl_For_Bank_help('mouseClick');" />
                                                </td>
                                                <td align="right">
                                                    <span class="elementLabel">A/C CODE :</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <asp:Button ID="btnDocNext" runat="server" Text="Next >>" CssClass="buttonDefault"
                                                        TabIndex="50" ToolTip="Go to Instructions" OnClientClick="return SaveUpdateData();"
                                                        OnClick="btnDocNext_Click" />
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    ...
                                                    <asp:CheckBox ID="chk_IMP_ACC_Commission" Text="Standard Charges" runat="server" CssClass="elementLabel"
                                                        TabIndex="101" onchange="return Commission_Toggel();"/>
                                                </td>
                                                ...
                                                <td align="left" colspan="2">
                                                    <span class="elementLabel">EXCH RATE :</span><asp:TextBox ID="txt_IMP_ACC_ExchRate" runat="server" CssClass="textBox" TabIndex="101" MaxLength="9"
                                                        Width="70px" Style="text-align: right" onkeydown="return validate_Number(event);" onchange="return Commission_Toggel();"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtprinc_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="106" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtprinc_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="107" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_matu" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="108" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="109" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        onkeydown="return validate_Number(event);" TabIndex="112" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtInterest_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        onkeydown="return validate_Number(event);" TabIndex="113" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_matu" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="114" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"
                                                        onkeyup="return Commission_Toggel();"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="115" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="118" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommission_Intnl_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="119" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_matu" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="120" Width="40px" onkeydown="return validate_Commission_MATU_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_lump" runat="server" CssClass="textBox" MaxLength="1"
                                                        TabIndex="121" Width="40px" onkeydown="return validate_Commission_LUMP_Code(event);"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_Ex_rate" runat="server" CssClass="textBox" MaxLength="9"
                                                        TabIndex="124" onkeydown="return validate_Number(event);" Width="70px"></asp:TextBox>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTheir_Commission_Intnl_Ex_rate" runat="server" CssClass="textBox"
                                                        TabIndex="125" onkeydown="return validate_Number(event);" MaxLength="9" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">
                                                    ...
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:TextBox ID="txt_CR_Code" runat="server" CssClass="textBox" MaxLength="5"
                                                                    TabIndex="126" Width="90px"></asp:TextBox>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Acceptance_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="130" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Acceptance_payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="131" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Interest_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="133" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Interest_payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="134" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Accept_Commission_amt" runat="server" CssClass="textBox"
                                                                    onkeydown="return validate_Number(event);" onchange="return Toggel_IMP_ACC_Coll_Comm();" TabIndex="136" MaxLength="9" Width="90px"
                                                                    Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Accept_Commission_Payer" runat="server" CssClass="textBox"
                                                                    TabIndex="137" MaxLength="1" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Pay_Handle_Commission_amt" runat="server" CssClass="textBox"
                                                                    onkeydown="return validate_Number(event);" TabIndex="139" MaxLength="9" Width="90px"
                                                                    Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Pay_Handle_Commission_Payer" runat="server" CssClass="textBox"
                                                                    TabIndex="140" MaxLength="1" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Others_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="142" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Others_Payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="143" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Their_Commission_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="145" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_CR_Their_Commission_Payer" runat="server" CssClass="textBox"
                                                                    TabIndex="146" MaxLength="1" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <asp:TextBox ID="txt_DR_Code" runat="server" CssClass="textBox" MaxLength="5" TabIndex="148"
                                                                    Width="90px" onkeyup="return Toggel_DR_Code();"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cust_abbr" runat="server" CssClass="textBox" MaxLength="12"
                                                                    TabIndex="149" Width="90px" onkeyup="return Toggel_IMP_ACC_Cust_abbr();"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cust_Acc" runat="server" CssClass="textBox" MaxLength="20"
                                                                    TabIndex="150" Width="90px" onkeyup="return Toggel_IMP_ACC_Cust_No();"></asp:TextBox>
                                                            </td>
                                                            <td align="center">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_amt" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="152" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_payer" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="153" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_amt2" runat="server" CssClass="textBox" MaxLength="9"
                                                                    onkeydown="return validate_Number(event);" TabIndex="155" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_payer2" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="156" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_amt3" runat="server" CssClass="textBox" MaxLength="9"
                                                                    TabIndex="157" onkeydown="return validate_Number(event);" Width="90px" Style="text-align: right"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txt_DR_Cur_Acc_payer3" runat="server" CssClass="textBox" MaxLength="1"
                                                                    TabIndex="158" Width="50px" onkeydown="return validate_Commission_PAYER_Code(event);" ></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <asp:Panel ID="panalGO_Swift_SFMS" runat="server" Visible="false">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Cust" runat="server" CssClass="textBox"
                                                                TabIndex="211"  Width="90px" MaxLength="12"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C CODE : </span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Cust_AcCode" runat="server" CssClass="textBox"
                                                                TabIndex="212" Width="90px" MaxLength="5"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C No : </span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Cust_AccNo" runat="server" CssClass="textBox" MaxLength="20"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                onkeydown="return validate_Number(event);" TabIndex="215" Width="90px" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="3">
                                                            ...
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Details" runat="server" CssClass="textBox" MaxLength="30"  Width="300px"
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Debit_Entity" runat="server" CssClass="textBox"
                                                                onkeydown="return validate_Number(event);" TabIndex="217" Width="90px" Style="text-align: right"
                                                                MaxLength="3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Amt" runat="server" CssClass="textBox"
                                                                Enabled="false" onkeydown="return validate_Number(event);" TabIndex="220" Width="90px"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Cust" runat="server" CssClass="textBox"
                                                                TabIndex="221" Width="90px" MaxLength="12"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C CODE : </span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Cust_AcCode" runat="server" CssClass="textBox"
                                                                TabIndex="222" Width="90px" MaxLength="5"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">A/C No : </span>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Cust_AccNo" runat="server" CssClass="textBox" MaxLength="20"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Exch_Rate" runat="server" CssClass="textBox"
                                                                onkeydown="return validate_Number(event);" TabIndex="225" Width="90px" Style="text-align: right"
                                                                MaxLength="16"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="3">
                                                            ...
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Details" runat="server" CssClass="textBox" MaxLength="30" Width="300px"
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_GO_Swift_SFMS_Credit_Entity" runat="server" CssClass="textBox"
                                                                onkeydown="return validate_Number(event);" TabIndex="228" Width="90px" Style="text-align: right"
                                                                MaxLength="3"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="90%">
                                                    ...
                                                    <asp:Button ID="btnGO_Next" runat="server" Text="Next>>" CssClass="buttonDefault"
                                                        ToolTip="Go to SWIFT FILES" TabIndex="256" OnClick="btnGO_Next_Click" OnClientClick="return SaveUpdateData();" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                    ...
                                    <ContentTemplate>
                                        <ajaxToolkit:TabContainer ID="TabContainerSwift" runat="server" ActiveTabIndex="0"
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td align="left">
                                                            <asp:TextBox ID="txt_740_Date" onkeydown="return allowBackSpace('DateandplaceofExpiry',event);"
                                                                Width="60px" runat="server" CssClass="textBox" MaxLength="10" TabIndex="4"></asp:TextBox>
                                                            ...
                                                            <asp:TextBox ID="txt_740_Placeofexpiry" runat="server" CssClass="textBox" MaxLength="29" TabIndex="238" Width="250px"></asp:TextBox>
                                                       </td>
                                                       <td align="right">
                                                      ...
                                                      <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="18%" align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlNegotiatingBankSwift" runat="server" CssClass="dropdownList" AutoPostBack="true" OnSelectedIndexChanged="ddlNegotiatingBankSwift_SelectedIndexChanged">
                                                            ...
                                                            <td width="25%" align="left">
                                                                <%--<asp:TextBox ID="txtNegoPartyIdentifier" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="10" MaxLength="1"></asp:TextBox>--%>
                                                                <asp:TextBox ID="txtNegoAccountNumber" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="250px" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="25%" align="left">
                                                                <asp:TextBox ID="txtNegoSwiftCode" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="100px" MaxLength="11"></asp:TextBox>
                                                                <asp:TextBox ID="txtNegoName" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="250px" Visible="false" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" width="15%">
                                                            ...
                                                            <td width="25%">
                                                                <asp:TextBox ID="txtNegoAddress1" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="250px" Visible="false" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="45%">
                                                                ...
                                                                <asp:TextBox ID="txtCreditAmount" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="90px" MaxLength="15"></asp:TextBox>
                                                            </td>
                                                            <td width="15%" align="right">
                                                                <asp:Label ID="lblNegoAddress2" runat="server" CssClass="elementLabel"></asp:Label>
                                                            </td>
                                                            <td width="25%">
                                                                <asp:TextBox ID="txtNegoAddress2" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="250px" Visible="false" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                           <td align="right" width="15%">
                                                            ...
                                                            <td width="25%">
                                                                <asp:TextBox ID="txtNegoAddress3" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="250px" Visible="false" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td width="45%">
                                                               <asp:TextBox ID="txt_Acceptance_Max_Credit_Amt" runat="server" CssClass="textBox"
                                                                    TabIndex="237" Width="130px" MaxLength="13"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" width="15%"></td>
														...
														<tr>
                                                            ...
                                                            <td width="85%" colspan="3">
                                                                <asp:TextBox ID="txt_740_Draftsat1" runat="server" CssClass="textBox"
                                                                    MaxLength="35" Width="300px" TabIndex="238"></asp:TextBox>
														...
														<tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlAvailablewithby_740" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlAvailablewithby_740_TextChanged" AutoPostBack="true">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtAvailablewithbyCode" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="250px" MaxLength="14"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                                <span class="elementLabel">[42A] Drawee : </span>
                                                                <asp:DropDownList ID="ddlDrawee_740" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlDrawee_740_TextChanged" AutoPostBack="true">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtDraweeAccountNumber" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="250px" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox runat="server" ID="txtAvailablewithbySwiftCode" CssClass="textBox"
                                                                    MaxLength="11" Width="100px" TabIndex="238"></asp:TextBox>
                                                                <asp:TextBox runat="server" ID="txtAvailablewithbyName" CssClass="textBox" Visible="false"
                                                                    MaxLength="35" Width="250px" TabIndex="238"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="45%">
                                                                <asp:TextBox ID="txt_Acceptance_Reimbur_Bank_Charges" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="30px" MaxLength="3"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" width="15%"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="85%" colspan="3">
                                                                <asp:TextBox ID="txt_Acceptance_Sender_to_Receiver_Information" runat="server" CssClass="textBox"
                                                                    MaxLength="35" Width="300px" TabIndex="239"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="85%" colspan="3">
                                                                ...
                                                                <asp:TextBox ID="txt_Acceptance_Sender_to_Receiver_Information5" Width="300px" runat="server" CssClass="textBox"
                                                                    MaxLength="35" TabIndex="239"></asp:TextBox>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td width="50%" align="right">
                                                                ...
                                                                <td align="left">
                                                                            <asp:TextBox runat="server" ID="txt_Discrepancy_Charges_Swift" CssClass="textBox" MaxLength="16" onkeydown="return validate_Number(event);" Width="100px" Style="text-align: right"></asp:TextBox>
                                                                        </td>
                                                                </tr>
                                                                    <tr>
                                                                        <td align="right">
                                            ...
                                            <ajaxToolkit:TabPanel ID="tbSwiftSFMS756" runat="server" HeaderText="SFMS 756"
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <tr><td align="right"><span class="elementLabel">Discrepancy Charges : </span></td>
                                                                <td align="left">
                                                                            <asp:TextBox runat="server" ID="txt_Discrepancy_Charges_SFMS" CssClass="textBox" MaxLength="16" onkeydown="return validate_Number(event);" Width="100px" Style="text-align: right"></asp:TextBox>
                                                                        </td>
                                                                </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtSenderPartyIdentifierSFMS" runat="server" CssClass="textBox" TabIndex="237"
                                                                    Width="10" MaxLength="1"></asp:TextBox>
                                        ...
                                        <tr>
                                                    <td align="right">
                                                      ...
                                                      <td align="left">
                                                             <asp:TextBox ID="txt_747_documentaryCredtno" runat="server" MaxLength="16" CssClass="textBox" Width="100px" TabIndex="1"></asp:TextBox>
                                                             <asp:Label ID="Label1" runat="server" ForeColor="Blue" Font-Size="Small"></asp:Label>
                                                      </td>
                                                    <td align="right">
                                                  ...
                                                  <tr>
                                                    <td align="right">
                                                      ...
                                                      <td align="left">
                                                              <%--vinay swift change--%>
                                                             <asp:TextBox ID="txt_747_DateofogauthriztnRmburse" Width="80px"
                                                             onkeydown="return allowBackSpace('Rmburse747',event);" runat="server" MaxLength="10" CssClass="textBox" TabIndex="2"></asp:TextBox>
                                                              <asp:Button ID="btncalendar_DateofogauthriztnRmburse747" runat="server" CssClass="btncalendar_enabled"
                                                TabIndex="-1" />
                                            <ajaxToolkit:MaskedEditExtender ID="md747date1" Mask="99/99/9999" MaskType="Date" runat="server"
                                                TargetControlID="txt_747_DateofogauthriztnRmburse" InputDirection="RightToLeft" AcceptNegative="Right"
                                                ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Right" PromptCharacter="_">
                                            </ajaxToolkit:MaskedEditExtender>
                                            <ajaxToolkit:CalendarExtender ID="calendar747Date1" runat="server" Format="dd/MM/yyyy"
                                                TargetControlID="txt_747_DateofogauthriztnRmburse" PopupButtonID="btncalendar_DateofogauthriztnRmburse747">
                                            </ajaxToolkit:CalendarExtender>
                                            <%-------------------end----------%>
                                            ...
                                            <asp:Label ID="Label3" runat="server" Font-Size="Small"></asp:Label>
                                                      ...
                                                      <td align="left">
                                                             <%-- vinay swift Changes--%>
                                                             <asp:TextBox ID="txt_747_NewDateofExpiry" onkeydown="return allowBackSpace('NewDateExp747',event);"
                                                              Width="100px" runat="server" CssClass="textBox" MaxLength="10" TabIndex="2"></asp:TextBox>
                                                              <asp:Button ID="btncalendar_NewDateofExpiry747" runat="server" CssClass="btncalendar_enabled"
                                                TabIndex="-1" />
                                            <ajaxToolkit:MaskedEditExtender ID="md747date2" Mask="99/99/9999" MaskType="Date" runat="server"
                                                TargetControlID="txt_747_NewDateofExpiry" InputDirection="RightToLeft" AcceptNegative="Right"
                                                ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Right" PromptCharacter="_">
                                            </ajaxToolkit:MaskedEditExtender>
                                            <ajaxToolkit:CalendarExtender ID="calendar747Date2" runat="server" Format="dd/MM/yyyy"
                                                TargetControlID="txt_747_NewDateofExpiry" PopupButtonID="btncalendar_NewDateofExpiry747">
                                            </ajaxToolkit:CalendarExtender>
                                            <%-------------------end----------%>
                                                      </td>
                                                 </tr>
                                                 ...
                                                 <tr>
                                                    <td align="right">
                                                      ...
                                                      <td align="left">
                                                             ...
                                                             <asp:TextBox ID="txt_747_IncreaseofDocumentaryCreditAmt" runat="server" MaxLength="15" CssClass="textBox" onkeydown="return validate_Number(event);" TabIndex="2"></asp:TextBox>
                                                      </td>
                                                      <td align="right">
                                                      ...
                                                      <td align="left">
                                                            <asp:TextBox ID="txt_747_DecreaseofDocumentaryCreditCurr" Width="50px" runat="server" CssClass="textBox" MaxLength="3" TabIndex="2"></asp:TextBox>
                                                             <asp:TextBox ID="txt_747_DecreaseofDocumentaryCreditAmt" runat="server" CssClass="textBox" onkeydown="return validate_Number(event);" MaxLength="15" TabIndex="2"></asp:TextBox>
                                                      </td>
                                                 </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                             ...
                                                             <asp:TextBox ID="txt_747_NewDocumentaryCreditAmtAfterAmendment"  runat="server" MaxLength="15" onkeydown="return validate_Number(event);" CssClass="textBox" TabIndex="2"></asp:TextBox>
                                                      </td>
                                                    <td align="right">
                                                            <span class="elementLabel">[39A] Percentage Credit Amount Tolerance :</span>
                                                    </td>
                                                    <td align="left">
                                                             <asp:TextBox ID="txt_747_PercentageCreditAmtTolerance1" runat="server" Width="50px" onkeydown="return validate_Number(event);" CssClass="textBox" MaxLength="2" TabIndex="2"></asp:TextBox>
                                                             <asp:TextBox ID="txt_747_PercentageCreditAmtTolerance2" runat="server" Width="50px" onkeydown="return validate_Number(event);" CssClass="textBox" MaxLength="2" TabIndex="2"></asp:TextBox>
                                                    </td>
                                                 </tr>
                                                                            ...
                                                                            <asp:Panel ID="panel_AddNarrative_747" runat="server">
                                                                                <table cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <span class="elementLabel">1.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_1" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <span class="elementLabel">2.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_2" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <span class="elementLabel">3.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_3" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <span class="elementLabel">4.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_4" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <span class="elementLabel">5.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_5" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <span class="elementLabel">6.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_6" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <span class="elementLabel">7.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_7" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <span class="elementLabel">8.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_8" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <span class="elementLabel">9.</span>
                                                                                            <asp:TextBox ID="txt_Narrative_747_9" Width="90%" runat="server" CssClass="textBox" MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="90%">
                                                    ...
                                                    <asp:CheckBox ID='rdb_swift_747' Text="MT / FIN 747" CssClass="elementLabel" runat="server"
                                                        onchange="return Toggel_Swift_Type('MT747');" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
