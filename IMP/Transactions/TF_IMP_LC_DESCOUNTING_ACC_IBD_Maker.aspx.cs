...
public partial class IMP_Transactions_TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker : System.Web.UI.Page
{
    ...
    string _txt_GOBR_Scheme_no, string _txt_GOBR_Debit_Code, string _txt_GOBR_Debit_Curr, string _txt_GOBR_Debit_Amt, string _txt_GOBR_Debit_Cust, string _txt_GOBR_Debit_Cust_Name, string _txt_GOBR_Debit_Cust_AcCode,
    string _txt_GOBR_Debit_Cust_AccNo, string _txt_GOBR_Debit_Cust_AcCode_Name, string _txt_GOBR_Debit_Exch_Rate, string _txt_GOBR_Debit_Exch_CCY, string _txt_GOBR_Debit_FUND, string _txt_GOBR_Debit_Check_No,
    ...
    string _txt_GOBR_Credit_Cust, string _txt_GOBR_Credit_Cust_Name, string _txt_GOBR_Credit_Cust_AcCode, string _txt_GOBR_Credit_Cust_AcCode_Name, string _txt_GOBR_Credit_Cust_AccNo, string _txt_GOBR_Credit_Exch_Rate, string _txt_GOBR_Credit_Exch_Curr,
            ...
            )
    {
        ...
        SqlParameter P_txt_GOBR_Debit_Cust_Name = new SqlParameter("@GOBR_Bill_Handling_Debit_Cust_Name", _txt_GOBR_Debit_Cust_Name.ToUpper());
        ...
        SqlParameter P_txt_GOBR_Debit_Cust_AcCode_Name = new SqlParameter("@GOBR_Bill_Handling_Debit_Cust_AccCode_Disc", _txt_GOBR_Debit_Cust_AcCode_Name.ToUpper());
        ...
        SqlParameter P_txt_GOBR_Credit_Cust_Name = new SqlParameter("@GOBR_Bill_Handling_Credit_Cust_Name", _txt_GOBR_Credit_Cust_Name.ToUpper());
        ...
        SqlParameter P_txt_GOBR_Credit_Cust_AcCode_Name = new SqlParameter("@GOBR_Bill_Handling_Credit_Cust_AccCode_Disc", _txt_GOBR_Credit_Cust_AcCode_Name.ToUpper());
        ...
        string _Result = obj.SaveDeleteData("TF_IMP_AddUpdate_LCDiscounting_IBD_ACC", P_BranchName, P_txtDocNo, P_txtIBDDocNo, P_Document_Curr,
        ...
        P_txt_GOBR_Debit_Amt, P_txt_GOBR_Debit_Cust, P_txt_GOBR_Debit_Cust_Name, P_txt_GOBR_Debit_Cust_AcCode, P_txt_GOBR_Debit_Cust_AcCode_Name,
        ...
        P_txt_GOBR_Debit_Inter_Rate, P_txt_GOBR_Credit_Code, P_txt_GOBR_Credit_Curr, P_txt_GOBR_Credit_Amt, P_txt_GOBR_Credit_Cust, P_txt_GOBR_Credit_Cust_Name,
        P_txt_GOBR_Credit_Cust_AcCode, P_txt_GOBR_Credit_Cust_AcCode_Name, P_txt_GOBR_Credit_Cust_AccNo, P_txt_GOBR_Credit_Exch_Rate, P_txt_GOBR_Credit_Exch_Curr,
    ...
    protected void Fill_Logd_Accept_Details()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //R42 file
            string R42_Related_Ref, R42_Doc_LC_No, R42_Drawer_NAME, R42_Document_No;
            if (("//YOUR REF NO:" + dt.Rows[0]["Related Reference"].ToString()).Length > 35)
                R42_Related_Ref = ("//YOUR REF NO:" + dt.Rows[0]["Related Reference"].ToString()).Substring(0, 35);
            else
                R42_Related_Ref = "//YOUR REF NO:" + dt.Rows[0]["Related Reference"].ToString();
            ...
            txt_R42_MoreInfo_7495.Text = R42_Drawer_NAME;// "//" + dt.Rows[0]["Drawer_NAME"].ToString();
            txt_R42_MoreInfo2_7495.Text =R42_Related_Ref;// "//YOUR REF NO:" + dt.Rows[0]["Related Reference"].ToString();
            txt_R42_MoreInfo3_7495.Text = R42_Doc_LC_No;// "//LC REF NO:" + dt.Rows[0]["Doc_LC_No"].ToString();
            txt_R42_MoreInfo4_7495.Text = R42_Drawer_NAME;// "//" + dt.Rows[0]["Drawer_NAME"].ToString();
            txt_R42_MoreInfo5_7495.Text = R42_Document_No;//"//OUR BILL REF NO:" + dt.Rows[0]["Document_No"].ToString();
    ...
    protected void Fill_LCDiscountingDetails()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if ((dt.Rows[0]["GOBR_Bill_Handling_Flag"].ToString() == "Y"))
            {
                ...
                cb_GOBranch_Bill_Handling_Flag_CheckedChanged(null, null);
            ...
            if ((dt.Rows[0]["GO_Bill_Handling_Flag"].ToString() == "Y"))
            {
                ...
                chk_GO1_Flag_CheckedChanged(null, null);
    ...
    protected void Intapp_CheckedChanged(object sender, EventArgs e)
    {
        ToggleapplicantBeni();
    }
    protected void Intbeni_CheckedChanged(object sender, EventArgs e)
    {
        ToggleapplicantBeni();
    }
    protected void ToggleapplicantBeni()
    {
        if (Intapp.Checked == true)
        {
            txtInterest_matu.Text = "2";
            txt_CR_AC_ShortName.Text = "RSV DEPO TO RBI";
            //TabContainerMain.Tabs[4].Visible = false;
        }
        else if (Intbeni.Checked == true)
        {
    ...
    protected void txtIBDDocNo_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            /////DraftAmt=CR_amt , IBD_DR_amt, DiscAmt
