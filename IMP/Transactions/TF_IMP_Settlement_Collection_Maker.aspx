<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_Settlement_Collection_Maker.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_Settlement_Collection_Maker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TF_IMP_Settlement_Collection_Maker.js" type="text/javascript"></script>
                ...
                <table id="tbl_Header" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel"><strong>Import Bill Settlement Collection - Maker</strong></span>
                        </td>
                    ...
                    <tr>
                        <td align="left" style="width: 100%;" valign="top" colspan="2">
                            ...
                            <input type="hidden" id="ACC_Their_Comm_Amount" runat="server" />
                            <input type="hidden" id="ACC_Their_Comm_Curr" runat="server" />
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_Collection_Settlement_for_Cust" runat="server" CssClass="textBox"
                                                        MaxLength="2" TabIndex="7" Width="30px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_Collection_Settlement_For_Bank" runat="server" CssClass="textBox"
                                                        MaxLength="2" Width="30px" TabIndex="8"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_Collection_Attn" runat="server" CssClass="textBox" TabIndex="9"
                                                        MaxLength="70" Width="300px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd/MM/yyyy"
                                                        TargetControlID="txt_UnderLC_Maturity" PopupButtonID="btncal_Maturity_Date" Enabled="True">
                                                    </ajaxToolkit:CalendarExtender>
                                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlExtender="MaskedEditExtender8"
                                                        ValidationGroup="dtVal" ControlToValidate="txt_UnderLC_Maturity" EmptyValueMessage="Enter Date Value"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="10%">
                                                    <asp:TextBox ID="txt_UnderLC_Interest_From" runat="server" CssClass="textBox" MaxLength="10"
                                                        AutoPostBack="true" TabIndex="9" ValidationGroup="dtVal" Width="70px" OnTextChanged="Get_Acceptance_Get_Date_Diff"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_UnderLC_Interest_To" runat="server" CssClass="textBox" MaxLength="10"
                                                        AutoPostBack="true" TabIndex="11" ValidationGroup="dtVal" Width="70px" OnTextChanged="Get_Acceptance_Get_Date_Diff"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txt_UnderLC_Rate" runat="server" CssClass="textBox" MaxLength="16"
                                                        TabIndex="13" Width="100px" Style="text-align: right" onkeyDown="return validate_Number(event);"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:TextBox ID="txt_UnderLC_Attn" runat="server" CssClass="textBox" TabIndex="18"
                                                        MaxLength="70" Width="190px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_IMPACC1Flag" Text="IMPORT ACCOUNTING I" runat="server" CssClass="elementLabel"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                <asp:TextBox ID="txt_IMPACC1_CR_Acceptance_Curr" runat="server" CssClass="textBox"
                                                                                    MaxLength="3" TabIndex="47" Width="40px"></asp:TextBox>
                                                                            </td>
                                                                            <td align="left">
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelACC2" runat="server" HeaderText="IMPORT ACCOUNTING II"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_IMPACC2Flag" Text="IMPORT ACCOUNTING II" runat="server" CssClass="elementLabel"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <span class="elementLabel"><b>/DR/</b> CODE:</span> &nbsp;<asp:Button ID="btn_IMPACC2_DR_Code_help"
                                                                                    runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC2','Debit');" />
                                                                            </td>
                                                                            <td align="left" colspan="3">
                                                                            </td>
                                                                            <td align="center">
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">
                                                                                <asp:TextBox ID="txt_IMPACC2_DR_Code" runat="server" CssClass="textBox" MaxLength="5"
                                                                                    TabIndex="65" Width="90px"></asp:TextBox>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_IMPACC2_DR_AC_Short_Name" runat="server" CssClass="textBox"
                                                                                    MaxLength="20" TabIndex="65" Width="150px"></asp:TextBox>
                                                                            </td>
                                                                            <td align="left">
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelACC3" runat="server" HeaderText="IMPORT ACCOUNTING III"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_IMPACC3Flag" Text="IMPORT ACCOUNTING III" runat="server" CssClass="elementLabel"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <span class="elementLabel"><b>/DR/</b> CODE:</span> &nbsp;<asp:Button ID="btn_IMPACC3_DR_Code_help"
                                                                                    runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC3','Debit');" />
                                                                            </td>
                                                                            <td align="left" colspan="3">
                                                                            </td>
                                                                            <td align="center">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_IMPACC3_DR_Cur_Acc_payer2" runat="server" CssClass="textBox"
                                                                                    MaxLength="1" TabIndex="71" Width="50px"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelACC4" runat="server" HeaderText="IMPORT ACCOUNTING IV"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_IMPACC4Flag" Text="IMPORT ACCOUNTING IV" runat="server" CssClass="elementLabel"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <span class="elementLabel"><b>/DR/</b> CODE:</span> &nbsp;<asp:Button ID="btn_IMPACC4_DR_Code_help"
                                                                                    runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC4','Debit');" />
                                                                            </td>
                                                                            <td align="left" colspan="3">
                                                                            </td>
                                                                            <td align="center">
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelACC5" runat="server" HeaderText="IMPORT ACCOUNTING V"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_IMPACC5Flag" Text="IMPORT ACCOUNTING V" runat="server" CssClass="elementLabel"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <span class="elementLabel"><b>/DR/</b> CODE:</span> &nbsp;<asp:Button ID="btn_IMPACC5_DR_Code_help"
                                                                                    runat="server" ToolTip="Press for AcCode list." CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','IMPACC5','Debit');" />
                                                                            </td>
                                                                            <td align="left" colspan="3">
                                                                            </td>
                                                                            <td align="center">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Curr" runat="server" CssClass="textBox" TabIndex="84"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO1','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    ...
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO1','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    ...
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO1','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Left_Debit_Exch_CCY" runat="server" CssClass="textBox" MaxLength="3"
                                                                                    TabIndex="87" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO1','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                    ...
                                                                    <asp:Panel ID="Panel_GO1Right" runat="server" Visible="false">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Curr" runat="server" CssClass="textBox" TabIndex="104"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO1','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    ...
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO1','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    ...
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO1','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO1_Right_Debit_Exch_CCY" runat="server" CssClass="textBox"
                                                                                    MaxLength="3" TabIndex="106" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO1','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:Button ID="Button1" runat="server" ToolTip="Press for Sundry list." CssClass="btnHelp_enabled"
                                                                                    OnClientClick="return OpenCR_Code_help('mouseClick','GO1Right2','Credit');" />
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO2_Left_Debit_Curr" runat="server" CssClass="textBox" TabIndex="84"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO2','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO2_Left_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="84" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO2','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO2_Left_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="87" Width="100px" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO2','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO2_Left_Debit_Exch_CCY" runat="server" CssClass="textBox" MaxLength="3"
                                                                                    TabIndex="87" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO2','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                    ...
                                                                    <asp:Panel ID="Panel_GO2Right" runat="server" Visible="false">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO2_Right_Debit_Curr" runat="server" CssClass="textBox" TabIndex="104"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO2','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO2_Right_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="104" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO2','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO2_Right_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="106" Width="100px" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO2','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO2_Right_Debit_Exch_CCY" runat="server" CssClass="textBox"
                                                                                    MaxLength="3" TabIndex="106" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO2','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:Button ID="Button2" runat="server" ToolTip="Press for Sundry list." CssClass="btnHelp_enabled"
                                                                                    OnClientClick="return OpenCR_Code_help('mouseClick','GO2Right2','Credit');" />
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                            ...
                                            <ajaxToolkit:TabPanel ID="TabPanelGO3" runat="server" HeaderText="GENERAL OPERATION III"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_GO3Flag" Text="GENERAL OPERATION III" runat="server" CssClass="elementLabel"
                                                                    OnCheckedChanged="chk_GO3Flag_OnCheckedChanged" AutoPostBack="true" />
                                                            </td>
                                                            <td align="center" width="50%">
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table width="100%">
                                                                    <asp:Panel ID="Panel_GO3Left" runat="server" Visible="false">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="24%">
                                                                                <asp:DropDownList ID="txt_GO3_Left_Debit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="84" onchange="return TogggleDebitCreditCode('3','1');">
                                                                                    <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                                                    <asp:ListItem Value="D" Text="D"></asp:ListItem>
                                                                                    <asp:ListItem Value="C" Text="C"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                &nbsp;
                                                                                <asp:Button ID="btn_GO3_Left_Debit_AccCode_help" runat="server" ToolTip="Press for GL Code list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenGO_help('mouseClick','GO3','Debit1');" />
                                                                                <asp:Button ID="btn_GO3_CR_Code_Left1_help" runat="server" ToolTip="Press for Sundry list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','GO3Left1','Credit');" />
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO3_Left_Debit_Curr" runat="server" CssClass="textBox" TabIndex="84"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO3','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO3_Left_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="84" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO3','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO3_Left_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="87" Width="100px" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO3','Left');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO3_Left_Debit_Exch_CCY" runat="server" CssClass="textBox" MaxLength="3"
                                                                                    TabIndex="87" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO3','Left');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:DropDownList ID="txt_GO3_Left_Credit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="91" onchange="return TogggleDebitCreditCode('3','2');">
                                                                                    <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                                                    <asp:ListItem Value="D" Text="D"></asp:ListItem>
                                                                                    <asp:ListItem Value="C" Text="C"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                &nbsp;
                                                                                <asp:Button ID="btn_GO3_Left_Credit_AccCode_help" runat="server" ToolTip="Press for GL Code list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenGO_help('mouseClick','GO3','Debit2');" />
                                                                                <asp:Button ID="btn_GO3_CR_Code_Left2_help" runat="server" ToolTip="Press for Sundry list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','GO3Left2','Credit');" />
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                                                ...
                                                                <table width="100%">
                                                                    <asp:Panel ID="Panel_GO3Right" runat="server" Visible="false">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" width="24%">
                                                                                <asp:DropDownList ID="txt_GO3_Right_Debit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="104" onchange="return TogggleDebitCreditCode('3','3');">
                                                                                    <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                                                    <asp:ListItem Value="D" Text="D"></asp:ListItem>
                                                                                    <asp:ListItem Value="C" Text="C"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                &nbsp;
                                                                                <asp:Button ID="btn_GO3_Right_Debit_AccCode_Help" runat="server" ToolTip="Press for GL Code list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenGO_help('mouseClick','GO3','Debit3');" />
                                                                                <asp:Button ID="btn_GO3_CR_Code_Right1_help" runat="server" ToolTip="Press for Sundry list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenCR_Code_help('mouseClick','GO3Right1','Credit');" />
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                                                            <td align="left" width="34%">
                                                                                <asp:TextBox ID="txt_GO3_Right_Debit_Curr" runat="server" CssClass="textBox" TabIndex="104"
                                                                                    Width="25px" MaxLength="3" onchange="return GO_Debit_Curr_Change('GO3','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right" width="6%">
                                                                                <span class="elementLabel">AMOUNT:</span>
                                                                            </td>
                                                                            <td align="left" width="20%">
                                                                                <asp:TextBox ID="txt_GO3_Right_Debit_Amt" runat="server" CssClass="textBox" Width="90px"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="104" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Amt_Calculation('GO3','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO3_Right_Debit_Exch_Rate" runat="server" CssClass="textBox"
                                                                                    onkeydown="return validate_Number(event);" TabIndex="106" Width="100px" Style="text-align: right"
                                                                                    MaxLength="16" onchange="return GO_Debit_Exch_Rate_Change('GO3','Right');"></asp:TextBox>
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">EXCH CCY:</span>
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txt_GO3_Right_Debit_Exch_CCY" runat="server" CssClass="textBox"
                                                                                    MaxLength="3" TabIndex="106" Width="25px" onchange="return GO_Debit_Exch_CCY_Change('GO3','Right');"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:DropDownList ID="txt_GO3_Right_Credit_Code" runat="server" Width="70px" CssClass="dropdownList"
                                                                                    TabIndex="110" onchange="return TogggleDebitCreditCode('3','4');">
                                                                                    <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                                                    <asp:ListItem Value="D" Text="D"></asp:ListItem>
                                                                                    <asp:ListItem Value="C" Text="C"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                                &nbsp;
                                                                                <asp:Button ID="btn_GO3_Right_Credit_Code_Help" runat="server" ToolTip="Press for GL Code list."
                                                                                    CssClass="btnHelp_enabled" OnClientClick="return OpenGO_help('mouseClick','GO3','Debit4');" />
                                                                                <asp:Button ID="Button3" runat="server" ToolTip="Press for Sundry list." CssClass="btnHelp_enabled"
                                                                                    OnClientClick="return OpenCR_Code_help('mouseClick','GO3Right2','Credit');" />
                                                                            </td>
                                                                            <td align="right">
                                                                                <span class="elementLabel">CCY:</span>
                                                                            </td>
                                            ...
                                            <ajaxToolkit:TabPanel ID="tbDocumentGOAccChange" runat="server" HeaderText="INTER-OFFICE"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="center" width="50%">
                                                                <asp:CheckBox ID="chk_GOAcccChangeFlag" Text="GENERAL OPERATION FOR INTER-OFFICE"
                                                                    ...
                                                                    <asp:Panel ID="panal_GOAccChange" runat="server" Visible="false">
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="3" align="left">
                                                                                <asp:TextBox ID="txt_GOAccChange_Comment" runat="server" CssClass="textBox" TabIndex="223"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                            ...
                                            <ajaxToolkit:TabPanel ID="tbSwift103" runat="server" HeaderText="MT 103" Font-Bold="true"
                                                ...
                                                <ContentTemplate>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="right">
                                                                <span class="mandatoryField">*</span><span class="elementLabel">Receiver:</span>
                                                            </td>
                                                            <td align="left" colspan="3">
                                                                <asp:TextBox ID="txt_MT103Receiver" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="100px" MaxLength="16"></asp:TextBox>
                                                                <asp:Button ID="btn_MT103Receiver" runat="server" ToolTip="Press for FC Nostro Bank list."
                                                                    CssClass="btnHelp_enabled" OnClientClick="return Open_NostroBank_help_MT103('mouseClick');" />
                                                                <asp:Label ID="lbl_MT103Receiver" runat="server" CssClass="mandatoryField"></asp:Label>
                                                            </td>
                                                            <td>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtTimeIndication" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="100px" MaxLength="18"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                                <span class="mandatoryField">*</span><span class="elementLabel">[23B] Bank Operation Code:</span>
                                                            </td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlBankOperationCode" runat="server" CssClass="dropdownList">
                                                                    <asp:ListItem Text="Select" Value=""   Enabled="false"></asp:ListItem>
                                                                    <asp:ListItem Text="CRED" Value="CRED" ></asp:ListItem>
                                                                    <asp:ListItem Text="CRTS" Value="CRTS" Enabled="false"></asp:ListItem>
                                                                    <asp:ListItem Text="SPAY" Value="SPAY" Enabled="false"></asp:ListItem>
                                                                    <asp:ListItem Text="SPRI" Value="SPRI" Enabled="false"></asp:ListItem>
                                                                    <asp:ListItem Text="SSTD" Value="SSTD" Enabled="false"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="3">
                                                                <span class="elementLabel">Value Date : </span>
                                                                <%--Swift change on 09072022--%>
                                                                <asp:TextBox ID="txt103Date" runat="server" CssClass="textBox" TabIndex="238" Width="70px"
                                                                    MaxLength="10" onkeydown="return allowBackSpace('103Date',event);"></asp:TextBox>
                                                                <asp:Button ID="btn_calander_103" runat="server" CssClass="btncalendar_enabled" TabIndex="-1" />
                                                                <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender2" Mask="99/99/9999" MaskType="Date"
                                                                    runat="server" TargetControlID="txt103Date" InputDirection="RightToLeft" AcceptNegative="Left"
                                                                    ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Left" PromptCharacter="_">
                                                                </ajaxToolkit:MaskedEditExtender>
                                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender103" runat="server" Format="dd/MM/yyyy"
                                                                    TargetControlID="txt103Date" PopupButtonID="btn_calander_103">
                                                                </ajaxToolkit:CalendarExtender>
                                                                <%-------------------------end---------------------------------%>
                                                                ...
                                                                <asp:TextBox ID="txt103Amount" runat="server" CssClass="textBox" TabIndex="238" Width="150px"
                                                                    MaxLength="15" Enabled="false" onkeydown="return validate_Number(event);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCurrency" runat="server" CssClass="textBox" TabIndex="238" Width="30px"
                                                                    OnTextChanged="txtCurrency_TextChanged" MaxLength="3" AutoPostBack="true"></asp:TextBox>
                                                                <asp:TextBox ID="txtInstructedAmount" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="150px" MaxLength="15" onkeydown="return validate_Number(event);"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtExchangeRate" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="120px" MaxLength="12" onkeydown="return validate_Number(event);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                                <span class="mandatoryField">*</span><span class="elementLabel">[50A] Ordering Customer : </span>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtOrderingCustomer_Acc" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="300px" MaxLength="34"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox runat="server" ID="txtOrderingCustomer_SwiftCode" CssClass="textBox"
                                                                    TabIndex="238" MaxLength="11" Width="100px"></asp:TextBox>
                                                                <asp:TextBox runat="server" ID="txtOrderingCustomer_Name" CssClass="textBox" Visible="false"
                                                                    TabIndex="238" MaxLength="35" Width="250px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="3">
                                                                <asp:TextBox ID="txtSendingInstitutionAccountNumber" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="300px" MaxLength="35"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtOrderingInstitutionName" CssClass="textBox" Visible="false"
                                                                    MaxLength="35" Width="250px"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlIntermediary103" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlIntermediary103_TextChanged" AutoPostBack="true">
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlAccountWithInstitution103" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlAccountWithInstitution103_TextChanged" AutoPostBack="true">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <span class="mandatoryField">*</span><span class="elementLabel">[59A] Beneficiary Customer A/C : </span>
                                                                <asp:DropDownList ID="ddlBeneficiaryCustomer" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlBeneficiaryCustomer_TextChanged" AutoPostBack="true">
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtBeneficiaryCustomerAccountNumber" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="200px" MaxLength="35"></asp:TextBox>
                                                            </td>
                                                            <td align="right">
                                                                <span class="mandatoryField">*</span><span class="elementLabel">[71A] Details Of Charges : </span>
                                                                <span class="mandatoryField">Details of Charges must be one of BEN, OUR or SHA.</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtDetailsOfCharges" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="30px" MaxLength="3"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                             ...
                                                             <td>
                                                            <asp:Label ID="Label1" runat="server" CssClass="mandatoryField"
                                                                    Visible="false" Text="Note:In 59F,Name must start with number 1/.Example below."></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                            <asp:Label ID="Label2" runat="server" CssClass="mandatoryField"
                                                                    Visible="false" Text="1/MARK PHILIPS"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                            <asp:Label ID="Label3" runat="server" CssClass="mandatoryField"
                                                                    Visible="false" Text="2/HOOGSTRAAT 6, APT 6C"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                            <asp:Label ID="Label4" runat="server" CssClass="mandatoryField"
                                                                    Visible="false" Text="3/BE/BRUSSELS"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtSenderCharges" runat="server" CssClass="textBox" TabIndex="238" AutoPostBack="true"
                                                                    Width="30px" OnTextChanged="txtSenderCharges_TextChanged" MaxLength="3"></asp:TextBox>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtReceiverCharges" runat="server" CssClass="textBox" TabIndex="238" AutoPostBack="true"
                                                                    Width="30px" OnTextChanged="txtReceiverCharges_TextChanged" MaxLength="3"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="3">
                                                                <asp:TextBox ID="txt202Amount" runat="server" CssClass="textBox" TabIndex="238" Width="150px"
                                                                    MaxLength="15" onkeydown="return validate_Number(event);"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlOrderingInstitution202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlOrderingInstitution202_TextChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="52A" Value="A"></asp:ListItem>
                                                                    <asp:ListItem Text="52D" Value="D"></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <span class="elementLabel">A / C :</span>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlSendersCorrespondent202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlSendersCorrespondent202_TextChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="53A" Value="A"></asp:ListItem>
                                                                    <asp:ListItem Text="53B" Value="B"></asp:ListItem>
                                                                    <asp:ListItem Text="53D" Value="D"></asp:ListItem>
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlReceiversCorrespondent202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlReceiversCorrespondent202_TextChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="54A" Value="A"></asp:ListItem>
                                                                    <asp:ListItem Text="54B" Value="B"></asp:ListItem>
                                                                    <asp:ListItem Text="54D" Value="D"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlIntermediary202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlIntermediary202_TextChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="56A" Value="A"></asp:ListItem>
                                                                    <asp:ListItem Text="56D" Value="D"></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <span class="elementLabel">A / C :</span>
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlAccountWithInstitution202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlAccountWithInstitution202_TextChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="57A" Value="A"></asp:ListItem>
                                                                    <asp:ListItem Text="57B" Value="B"></asp:ListItem>
                                                                    <asp:ListItem Text="57D" Value="D"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:DropDownList ID="ddlBeneficiaryInstitution202" runat="server" CssClass="dropdownList"
                                                                    OnSelectedIndexChanged="ddlBeneficiaryInstitution202_TextChanged" AutoPostBack="true">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="3">
                                                                <asp:TextBox ID="txt200BicCode" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="100px" MaxLength="16"></asp:TextBox>
                                                                <asp:Button ID="btn200BicCode" runat="server" ToolTip="Press for FC Nostro Bank list."
                                                                    CssClass="btnHelp_enabled" OnClientClick="return Open_NostroBank_help_MT200('mouseClick');" />
                                                                <asp:Label ID="lbl200BicCode" runat="server" CssClass="mandatoryField"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="3">
                                                                ...
                                                                <asp:TextBox ID="txt200Date" runat="server" CssClass="textBox" TabIndex="238" Width="70px"
                                                                    MaxLength="10" onkeydown="return allowBackSpace('200Date',event);"></asp:TextBox>
                                                                <asp:Button ID="btn_calander_200" runat="server" CssClass="btncalendar_enabled" TabIndex="-1" />
                                                                <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" Mask="99/99/9999" MaskType="Date"
                                                                    runat="server" TargetControlID="txt200Date" InputDirection="RightToLeft" AcceptNegative="Left"
                                                                    ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Left" PromptCharacter="_">
                                                                </ajaxToolkit:MaskedEditExtender>
                                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender200" runat="server" Format="dd/MM/yyyy"
                                                                    TargetControlID="txt200Date" PopupButtonID="btn_calander_200">
                                                                </ajaxToolkit:CalendarExtender>
                                                                <%-------------------------end---------------------------------%>
                                                                <span class="elementLabel">Currency Code : </span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtTransactionRefNoR42" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="110px" MaxLength="14"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtRelatedReferenceR42" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="125px" MaxLength="16"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                                <span class="elementLabel">Date</span><asp:TextBox ID="txtValueDateR42" runat="server"
                                                                    CssClass="textBox" TabIndex="238" Width="80px" MaxLength="10"></asp:TextBox>
                                                                <span class="elementLabel">Currency</span><asp:TextBox ID="txtCureencyR42" runat="server"
                                                                    CssClass="textBox" TabIndex="238" Width="25px" MaxLength="3"></asp:TextBox>
                                                                <span class="elementLabel">Amount</span><asp:TextBox ID="txtAmountR42" runat="server"
                                                                    CssClass="textBox" TabIndex="238" Width="110px" MaxLength="16"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtOrderingInstitutionIFSCR42" runat="server" CssClass="textBox"
                                                                    TabIndex="238" Width="90px" MaxLength="11"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtCodeWordR42" runat="server" CssClass="textBox" TabIndex="238"
                                                                    Width="25px" MaxLength="3" Text="TRF"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                ...
                                                                <asp:TextBox ID="txtPrinAmtPaidAccNegoDate_754" runat="server" CssClass="textBox"
                                                                    Width="60px" MaxLength="10" TabIndex="2" onkeydown="return allowBackSpace('Nego754Date',event);"></asp:TextBox>
                                                                <asp:Button ID="btncalendar_PrinAmtPaidAccNegoDate_754" runat="server" CssClass="btncalendar_enabled"
                                                                    TabIndex="-1" />
                                                                <ajaxToolkit:MaskedEditExtender ID="md754date" Mask="99/99/9999" MaskType="Date"
                                                                    runat="server" TargetControlID="txtPrinAmtPaidAccNegoDate_754" InputDirection="RightToLeft"
                                                                    AcceptNegative="Left" ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Left"
                                                                    PromptCharacter="_">
                                                                </ajaxToolkit:MaskedEditExtender>
                                                                <ajaxToolkit:CalendarExtender ID="calendartxtPrinAmtPaidAccNegoDate_754" runat="server"
                                                                    Format="dd/MM/yyyy" TargetControlID="txtPrinAmtPaidAccNegoDate_754" PopupButtonID="btncalendar_PrinAmtPaidAccNegoDate_754">
                                                                </ajaxToolkit:CalendarExtender>
                                                                <span class="elementLabel">CCY:</span>
                                                                <asp:TextBox ID="txtPrinAmtPaidAccNegoCurr_754" runat="server" CssClass="textBox"
                                                                    MaxLength="3" Width="35px" TabIndex="2"></asp:TextBox>
                                                                <span class="elementLabel">Amt:</span>
                                                                <asp:TextBox ID="txtPrinAmtPaidAccNegoAmt_754" runat="server" CssClass="textBox"
                                                                    onkeydown="return validate_Number(event);" Style="text-align: right" MaxLength="16"
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="elementLabel">Amt:</span>
                                                                <asp:TextBox ID="txt_754_AddAmtClamd_Amt" runat="server" CssClass="textBox" onkeydown="return validate_Number(event);"
                                                                    Style="text-align: right" MaxLength="15" Width="100px" TabIndex="2"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txt_754_ChargesAdded1" runat="server" CssClass="textBox" Width="330px"
                                                                    MaxLength="35" TabIndex="4"></asp:TextBox>
                                                            </td>
                                                            <tr>
                                                                <td align="right">
                                                                    <span></span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    <asp:TextBox ID="txt_754_TotalAmtClmd_Date" runat="server" CssClass="textBox" Width="60px"
                                                                        MaxLength="10" TabIndex="5" onkeydown="return allowBackSpace('Total754Date',event);"></asp:TextBox>
                                                                    <asp:Button ID="btncalendar_754_TotalAmtClmd_Date" runat="server" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                    <ajaxToolkit:MaskedEditExtender ID="md754TotalAmtdate" Mask="99/99/9999" MaskType="Date"
                                                                        runat="server" TargetControlID="txt_754_TotalAmtClmd_Date" InputDirection="RightToLeft"
                                                                        AcceptNegative="Left" ErrorTooltipEnabled="true" CultureName="en-GB" DisplayMoney="Left"
                                                                        PromptCharacter="_">
                                                                    </ajaxToolkit:MaskedEditExtender>
                                                                    <ajaxToolkit:CalendarExtender ID="Calendar754_TotalAmtClmd_Date" runat="server" Format="dd/MM/yyyy"
                                                                        TargetControlID="txt_754_TotalAmtClmd_Date" PopupButtonID="btncalendar_754_TotalAmtClmd_Date">
                                                                    </ajaxToolkit:CalendarExtender>
                                                                    <span class="elementLabel">CCY:</span>
                                                                    <asp:TextBox ID="txt_754_TotalAmtClmd_Ccy" runat="server" CssClass="textBox" MaxLength="3"
                                                                        Width="35px" TabIndex="5"></asp:TextBox>
                                                                    <span class="elementLabel">Amt:</span>
                                                                    <asp:TextBox ID="txt_754_TotalAmtClmd_Amt" runat="server" CssClass="textBox" onkeydown="return validate_Number(event);"
                                                                        Style="text-align: right" MaxLength="16" Width="100px" TabIndex="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    <asp:TextBox ID="txtReimbursingBankpartyidentifier_754" runat="server" CssClass="textBox"
                                                                        TabIndex="6" Width="330px" MaxLength="34"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                ...
                                                                <td align="left">
                                                                    ...
                                                                    <asp:TextBox runat="server" ID="txtReimbursingBankLocation_754" CssClass="textBox"
                                                                        Visible="false" MaxLength="35" TabIndex="6" Width="330px"></asp:TextBox>
                                                                    <asp:TextBox runat="server" ID="txtReimbursingBankName_754" CssClass="textBox" Visible="false"
                                                                        MaxLength="35" TabIndex="6" Width="330px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <asp:TextBox ID="txt_Narrative_754_2" Width="90%" runat="server" CssClass="textBox"
                                                                                    MaxLength="35" TabIndex="46"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td width="90%">
                                                    ...
                                                    <asp:CheckBox ID='rdb_swift_103' Text="MT 103" CssClass="elementLabel" runat="server"
                                                        onchange="return Toggel_Swift_Type('MT103');" />
                                                    <asp:CheckBox ID='rdb_swift_202' Text="MT 202" CssClass="elementLabel" runat="server"
                                                        onchange="return Toggel_Swift_Type('MT202');" />
                                                    ...
                                                    <asp:CheckBox ID='rdb_swift_754' Text="MT 754" CssClass="elementLabel" runat="server"
                                                        onchange="return Toggel_Swift_Type('MT754');" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                    ...
                    <tr>
                        <td align="center" colspan="5">
                            <asp:Button ID="btnSubmit" runat="server" Text="Submit to Checker" CssClass="buttonDefault"
                                Width="150px" ToolTip="Submit to Checker" Enabled="false" TabIndex="256" OnClick="btnSubmit_Click"
