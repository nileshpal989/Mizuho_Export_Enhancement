<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BOE_Maker_View.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_BOE_Maker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Import Bill Lodgment View - Maker</strong></span>
                            </td>
                            <td align="right">
                        ...
                        <tr style="height: 35px">
                            ...
                            <td align="left">
                                ...
                                <asp:TextBox ID="txtYear" runat="server" CssClass="textBox" Width="17px" OnTextChanged="txtYear_TextChanged"
                                    AutoPostBack="true" TabIndex="4" MaxLength="2" Enabled="false"></asp:TextBox>
                                <asp:TextBox ID="txtDocumentNo" runat="server" CssClass="textBox" Width="40px" TabIndex="5" Enabled="false"
                                    MaxLength="4"></asp:TextBox>
                            </td>
                            <td align="left">
                                <asp:Panel ID="Panal_Scrutiny" runat="server" Width="240px">
                                    &nbsp;&nbsp;<span class="elementLabel">Documents Scrutiny :</span>
                                    <asp:DropDownList ID="ddl_Doc_Scrutiny" runat="server" CssClass="dropdownList" TabIndex="35">
                            ...
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewImpEntryList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Lodgment Date" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-Width="7%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Swift Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="7%" ItemStyle-Width="7%">
                                            <ItemTemplate>
