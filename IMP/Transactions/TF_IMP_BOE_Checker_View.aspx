<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_BOE_Checker_View.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_BOE_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2" >
                                <span class="pageLabel"><strong>Import Bill Lodgment View - Checker</strong></span>
                            </td>
                        ...
                        <tr align="right">
                            ...
                            <td width="45%" align="left">
                                ...
                                <asp:TextBox ID="txtLodgementDate" runat="server" CssClass="textBox" MaxLength="10"
                                    ValidationGroup="dtVal" Width="70px" TabIndex="15" AutoPostBack="true" OnTextChanged="txtLodgementDate_TextChanged"></asp:TextBox>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewImpEntryList" runat="server" AutoGenerateColumns="False"
                                    Width="90%" AllowPaging="True" OnRowCommand="GridViewImpEntryList_RowCommand"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillAmt" runat="server" Text='<%# Eval("Bill_Amount") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="SFMS Status" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-Width="7%">
                                            <ItemTemplate>
