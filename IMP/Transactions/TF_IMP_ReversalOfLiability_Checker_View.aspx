<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_ReversalOfLiability_Checker_View.aspx.cs" Inherits="IMP_Transactions_TF_IMP_ReversalOfLiability_Checker_View" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2" >
                                <span class="pageLabel"><strong>Reversal Of Liability View - Checker</strong></span>
                            </td>
                         ...
                         <td width="15%" align="left">
                             ...
                             <td width="45%" align="left">
                               <span class="elementLabel">Value Date :</span>
                                <asp:TextBox ID="txtbrodate" runat="server" CssClass="textBox" MaxLength="10"
                                    ValidationGroup="dtVal" Width="80px" TabIndex="15" AutoPostBack="true" OnTextChanged="txtbrodate_TextChanged"></asp:TextBox>
                                <ajaxToolkit:MaskedEditExtender ID="ME_brodate" Mask="99/99/9999" MaskType="Date"
                                    runat="server" TargetControlID="txtbrodate" ErrorTooltipEnabled="True"
                                ...
                                <asp:Button ID="btnCal_brodate" runat="server" CssClass="btncalendar_enabled" />
                                <ajaxToolkit:CalendarExtender ID="CE_LodgementDate" runat="server" Format="dd/MM/yyyy"
                                    TargetControlID="txtbrodate" PopupButtonID="btnCal_brodate" Enabled="True">
                                </ajaxToolkit:CalendarExtender>
                                <ajaxToolkit:MaskedEditValidator ID="MV_BRO_Date" runat="server" ControlExtender="ME_brodate"
                                    ValidationGroup="dtVal" ControlToValidate="txtbrodate" EmptyValueMessage="Enter Date Value"
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewBRO_checker" runat="server" AutoGenerateColumns="false" Width="80%"
                                    GridLines="Both" AllowPaging="true" OnRowCommand="GridViewBRO_checker_RowCommand"
                                    OnRowDataBound="GridViewBRO_checker_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Value Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="7%" ItemStyle-Width="7%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblValue" runat="server" Text='<%# Eval("ValueDate") %>'  CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Cust A/C" HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                            HeaderStyle-Width="12%" ItemStyle-Width="12%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustAC" runat="server" Text='<%#Eval("CustAcNo")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
