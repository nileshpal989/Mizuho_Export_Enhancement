<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMP_LC_DESCOUNTING_ACC_IBD_Maker_View.aspx.cs"
    Inherits="IMP_Transactions_TF_IMP_LC_DESCOUNTING_ACC_IBD" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Own LC Bill Discounting View (IBD,ACC)-Maker</strong></span>
                            </td>
                            <td align="right">
                                ...
                                <asp:GridView ID="GridViewLCdescounting" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="IBD Ref. No" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblIBDDocNo" runat="server" Text='<%# Eval("IBDDocument_No") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Document Scrutiny" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocScrutiny" runat="server" Text='<%# Eval("Document_Scrutiny") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
