...
public partial class IMP_TF_ImpAuto_AddEdit_NonLC : System.Web.UI.Page
{
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (_docType == "FLC" || _docType == "ILC")
                        {
                            ...
                            rdbSight.Visible = false;
                            rdbUsance.Visible = false;
    ...
    //{
    //    TF_DATA objdata = new TF_DATA();
    //    SqlParameter p1 = new SqlParameter("@currid",SqlDbType.VarChar);
    //    p1.Value = txtcurr.Text;
    ...
    //    if (dt.Rows.Count > 0)
    //    {
    //        txtcurr.Text = dt.Rows[0]["C_CODE"].ToString();
    //        lblcurr.Text = dt.Rows[0]["C_DESCRIPTION"].ToString();
    //    }
    //}
