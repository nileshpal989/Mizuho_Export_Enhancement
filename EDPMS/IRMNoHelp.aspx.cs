...
public partial class EDPMS_IRMNoHelp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        p1.Value = search;
        SqlParameter p2 = new SqlParameter("@year",Request.QueryString["year"].ToString());

        txtSearch.Text = search;
        string _query = "GetIrmNoHelp";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                pageurl = "window.opener.saveTTRefDetails('" + lblirmno.Text + "');window.opener.EndRequest();window.close();";
