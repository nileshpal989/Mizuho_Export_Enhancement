<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_Doc_No.aspx.cs" Inherits="EDPMS_Help_Doc_No" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No." HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("ADBillNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillAmount" runat="server" Text='<%# Eval("BillAmt") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
