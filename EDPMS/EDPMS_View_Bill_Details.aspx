<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_View_Bill_Details.aspx.cs"
    Inherits="EDPMS_EDPMS_View_Bill_Details" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Updation of EDPMS Bill Details View</span>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <asp:GridView ID="GridViewEDPMSbillEntry" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocumentNo" runat="server" Text='<%# Eval("ADBillNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillAmount" runat="server" Text='<%# Eval("BillAmt","{0:0.00}") %>'
