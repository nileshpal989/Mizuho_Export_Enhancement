<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_Generate_XMLFile_Receipt_Document.aspx.cs"
    Inherits="EDPMS_EDPMS_Generate_XMLFile_Receipt_Document" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" Style="font-weight: bold" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
