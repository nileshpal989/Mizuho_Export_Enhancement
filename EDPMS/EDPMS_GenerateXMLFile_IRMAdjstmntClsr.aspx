<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_GenerateXMLFile_IRMAdjstmntClsr.aspx.cs"
    Inherits="EDPMS_EDPMS_GenerateXMLFile_IRMAdjstmntClsr" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>EDPMS XML File Generation-IRM Adjustment Closure</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
