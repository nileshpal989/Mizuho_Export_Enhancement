<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IRMNoHelp.aspx.cs" Inherits="EDPMS_IRMNoHelp" %>
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="IRM No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblirmno" runat="server" Text='<%# Eval("Document_No") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="IRM Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
