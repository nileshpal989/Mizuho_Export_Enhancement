<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_EDPMSAckwAndRealized_CSV.aspx.cs" Inherits="EXP_EXP_EDPMSAckwAndRealized_CSV" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validate_save() {
            var txtFrmDate = document.getElementById('txtFromDate');
                    ...
                    <table cellspacing="2"  cellpadding="2" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>Acknowledgment And Realized File Creation</strong></span>
                            </td>
                        </tr>
                        <tr>
