<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_OUTSTANDING_BILLS_FILE_UPLOAD.aspx.cs" Inherits="EDPMS_EDPMS_OUTSTANDING_BILLS_FILE_UPLOAD" %>
        ...
        <table width="100%">
            <tr>
                <td align="left" colspan="2">
                    <span class="pageLabel">DATA UPLOAD OF O/S BILLS</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="ddlRefNo" runat="server" CssClass="textBox" Width="100px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
