<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_GenerateXMLFile_INWRemittance.aspx.cs"
    Inherits="EDPMS_EDPMS_GenerateXMLFile_INWRemittance" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>EDPMS XML File Generation-Inward Remittance</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 10%; padding-top: 10px; padding-bottom: 10px" valign="bottom"
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Genarate XML File"
                                                ToolTip="Genarate XML File" TabIndex="9" Width="120px" 
