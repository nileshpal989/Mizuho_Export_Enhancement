<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_E_FIRC_Closure_XML_Generation.aspx.cs" Inherits="EDPMS_EDPMS_E_FIRC_Closure_XML_Generation" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server"><strong>EDPMS XML File Generation-E FIRC Closure</strong></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="line-height: 150%">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 12%" nowrap>
                                            <span class="mandatoryField">*</span><span class="elementLabel">From E FIRC Adjsustment Date :</span>
                                        </td>
                                        ...
                                        <td align="left" style="width: 8%" nowrap>
                                            <span class="mandatoryField">*</span><span class="elementLabel">To E FIRC Adjsustment Date :</span>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td align="left" width="0px" style="font-weight: bold; color: #000000;" nowrap>
                                            <asp:TextBox ID="txtfileName" runat="server" CssClass="textBox" MaxLength="20" Width="80px"
