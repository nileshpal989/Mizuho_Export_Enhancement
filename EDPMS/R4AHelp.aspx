<%@ Page Language="C#" AutoEventWireup="true" CodeFile="R4AHelp.aspx.cs" Inherits="EDPMS_R4AHelp" %>
                    ...
                    <table align="left" cellspacing="0" border="0" width="80%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                ...
                                &nbsp;<asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40"
                                    Width="200px"  onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    Width="90%" AllowPaging="false" OnRowCommand="GridViewBankList_RowCommand"
                                    OnRowDataBound="GridViewBankList_RowDataBound" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Adjustment Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbladjcode" runat="server" Text='<%# Eval("Adjustment_Code") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Adjustment Descreption" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbladjdesc" runat="server" Text='<%# Eval("Adjustment_Description") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
