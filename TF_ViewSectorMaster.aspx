<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewSectorMaster.aspx.cs" Inherits="TF_ViewSectorMaster" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Sector Master View</span>
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewSectorList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="True" OnRowCommand="GridViewSectorList_RowCommand"
                                    OnRowDataBound="GridViewSectorList_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sector ID" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsectorID" runat="server" CssClass="elementLabel" Text='<%# Eval("SECTOR_ID") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Sector Name" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsectorName" runat="server" CssClass="elementLabel" Text='<%# Eval("SECTOR_NAME") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" 
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" 
                                                    CommandArgument='<%# Eval("SECTOR_ID") %>' CommandName="RemoveRecord" 
