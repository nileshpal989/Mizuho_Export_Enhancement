<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_Document_No_Help.aspx.cs"
    Inherits="TF_Document_No_Help" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 90%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="5%" ItemStyle-Width="6%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocNo" runat="server" Text='<%#  Eval("Doc_No")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Document Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocDate" runat="server" Text='<%#  Eval("Doc_Date")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
