<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ACofficerHelpL1.aspx.cs" Inherits="TF_ACofficerHelpL1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Business Source Help</title>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 200px;">
                            <asp:Label ID="lblCustName" runat="server">Enter Business Source Name : &nbsp;</asp:Label>
                        </td>
                        <td style="width: 200px">
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BUSINESS_SOURCE_ID" HeaderText="ID" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="left">
