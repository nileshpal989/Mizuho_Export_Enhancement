<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_CountryLookUp1.aspx.cs" Inherits="TF_CountryLookUp1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewCountryList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewCountryList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewCountryList_RowCommand"
                                    OnRowDataBound="GridViewCountryList_RowDataBound" 
                                    onrowcreated="GridViewCountryList_RowCreated" PageSize=15  onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Country ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Country Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="75%" ItemStyle-Width="75%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCountryName" runat="server" Text='<%# Eval("CountryName") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
