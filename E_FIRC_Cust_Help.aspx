<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_FIRC_Cust_Help.aspx.cs" Inherits="Reports_EDPMS_Reports_E_FIRC_Cust_Help" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 200px">
                            <asp:TextBox ID="txtsearch" runat="server" Width="196px" AutoPostBack="True"
                                MaxLength="20" ontextchanged="txtsearch_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IECode" HeaderText="IE CODE" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="left">
                                        <ItemStyle HorizontalAlign="left" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="IEName" HeaderText="IE NAME" 
