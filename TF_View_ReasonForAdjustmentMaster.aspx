<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_View_ReasonForAdjustmentMaster.aspx.cs"
    Inherits="TF_View_ReasonForAdjustmentMaster" %>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel">Reason For Adjustment Master View</span>
                                </td>
                            ...
                            <tr id="rowGrid" runat="server">
                                <td align="left" style="width: 50%" valign="top" colspan="2">
                                    <asp:GridView ID="GridViewAdjustment" runat="server" 
                                        AutoGenerateColumns="False" Width="50%"
                                        GridLines="Both" AllowPaging="true" 
                                        onrowcommand="GridViewAdjustment_RowCommand" 
                                        onrowdatabound="GridViewAdjustment_RowDataBound" >
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Adjustment Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAdjustmentCode" runat="server" Text='<%#Eval("Adjustment_Code")%>' CssClass="elementLabel"></asp:Label>
                                                    <asp:Label ID="lblAdjustID" runat="server" Text='<%#Eval("Adjustment_Code")%>' Visible="false"></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("Adjustment_Description")%>' CssClass="elementLabel"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                        CommandArgument='<%#Eval("Adjustment_Code")%>' Text="Delete" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
