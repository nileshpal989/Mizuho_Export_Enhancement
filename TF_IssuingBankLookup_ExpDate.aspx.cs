...
public partial class TF_IssuingBankLookup_ExpDate : System.Web.UI.Page
{
    string query;
    ...
    public void grdDataBind()
    {
        ...
        query = "HelpIssuingBankMstr_ExpDate";
    ...
    protected void txtsearch_TextChanged(object sender, EventArgs e)
    {
        if (txtsearch.Text != "")
        {
            query = "HelpIssuingBankSearchId_ExpDate";
            System.Globalization.DateTimeFormatInfo dateInfo = new System.Globalization.DateTimeFormatInfo();
            dateInfo.ShortDatePattern = "dd/MM/yyyy";
            string date = Request.QueryString["frdate"].ToString();
            DateTime documentDate = Convert.ToDateTime(date, dateInfo);
        ...
        else if (txtsearch.Text == "")
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "message", "alert('Please Enter Issuing Bank');", true);
            grdDataBind();
            txtsearch.Focus();
        }
    }
