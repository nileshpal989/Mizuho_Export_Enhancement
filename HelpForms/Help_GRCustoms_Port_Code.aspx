<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_GRCustoms_Port_Code.aspx.cs"
    Inherits="XOS_Help_GRCustoms_Port_Code" %>
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="textBox" MaxLength="40" Width="100px"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    OnRowCreated="GridViewUserList_RowCreated" PageSize="15" CssClass="GridView">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Port Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityDesc" runat="server" Text='<%# Eval("portName") %>'
