<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_GBase_Commodity.aspx.cs"
    Inherits="EXP_Help_GRCustoms_Commodity" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommodityDesc" runat="server" Text='<%# Eval("GBase_Commodity_Description") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
