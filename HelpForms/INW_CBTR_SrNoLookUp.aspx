<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INW_CBTR_SrNoLookUp.aspx.cs"
    Inherits="INW_INW_CBTR_SrNoLookUp" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" 
                                    Width="90%" OnRowDataBound="GridViewBankList_RowDataBound" OnRowCreated="GridViewBankList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SrNo" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblStateCode" runat="server" Text='<%# Eval("SrNo") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblStateName" runat="server" Text='<%# Eval("Name") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
