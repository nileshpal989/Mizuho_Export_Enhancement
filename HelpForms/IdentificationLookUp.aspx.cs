...
public partial class HelpForms_IndentificationLookUp : System.Web.UI.Page
{
    ...
    {
        SqlParameter p1 = new SqlParameter("@EnumerationType", "Identification");
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label lblIdCode = new Label();
            lblIdCode = (Label)e.Row.FindControl("lblIdCode");

            int i = 0;
            foreach (TableCell cell in e.Row.Cells)
            {
                string pageurl = "";
                pageurl = "window.opener.selectIndentificationType('" + lblIdCode.Text + "');window.opener.EndRequest();window.close();";
