                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">                           
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    Width="90%" OnRowCommand="GridViewBankList_RowCommand"
                                    OnRowDataBound="GridViewBankList_RowDataBound" 
                                    onrowcreated="GridViewBankList_RowCreated" PageSize=15  
                                    onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Country ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCountryID" runat="server" Text='<%# Eval("CountryID") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Country Name" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
