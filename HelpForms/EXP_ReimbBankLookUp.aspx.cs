...
public partial class EXP_EXP_ReimbBankLookUp : System.Web.UI.Page
{
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                pageurl = "window.opener.selectReimbBank('" + lblBankCode.Text + "');window.opener.EndRequest();window.close();";
