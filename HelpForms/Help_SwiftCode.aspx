<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Help_SwiftCode.aspx.cs" Inherits="Help_SwiftCode" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Bank Name " HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankName" runat="server" ToolTip='<%#  Eval("BankName") %>' Text='<%# (Eval("BankName").ToString().Length > 60) ? (Eval("BankName").ToString().Substring(0, 60) + "...") : Eval("BankName")%>'
