<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpBOEDocNo.aspx.cs" Inherits="HelpForms_HelpBOEDocNo" %>
                                ...
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblAcNo" runat="server" Text='<%#  Eval("Docno")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
