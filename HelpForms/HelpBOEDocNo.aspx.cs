...
public partial class HelpForms_HelpBOEDocNo : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_IDPMS_BOEDocNoHelp";
    ...
    protected void GridViewUserList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            lblbilldate = (Label)e.Row.FindControl("lblbilldate");
            int i = 0;
            foreach (TableCell cell in e.Row.Cells)
            {
                string pageurl = "";
                pageurl = "window.opener.selectAccount('" + lblAcNo.Text + "','" + lblbillno.Text + "','" + lblportcode.Text + "','" + lblbilldate.Text + "');window.opener.EndRequest();window.close();";
                if (i != 2)
