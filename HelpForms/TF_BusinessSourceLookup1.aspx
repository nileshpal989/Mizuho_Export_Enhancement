<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_BusinessSourceLookup1.aspx.cs"
    Inherits="TF_BusinessSourceLookup1" %>
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="BUSINESS_SOURCE_ID" HeaderText="ID" ItemStyle-Width="70px"
                                        ItemStyle-HorizontalAlign="left">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NAME" HeaderText="NAME" ItemStyle-Width="300px">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DESIGNATION" HeaderText="DESIGNATION" ItemStyle-Width="500px">
                                    </asp:BoundField>
                                </Columns>
