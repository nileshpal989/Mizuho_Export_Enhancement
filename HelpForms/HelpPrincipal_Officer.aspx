<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpPrincipal_Officer.aspx.cs" Inherits="INW_HelpPrincipal_Officer" %>
...
<body bgcolor="#CDDAE4"
    onload="disable_parent();EndRequest();" onunload="enable_parent();">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Principal Officer Id" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("PrincOfficerId") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                          
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Principal Officer Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustName" runat="server" Text='<%# Eval("PrincOfficerName") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
