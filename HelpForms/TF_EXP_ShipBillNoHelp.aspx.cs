...
public partial class TF_EXP_ShipBillNoHelp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_EXP_ShipBillNohelpWithInvoice";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            lblInvDate = (Label)e.Row.FindControl("lblInvDate");

            int i = 0;
            foreach (TableCell cell in e.Row.Cells)
            {
                string pageurl = "window.opener.SelectShipBillNoWithInvoice('" + lblshipbillno.Text + "','" + lblshipbilldate.Text + "','" + lblportcode.Text + "','" + lblInvSrNo.Text + "','" + lblInvNo.Text + "','" + lblInvDate.Text + "');window.opener.EndRequest();window.close();";
                if (i != 6)
