<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountTypeLookUp.aspx.cs"
    Inherits="HelpForms_AccountTypeLookUp" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    OnRowDataBound="GridViewBankList_RowDataBound" OnRowCreated="GridViewBankList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Account Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAccCode" runat="server" Text='<%# Eval("AccountCode") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("AccountDescription") %>'
