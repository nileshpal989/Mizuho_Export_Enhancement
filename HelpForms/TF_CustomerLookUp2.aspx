<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_CustomerLookUp2.aspx.cs" Inherits="TF_CustomerLookUp2" %>
                            ...
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
