...
public partial class HelpForms_AccountTypeLookUp : System.Web.UI.Page
{
    ...
    {
        SqlParameter p1 = new SqlParameter("@EnumerationType", "Account Type");
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "";
                pageurl = "window.opener.selectAccountType('" + lblAccCode.Text + "');window.opener.EndRequest();window.close();";
