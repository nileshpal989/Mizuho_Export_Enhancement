<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RiskCategoryLookUp.aspx.cs" Inherits="HelpForms_RiskCategoryLookUp" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Risk Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRiskCode" runat="server" Text='<%# Eval("RiskCode") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("RiskDescription") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
