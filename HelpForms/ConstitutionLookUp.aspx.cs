...
public partial class HelpForms_ConstitutionLookUp : System.Web.UI.Page
{
    ...
    {
        SqlParameter p1 = new SqlParameter("@EnumerationType", "Constitution Type");
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label lblConstiCode = new Label();
            lblConstiCode = (Label)e.Row.FindControl("lblConstiCode");

            int i = 0;
            foreach (TableCell cell in e.Row.Cells)
            {
                string pageurl = "";
                pageurl = "window.opener.selectConstitution('" + lblConstiCode.Text + "');window.opener.EndRequest();window.close();";
