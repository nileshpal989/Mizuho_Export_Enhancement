<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpBranchCategory.aspx.cs"
    Inherits="HelpBranchCategory" %>
                    ...
                    <table align="left" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 20%;" valign="middle" nowrap>
                                &nbsp;
                                <asp:Label ID="lblcategoryNames" runat="server" Font-Bold="true">Search : </asp:Label>
                                &nbsp; &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 90%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Category Id" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="4%" ItemStyle-Width="4%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcatid" runat="server" Text='<%#  Eval("Catid")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Category " HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblcategory" runat="server" Text='<%#  Eval("Category") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
