<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXP_INWDOCLIST.aspx.cs"
    Inherits="TF_EXP_INWDOCLIST" %>
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewDocList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="true" OnRowCommand="GridViewDocList_RowCommand" OnRowDataBound="GridViewDocList_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Nego Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDocDate" runat="server" Text='<%# Eval("Date_Negotiated") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
