<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpStateMaster.aspx.cs"
    Inherits="HelpStateMaster" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 90%" valign="top">
                                <asp:GridView ID="GridViewUserList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="State Id" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblState" runat="server" Text='<%#  Eval("State_ID")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                           
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="State Name " HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblSateName" runat="server" Text='<%#  Eval("State_Name") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
