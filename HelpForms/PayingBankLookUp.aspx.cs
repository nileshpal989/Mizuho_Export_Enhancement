...
public partial class PayingBankLookUp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_GetPayingBankMasterList";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                pageurl = "window.opener.selectPayingBank('" + hNo + "','" + lblBankCode.Text + "');window.opener.EndRequest();window.close();";
