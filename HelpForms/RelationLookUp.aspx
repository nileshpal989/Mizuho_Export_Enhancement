<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelationLookUp.aspx.cs" Inherits="HelpForms_RelationLookUp" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Relation Code" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRelationCode" runat="server" Text='<%# Eval("RelationCode") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("RelationDescription") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
