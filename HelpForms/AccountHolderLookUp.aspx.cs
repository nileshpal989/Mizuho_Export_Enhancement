...
public partial class HelpForms_AccountHolderLookUp : System.Web.UI.Page
{
    ...
    {
        SqlParameter p1 = new SqlParameter("@EnumerationType", "Account Holder Type");
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "";
                pageurl = "window.opener.selectAccountHolder('" + lblAccCode.Text + "');window.opener.EndRequest();window.close();";
