<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_BeneficiaryLookUp_ExpDate.aspx.cs" Inherits="TF_BeneficiaryLookUp_ExpDate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Beneficiary Help</title>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 155px;">
                            <asp:Label ID="lblCustName" runat="server">Enter Beneficiary : &nbsp;</asp:Label>
                        </td>
