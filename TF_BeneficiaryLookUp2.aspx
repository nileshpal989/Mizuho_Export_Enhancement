<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_BeneficiaryLookUp2.aspx.cs" Inherits="TF_BeneficiaryLookUp2" %>
        ...
        <script type="text/javascript">
            ...
            function GetValues() {
                ...
                if (SelectedRowIndex >= 0) {
                    ...
                    document.getElementById('txtcell1').value = CellValue2;
                    window.opener.document.getElementById('btnSearchCriteria').click();
                    window.close();
                }
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 155px;">
                            <asp:Label ID="lblCustName" runat="server">Enter Customer Name : &nbsp;</asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Beneficiary_Bank_Code" HeaderText="Bank Code" ItemStyle-Width="30px"
                                        ItemStyle-HorizontalAlign="Left" >
                                    <ItemStyle HorizontalAlign="Left" Width="30px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Beneficiary_Name" HeaderText="Beneficiary Name" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="left">
                                        <ItemStyle HorizontalAlign="left" Width="150px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Our_Ref_No" HeaderText="Doc No" 
                            ...
                            <asp:Label ID="NoRecords" runat="server" ForeColor="Red" 
                                Text="No Record's Found" Visible="False"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                        </td>
