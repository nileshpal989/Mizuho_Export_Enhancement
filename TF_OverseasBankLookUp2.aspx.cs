...
public partial class TF_OverseasBankLookUp2 : System.Web.UI.Page
{
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.opener.selectOverseasBank('" + lblBankCode.Text + "');window.opener.EndRequest();window.close();";
                if (i != 6)
