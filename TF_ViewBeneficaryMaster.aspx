<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewBeneficaryMaster.aspx.cs" Inherits="TF_ViewBeneficaryMaster" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Beneficiary Master View</span>
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewBeneficaryPartyList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="True" OnRowCommand="GridViewBeneficaryPartyList_RowCommand"
                                    OnRowDataBound="GridViewBeneficaryPartyList_RowDataBound" 
                                    >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Party ID" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPartyID" runat="server" CssClass="elementLabel" Text='<%# Eval("Benf_Id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Party Name" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblPartyName" runat="server" CssClass="elementLabel" Text='<%# Eval("Benf_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="City" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCity" runat="server" CssClass="elementLabel" Text='<%# Eval("Benf_City") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Country" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCountry" runat="server" CssClass="elementLabel" Text='<%# Eval("Benf_Country") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Type" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltype" runat="server" CssClass="elementLabel" Text='<%# Eval("Benf_type") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" 
                                            HeaderText="Delete" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" 
                                                    CommandArgument='<%# Eval("Benf_Id")+";"+Eval("Benf_type") %>' CommandName="RemoveRecord" 
