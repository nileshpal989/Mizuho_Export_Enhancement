...
public partial class RBI_PortCodeLookup : System.Web.UI.Page
{
    ...
    {
        string search = Request.QueryString["PortID"].ToString();
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.opener.selectPort('" + lblBankCode.Text + "');window.opener.EndRequest();window.close();";
                if (i != 6)
