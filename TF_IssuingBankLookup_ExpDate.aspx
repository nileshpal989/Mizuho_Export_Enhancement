<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IssuingBankLookup_ExpDate.aspx.cs" Inherits="TF_IssuingBankLookup_ExpDate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Issuing Bank Help</title>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 200px;">
                            <asp:Label ID="lblCustName" runat="server">Enter Issuing Bank : &nbsp;</asp:Label>
                        </td>
                        <td style="width: 200px">
                        ...
                        <td class="style3" colspan="3">
                            ...
                            <asp:GridView ID="grdsearch" runat="server" AutoGenerateColumns="False" ondblclick="GetValues()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Issuing_Bank_Code" HeaderText="Bank Code" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="left">
