<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewRealisationEntry_Maker.aspx.cs"
    Inherits="EXP_EXP_ViewRealisationEntry_Maker" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Export Realisation Data Entry View-Maker</strong></span>
                            </td>
                                ...
                                <asp:GridView ID="GridViewEXPDocRealised" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Maker Name" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMaker" runat="server" Text='<%# Eval("Addedby") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Checker Name" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblChecker" runat="server" Text='<%# Eval("Checkby") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
