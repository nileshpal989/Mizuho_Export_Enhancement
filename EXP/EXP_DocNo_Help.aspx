<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_DocNo_Help.aspx.cs" Inherits="EXP_EXP_DocNo_Help" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewDocList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                ...
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="80%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewDocList" runat="server" AutoGenerateColumns="False" Width="90%"
                                    AllowPaging="false" OnRowCommand="GridViewDocList_RowCommand" OnRowDataBound="GridViewDocList_RowDataBound"
                                    OnRowCreated="GridViewDocList_RowCreated" PageSize="15" onblur="GiveFocus='FALSE';CheckFocus();"
                                    OnDataBound="GridViewDocList_DataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Document NO" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                          ...
                                          <asp:TemplateField HeaderText="Customer Ac No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="15%" ItemStyle-Width="15%">
                                            <ItemTemplate>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Port Name" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankName" runat="server" Text='<%# Eval("portName") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
