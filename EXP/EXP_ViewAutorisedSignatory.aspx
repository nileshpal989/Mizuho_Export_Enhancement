<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewAutorisedSignatory.aspx.cs"
    Inherits="EXP_EXP_ViewAutorisedSignatory" %>
                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel">Authorised Signatory Master View</span>
                        </td>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top" colspan="2">
                            <asp:GridView ID="GridViewAuthorisedSignatoryList" runat="server" AutoGenerateColumns="False"
                                Width="100%" AllowPaging="True" OnRowCommand="GridViewAuthorisedSignatoryList_RowCommand"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Branch" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblBranch" runat="server" CssClass="elementLabel" Text='<%# Eval("C_CODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Authorised Signatory Name" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" CssClass="elementLabel" Text='<%# Eval("C_DESCRIPTION") %>'></asp:Label>
                                        </ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Designation" HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDesignation" runat="server" CssClass="elementLabel" Text='<%# Eval("C_TEXT1") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Email ID" HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmailID" runat="server" CssClass="elementLabel" Text='<%# Eval("C_TEXT2") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                        ...
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("C_CODE") %>'
