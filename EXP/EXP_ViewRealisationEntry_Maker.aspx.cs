...
public partial class EXP_EXP_ViewRealisationEntry_Maker : System.Web.UI.Page
{
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                if (rbtnForeign.Checked == true)
                    ...
                    Foreginlocal = "L";
                string pageurl = "window.location='EXP_AddEditFullRealisation_Maker.aspx?mode=edit&DocNo=" + lblDocumentNo.Text.Trim()
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (rbtnForeign.Checked == true)
            ...
            Foreginlocal = "L";
        Response.Redirect("EXP_AddEditFullRealisation_Maker.aspx?mode=add&DocPrFx=" + txtDocPrFx.Value + "&BranchCode=" + hdnBranchCode.Value.Trim() + "&BranchName=" + ddlBranch.Text + "&ForeignOrLocal=" + Foreginlocal + "&year=" + year, true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string query = "TF_EXPGetRealisationEntryList_Maker";
