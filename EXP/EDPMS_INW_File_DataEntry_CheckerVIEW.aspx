<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDPMS_INW_File_DataEntry_CheckerVIEW.aspx.cs" Inherits="EXP_EDPMS_INW_File_DataEntry_CheckerVIEW" %>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" nowrap>
                                    <span class="pageLabel"><strong>Inward Remittances Data Entry View-Checker</strong></span>
                                </td>
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <span style="margin-left:30px;" class="elementLabel">Document Date : </span>
                                    ...
                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator3" runat="server" ControlExtender="mdDocdate"
                                        ...
                                        InvalidValueBlurredMessage="Date is invalid" EmptyValueBlurredText="*" ErrorMessage="*"></ajaxToolkit:MaskedEditValidator>
                                         <asp:RadioButton ID="rdbPending" runat="server" Text="Pending" AutoPostBack="true" Checked="true"
                                     GroupName="Status" OnCheckedChanged="rdbPending_CheckedChanged" Font-Bold="true"
                                    ...
                                    <asp:GridView ID="GridViewInwData" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="API Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAPIStatus" runat="server" Text='<%# Eval("PUSH_STATUS") %>' CssClass="elementLabel"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                         <asp:TemplateField HeaderText="DGFT Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                HeaderStyle-Width="8%" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDGFTStatus" runat="server" Text='<%# Eval("GET_STATUS") %>' CssClass="elementLabel"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
