...
public partial class EXP_EXP_ViewCurrencyCardRate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ddlrecordpage.SelectedValue = "12";
                fillGrid();
    ...
    protected void GridViewCountry_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        p1.Value = _countryid;
        string query = "TF_EXP_DeleteCurrCardRateDetails";
    ...
    protected void GridViewCountry_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string url = "window.location='EXP_AddEditCurrCardRate.aspx?mode=edit&AsOnDate=" + lblDate.Text.Trim() + "'";
                if (i != 4)
    ...
    {
        Response.Redirect("EXP_AddEditCurrCardRate.aspx?mode=add", true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string query = "TF_EXP_GetCurrencyCardRateList";
        TF_DATA objdata = new TF_DATA();
