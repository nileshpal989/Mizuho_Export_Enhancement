<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXP_SundryaccountHelp.aspx.cs" Inherits="EXP_HelpForms_TF_EXP_SundryaccountHelp" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RadioButton ID="rdb_NostroAc" runat="server" GroupName="Account" Text="Nostro Account"
                                    OnCheckedChanged="sundryAc_Rdbtn_CheckedChanged" AutoPostBack="true" />
                                &nbsp;
                                <asp:RadioButton ID="rdb_CustAc" runat="server" GroupName="Account" Text="Customer Account"
                                    OnCheckedChanged="sundryAc_Rdbtn_CheckedChanged" AutoPostBack="true" />
                                 &nbsp;
                                <asp:RadioButton ID="rbd_SuspenseAC" runat="server" GroupName="Account" Text="Suspense Account"
                                    OnCheckedChanged="sundryAc_Rdbtn_CheckedChanged" AutoPostBack="true" />
                            </td>
                        </tr>
                        <tr>
