<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXP_AddEditSundryAccountMaster.aspx.cs" Inherits="EXP_TF_EXP_AddEditSundryAccountMaster" %>
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                ...
                <ContentTemplate>
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <%--BY NILESH--%>
                        <input type="hidden" runat="server" id="hdndesc" />
                        <input type="hidden" runat="server" id="hdnbranch" />
                        <input type="hidden" runat="server" id="hdnccy" />
                             <input type="hidden" runat="server" id="hdncstabbr" />
                        <input type="hidden" runat="server" id="hdnacntno" />
                        <%--END BY NILESH--%>
