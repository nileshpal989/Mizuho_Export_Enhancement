...
public partial class EXP_EXP_ViewPaymentExtension : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_EXP_Getpaymentextndetails";
        TF_DATA objData = new TF_DATA();
        ...
        if (e.Row.RowType==DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                string pageurl = "window.location='TF_AddEditPaymentExtn.aspx?mode=edit&custacno=" + lblcustacno.Text.Trim()
                    + "&DocYear=" + txtYear.Text + "&BranchName=" + ddlBranch.Text.Trim() + "&docno="+lbldocno.Text+"&shipbillno="+lblshipbillno.Text+ "'";
                if (i != 7)
