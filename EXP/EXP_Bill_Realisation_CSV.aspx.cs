...
using System.Data;
public partial class EXP_EXP_Bill_Realisation_CSV : System.Web.UI.Page
{
    string s = "";
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        string _query = "TF_EXP_Bill_Realisation_CSV";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string _filePath = _directoryPath + "/Export Realisation Bill Details" + "-" + _FromDate + " to " + _ToDate + ".csv";
            StreamWriter sw;
