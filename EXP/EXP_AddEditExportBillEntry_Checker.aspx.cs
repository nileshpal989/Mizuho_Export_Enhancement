...
public partial class EXP_AddEditExportBillEntry_Checkar : System.Web.UI.Page
{
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    fillPortCodes();
                    fillCurrency(ddlCurrency, ddlOtherCurrency, ddlCurrencyGRPP, ddlFreightCurr, ddlInsCurr, ddlDiscCurr, ddlCommCurr, ddlOthDedCurr, ddlPackChgCurr);
                ...
                ddlApproveReject.Attributes.Add("onchange", "return DialogAlertLodgement();");
                SetInitialRow();
                ...
                if (Request.QueryString["Status"].ToString() == "Send To Checker")
                {
                    ...
                    string Result = obj.SaveDeleteData("TF_EXP_SameTransIdCheckerAlert", p1, p2);
                }
            }
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        //TF_DATA obj = new TF_DATA();
        //SqlParameter p1 = new SqlParameter("@DocNo", txtDocumentNo.Text.Trim());
        //string Result = obj.SaveDeleteData("TF_EXP_UpdateSameTransIdCheckerAlert", p1);

        Response.Redirect("EXP_ViewExportBillEntry_Checker.aspx", true);
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (ddlApproveReject.SelectedIndex == 1)
            {
                ...
                SqlParameter LEIdocNo = new SqlParameter("@docNo", txtDocumentNo.Text.Trim());
            ...
            string Result = obj.SaveDeleteData("TF_EXP_ChekerApproveReject_Lodgement", P_DocNo, P_Status, P_RejectReason, P_CheckedBy);
            if (AR == "A")
            {
                TransferExportToEDPMS();
            }

            Response.Redirect("EXP_ViewExportBillEntry_Checker.aspx?DocNo=" + Result.Substring(7) + "&AR=" + AR, true);
    ...
    private void TransferExportToEDPMS()
    {
        ...
        if (txtDocumentNo.Text.Substring(0, 2) == "EB")
        {
            string Result1 = obj.SaveDeleteData("TF_EDPMS_DATA_TRANSFER_APPROVE_PRN_EB", P_DocNo);
        }
        ...
        if (dt.Rows.Count > 0)
        {
                         ...
                         <script type='text/javascript'>
                             ...
                             if (confirmation) {
                                ExecuteCSharpCodeLodg();
                                 ...
                                 // Redirect to a page
                                 window.location.href = 'EXP_ViewExportBillEntry_Checker.aspx';
                            }
                         </script>
                     ";
           ...
           // }
            ...
            if (dt.Rows[0]["TTREFNO1"].ToString().Trim() != "")
            {
                ...
                txtTTCurr1.Text = dt.Rows[0]["TTCurr1"].ToString().Trim();
                txtTotTTAmt1.Text = dt.Rows[0]["TotTTAmt1"].ToString().Trim();
                txtBalTTAmt1.Text = dt.Rows[0]["BalTTAmt1"].ToString().Trim();
                txtTTRealisedCurr1.Text = dt.Rows[0]["TTRealisedCurr1"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr1.Visible = false;
                txtTotTTAmt1.Visible = false;
                txtBalTTAmt1.Visible = false;
                txtTTRealisedCurr1.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO2"].ToString().Trim() != "")
            {
                ...
                txtTTCurr2.Text = dt.Rows[0]["TTCurr2"].ToString().Trim();
                txtTotTTAmt2.Text = dt.Rows[0]["TotTTAmt2"].ToString().Trim();
                txtBalTTAmt2.Text = dt.Rows[0]["BalTTAmt2"].ToString().Trim();
                txtTTRealisedCurr2.Text = dt.Rows[0]["TTRealisedCurr2"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr2.Visible = false;
                txtTotTTAmt2.Visible = false;
                txtBalTTAmt2.Visible = false;
                txtTTRealisedCurr2.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO3"].ToString().Trim() != "")
            {
                ...
                txtTTCurr3.Text = dt.Rows[0]["TTCurr3"].ToString().Trim();
                txtTotTTAmt3.Text = dt.Rows[0]["TotTTAmt3"].ToString().Trim();
                txtBalTTAmt3.Text = dt.Rows[0]["BalTTAmt3"].ToString().Trim();
                txtTTRealisedCurr3.Text = dt.Rows[0]["TTRealisedCurr3"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr3.Visible = false;
                txtTotTTAmt3.Visible = false;
                txtBalTTAmt3.Visible = false;
                txtTTRealisedCurr3.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO4"].ToString().Trim() != "")
            {
                ...
                txtTTCurr4.Text = dt.Rows[0]["TTCurr4"].ToString().Trim();
                txtTotTTAmt4.Text = dt.Rows[0]["TotTTAmt4"].ToString().Trim();
                txtBalTTAmt4.Text = dt.Rows[0]["BalTTAmt4"].ToString().Trim();
                txtTTRealisedCurr4.Text = dt.Rows[0]["TTRealisedCurr4"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr4.Visible = false;
                txtTotTTAmt4.Visible = false;
                txtBalTTAmt4.Visible = false;
                txtTTRealisedCurr4.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO5"].ToString().Trim() != "")
            {
                ...
                txtTTCurr5.Text = dt.Rows[0]["TTCurr5"].ToString().Trim();
                txtTotTAmt5.Text = dt.Rows[0]["TotTTAmt5"].ToString().Trim();//check
                txtBalTTAmt5.Text = dt.Rows[0]["BalTTAmt5"].ToString().Trim();
                txtTTRealisedCurr5.Text = dt.Rows[0]["TTRealisedCurr5"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr5.Visible = false;
                txtTotTAmt5.Visible = false;
                txtBalTTAmt5.Visible = false;
                txtTTRealisedCurr5.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO6"].ToString().Trim() != "")
            {
                ...
                txtTTCurr6.Text = dt.Rows[0]["TTCurr6"].ToString().Trim();
                txtTotTTAmt6.Text = dt.Rows[0]["TotTTAmt6"].ToString().Trim();
                txtBalTTAmt6.Text = dt.Rows[0]["BalTTAmt6"].ToString().Trim();
                txtTTRealisedCurr6.Text = dt.Rows[0]["TTRealisedCurr6"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr6.Visible = false;
                txtTotTTAmt6.Visible = false;
                txtBalTTAmt6.Visible = false;
                txtTTRealisedCurr6.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO7"].ToString().Trim() != "")
            {
                ...
                txtTTCurr7.Text = dt.Rows[0]["TTCurr7"].ToString().Trim();
                txtTotTTAmt7.Text = dt.Rows[0]["TotTTAmt7"].ToString().Trim();
                txtBalTTAmt7.Text = dt.Rows[0]["BalTTAmt7"].ToString().Trim();
                txtTTRealisedCurr7.Text = dt.Rows[0]["TTRealisedCurr7"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr7.Visible = false;
                txtTotTTAmt7.Visible = false;
                txtBalTTAmt7.Visible = false;
                txtTTRealisedCurr7.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO8"].ToString().Trim() != "")
            {
                ...
                txtTTCurr8.Text = dt.Rows[0]["TTCurr8"].ToString().Trim();
                txtTotTTAmt8.Text = dt.Rows[0]["TotTTAmt8"].ToString().Trim();
                txtBalTAmt8.Text = dt.Rows[0]["BalTTAmt8"].ToString().Trim();//check
                txtTTRealisedCurr8.Text = dt.Rows[0]["TTRealisedCurr8"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr8.Visible = false;
                txtTotTTAmt8.Visible = false;
                txtBalTAmt8.Visible = false;
                txtTTRealisedCurr8.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO9"].ToString().Trim() != "")
            {
                ...
                txtTTCurr9.Text = dt.Rows[0]["TTCurr9"].ToString().Trim();
                txtTtTTAmt9.Text = dt.Rows[0]["TotTTAmt9"].ToString().Trim();//check
                txtBalTTAmt9.Text = dt.Rows[0]["BalTTAmt9"].ToString().Trim();
                txtTTRealisedCurr9.Text = dt.Rows[0]["TTRealisedCurr9"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr9.Visible = false;
                txtTtTTAmt9.Visible = false;
                txtBalTTAmt9.Visible = false;
                txtTTRealisedCurr9.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO10"].ToString().Trim() != "")
            {
                ...
                txtTTCurr10.Text = dt.Rows[0]["TTCurr10"].ToString().Trim();
                txtTotTTAmt10.Text = dt.Rows[0]["TotTTAmt10"].ToString().Trim();
                txtBalTTAmt10.Text = dt.Rows[0]["BalTTAmt10"].ToString().Trim();
                txtTTRealisedCurr10.Text = dt.Rows[0]["TTRealisedCurr10"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr10.Visible = false;
                txtTotTTAmt10.Visible = false;
                txtBalTTAmt10.Visible = false;
                txtTTRealisedCurr10.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO11"].ToString().Trim() != "")
            {
                ...
                txtTTCurr11.Text = dt.Rows[0]["TTCurr11"].ToString().Trim();
                txtTotTTAmt11.Text = dt.Rows[0]["TotTTAmt11"].ToString().Trim();
                txtBalTTAmt11.Text = dt.Rows[0]["BalTTAmt11"].ToString().Trim();
                txtTTRealisedCurr11.Text = dt.Rows[0]["TTRealisedCurr11"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr11.Visible = false;
                txtTotTTAmt11.Visible = false;
                txtBalTTAmt11.Visible = false;
                txtTTRealisedCurr11.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO12"].ToString().Trim() != "")
            {
                ...
                txtTTCurr12.Text = dt.Rows[0]["TTCurr12"].ToString().Trim();
                txtTotTTAmt12.Text = dt.Rows[0]["TotTTAmt12"].ToString().Trim();
                txtBalTTAmt12.Text = dt.Rows[0]["BalTTAmt12"].ToString().Trim();
                txtTTRealisedCurr12.Text = dt.Rows[0]["TTRealisedCurr12"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr12.Visible = false;
                txtTotTTAmt12.Visible = false;
                txtBalTTAmt12.Visible = false;
                txtTTRealisedCurr12.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO13"].ToString().Trim() != "")
            {
                ...
                txtTTCurr13.Text = dt.Rows[0]["TTCurr13"].ToString().Trim();
                txtTotTTAmt13.Text = dt.Rows[0]["TotTTAmt13"].ToString().Trim();
                txtBalTTAmt13.Text = dt.Rows[0]["BalTTAmt13"].ToString().Trim();
                txtTTRealisedCurr13.Text = dt.Rows[0]["TTRealisedCurr13"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr13.Visible = false;
                txtTotTTAmt13.Visible = false;
                txtBalTTAmt13.Visible = false;
                txtTTRealisedCurr13.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO14"].ToString().Trim() != "")
            {
                ...
                txtTTCurr14.Text = dt.Rows[0]["TTCurr14"].ToString().Trim();
                txtTotTTAmt14.Text = dt.Rows[0]["TotTTAmt14"].ToString().Trim();
                txtBalTTAmt14.Text = dt.Rows[0]["BalTTAmt14"].ToString().Trim();
                txtTTRealisedCurr14.Text = dt.Rows[0]["TTRealisedCurr14"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr14.Visible = false;
                txtTotTTAmt14.Visible = false;
                txtBalTTAmt14.Visible = false;
                txtTTRealisedCurr14.Visible = false;
            ...
            if (dt.Rows[0]["TTREFNO15"].ToString().Trim() != "")
            {
                ...
                txtTTCurr15.Text = dt.Rows[0]["TTCurr15"].ToString().Trim();
                txtTotTTAmt15.Text = dt.Rows[0]["TotTTAmt15"].ToString().Trim();
                txtBalTTAmt15.Text = dt.Rows[0]["BalTTAmt15"].ToString().Trim();
                txtTTRealisedCurr15.Text = dt.Rows[0]["TTRealisedCurr15"].ToString().Trim();
            ...
            else
            {
                ...
                txtTTCurr15.Visible = false;
                txtTotTTAmt15.Visible = false;
                txtBalTTAmt15.Visible = false;
                txtTTRealisedCurr15.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank1"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency1_OB.Text = dt.Rows[0]["FIRCCurrency1_OB"].ToString().Trim();
                txtFIRCRealisedCurr1_OB.Text = dt.Rows[0]["FIRCRealisedCurr1_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency1_OB.Visible = false;
                txtFIRCRealisedCurr1_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank2"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency2_OB.Text = dt.Rows[0]["FIRCCurrency2_OB"].ToString().Trim();
                txtFIRCRealisedCurr2_OB.Text = dt.Rows[0]["FIRCRealisedCurr2_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency2_OB.Visible = false;
                txtFIRCRealisedCurr2_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank3"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency3_OB.Text = dt.Rows[0]["FIRCCurrency3_OB"].ToString().Trim();
                txtFIRCRealisedCurr3_OB.Text = dt.Rows[0]["FIRCRealisedCurr3_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency3_OB.Visible = false;
                txtFIRCRealisedCurr3_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank4"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency4_OB.Text = dt.Rows[0]["FIRCCurrency4_OB"].ToString().Trim();
                txtFIRCRealisedCurr4_OB.Text = dt.Rows[0]["FIRCRealisedCurr4_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency4_OB.Visible = false;
                txtFIRCRealisedCurr4_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank5"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency5_OB.Text = dt.Rows[0]["FIRCCurrency5_OB"].ToString().Trim();
                txtFIRCRealisedCurr5_OB.Text = dt.Rows[0]["FIRCRealisedCurr5_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency5_OB.Visible = false;
                txtFIRCRealisedCurr5_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank6"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency6_OB.Text = dt.Rows[0]["FIRCCurrency6_OB"].ToString().Trim();
                txtFIRCRealisedCurr6_OB.Text = dt.Rows[0]["FIRCRealisedCurr6_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency6_OB.Visible = false;
                txtFIRCRealisedCurr6_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank7"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency7_OB.Text = dt.Rows[0]["FIRCCurrency7_OB"].ToString().Trim();
                txtFIRCRealisedCurr7_OB.Text = dt.Rows[0]["FIRCRealisedCurr7_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency7_OB.Visible = false;
                txtFIRCRealisedCurr7_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank8"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency8_OB.Text = dt.Rows[0]["FIRCCurrency8_OB"].ToString().Trim();
                txtFIRCRealisedCurr8_OB.Text = dt.Rows[0]["FIRCRealisedCurr8_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency8_OB.Visible = false;
                txtFIRCRealisedCurr8_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank9"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency9_OB.Text = dt.Rows[0]["FIRCCurrency9_OB"].ToString().Trim();
                txtFIRCRealisedCurr9_OB.Text = dt.Rows[0]["FIRCRealisedCurr9_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency9_OB.Visible = false;
                txtFIRCRealisedCurr9_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank10"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency10_OB.Text = dt.Rows[0]["FIRCCurrency10_OB"].ToString().Trim();
                txtFIRCRealisedCurr10_OB.Text = dt.Rows[0]["FIRCRealisedCurr10_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency10_OB.Visible = false;
                txtFIRCRealisedCurr10_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank11"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency11_OB.Text = dt.Rows[0]["FIRCCurrency11_OB"].ToString().Trim();
                txtFIRCRealisedCurr11_OB.Text = dt.Rows[0]["FIRCRealisedCurr11_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency11_OB.Visible = false;
                txtFIRCRealisedCurr11_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank12"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency12_OB.Text = dt.Rows[0]["FIRCCurrency12_OB"].ToString().Trim();
                txtFIRCRealisedCurr12_OB.Text = dt.Rows[0]["FIRCRealisedCurr12_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency12_OB.Visible = false;
                txtFIRCRealisedCurr12_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank13"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency13_OB.Text = dt.Rows[0]["FIRCCurrency13_OB"].ToString().Trim();
                txtFIRCRealisedCurr13_OB.Text = dt.Rows[0]["FIRCRealisedCurr13_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency13_OB.Visible = false;
                txtFIRCRealisedCurr13_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank14"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency14_OB.Text = dt.Rows[0]["FIRCCurrency14_OB"].ToString().Trim();
                txtFIRCRealisedCurr14_OB.Text = dt.Rows[0]["FIRCRealisedCurr14_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency14_OB.Visible = false;
                txtFIRCRealisedCurr14_OB.Visible = false;
            ...
            if (dt.Rows[0]["FIRCNo_OtrBank15"].ToString().Trim() != "")
            {
                ...
                txtFIRCCurrency15_OB.Text = dt.Rows[0]["FIRCCurrency15_OB"].ToString().Trim();
                txtFIRCRealisedCurr15_OB.Text = dt.Rows[0]["FIRCRealisedCurr15_OB"].ToString().Trim();
            ...
            else
            {
                ...
                txtFIRCCurrency15_OB.Visible = false;
                txtFIRCRealisedCurr15_OB.Visible = false;
    ...
    protected void btnalert_Click(object sender, EventArgs e)
    {
        ...
        if (txtDueDate.Text.Trim() != "")
        {
            ...
            mDate = Convert.ToDateTime(txtDueDate.Text.Trim(), dateInfo);

            if (flag == false)
            {
                string weekDay = mDate.DayOfWeek.ToString();
                if (weekDay == "Sunday" || weekDay == "Saturday")
                {
                    _DateDetails = weekDay;
                    flag = true;
                }
            }
            ...
            if (flag == true)
            {
                _script = "alert('" + txtDueDate.Text.Trim() + " is " + _DateDetails + ". (Due Date) ');";
    ...
    protected void TTRemitterName(string TTno, string LblRname)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            switch (LblRname)
            {
                case "1": lblTTRname1.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname1.Visible = true;
                    break;

                case "2": lblTTRname2.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname2.Visible = true;
                    break;

                case "3": lblTTRname3.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname3.Visible = true;
                    break;

                case "4": lblTTRname4.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname4.Visible = true;
                    break;
                case "5": lblTTRname5.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname5.Visible = true;
                    break;

                case "6": lblTTRname6.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname6.Visible = true;
                    break;

                case "7": lblTTRname7.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname7.Visible = true;
                    break;

                case "8": lblTTRname8.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname8.Visible = true;
                    break;

                case "9": lblTTRname9.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname9.Visible = true;
                    break;

                case "10": lblTTRname10.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname10.Visible = true;
                    break;

                case "11": lblTTRname11.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname11.Visible = true;
                    break;

                case "12": lblTTRname12.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname12.Visible = true;
                    break;

                case "13": lblTTRname13.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname13.Visible = true;
                    break;

                case "14": lblTTRname14.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
                    lblTTRname14.Visible = true;
                    break;
                case "15": lblTTRname15.ToolTip = dt.Rows[0]["RemitterName"].ToString().Trim();
    ...
    public void AuditChecker(string _query1, string _NewValues, string _OldValues, string _userName, string _script, string _result, string _Status)
    {
        ...
        TF_DATA objSave = new TF_DATA();
        _query1 = "TF_Data_AuditTrailDocument";
        ...
        string at = objSave.SaveDeleteData(_query1, Branch, Mod, oldvalues, newvalues, Acno, DocumentNo, DocumnetDate, Mode, user, moddate, menu, TabName);
    }
}