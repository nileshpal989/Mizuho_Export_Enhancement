...
public partial class EXP_EXP_ViewRealisationEntry_PRN_Maker : System.Web.UI.Page
{
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (TableCell cell in e.Row.Cells)
            {
                ...
                if (rbtnForeign.Checked == true)
                    ...
                    Foreginlocal = "L";
                string pageurl = "window.location='EXP_AddEditFullRealisationPRN_Maker.aspx?mode=edit&DocNo=" + lblDocumentNo.Text.Trim()
                    + "&DocPrFx=" + txtDocPrFx.Value + "&BranchCode=" + hdnBranchCode.Value.Trim() + "&ForeignOrLocal=" + Foreginlocal + "&BranchName=" + ddlBranch.Text + "&SrNo=" + lblSrNo.Text.Trim() + "'";
                if (i != 10)
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (rbtnForeign.Checked == true)
            ...
            Foreginlocal = "L";
        //Response.Redirect("EXP_AddEditFullRealisationPRN_Maker.aspx?mode=add&DocPrFx=" + txtDocPrFx.Value + "&BranchCode=" + hdnBranchCode.Value.Trim() + "&BranchName=" + ddlBranch.Text + "&ForeignOrLocal=" + Foreginlocal + "&year=" + year, true);
    }
    ...
    protected void fillGrid()
    {
        ...
        string query = "TF_EXPGetRealisationEntryList_PendingPRN";
