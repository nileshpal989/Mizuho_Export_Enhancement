...
public partial class EXP_EXP_AddEditFullRealisationPRN_Checker : System.Web.UI.Page
{
    string branchcode = "";
    string DocPrFx = "";
    string SrNo = "";
            ...
            if (!IsPostBack)
            {
               ...
               // txtSwift.Attributes.Add("onblur", "return calTax();");
                ...
                if (Request.QueryString["Status"].ToString() == "Send To Checker")
                {
                    ...
                    string Result = obj.SaveDeleteData("TF_EXP_Realisation_SameTransIdCheckerAlert_PRN", p1, p2, p3);
                }
            }
            ddlApproveReject.Attributes.Add("onchange", "return DialogAlertRealisationPRN();");
        }
    }
    ...
    protected void fillDetails(string docno, string SrNo)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            string STATUSI = dt.Rows[0]["ApprovePRN"].ToString().Trim();
            string USERI = dt.Rows[0]["ApprovedPRNCheckBy"].ToString().Trim();
                         ...
                         <script type='text/javascript'>
                             ...
                             if (confirmation) {
                                executeCSharpCode();
                                 ...
                                 // Redirect to a page
                                 window.location.href = 'EXP_ViewRealisationEntry_PRN_Checker.aspx';
                             }
                         </script>
                     ";
            ...
            if (dt.Rows[0]["ApprovePRN"].ToString() == "A")
            {
    ...
    {
        Response.Redirect("EXP_ViewRealisationEntry_PRN_Checker.aspx", true);
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            CheckerStatus = dt.Rows[0]["ApprovePRN"].ToString();
        }
        ...
        else
        {
            ...
            string Result = obj.SaveDeleteData("TF_EXP_ChekerApproveRejectRealisation_PendingPRN", P_DocNo, P_Status, P_RejectReason, P_CheckedBy, P_SR_NO);
            Response.Redirect("EXP_ViewRealisationEntry_PRN_Checker.aspx?DocNo=" + Result.Substring(7) + "&AR=" + AR, true);
        }
    }
    ...
    private void TransferExportToEDPMS_PRN()
    {
        if (chkIRMCreate.Checked == true)
        {
            ...
            string Result = obj.SaveDeleteData("TF_EDPMS_DATA_TRANSFER_Approve_PRN_CreateIRM_PendingPRN", P_DocNo, P_SRNo);
        }
        else if (btnTTRefNoList.Checked == true)
        {
            ...
            SqlParameter P_DocNo = new SqlParameter("@Document_No", hdnDocNo.Value.Trim());
            SqlParameter P_SRNo = new SqlParameter("@SrNo", txtSrNo.Text);
            string Result = obj.SaveDeleteData("TF_EDPMS_DATA_TRANSFER_Approve_PRN_LnikIRM_PendingPRN", P_DocNo, P_SRNo);
        }
        else if (chkFirc.Checked == true)
        {
            ...
            SqlParameter P_DocNo = new SqlParameter("@Document_No", hdnDocNo.Value.Trim());
            SqlParameter P_SRNo = new SqlParameter("@SrNo", txtSrNo.Text);
            string Result = obj.SaveDeleteData("TF_EDPMS_DATA_TRANSFER_Approve_PRN_FIRC_PendingPRN", P_DocNo, P_SRNo);
        }
