<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_CommisionLookUp.aspx.cs"
    Inherits="EXP_EXP_CommisionLookUp" %>
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="false" Width="95%"
                                    ...
                                    <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Cust A/C No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="From Rs." HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblFromRs" runat="server" Text='<%# Eval("Slab1") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="To Rs." HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblFromToRs" runat="server" Text='<%# Eval("Slab2") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
