<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_AddEditApprovedLodgemetForROD_Maker.aspx.cs" Inherits="EXP_EXP_AddEditApprovedLodgemetForROD_Maker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../IMP/Scripts/TF_EXP_INW_REMMITENCE_CHECKER.js" type="text/javascript"></script>
    <style type="text/css">
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 25%;" valign="bottom">
                                    <span class="pageLabel" style="font-weight: bold">Approved Lodgement For ROD Details</span>
                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" style="padding-top: 10px; padding-bottom: 10px; white-space: nowrap">
                                                                ...
                                                                &nbsp;<asp:Button ID="btnLEI" runat="server" Text="Verify LEI" CssClass="buttonDefault"
                                                                    ToolTip="Verify LEI" TabIndex="132" OnClick="btnLEI_Click" Visible="true" Style="display: none;" />
                                                                &nbsp;<asp:Button ID="btnSaveDraft" runat="server" Text="Save & Draft" CssClass="buttonDefault"
                                                                    ToolTip="Save & Draft" TabIndex="133" CommandName="1" OnClick="btnSaveDraft_Click"
                                                                    CommandArgument="save" Style="display: none;" />
