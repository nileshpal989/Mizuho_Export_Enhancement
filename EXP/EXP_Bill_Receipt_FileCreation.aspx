<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_Bill_Receipt_FileCreation.aspx.cs"
    Inherits="EXP_EXP_Bill_Receipt_FileCreation" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>EXPORT Bill Receipt  CSV File Creation</strong></span>
                            </td>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                            <asp:RadioButton ID="rdbAllCustomer" runat="server" AutoPostBack="true" 
                                                ...
                                                Text="All Customers" Checked="true" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate"
                                             ...
                                             <asp:Button ID="btnDownload" runat="server" CssClass="buttonDefault" Text="Download"
                                                ToolTip="Download" TabIndex="8" onclick="btnDownload_Click"/>
