<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLEI_EOD_reports.aspx.cs"
    Inherits="EXP_rptLEI_EOD_reports" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function confirmmessage() {
            var message = confirm("Do you want to download EOD Report?")
            if (message == true) {
                    ...
                    <table cellspacing="2" cellpadding="2" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom" colspan="2">
                                <span class="pageLabel"><strong>LEI EOD Transaction Reports</strong></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" style="width: 100%" valign="top" colspan="2">
                                ...
                                <asp:HiddenField ID="hdnpathname" runat="server" />
                                <input type="hidden" id="hdnModuleIDLEI" runat="server" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="left" height="40px">
                                <asp:Button ID="btnCreate" runat="server" CssClass="buttonDefault" Text="Download Report"
                                    ToolTip="Download Report" TabIndex="7" OnClick="btnCreate_Click" />
