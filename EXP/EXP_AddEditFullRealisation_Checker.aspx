<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_AddEditFullRealisation_Checker.aspx.cs" Inherits="EXP_EXP_AddEditFullRealisation_Checker" %>
...
//        }
        ...
        function executeCSharpCode() {
            ...
            $.ajax({
                type: 'POST',
                url: 'EXP_AddEditFullRealisation_Checker.aspx/ExecuteCSharpCode',
                        ...
                        <table border="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <span class="pageLabel" style="font-weight: bold">Export Realisation Data Entry-Checker</span>
                                </td>
                                    ...
                                    <ContentTemplate>
                                       <table width="100%">
                                                        <tr>
                                                            ...
                                                            <asp:Panel runat="server" id="PnlApproveIdGO2">
                                                ...
                                                <ContentTemplate>
                                                  <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="left" width="60%">
                                                            <span class="elementLabel">Approve / Reject :</span>
                                                        <asp:DropDownList ID="ddlApproveReject1" runat="server" CssClass="dropdownList" TabIndex="35">
                                                            <asp:ListItem Value="" Text="-Select-"></asp:ListItem>
                                                            <asp:ListItem Value="1" Text="Approve"></asp:ListItem>
                                                            <asp:ListItem Value="2" Text="Reject"></asp:ListItem>
                                                        </asp:DropDownList>
