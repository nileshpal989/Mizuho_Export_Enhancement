<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewExportBillEntry.aspx.cs"
    Inherits="EXP_EXP_ViewExportBillEntry" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom">
                                <span class="pageLabel"><strong>Export Bill Entry View</strong></span>
                            </td>
                        ...
                        <tr align="right">
                            ...
                            <td align="left">
                                <asp:RadioButton ID="rbtnForeign" runat="server" CssClass="elementLabel" Text="Foreign"
                                    GroupName="FL" AutoPostBack="true" Checked="true" OnCheckedChanged="rbtnForeign_CheckedChanged" /><asp:RadioButton
                                        ID="rbtnLocal" runat="server" CssClass="elementLabel" Text="Local" GroupName="FL"
                        ...
                        <tr>
                            <td nowrap align="left" colspan="2">
                                ...
                                <asp:TextBox ID="txtDocumentNo" runat="server" CssClass="textBox" Style="width: 40px;"
                                    TabIndex="3" MaxLength="4"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" colspan="5">
                                ...
                                <asp:GridView ID="GridViewEXPbillEntry" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="49%" ItemStyle-Width="49%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Dispatch-Indicator" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="8%" ItemStyle-Width="5%">
                                            <ItemTemplate>
