<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_AddEditExportBillEntry_Checker.aspx.cs" Inherits="EXP_AddEditExportBillEntry_Checkar" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fbkcal() {
            ...
            if (txtfbkcharges.value == '') {
                ...
                //var staxper = $get("TabContainerMain_tbTransactionDetails_ddlServiceTaxfbk");

                ///var staxamtfbk = $get("TabContainerMain_tbTransactionDetails_txtSTaxAmountfbk");

                ///var sbcessfbkper = $get("TabContainerMain_tbTransactionDetails_txtsbcessfbk");

                /// var sbcessfbk = $get("TabContainerMain_tbTransactionDetails_txtSBcesssamtfbk");

                /// var kkcessfbkper = $get("TabContainerMain_tbTransactionDetails_txt_kkcessperfbk");

                ///var kkcessfbk = $get("TabContainerMain_tbTransactionDetails_txt_kkcessamtfbk");

                /// var totstaxfbk = $get("TabContainerMain_tbTransactionDetails_txtsttamtfbk");
                ...
                //                if (sbcessfbkper.value=='') {

                //                    sbcessfbkper.value = 0;
                //                    sbcessfbkper.value = parseFloat(sbcessfbkper.value).toFixed(2);
                //                    $get("TabContainerMain_tbTransactionDetails_txtsbcessfbk").value = sbcessfbkper.value;
                //                }

                //                if (kkcessfbkper.value == '') {

                //                    kkcessfbkper.value = 0;
                //                    kkcessfbkper.value = parseFloat(kkcessfbkper.value).toFixed(2);
                //                    $get("TabContainerMain_tbTransactionDetails_txt_kkcessperfbk").value = kkcessfbkper.value;
                //                }
                ...
                // staxamtfbk.value = parseFloat(fbkinr * ((staxper.value) / 100)).toFixed(2);
                //sbcessfbk.value = parseFloat(fbkinr * ((sbcessfbkper.value) / 100)).toFixed(2);
                // kkcessfbk.value = parseFloat(fbkinr * ((kkcessfbkper.value) / 100)).toFixed(2);
                ///totstaxfbk.value = parseFloat(parseFloat(fbkinr * ((staxper.value) / 100)) + parseFloat(fbkinr * ((sbcessfbkper.value) / 100)) + parseFloat(fbkinr * ((kkcessfbkper.value) / 100))).toFixed(2);

            }

        }

        function saveTTRefDetails(TTRefNo, TTAmt, hNo) {

            switch (hNo) {
                case "1":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo1").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount1").value = TTAmt;
                    break;
                case "2":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo2").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount2").value = TTAmt;
                    break;
                case "3":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo3").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount3").value = TTAmt;
                    break;
                case "4":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo4").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount4").value = TTAmt;
                    break;
                case "5":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo5").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount5").value = TTAmt;
                    break;
                case "6":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo6").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount6").value = TTAmt;
                    break;

                case "7":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo7").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount7").value = TTAmt;
                    break;

                case "8":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo8").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount8").value = TTAmt;
                    break;

                case "9":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo9").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount9").value = TTAmt;
                    break;

                case "10":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo10").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount10").value = TTAmt;
                    break;

                case "11":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo11").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount11").value = TTAmt;
                    break;

                case "12":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo12").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount12").value = TTAmt;
                    break;

                case "13":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo13").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount13").value = TTAmt;
                    break;

                case "14":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo14").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount14").value = TTAmt;
                    break;

                case "15":
                    $get("TabContainerMain_tbDocumentDetails_txtTTRefNo15").value = TTRefNo;
                    $get("TabContainerMain_tbDocumentDetails_txtTTAmount15").value = TTAmt;
                    break;
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateSave() {
            ...
            //  TT Amount Calcalution Amount

            var TTAmount1 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount1");
            var TTAmount2 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount2");
            var TTAmount3 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount3");
            var TTAmount4 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount4");
            var TTAmount5 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount5");
            var TTAmount6 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount6");
            var TTAmount7 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount7");
            var TTAmount8 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount8");
            var TTAmount9 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount9");
            var TTAmount10 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount10");
            var TTAmount11 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount11");
            var TTAmount12 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount12");
            var TTAmount13 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount13");
            var TTAmount14 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount14");
            var TTAmount15 = $get("TabContainerMain_tbDocumentDetails_txtTTAmount15");


            if (TTAmount1.value == '') {
                TTAmount1.value = 0;
                TTAmount1.value = parseFloat(TTAmount1.value).toFixed(2);
            }
            if (TTAmount2.value == '') {
                TTAmount2.value = 0;
                TTAmount2.value = parseFloat(TTAmount2.value).toFixed(2);
            }
            if (TTAmount3.value == '') {
                TTAmount3.value = 0;
                TTAmount3.value = parseFloat(TTAmount3.value).toFixed(2);
            }
            if (TTAmount4.value == '') {
                TTAmount4.value = 0;
                TTAmount4.value = parseFloat(TTAmount4.value).toFixed(2);
            }
            if (TTAmount5.value == '') {
                TTAmount5.value = 0;
                TTAmount5.value = parseFloat(TTAmount5.value).toFixed(2);
            }
            if (TTAmount6.value == '') {
                TTAmount6.value = 0;
                TTAmount6.value = parseFloat(TTAmount6.value).toFixed(2);
            }
            if (TTAmount7.value == '') {
                TTAmount7.value = 0;
                TTAmount7.value = parseFloat(TTAmount7.value).toFixed(2);
            }
            if (TTAmount8.value == '') {
                TTAmount8.value = 0;
                TTAmount8.value = parseFloat(TTAmount8.value).toFixed(2);
            }
            if (TTAmount9.value == '') {
                TTAmount9.value = 0;
                TTAmount9.value = parseFloat(TTAmount9.value).toFixed(2);
            }
            if (TTAmount10.value == '') {
                TTAmount10.value = 0;
                TTAmount10.value = parseFloat(TTAmount10.value).toFixed(2);
            }
            if (TTAmount11.value == '') {
                TTAmount11.value = 0;
                TTAmount11.value = parseFloat(TTAmount11.value).toFixed(2);
            }
            if (TTAmount12.value == '') {
                TTAmount12.value = 0;
                TTAmount12.value = parseFloat(TTAmount12.value).toFixed(2);
            }
            if (TTAmount13.value == '') {
                TTAmount13.value = 0;
                TTAmount13.value = parseFloat(TTAmount13.value).toFixed(2);
            }
            if (TTAmount14.value == '') {
                TTAmount14.value = 0;
                TTAmount14.value = parseFloat(TTAmount14.value).toFixed(2);
            }
            if (TTAmount15.value == '') {
                TTAmount15.value = 0;
                TTAmount15.value = parseFloat(TTAmount15.value).toFixed(2);
            }
            var _TTTotalAmt = 0;
            _TTTotalAmt = parseFloat(parseFloat(TTAmount1.value) + parseFloat(TTAmount2.value) + parseFloat(TTAmount3.value) + parseFloat(TTAmount4.value) + parseFloat(TTAmount5.value) + parseFloat(TTAmount6.value) + parseFloat(TTAmount7.value) + parseFloat(TTAmount8.value) + parseFloat(TTAmount9.value) + parseFloat(TTAmount10.value) + parseFloat(TTAmount11.value) + parseFloat(TTAmount12.value) + parseFloat(TTAmount13.value) + parseFloat(TTAmount14.value) + parseFloat(TTAmount15.value)).toFixed(2);

            var hdnTTTotalAmt = document.getElementById('hdnTTTotalAmt');
            hdnTTTotalAmt.value = _TTTotalAmt;
            ...
            if (Document_Type == 'EB') {
                if (parseFloat(_TTTotalAmt) > parseFloat(txtBillAmount.value)) {
                    alert('TT Amount is More Than Bill Amount');
    ...
    <script language="javascript" type="text/javascript">
        ...
        function radioButtonChanged() {
            ...
            if (rbtnAfterAWB.checked == true) {
                ...
                txtOtherTenorRemarks.value = 'Days D/A';
            }
        ...
        function ExecuteCSharpCodeLodg() {
            ...
            $.ajax({
                type: 'POST',
                url: 'EXP_AddEditExportBillEntry_Checker.aspx/ExecuteCSharpCodeLodg',
        ...
        <div>
            <center>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 25%;" valign="bottom">
                                    <span class="pageLabel" style="font-weight: bold">Export Bill Entry Details Checker</span>
                                </td>
                            ...
                            <tr>
                                <td align="right" style="width: 100%" valign="top" colspan="3">
                                    ...
                                    <%--<asp:Button ID="btnGridValues" Style="display: none;" runat="server" OnClick="btnGridValues_Click" /> commented for diasable click on grpp gridview --%>
                            ...
                            <tr>
                                <td align="left" colspan="2" style="white-space: nowrap">
                                    <span class="elementLabel">Doc Type :</span><asp:TextBox ID="txtDocType" Width="25px"
                                        runat="server" CssClass="textBox" Enabled="false" TabIndex="-1"></asp:TextBox>&nbsp;<asp:Label
                                ...
                                <td align="right" style="white-space: nowrap">
                                    <asp:Label ID="lblCopyFrom" runat="server" CssClass="elementLabel" Text="Copy From : "
                                        Width="70px" Visible="false"></asp:Label><asp:TextBox ID="txtCopyFromDocNo" Width="150px"
                                            runat="server" CssClass="textBox" TabIndex="115" Visible="false" MaxLength="18"></asp:TextBox><asp:Button
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <asp:TextBox ID="txtRBIDocType" Width="70px" runat="server" CssClass="textBox" Enabled="false"
                                            ...
                                            <ContentTemplate>
                                                <table cellpadding="0" cellspacing="2" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtCustAcNo" runat="server" AutoPostBack="True" CssClass="textBox"
                                                                MaxLength="14" OnTextChanged="txtCustAcNo_TextChanged" Enabled="false" onkeydown="OpenCustomerCodeList(this);"
                                                                TabIndex="1" Width="100px" ToolTip="Press F2 for help."></asp:TextBox>
                                                            <asp:Button ID="btnCustomerList" Enabled="false" runat="server" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDateRcvd" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td nowrap colspan="5">
                                                            <asp:TextBox ID="txtOverseasPartyID" runat="server" Enabled="false" AutoPostBack="True" CssClass="textBox"
                                                            ...
                                                            <asp:Button ID="btnOverseasPartyList" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtENCdate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                            ...
                                                            <asp:Button ID="Button9" runat="server" Enabled="false" CssClass="btncalendar_enabled" TabIndex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td nowrap colspan="4">
                                                            <asp:TextBox ID="txtconsigneePartyID" runat="server" Enabled="false" AutoPostBack="True" CssClass="textBox"
                                                            ...
                                                            <asp:Button ID="btnConsigneePartyList" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDateNegotiated" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                            ...
                                                            <asp:Button ID="Button10" runat="server" Enabled="false" CssClass="btncalendar_enabled" TabIndex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td nowrap colspan="4">
                                                            <asp:TextBox ID="txtOverseasBankID" runat="server" Enabled="false" AutoPostBack="True" CssClass="textBox"
                                                            ...
                                                            <asp:Button ID="btnOverseasBankList" Enabled="false" runat="server" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                        ...
                                                        <tr>
                                                            <tr>
                                                                ...
                                                                <td width="10%" colspan="2" nowrap>
                                                                    <asp:RadioButton ID="rdbOurADCode" CssClass="elementLabel" GroupName="ADCODE" runat="server"
                                                                        AutoPostBack="true" Enabled="false" OnCheckedChanged="onourADCode" />
                                                                    <span class="elementLabel">Our AdCode</span>
                                                                    <asp:RadioButton ID="rdbotherAdcode" Enabled="false" CssClass="elementLabel" GroupName="ADCODE" runat="server"
                                                            ...
                                                            <tr runat="server" visible="false" id="ADCode">
                                                                ...
                                                                <td width="10%" nowrap>
                                                                    <asp:TextBox ID="txtADCode" runat="server" Enabled="false" CssClass="textBox" Width="90px" MaxLength="10"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right" width="15%">
                                                                ...
                                                                <td width="5%">
                                                                    <asp:TextBox ID="txtLCNo" Width="100px" Enabled="false" runat="server" CssClass="textBox" TabIndex="7"
                                                                ...
                                                                <td width="5%" nowrap>
                                                                    <asp:TextBox ID="txtLCNoDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                                    ...
                                                                    <asp:Button ID="btnDTDraftDoc" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td nowrap colspan="2">
                                                                    <asp:TextBox ID="txtLCNoIssuedBy" Width="180px" runat="server" Enabled="false" CssClass="textBox"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="5%">
                                                                    <asp:TextBox ID="txtBENo" Width="100px" runat="server" Enabled="false" CssClass="textBox" TabIndex="10"
                                                                ...
                                                                <td nowrap>
                                                                    <asp:TextBox ID="txtBEDate" runat="server" CssClass="textBox" Enabled="false" MaxLength="10" ValidationGroup="dtVal"
                                                                    ...
                                                                    <asp:Button ID="Button2" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td nowrap colspan="2" align="right">
                                                                    <asp:CheckBox ID="chkBankLineTransfer" runat="server" Enabled="false" Text="Bank Line Transfer (Accp Date)"
                                                                        CssClass="elementLabel" TabIndex="12" />
                                                                    <%--<span class="elementLabel">(Accp Date) :</span>--%>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtAccpDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                                    ...
                                                                    <asp:Button ID="Button3" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtBENoDoc" Width="50px" Enabled="false" runat="server" CssClass="textBox" TabIndex="14"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtBENoDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="14"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td nowrap>
                                                                    <asp:TextBox ID="txtInvoiceNo" Width="100px" runat="server" Enabled="false" CssClass="textBox" TabIndex="14"
                                                                        MaxLength="100"></asp:TextBox>
                                                                </td>
                                                                <td align="right" nowrap>
                                                                    <span class="elementLabel">Dated :</span>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtInvoiceDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                    ...
                                                                    <asp:Button ID="btnDTInvoice" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td colspan="2" align="left">
                                                                    <asp:DropDownList ID="ddlDispachInd" runat="server" Enabled="false" CssClass="dropdownList" TabIndex="15"
                                                            ...
                                                            <asp:ListItem Value="Sent to drawee">Sent to drawee</asp:ListItem>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlDispBydefault" runat="server" Enabled="false" CssClass="dropdownList" TabIndex="15"
                                                                        Width="100px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtInvoiceDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="16"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtInvoiceDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="16"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtAWBno" Width="100px" runat="server" Enabled="false" CssClass="textBox" TabIndex="17"
                                                                        MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td align="right">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtAWBDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                                ...
                                                                <td nowrap colspan="2">
                                                                    <asp:TextBox ID="txtAwbIssuedBy" Width="180px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="19" MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtAWBDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="20"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtAWBDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="20"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtPackingList" Width="100px" runat="server" Enabled="false" CssClass="textBox"
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtPackingListDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                    ...
                                                                    <asp:Button ID="btnDTPackingList" runat="server" Enabled="false" Visible="False" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td colspan="3"></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPackingDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="23"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtPackingDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="23"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCertOfOrigin" Width="100px" runat="server" Enabled="false" CssClass="textBox"
                                                                ...
                                                                <td nowrap colspan="2">
                                                                    <asp:TextBox ID="txtCertIssuedBy" Width="180px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="25" MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtCertOfOriginDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="26" MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtCertOfOriginDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox"
                                                            TabIndex="26" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCustomsInvoice" Width="100px" runat="server" Enabled="false" CssClass="textBox"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Button ID="Button4" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td align="right" style="white-space: nowrap">
                                                                    <span class="mandatoryField">* </span><span class="elementLabel">RBI Commodity ID :</span>
                                                                </td>
                                                                <td colspan="2" align="left" style="white-space: nowrap">
                                                                    <asp:TextBox ID="txtCommodityID" Width="25px" runat="server" Enabled="false" CssClass="textBox" TabIndex="29"
                                                                        MaxLength="3" AutoPostBack="True" OnTextChanged="txtCommodityID_TextChanged" />
                                                                    <asp:Button ID="btnCommodityList" TabIndex="-1" CssClass="btnHelp_enabled" Enabled="false" runat="server" />
                                                                    <asp:Label ID="lblCommodityDescription" Width="150px" Enabled="false" runat="server" CssClass="elementLabel" />
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtCustomsDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="30"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtCustomsDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="30"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right" style="white-space: nowrap" colspan="5">
                                                                    <span class="mandatoryField">* </span><span class="elementLabel">GBase Commodity ID
                                                            :</span>
                                                                </td>
                                                                <td colspan="2" align="left" style="white-space: nowrap">
                                                                    <asp:TextBox ID="txtGBaseCommodityID" Width="25px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="30" MaxLength="3" AutoPostBack="True" OnTextChanged="txtGBaseCommodityID_TextChanged" />
                                                                    <asp:Button ID="btnGBaseCommodityList" TabIndex="-1" CssClass="btnHelp_enabled" Enabled="false" runat="server" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtInsPolicy" Width="100px" runat="server" Enabled="false" CssClass="textBox" TabIndex="31"
                                                                        MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td align="right">
                                                                    <span class="elementLabel">Dated :</span>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtInsPolicyDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                    ...
                                                                    <asp:Button ID="btnDTInsPolicy" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td nowrap colspan="2">
                                                                    <asp:TextBox ID="txtInsPolicyIssuedBy" Width="180px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="33" MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtInsPolicyDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="34" MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtInsPolicyDoc1" Width="50px" runat="server" Enabled="false" CssClass="textBox"
                                                            TabIndex="34" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtGSPDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                                    ...
                                                                    <asp:Button ID="Button5" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td nowrap width="10%">
                                                                    <asp:TextBox ID="txtContractNo" Width="90px" runat="server" Enabled="false" CssClass="textBox" TabIndex="36"
                                                                        MaxLength="50"></asp:TextBox>
                                                                    &nbsp;&nbsp;<span class="elementLabel">Rate :</span>
                                                                </td>
                                                                <td nowrap align="left">
                                                                    <asp:TextBox ID="txtRate" Width="45px" runat="server" Enabled="false" CssClass="textBox" TabIndex="37"
                                                                        MaxLength="15"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtGSPDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="38"
                                                                        MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtFIRCno" Width="100px" Enabled="false" runat="server" CssClass="textBox" TabIndex="39"
                                                                        MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td align="right">
                                                                    <span class="elementLabel">Dated :</span>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtFIRCdate" runat="server" CssClass="textBox" Enabled="false" MaxLength="10" ValidationGroup="dtVal"
                                                                    ...
                                                                    <asp:Button ID="Button6" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td nowrap colspan="2">
                                                                    <asp:TextBox ID="txtFIRCnoIssuedBy" Width="180px" runat="server" Enabled="false" CssClass="textBox"
                                                                        TabIndex="41" MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtFIRCdoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                                        MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <%--New Fields--%>
                                                    ...
                                                    <td align="left" colspan="3">
                                                        <asp:DropDownList ID="ddlMercTrade" runat="server" TabIndex="91" CssClass="dropdownList">
                                                            ...
                                                            <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtINSP" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtINSP1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtWM" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtWM1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtOther" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                                        MaxLength="5"></asp:TextBox>
                                                                    &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtOther1" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="42"
                                                            MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="left" colspan="3">
                                                                    <asp:DropDownList ID="ddlMercTrade" runat="server" Enabled="false" TabIndex="91" CssClass="dropdownList">
                                                                        <asp:ListItem Value="0">Select</asp:ListItem>
                                                                        <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <asp:TextBox ID="txtMiscellaneous" Width="250px" runat="server" Enabled="false" CssClass="textBox"
                                                                ...
                                                                <td colspan="2">
                                                                    <asp:RadioButton ID="rdbByAir" Text="By Air" CssClass="elementLabel" runat="server" Enabled="false"
                                                                        GroupName="Shipment" Checked="True" TabIndex="44" />
                                                                    <asp:RadioButton ID="rdbBySea" Text="By Sea" CssClass="elementLabel" runat="server" Enabled="false"
                                                                        GroupName="Shipment" TabIndex="44" />
                                                                    <asp:RadioButton ID="rdbByRoad" Text="By Road" CssClass="elementLabel" runat="server" Enabled="false"
                                                                        GroupName="Shipment" TabIndex="44" />
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtMiscDoc" Width="50px" runat="server" Enabled="false" CssClass="textBox" TabIndex="45"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td nowrap>
                                                                    <asp:TextBox ID="txtCoveringTo" runat="server" Enabled="false" CssClass="textBox" MaxLength="20"
                                                                ...
                                                                <td align="left" nowrap>
                                                                    <asp:TextBox ID="txtCountry" runat="server" Enabled="false" CssClass="textBox" MaxLength="2" TabIndex="48"
                                                                        Width="30px" AutoPostBack="True" OnTextChanged="txtCountry_TextChanged"></asp:TextBox>
                                                                    <asp:Button ID="btnCountryList" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtReimbValDate" Enabled="false" runat="server" CssClass="textBox" MaxLength="10"
                                                                    ...
                                                                    <asp:Button ID="Button7" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtReimbClaimDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                    ...
                                                                    <asp:Button ID="Button8" runat="server" Visible="False" Enabled="false" CssClass="btncalendar_enabled"
                                                                        TabIndex="-1" />
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtBkName" Width="100px" Enabled="false" runat="server" CssClass="textBox" TabIndex="51"
                                                                        MaxLength="50"></asp:TextBox>
                                                                </td>
                                                                <td align="right">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtBIC" Width="120px" runat="server" Enabled="false" CssClass="textBox" TabIndex="52"
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtReimbAmt" Width="70px" runat="server" Enabled="false" CssClass="textBox" TabIndex="53"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <asp:TextBox ID="txtNotes" Width="300px" Enabled="false" runat="server" CssClass="textBox" TabIndex="55"
                                                                        MaxLength="100"></asp:TextBox>
                                                                </td>
                                                                <td></td>
                                                                <td colspan="3">
                                            ...
                                            <ContentTemplate>
                                                <table cellspacing="1" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="5%" nowrap>
                                                            <asp:DropDownList ID="ddlCurrency" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57"
                                                                AutoPostBack="true" OnSelectedIndexChanged="ddlCurrency_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td nowrap width="10%">
                                                            <asp:CheckBox ID="chkLoanAdv" runat="server" Enabled="false" CssClass="elementLabel" Text="Loan Advanced"
                                                                TabIndex="58" />
                                                        </td>
                                                        ...
                                                        <td nowrap width="5%">
                                                            <asp:DropDownList ID="ddlOtherCurrency" runat="server" Enabled="false" CssClass="dropdownList" TabIndex="59">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td align="left" nowrap width="5%">
                                                            <span class="elementLabel">Exch Rt :</span><asp:TextBox ID="txtExchRate" runat="server" Enabled="false"
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtNoOfDays" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="25px" TabIndex="61" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td colspan="2">
                                                            <asp:RadioButton ID="rbtnEBR" runat="server" Enabled="false" CssClass="elementLabel" GroupName="EbrBdr"
                                                                TabIndex="61" Text="EBR" />&nbsp;<asp:RadioButton ID="rbtnBDR" Enabled="false" runat="server" CssClass="elementLabel"
                                                                    GroupName="EbrBdr" TabIndex="61" Text="BDR" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="10">
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="white-space: nowrap">
                                                            <asp:RadioButton ID="rbtnAfterAWB" runat="server" Enabled="false" CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="After
				AWB/BL Date" />
                                                            &nbsp;<asp:RadioButton ID="rbtnFromAWB" runat="server" Enabled="false" CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="From AWB/BL Date" />
                                                            &nbsp;<asp:RadioButton ID="rbtnSight" runat="server" Enabled="false" CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="xx Days Sight" />
                                                            &nbsp;<asp:RadioButton ID="rbtnDA" runat="server" Enabled="false" CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="from draft/BOE date" />
                                                            &nbsp;<asp:RadioButton ID="rbtnFromInvoice" runat="server" Enabled="false" CssClass="elementLabel"
                                                                GroupName="InterestDays" TabIndex="62" Text="From Invoice Date" />
                                                            &nbsp;<asp:RadioButton ID="rbtnOthers" runat="server" Enabled="false" CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="Others" />
                                                            &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtOtherTenorRemarks" Enabled="false" runat="server" CssClass="textBox" Width="200px"
                                                            TabIndex="62" onfocus="this.select()" MaxLength="31"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"></td>
                                                        ...
                                                        <td width="5%">
                                                            <asp:TextBox ID="txtLibor" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="60px" TabIndex="63" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap width="5%">
                                                            <span class="elementLabel">Out of Days :</span>
                                                        </td>
                                                        <td align="left" nowrap>
                                                            <asp:TextBox ID="txtOutOfDays" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                        </td>
                                                        <td align="left" nowrap>
                                                            <span class="elementLabel">Due Date </span>
                                                        </td>
                                                        <td align="left" nowrap>
                                                            <asp:TextBox ID="txtDueDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10" ValidationGroup="dtVal"
                                                                Width="70px" TabIndex="65"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4" rowspan="9">
                                                            <table width="100%" border="1" cellpadding="1">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate1" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate1" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate1" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64" onblur="CalculateNoOfDays('1','2');"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays1" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate2" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate2" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate2" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays2" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate3" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate3" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate3" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays3" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate4" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate4" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate4" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays4" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate5" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate5" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate5" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays5" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntRate6" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="60px" TabIndex="64" onfocus="this.select()" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate6" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate6" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtForDays6" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                            Width="30px" TabIndex="64" onfocus="this.select()" MaxLength="4"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBillAmount" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="70" onfocus="this.select()" MaxLength="20" OnTextChanged="txtBillAmount_TextChanged"
                                                                AutoPostBack="True"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtBillAmountinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="71" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiatedAmt" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="73" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiatedAmtinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="74" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtInterest" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="75" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtInterestinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="76" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNetAmt" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="77" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtNetAmtinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtExchRtEBR" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="15" OnTextChanged="txtExchRtEBR_TextChanged"
                                                                AutoPostBack="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txt_fbkcharges" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_fbkchargesinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtOtherChrgs" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="79" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtBankCert" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="80" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiationFees" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="81" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtCourierChrgs" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="82" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtMarginAmt" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="83" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCommissionID" runat="server" Enabled="false" CssClass="textBox" Width="20px"
                                                                TabIndex="84" onfocus="this.select()" MaxLength="2"></asp:TextBox><asp:Button ID="btnCommissionList"
                                                                    runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" OnClientClick="return OpenCommissionList();" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtCommission" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="84" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap colspan="2">
                                                            <span class="elementLabel">Accepted Due Date :</span>
                                                            <asp:TextBox ID="txtAcceptedDueDate" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                ValidationGroup="dtVal" Width="80px" TabIndex="72"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlServiceTax" runat="server" Enabled="false" CssClass="dropdownList" Width="60px"
                                                                TabIndex="85">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtSTaxAmount" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="86" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" colspan="2">
                                                            <span class="elementLabel">SBCess (%) :</span>
                                                            <asp:TextBox ID="txtsbcess" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>
                                                            <asp:TextBox ID="txtSBcesssamt" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="80px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="center" colspan="2">
                                                            <span class="elementLabel">KKCess (%) :</span>
                                                            <asp:TextBox ID="txt_kkcessper" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>&nbsp;
                                                        <asp:TextBox ID="txt_kkcessamt" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="80px"
                                                            Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtsttamt" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="100px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chkApplicable" runat="server" Enabled="false" CssClass="elementLabel" OnCheckedChanged="chkApplicable_CheckedChanged"
                                                                Text="Yes/No" AutoPostBack="True" TabIndex="87" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtSTFXDLS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="88" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <span class="elementLabel">SBCess on FxDls :</span>
                                                        </td>
                                                        <td align="left" width="10%">
                                                            <asp:TextBox ID="txtsbfx" runat="server" Enabled="false" CssClass="textBox" Width="80px" Style="text-align: right"
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_kkcessonfx" runat="server" Enabled="false" CssClass="textBox" Width="80px" Style="text-align: right"
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txttotsbcess" runat="server" Enabled="false" CssClass="textBox" Width="100px" Style="text-align: right"
                                                    ...
                                                    <tr runat="server" visible="False" b>
                                                        ...
                                                        <td runat="server">
                                                            <asp:DropDownList ID="ddlServiceTaxfbk" Enabled="false" runat="server" CssClass="dropdownList" Width="60px"
                                                                TabIndex="85">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:TextBox ID="txtSTaxAmountfbk" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="86" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" colspan="2" runat="server">
                                                            <span class="elementLabel">SBCess on FBK (%) :</span>
                                                            <asp:TextBox ID="txtsbcessfbk" runat="server" CssClass="textBox" Enabled="false" TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>
                                                            <asp:TextBox ID="txtSBcesssamtfbk" runat="server" CssClass="textBox" Enabled="false" TabIndex="86"
                                                        ...
                                                        <td align="left" colspan="2" nowrap="nowrap" runat="server">
                                                            ...
                                                            <asp:TextBox ID="txt_kkcessperfbk" runat="server" Enabled="false" CssClass="textBox" TabIndex="86"
                                                                Width="40px" Style="text-align: right; font-weight: bold"></asp:TextBox>&nbsp;
                                                        <asp:TextBox ID="txt_kkcessamtfbk" runat="server" Enabled="false" CssClass="textBox" TabIndex="86"
                                                            Width="80px" Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap="nowrap" runat="server">
                                                        ...
                                                        <td align="left" runat="server">
                                                            <asp:TextBox ID="txtsttamtfbk" runat="server" Enabled="false" CssClass="textBox" TabIndex="86" Width="100px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td runat="server"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCurrentAcinRS" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="91" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>&nbsp;
                                                        <asp:CheckBox ID="chkRBI" runat="server" Enabled="false" CssClass="elementLabel" Text="RBI A/C" TextAlign="Left"
                                                            TabIndex="92" Visible="False" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                            ...
                                                            <asp:Button runat="server" Text="E-Firc Reference No." CssClass="buttonDefault" Height="20px"
                                                                TabIndex="54" Width="150px" ID="btnFircRefNoList"></asp:Button>
                                                                        </td>
                                                                        <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            ...
                                                                                            <ajaxToolkit:CollapsiblePanelExtender ID="cpe2" runat="Server" TargetControlID="panelSecondAdd"
                                                                                                CollapsedSize="0" ExpandedSize="45" Collapsed="false" ExpandControlID="btnTTRefNoList"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <table cellspacing="0" border="0" width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo1" runat="server" TabIndex="-1" CssClass="textBox" Width="150px" Enabled="false"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef1" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount1" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr1" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate1" AutoPostBack="true" Enabled="false" runat="server" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised1" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo2" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef2" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount2" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr2" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate2" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised2" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo3" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount3" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr3" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate3" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised3" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo4" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef4" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount4" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr4" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate4" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised4" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo5" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef5" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount5" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr5" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate5" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised5" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo6" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef6" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount6" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr6" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate6" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised6" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo7" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef7" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount7" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr7" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate7" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised7" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo8" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef8" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount8" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr8" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate8" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised8" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo9" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef9" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount9" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr9" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate9" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised9" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo10" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef10" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount10" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr10" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate10" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised10" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo11" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef11" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount11" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr11" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate11" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised11" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo12" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef12" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount12" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr12" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate12" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised12" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo13" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef13" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount13" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr13" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate13" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised13" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo14" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef14" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount14" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr14" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate14" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised14" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo15" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef15" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount15" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTRealisedCurr15" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate15" runat="server" Enabled="false" AutoPostBack="true" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised15" runat="server" Enabled="false" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <ajaxToolkit:CollapsiblePanelExtender ID="Cpe3" runat="Server" TargetControlID="panelSecondAdd1"
                                                                                                    CollapsedSize="0" ExpandedSize="43" Collapsed="false" ExpandControlID="btnFircRefNoList"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <table cellspacing="0" border="0" width="100%">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo1_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate1_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency1_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount1_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr1_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate1_OB" Enabled="false" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB1_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode1_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo2_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate2_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency2_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount2_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr2_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate2_OB" runat="server" Enabled="false" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB2_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode2_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo3_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate3_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency3_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount3_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr3_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate3_OB" runat="server" Enabled="false" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB3_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode3_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo4_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate4_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency4_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount4_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr4_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate4_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB4_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>

                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode4_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo5_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate5_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency5_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount5_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr5_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate5_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB5_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>

                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode5_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo6_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate6_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency6_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount6_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr6_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate6_OB" runat="server" Enabled="false" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB6_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode6_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo7_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate7_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency7_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount7_OB" AutoPostBack="true" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr7_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate7_OB" runat="server" Enabled="false" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB7_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode7_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo8_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate8_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency8_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount8_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr8_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate8_OB" runat="server" Enabled="false" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB8_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode8_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo9_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox" Width="150px"
                                                                                                                                MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate9_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency9_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount9_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr9_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate9_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB9_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode9_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo10_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate10_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency10_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount10_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr10_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate10_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB10_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode10_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo11_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate11_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency11_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount11_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr11_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate11_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB11_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode11_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo12_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate12_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency12_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount12_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr12_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate12_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB12_OB" Enabled="false" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode12_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo13_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate13_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency13_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount13_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr13_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate13_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB13_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode13_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo14_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate14_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency14_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount14_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr14_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate14_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB14_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode14_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td nowrap align="left">
                                                                                                                            <asp:TextBox ID="txtFIRCNo15_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                Width="150px" MaxLength="35"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCDate15_OB" runat="server" Enabled="false" CssClass="textBox" MaxLength="10"
                                                                                                                                ValidationGroup="dtVal" Width="70px" TabIndex="55"></asp:TextBox>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCurrency15_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCAmount15_OB" AutoPostBack="true" runat="server" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCRealisedCurr15_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCCrossCurrRate15_OB" runat="server" AutoPostBack="true" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px" Enabled="false"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCTobeAdjustedinSB15_OB" runat="server" Enabled="false" TabIndex="55" CssClass="textBox"
                                                                                                                                MaxLength="20" Width="100px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="txtFIRCADCode15_OB" runat="server" TabIndex="55" Enabled="false" CssClass="textBox"
                                                                                                                                MaxLength="15" Width="150px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" colspan="5">
                                                            <asp:Button ID="btn_Trans_Prev" runat="server" Text="<< Prev" CssClass="buttonDefault"
                                                                ToolTip="Back to Document Details" TabIndex="106" OnClientClick="return OnDocNextClick(0);" />&nbsp;&nbsp;&nbsp;
                                                        <asp:Button ID="btn_Trans_Next" runat="server" Text=">> Next" CssClass="buttonDefault"
                                                            ToolTip="Go to G-Base Details" TabIndex="106" OnClientClick="return OnDocNextClick(2);" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ContentTemplate>
                                        ...
                                        <ajaxToolkit:TabPanel ID="tbGBaseDetails" runat="server" HeaderText="G-Base Details"
                                            ...
                                            <ContentTemplate>
                                                <table cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:TextBox ID="txtOperationType" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:TextBox ID="txtSettlementOption" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                                Width="20px" TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtRiskCountry" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:RadioButton ID="rdbShipper" runat="server" Enabled="false" CssClass="elementLabel" Text="Shipper"
                                                                AutoPostBack="true" GroupName="grpPayer" Checked="true" />
                                                            <asp:RadioButton ID="rdbBuyer" runat="server" Enabled="false" CssClass="elementLabel" Text="Buyer"
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:TextBox ID="txtFundType" runat="server" Enabled="false" Width="20px" TabIndex="91" CssClass="textBox"
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:TextBox ID="txtBaseRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                                Width="20px" TabIndex="91" onfocus="this.select()" MaxLength="2"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtGradeCode" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                        ...
                                                        <td align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtDirection" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                                Width="20px" TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtCovrInstr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center"
                                                                Width="20px" TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap">
                                                            <asp:TextBox ID="txtInternalRate" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtSpread" runat="server" Enabled="false" CssClass="textBox" Style="text-align: right"
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtApplNo" runat="server" Enabled="false" CssClass="textBox" Width="100px" TabIndex="91"
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:DropDownList ID="ddlRemEUC" runat="server" Enabled="false" TabIndex="91" CssClass="dropdownList">
                                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                                        ...
                                                        <td align="left" style="white-space: nowrap" colspan="5">
                                                            <asp:TextBox ID="txtDraftNo" runat="server" Enabled="false" CssClass="textBox" Style="width: 150px; vertical-align: middle"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="3">
                                                            <asp:TextBox ID="txtRiskCustomer" runat="server" Enabled="false" CssClass="textBox" Width="150px"
                                                        ...
                                                        <td align="left" style="white-space: nowrap" colspan="3">
                                                            <asp:TextBox ID="txtVesselName" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle"
                                                        ...
                                                        <td align="left" style="white-space: nowrap" colspan="3">
                                                            <asp:DropDownList ID="ddlInstructions" runat="server" Enabled="false" CssClass="dropdownList" TabIndex="91">
                                                                <asp:ListItem Value="">Select</asp:ListItem>
                                                        ...
                                                        <td style="text-align: left; white-space: nowrap" colspan="5">
                                                            <asp:TextBox ID="txtReimbBank" runat="server" Enabled="false" AutoPostBack="True" CssClass="textBox"
                                                            ...
                                                            <asp:Button ID="btnReimbBank" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4">
                                                            <asp:TextBox ID="txtGBaseRemarks" runat="server" Enabled="false" CssClass="textBox" Width="300px"
                                                        ...
                                                        <td align="left" colspan="7">
                                                            <asp:TextBox ID="txtMerchandise" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="17">
                                                            <asp:TextBox ID="txtPayingBankID" runat="server" Enabled="false" AutoPostBack="True" CssClass="textBox"
                                                            ...
                                                            <asp:Button ID="btnPayingBankList" runat="server" Enabled="false" CssClass="btnHelp_enabled" TabIndex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                    ...
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions3" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions4" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions5" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions6" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions7" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions8" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions9" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right"></td>
                                                        <td colspan="17" align="left" style="white-space: nowrap">
                                                            <asp:TextBox ID="txtSpecialInstructions10" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle;"
                                                                Width="800px" TabIndex="91" onfocus="this.select()" MaxLength="77"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table width="100%" cellspacing="1" cellpadding="2" border="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtPrincipalContractNo1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtPrincipalContractNo2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtPrincipalExchCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtPrincipalExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtPrincipalIntExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtInterestLump" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtInterestContractNo1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtInterestContractNo2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtInterestExchCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtInterestExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtInterestIntExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCommissionMatu" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <span class="elementLabel">X</span>
                                                        ...
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtCommissionContractNo1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtCommissionContractNo2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtCommissionExchCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtCommissionExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtCommissionIntExchRate" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table width="100%" cellspacing="1" cellpadding="2" border="1">
                                                    ...
                                                    <tr>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRGLCode" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtCRCustAbbr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtCRCustAbbr_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtCRCustAcNo1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtCRCustAcNo2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <span class="elementLabel">X</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRIntCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRIntAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <asp:TextBox ID="txtCRIntPayer" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRPaymentCommCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRPaymentCommAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <asp:TextBox ID="txtCRPaymentCommPayer" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRHandlingCommCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRHandlingCommAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <asp:TextBox ID="txtCRHandlingCommPayer" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRPostageCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRPostageAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <asp:TextBox ID="txtCRPostagePayer" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtCRCurr1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtCRAmount1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center">
                                                            <asp:TextBox ID="txtCRPayer1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="1"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; text-align: left" colspan="2"></td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRGLCode1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtDRCustAbbr1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtDRCustAbbr1_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtDRCustAcNo11" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtDRCustAcNo12" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount1" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center"></td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRGLCode2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtDRCustAbbr2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtDRCustAbbr2_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtDRCustAcNo21" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtDRCustAcNo22" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount2" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center"></td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRGLCode3" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtDRCustAbbr3" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtDRCustAbbr3_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtDRCustAcNo31" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtDRCustAcNo32" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr3" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount3" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center"></td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRGLCode4" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtDRCustAbbr4" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtDRCustAbbr4_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtDRCustAcNo41" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtDRCustAcNo42" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr4" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount4" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center"></td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRGLCode5" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 50px"
                                                                TabIndex="91" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center; vertical-align: middle">
                                                            <asp:TextBox ID="txtDRCustAbbr5" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: left; width: 120px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="12"
                                                                AutoPostBack="true" OnTextChanged="txtDRCustAbbr5_TextChanged"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 20%; text-align: center">
                                                            <asp:TextBox ID="txtDRCustAcNo51" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                            &nbsp;
                                                        <asp:TextBox ID="txtDRCustAcNo52" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 80px"
                                                            TabIndex="91" onfocus="this.select()" MaxLength="6"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 10%; text-align: center">
                                                            <asp:TextBox ID="txtDRCurr5" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: center; width: 40px"
                                                                TabIndex="91" onfocus="this.select()" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 25%; text-align: center">
                                                            <asp:TextBox ID="txtDRAmount5" runat="server" Enabled="false" CssClass="textBox" Style="vertical-align: middle; text-align: right; width: 120px"
                                                                TabIndex="91" onfocus="this.select()"></asp:TextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; width: 5%; text-align: center"></td>
                                                    </tr>
                                                ...
                                                <table cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td width="2%" valign="top">
                                                            <asp:CheckBox ID="chk1" runat="server" CssClass="elementLabel" Enabled="false" TabIndex="89" />
                                                        </td>
                                                        <td>
				...
				above bill (s) is / are drawn under Letter of Credit No. _______________dated __________"></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk2" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="90" />
                                                        </td>
                                                        <td>
				...
				with."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk3" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="91" />
                                                        </td>
                                                        <td>
				...
				the below noted discrepancy(ies)."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk4" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="92" />
                                                        </td>
                                                        <td>
				...
				deliver documents against payment."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk5" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="93" />
                                                        </td>
                                                        <td>
				...
				of the bill."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk6" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="94" />
                                                        </td>
                                                        <td>
				...
				our IBA Account under advice to us held with , "></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk7" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="95" />
                                                        </td>
                                                        <td>
				...
				per terms of credit we have claimed reimbursement on _________________"></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk7A" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="96" />
                                                        </td>
                                                        <td>
				...
				maturity."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk7B" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="97" />
                                                        </td>
                                                        <td>
				...
				us to claim reimbursement on ____________ from _______."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk8" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="98" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk9" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="99" />
                                                        </td>
                                                        <td>
				...
				CHARGES."
                                                    ...
                                                    <tr>
                                                        <td width="5%" valign="top">
                                                            <asp:CheckBox ID="chk11" runat="server" Enabled="false" CssClass="elementLabel" TabIndex="54" />
                                                        </td>
                                                        <td>
				...
				copy."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk12" runat="server" CssClass="elementLabel" Enabled="false" TabIndex="55" />
                                                        </td>
                                                        <td>
				...
				acceptance/payment of equivalent bill amount plus all other charges."></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <asp:CheckBox ID="chk13" runat="server" CssClass="elementLabel" Enabled="false" TabIndex="59" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right" colspan="1">
                                                            ...
                                                            <asp:CheckBox ID="chkManualGR" runat="server" CssClass="elementLabel" TabIndex="102"
                                                                onclick="ChangeManualGRText();" Enabled="false"/>
                                                        ...
                                                        <td style="text-align: left;" colspan="1">
                                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="elementLabel" style="color: Black; font-weight: bold">No of Shipping Bills :</span>
                                                            <asp:TextBox ID="txtNoOfSB" runat="server" CssClass="textBox" TabIndex="102" Width="30px" MaxLength="3" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" style="padding-top: 10px; padding-bottom: 10px; white-space: nowrap">
                                                            ...
                                                            &nbsp;<asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="buttonDefault"
                                                                ToolTip="Cancel" OnClick="btnCancel_Click" TabIndex="135" />
                                                            ...
                                                            &nbsp;<asp:Button ID="btnSave" runat="server" Text="Send To Checker" CssClass="buttonDefault"
                                                                ToolTip="Save" OnClick="btnSave_Click" TabIndex="132" CommandName="1" CommandArgument="save" Style="visibility: hidden" />
                                                            &nbsp;<asp:Button ID="btnSavePrint" runat="server" Text="Save & Print" CssClass="buttonDefault"
                                                                ToolTip="Save & Print Export Bill lodgement Advice" OnClick="btnSave_Click" TabIndex="134"
                                                                CommandName="2" CommandArgument="print" Style="visibility: hidden" />
                                                            ...
                                                            <asp:GridView ID="GridViewGRPPCustomsDetails" runat="server" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Cust. No." HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                        HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblGR" runat="server" Text='<%# Eval("GR") %>'
                                                                                CssClass="elementLabel"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                                                        <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Port Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lblInsCurr" runat="server" Text='<%#Eval("InsuranceCurr") %>'
                                                                    ...
                                                                    <asp:TemplateField Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%#Eval("SrNo") %>'
                                                                                CommandName="RemoveRecord" CssClass="deleteButton" Visible="false" OnClick="LinkButtonClick" Text="Delete" ToolTip="Delete Record" />
                                                                        </ItemTemplate>
