<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Expswift_Makerview.aspx.cs"
    Inherits="EXP_Expswift_Makerview" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><b>Export Swift View - Maker<b></span>
                            </td>
                        ...
                        <tr align="right">
                            ...
                            <td align="right" style="width: 60%;" valign="top">
                                <span class="elementLabel">Search :</span> &nbsp;<asp:TextBox ID="txtSearch" runat="server"
                                    CssClass="textBox" MaxLength="40" Width="180px"
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="ExportViewMaker" runat="server" AutoGenerateColumns="false" Width="90%"
                                    GridLines="Both" AllowPaging="true" OnRowCommand="ExportViewMaker_RowCommand"
                                    OnRowDataBound="ExportViewMaker_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="5%" HeaderText="Delete"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("Trans_RefNo") %>'
