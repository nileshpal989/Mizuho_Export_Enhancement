<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VIEW_LEI_Threshold_Master.aspx.cs"
    Inherits="EXP_VIEW_LEI_Threshold_Master" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><b>LEI Threshold Master View</b></span>
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewServiceTax" runat="server" AutoGenerateColumns="false"
                                    Width="50%" GridLines="Both" AllowPaging="true" OnRowCommand="GridViewServiceTax_RowCommand"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Threshold Amount" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblThresholdAmt" runat="server" Text='<%# Eval("Threshold_Amount") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("EffectiveDate") %>'
