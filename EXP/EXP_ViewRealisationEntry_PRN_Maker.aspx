<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewRealisationEntry_PRN_Maker.aspx.cs"
    Inherits="EXP_EXP_ViewRealisationEntry_PRN_Maker" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Approved Realisation For PRN View-Maker</strong></span>
                            </td>
                            <td align="right" style="width: 50%">
                                <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="buttonDefault" ToolTip="Add New Record"
                                    OnClick="btnAdd_Click" TabIndex="5" style="display:none" />
                            </td>
                        </tr>
                        <tr>
