<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_AddEditApprovedLodgemetForROD_Checker.aspx.cs" Inherits="EXP_EXP_AddEditApprovedLodgemetForROD_Checker" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Scripts/TF_EXP_INW_REMMITENCE_CHECKER.js" type="text/javascript"></script>
    <style type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ExecuteCSharpCodeLodg() {
            ...
            $.ajax({
                type: 'POST',
                url: 'EXP_AddEditApprovedLodgemetForROD_Checker.aspx/ExecuteCSharpCodeLodg',
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 25%;" valign="bottom">
                                    <span class="pageLabel" style="font-weight: bold">Approved ROD Details Checker</span>
                                </td>
                                            ...
                                            <ContentTemplate>
                                                <table cellspacing="1" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="5%" nowrap>
                                                            <asp:DropDownList ID="ddlCurrency" Enabled="False" runat="server"
                                                                CssClass="dropdownList" TabIndex="57"
                                                                AutoPostBack="True"
                                                                OnSelectedIndexChanged="ddlCurrency_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td nowrap width="10%">
                                                            <asp:CheckBox ID="chkLoanAdv" runat="server" Enabled="False"
                                                                CssClass="elementLabel" Text="Loan Advanced"
                                                                TabIndex="58" />
                                                        </td>
                                                        ...
                                                        <td nowrap width="5%">
                                                            <asp:DropDownList ID="ddlOtherCurrency" runat="server" Enabled="False"
                                                                CssClass="dropdownList" TabIndex="59">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td align="left" nowrap width="5%">
                                                            <span class="elementLabel">Exch Rt :</span><asp:TextBox ID="txtExchRate"
                                                    ...
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td colspan="2">
                                                            <asp:RadioButton ID="rbtnEBR" runat="server" Enabled="False"
                                                                CssClass="elementLabel" GroupName="EbrBdr"
                                                                TabIndex="61" Text="EBR" />&nbsp;<asp:RadioButton ID="rbtnBDR"
                                                                    Enabled="False" runat="server" CssClass="elementLabel"
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="white-space: nowrap">
                                                            <asp:RadioButton ID="rbtnAfterAWB" runat="server" Enabled="False"
                                                                CssClass="elementLabel" GroupName="InterestDays"
                                                                TabIndex="62" Text="After
				AWB/BL Date" />
                                                            &nbsp;<asp:RadioButton ID="rbtnFromAWB" runat="server" Enabled="False" 
                                                            CssClass="elementLabel" GroupName="InterestDays"
                                                            TabIndex="62" Text="From AWB/BL Date" />
                                                        &nbsp;<asp:RadioButton ID="rbtnSight" runat="server" Enabled="False" 
                                                            CssClass="elementLabel" GroupName="InterestDays"
                                                            TabIndex="62" Text="xx Days Sight" />
                                                        &nbsp;<asp:RadioButton ID="rbtnDA" runat="server" Enabled="False" 
                                                            CssClass="elementLabel" GroupName="InterestDays"
                                                        ...
                                                        &nbsp;<asp:RadioButton ID="rbtnOthers" runat="server" Enabled="False" 
                                                            CssClass="elementLabel" GroupName="InterestDays"
                                                            TabIndex="62" Text="Others" />
                                                            &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtOtherTenorRemarks" Enabled="False" runat="server"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" nowrap>
                                                            <asp:TextBox ID="txtOutOfDays" runat="server" Enabled="False"
                                                        ...
                                                        <td align="left" nowrap>
                                                            <asp:TextBox ID="txtDueDate" runat="server" Enabled="False" CssClass="textBox"
                                                                MaxLength="10" ValidationGroup="dtVal"
                                                        ...
                                                        <td colspan="4" rowspan="9">
                                                            <table width="100%" border="1" cellpadding="1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate1" runat="server" Enabled="False"
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate1" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"
                                                                            onblur="CalculateNoOfDays('1','2');"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate2" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate2" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate3" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate3" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate4" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate4" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate5" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate5" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntFrmDate6" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtIntToDate6" runat="server" Enabled="False"
                                                                            CssClass="textBox" MaxLength="10"
                                                                            ValidationGroup="dtVal" Width="70px" TabIndex="64"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBillAmountinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiatedAmt" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="73" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiatedAmtinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtInterestinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNetAmtinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtExchRtEBR" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txt_fbkcharges" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txt_fbkchargesinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="78" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtOtherChrgs" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtNegotiationFees" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtCourierChrgs" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:TextBox ID="txtMarginAmt" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCommissionID" runat="server" Enabled="False"
                                                                CssClass="textBox" Width="20px"
                                                                TabIndex="84" onfocus="this.select()" MaxLength="2"></asp:TextBox><asp:Button ID="btnCommissionList"
                                                                    runat="server" Enabled="False" CssClass="btnHelp_enabled"
                                                                    TabIndex="-1" OnClientClick="return OpenCommissionList();" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtCommission" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="84" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap colspan="2">
                                                            <span class="elementLabel">Accepted Due Date :</span>
                                                            <asp:TextBox ID="txtAcceptedDueDate" runat="server" Enabled="False"
                                                                CssClass="textBox" MaxLength="10"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlServiceTax" runat="server" Enabled="False"
                                                                CssClass="dropdownList" Width="60px"
                                                                TabIndex="85">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtSTaxAmount" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="86" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" colspan="2">
                                                            <span class="elementLabel">SBCess (%) :</span>
                                                            <asp:TextBox ID="txtsbcess" runat="server" CssClass="textBox" Enabled="False"
                                                                TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>
                                                            <asp:TextBox ID="txtSBcesssamt" runat="server" CssClass="textBox"
                                                                Enabled="False" TabIndex="86" Width="80px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="center" colspan="2">
                                                            <span class="elementLabel">KKCess (%) :</span>
                                                            <asp:TextBox ID="txt_kkcessper" runat="server" CssClass="textBox"
                                                                Enabled="False" TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>&nbsp;
                                                        <asp:TextBox ID="txt_kkcessamt" runat="server" CssClass="textBox"
                                                            Enabled="False" TabIndex="86" Width="80px"
                                                            Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtsttamt" runat="server" CssClass="textBox" Enabled="False"
                                                                TabIndex="86" Width="100px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chkApplicable" runat="server" Enabled="False"
                                                                CssClass="elementLabel" OnCheckedChanged="chkApplicable_CheckedChanged"
                                                        ...
                                                        <td align="left" width="10%">
                                                            <asp:TextBox ID="txtsbfx" runat="server" Enabled="False" CssClass="textBox"
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt_kkcessonfx" runat="server" Enabled="False"
                                                                CssClass="textBox" Width="80px" Style="text-align: right"
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txttotsbcess" runat="server" Enabled="False"
                                                                CssClass="textBox" Width="100px" Style="text-align: right"
                                                    ...
                                                    <tr runat="server" visible="False" b>
                                                        ...
                                                        <td runat="server">
                                                            <asp:DropDownList ID="ddlServiceTaxfbk" Enabled="False" runat="server"
                                                                CssClass="dropdownList" Width="60px"
                                                                TabIndex="85">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td runat="server">
                                                            <asp:TextBox ID="txtSTaxAmountfbk" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="86" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td align="right" colspan="2" runat="server">
                                                            <span class="elementLabel">SBCess on FBK (%) :</span>
                                                            <asp:TextBox ID="txtsbcessfbk" runat="server" CssClass="textBox"
                                                                Enabled="False" TabIndex="86" Width="40px"
                                                                Style="text-align: right; font-weight: bold"></asp:TextBox>
                                                            <asp:TextBox ID="txtSBcesssamtfbk" runat="server" CssClass="textBox"
                                                                Enabled="False" TabIndex="86"
                                                        ...
                                                        <td align="left" colspan="2" nowrap="nowrap" runat="server">
                                                            ...
                                                            <asp:TextBox ID="txt_kkcessperfbk" runat="server" Enabled="False"
                                                                CssClass="textBox" TabIndex="86"
                                                                Width="40px" Style="text-align: right; font-weight: bold"></asp:TextBox>&nbsp;
                                                        <asp:TextBox ID="txt_kkcessamtfbk" runat="server" Enabled="False"
                                                            CssClass="textBox" TabIndex="86"
                                                            Width="80px" Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td align="right" nowrap="nowrap" runat="server">
                                                        ...
                                                        <td align="left" runat="server">
                                                            <asp:TextBox ID="txtsttamtfbk" runat="server" Enabled="False"
                                                                CssClass="textBox" TabIndex="86" Width="100px"
                                                                Style="text-align: right"></asp:TextBox>
                                                        </td>
                                                        <td runat="server"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCurrentAcinRS" runat="server" Enabled="False"
                                                                CssClass="textBox" Style="text-align: right"
                                                                Width="80px" TabIndex="91" onfocus="this.select()" MaxLength="20"></asp:TextBox>
                                                        </td>
                                                        <td>&nbsp;
                                                        <asp:CheckBox ID="chkRBI" runat="server" Enabled="False"
                                                            CssClass="elementLabel" Text="RBI A/C" TextAlign="Left"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            ...
                                                                                            <ajaxToolkit:CollapsiblePanelExtender ID="cpe2" runat="server" TargetControlID="panelSecondAdd"
                                                                                                CollapsedSize="0" ExpandedSize="45" ExpandControlID="btnTTRefNoList"
                                                                                                CollapseControlID="btnTTRefNoList" Enabled="True" />
                                                                                            <asp:Panel ID="panelSecondAdd" runat="server">
                                                                                                <table cellspacing="1" border="1" width="95%">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <table cellspacing="0" border="0" width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo1" runat="server" TabIndex="-1" CssClass="textBox"
                                                                                                                            Width="150px" Enabled="False"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef1" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('1');" />
                                                                                                                        <asp:Label ID="lblTTRname1" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount1" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr1" runat="server" Enabled="False" 
                                                                                                    TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr1" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate1" AutoPostBack="True" Enabled="False"
                                                                                                                            runat="server" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised1" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo2" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef2" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('2');" />
                                                                                                                        <asp:Label ID="lblTTRname2" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount2" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr2" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr2" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate2" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised2" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo3" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef3" runat="server" CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('3');" />
                                                                                                                        <asp:Label ID="lblTTRname3" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount3" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%-- <asp:TextBox ID="txtTTRealisedCurr3" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr3" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate3" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised3" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo4" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef4" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('4');" />
                                                                                                                        <asp:Label ID="lblTTRname4" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount4" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%-- <asp:TextBox ID="txtTTRealisedCurr4" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr4" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate4" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised4" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo5" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef5" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('5');" />
                                                                                                                        <asp:Label ID="lblTTRname5" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount5" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr5" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr5" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate5" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised5" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo6" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef6" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('6');" />
                                                                                                                        <asp:Label ID="lblTTRname6" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount6" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr6" runat="server"  Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr6" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate6" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised6" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo7" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef7" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('7');" />
                                                                                                                        <asp:Label ID="lblTTRname7" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount7" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr7" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr7" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate7" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised7" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo8" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef8" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('8');" />
                                                                                                                        <asp:Label ID="lblTTRname8" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount8" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr8" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr8" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate8" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised8" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo9" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef9" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('9');" />
                                                                                                                        <asp:Label ID="lblTTRname9" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount9" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr9" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr9" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate9" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised9" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo10" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef10" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('10');" />
                                                                                                                        <asp:Label ID="lblTTRname10" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount10" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%-- <asp:TextBox ID="txtTTRealisedCurr10" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr10" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate10" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised10" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo11" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef11" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('11');" />
                                                                                                                        <asp:Label ID="lblTTRname11" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount11" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr11" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr11" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate11" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised11" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo12" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef12" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('12');" />
                                                                                                                        <asp:Label ID="lblTTRname12" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount12" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr12" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr12" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate12" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised12" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo13" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef13" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('13');" />
                                                                                                                        <asp:Label ID="lblTTRname13" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount13" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr13" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr13" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate13" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised13" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo14" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef14" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('14');" />
                                                                                                                        <asp:Label ID="lblTTRname14" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount14" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr14" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr14" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate14" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised14" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td nowrap align="left">
                                                                                                                        <asp:TextBox ID="txtTTRefNo15" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="150px"></asp:TextBox>
                                                                                                                        <asp:Button ID="btnTTRef15" runat="server" Enabled="False"
                                                                                                                            CssClass="btnHelp_enabled" TabIndex="-1"
                                                                                                                            OnClientClick="return OpenTTNoList('15');" />
                                                                                                                        <asp:Label ID="lblTTRname15" runat="server" Width="16px"
                                                                                                                            CssClass="lblHelp_TT" Visible="False"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                    ...
                                                                                                    Width="80px"></asp:TextBox>--%>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmount15" runat="server" Enabled="False" TabIndex="-1"
                                                                                                                            CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtTTRealisedCurr15" runat="server" Enabled="False" 
                                                                                                     TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlTTRealisedCurr15" Enabled="false" runat="server" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTCrossCurrRate15" runat="server" Enabled="False"
                                                                                                                            AutoPostBack="True" TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtTTAmtRealised15" runat="server" Enabled="False"
                                                                                                                            TabIndex="-1" CssClass="textBox" Width="80px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                            ...
                                                                            <td align="right" colspan="7">
                                                                                <table width="130%">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <br />
                                                                                            <ajaxToolkit:CollapsiblePanelExtender ID="Cpe3" runat="server"
                                                                                                CollapseControlID="btnFircRefNoList" CollapsedSize="0" Enabled="True"
                                                                                                ExpandControlID="btnFircRefNoList" ExpandedSize="43"
                                                                                                TargetControlID="panelSecondAdd1">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <table border="0" cellspacing="0" width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo1_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate1_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender21" runat="server"
                                                                                                                            ...
                                                                                                                            TargetControlID="txtFIRCDate1_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency1_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency1_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount1_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr1_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr1_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate1_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB1_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode1_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo2_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate2_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender22" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate2_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency2_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency2_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount2_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr2_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr2_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate2_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB2_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode2_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo3_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate3_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender23" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate3_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency3_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency3_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount3_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr3_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr3_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate3_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB3_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode3_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo4_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate4_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender24" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate4_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency4_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency4_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount4_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr4_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr4_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate4_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB4_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode4_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo5_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate5_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender25" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate5_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency5_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency5_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount5_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr5_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr5_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate5_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB5_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode5_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo6_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate6_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender26" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate6_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency6_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency6_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount6_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr6_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr6_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate6_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB6_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode6_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo7_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate7_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender27" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate7_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency7_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency7_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount7_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr7_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr7_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate7_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB7_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode7_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo8_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate8_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender28" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate8_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency8_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency8_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount8_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr8_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr8_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate8_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB8_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode8_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo9_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate9_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender29" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate9_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency9_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency9_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount9_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr9_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr9_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate9_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB9_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode9_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo10_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate10_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender30" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate10_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency10_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency10_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount10_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr10_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr10_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate10_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB10_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode10_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo11_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate11_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender31" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate11_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency11_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency11_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount11_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr11_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr11_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate11_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB11_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode11_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo12_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate12_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender32" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate12_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency12_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency12_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount12_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr12_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr12_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate12_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB12_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode12_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo13_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate13_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender33" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate13_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency13_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency13_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount13_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr13_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr13_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate13_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB13_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode13_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo14_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate14_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender34" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate14_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency14_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency14_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount14_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr14_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr14_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate14_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB14_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode14_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td align="left" nowrap>
                                                                                                                        <asp:TextBox ID="txtFIRCNo15_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCDate15_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="10" TabIndex="55" ValidationGroup="dtVal"
                                                                                                                            Width="70px"></asp:TextBox>
                                                                                                                        <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender35" runat="server"
                                                                                                                            CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="£"
                                                                                                                            CultureDateFormat="DMY" CultureDatePlaceholder="/"
                                                                                                                            CultureDecimalPlaceholder="." CultureName="en-GB"
                                                                                                                            CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True"
                                                                                                                            ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date"
                                                                                                                            TargetControlID="txtFIRCDate15_OB">
                                                                                                                        </ajaxToolkit:MaskedEditExtender>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCCurrency15_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCCurrency15_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCAmount15_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%--<asp:TextBox ID="txtFIRCRealisedCurr15_OB" runat="server" CssClass="textBox" 
                                                                                                    Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>--%>
                                                                                                                        <asp:DropDownList ID="ddlFIRCRealisedCurr15_OB" runat="server" Enabled="False" CssClass="dropdownList" TabIndex="57">
                                                                                                                        </asp:DropDownList>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCCrossCurrRate15_OB" runat="server" AutoPostBack="True"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCTobeAdjustedinSB15_OB" runat="server"
                                                                                                                            CssClass="textBox" Enabled="False" MaxLength="20" TabIndex="55" Width="100px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <asp:TextBox ID="txtFIRCADCode15_OB" runat="server" CssClass="textBox"
                                                                                                                            Enabled="False" MaxLength="15" TabIndex="55" Width="150px"></asp:TextBox>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                ...
                                                <table cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right" colspan="1">
                                                            ...
                                                            <asp:CheckBox ID="chkManualGR" runat="server" CssClass="elementLabel" TabIndex="102" Enabled="false"
                                                                onclick="ChangeManualGRText();" />
                                                            <asp:Label ID="lblManualGR" runat="server" CssClass="elementLabel" Style="color: Red;"></asp:Label>
                                                        </td>
                                                        <td style="text-align: left;" colspan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="elementLabel" style="color: Black; font-weight: bold">No of Shipping Bills :</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" style="padding-top: 10px; padding-bottom: 10px; white-space: nowrap">
                                                            ...
                                                            &nbsp;<asp:Button ID="btnLEI" runat="server" Text="Verify LEI" CssClass="buttonDefault"
                                                                ToolTip="Verify LEI" TabIndex="132" OnClick="btnLEI_Click" Visible="false" Style="display: none;" />
