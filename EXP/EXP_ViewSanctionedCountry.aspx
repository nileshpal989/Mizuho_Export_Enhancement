<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewSanctionedCountry.aspx.cs" Inherits="EXP_EXP_ViewSanctionedCountry" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Sanctioned Country Master View</strong></span>
                            </td>
                            <td align="right" style="width: 50%">
                             <input type="hidden" id="hdnsancid" runat="server" />
                             <input type="hidden" id="hdnsanname" runat="server" />
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewCountry" runat="server" AutoGenerateColumns="false" Width="55%"
                                    GridLines="Both" AllowPaging="true" OnRowCommand="GridViewCountry_RowCommand"
                                    OnRowDataBound="GridViewCountry_RowDataBound"  CssClass="GridView">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sanctioned Country ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Sanctioned Country Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" CommandArgument='<%#Eval("CountryID")+";"+Eval("CountryName")%>'
