<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewRealisationEntry_PRN_Checker.aspx.cs" Inherits="EXP_EXP_ViewRealisationEntry_PRN_Checker" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Approved Realisation For PRN View-Checker</strong></span>
                            </td>
                             <%---------------------Anand 02-09-2023-----------------------%>
                            ...
                            <td align="right" style="width: 50%">
                                <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="buttonDefault" ToolTip="Add New Record"
                                    OnClick="btnAdd_Click" TabIndex="5" style="visibility:hidden"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; width: 45%; text-align: left">
                                ...
                                <asp:TextBox ID="txtDocDate" runat="server" CssClass="textBox" AutoPostBack="true" Style="width: 70px"
                                    TabIndex="4" OnTextChanged="txtDocDate_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td width="20%" nowrap align="left">
                                <asp:RadioButton ID="rbtIBD" runat="server" CssClass="elementLabel" Text="Vendor Bill Discounting"
                                    GroupName="TransType" AutoPostBack="true" OnCheckedChanged="rbtIBD_CheckedChanged" Enabled="false"  Visible="false"/>&nbsp;
                            </td>
                            <td align="left">
                                <asp:RadioButton ID="rbtBEB" runat="server" CssClass="elementLabel" Text="Advance"
                                    GroupName="TransType" AutoPostBack="true" OnCheckedChanged="rbtBEB_CheckedChanged" Enabled="false" Visible="false"/>&nbsp;
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" nowrap align="left">
                                ...
                                <asp:GridView ID="GridViewEXPDocRealised" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Checker Status" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Maker Name" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPRNMaker" runat="server" Text='<%# Eval("ApprovePRNUpdatedBy") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Checker Name" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPRNChecker" runat="server" Text='<%# Eval("ApprovedPRNCheckBy") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
