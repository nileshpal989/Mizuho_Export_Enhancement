<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EXPGABSE_LOG_Reports.aspx.cs" Inherits="EXP_TF_EXPGABSE_LOG_Reports" %>
                                ...
                                <table>
                                    <tr valign="bottom">
                                        ...
                                        <td align="left" style="width: 700px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            &nbsp;
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate" OnClick="btnsave_Click"
