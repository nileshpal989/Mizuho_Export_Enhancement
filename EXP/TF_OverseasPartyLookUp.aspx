<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_OverseasPartyLookUp.aspx.cs"
    Inherits="EXP_TF_OverseasPartyLookUp" %>
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%; white-space: nowrap; vertical-align: middle">
                                <span style="vertical-align: middle" class="elementLabel">Search :</span> &nbsp;<asp:TextBox
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    AllowPaging="true" OnRowCommand="GridViewBankList_RowCommand" OnRowDataBound="GridViewBankList_RowDataBound"
                                    OnRowCreated="GridViewBankList_RowCreated" PageSize="20" onblur="GiveFocus='FALSE';CheckFocus();">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Party Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankName" runat="server" Text='<%# Eval("Party_Name") %>' ToolTip='<%# Eval("ToolTipName") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Party Address" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBankAddress" runat="server" Text='<%# Eval("Party_Address") %>'
                                                    ToolTip='<%# Eval("ToolTipAddress") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
