...
public partial class EXP_EXP_CommisionLookUp : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_GetCommissionMasterListHelp";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.opener.selectCommision('" + lblSrNo.Text + "','" + lblRate.Text + "','" + lblMinAmt.Text + "','" + lblMaxAmt.Text + "','" + lblFlatAmt.Text + "');window.opener.EndRequest();window.close();";
                if (i != 8)
