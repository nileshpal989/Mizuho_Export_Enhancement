<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EXP_ViewRealisationEntry_Checker.aspx.cs" Inherits="EXP_EXP_ViewRealisationEntry_Checker" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><strong>Export Realisation Data Entry View-Checker</strong></span>
                            </td>
                             <%---------------------Anand 02-09-2023-----------------------%>
