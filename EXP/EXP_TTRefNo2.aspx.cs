...
public partial class EXP_EXP_TTRefNo2 : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        string _query = "TF_EXP_GetTTnoList2";
    ...
    protected void GridViewBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string pageurl = "window.opener.saveTTRefDetails('" + lblDocNo.Text + "','" + lblAmount.Text + "','" + hNo + "','" + lbltotalamt.Text + "');window.opener.EndRequest();window.close();";
                if (i != 6)
