<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_CustomerLookUp.aspx.cs"
                                ...
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer ID" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%" Visible="false">
                                            <ItemTemplate>
