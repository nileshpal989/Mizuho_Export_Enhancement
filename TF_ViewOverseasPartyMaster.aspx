<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewOverseasPartyMaster.aspx.cs"
    Inherits="TF_ViewOverseasPartyMaster" %>
    ...
    <script type = "text/javascript">
        function Confirm1() {
            ...
            if (confirm("Are you sure you want to delete this record?")) {
                ...
                if (confirm("Do you want to Delete data Consignee Party Master?")) {
                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel">Overseas Party Master View</span>
                        </td>
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="width: 100%" valign="top" colspan="2">
                            <asp:GridView ID="GridViewOverseasPartyList" runat="server" AutoGenerateColumns="False"
                                Width="100%" AllowPaging="True" OnRowCommand="GridViewOverseasPartyList_RowCommand"
                                OnRowDataBound="GridViewOverseasPartyList_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Party ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPartyID" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_Code") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Party Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblPartyName" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_Name") %>'></asp:Label>
                                        </ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Address" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblPartyAddress" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_Address") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="City" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCity" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_City") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LEI No" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLEINo" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_LEI_No") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="9%" />
                                        <ItemStyle HorizontalAlign="Center" Width="9%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LEI Expiry Date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLEIExpiry" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_LEI_Expiry_Date") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Country" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCountry" runat="server" CssClass="elementLabel" Text='<%# Eval("Party_Country") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="Delete"
                                        ...
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("Party_Code")%>'
