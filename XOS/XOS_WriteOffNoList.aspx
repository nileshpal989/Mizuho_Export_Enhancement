<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XOS_WriteOffNoList.aspx.cs"
    Inherits="XOS_XOS_WriteOffNoList" %>
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="90%">
                        ...
                        <tr>
                            <td align="left" style="width: 50%; height: 21px;" valign="top">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Write Off No" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Write Off Date" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Write Off Amount" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWriteOffAmt" runat="server" Text='<%# Eval("WrittenOffAmount","{0:0.00}") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="20%" />
