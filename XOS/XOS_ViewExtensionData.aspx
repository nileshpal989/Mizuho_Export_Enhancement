<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XOS_ViewExtensionData.aspx.cs"
    Inherits="XOS_XOS_ViewExtensionData" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom">
                                <span class="pageLabel">Due Date Entension Entry View</span>
                            </td>
                        ...
                        <tr align="right">
                            ...
                            <td align="right" valign="top" colspan="3">
                                <span class="elementLabel">Search :</span> &nbsp;<asp:TextBox ID="txtSearch" runat="server"
                                    CssClass="textBox" MaxLength="40" Style="width: 180px;" TabIndex="5"></asp:TextBox>
                        ...
                        <tr>
                            <td nowrap align="left" colspan="2">
                                ...
                                <asp:TextBox ID="txtDocPrFx" runat="server" CssClass="textBox" Style="width: 30px;" Text="ETX"
                                    ReadOnly="True"></asp:TextBox>
                                <asp:TextBox ID="txtBranchCode" runat="server" CssClass="textBox" Style="width: 30px; font-weight:bold;"
                                    TabIndex="3" MaxLength="5" Enabled="false"></asp:TextBox>
                                <asp:TextBox ID="txtYear" runat="server" CssClass="textBox" Style="width: 20px;"
                                    OnTextChanged="txtYear_TextChanged" AutoPostBack="true" TabIndex="4" MaxLength="2"></asp:TextBox>
                                <asp:TextBox ID="txtDocumentNo" runat="server" CssClass="textBox" Style="width: 40px; font-weight:bold;"
                                    TabIndex="3" MaxLength="5" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="5">
                                <asp:GridView ID="GridViewEXPbillEntry" runat="server" AutoGenerateColumns="false"
                                    Width="100%" GridLines="Both" AllowPaging="true" OnRowDataBound="GridViewEXPbillEntry_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Bill No" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="Bill Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillDate" runat="server" Text='<%# Eval("BillDate","{00:dd/MM/yyyy}") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBillAmount" runat="server" Text='<%# Eval("BillAmount","{0:0.00}") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Balance" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBalance" runat="server" Text='<%# Eval("Balance","{0:0.00}") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Right" Width="5%" />
                                            <ItemStyle HorizontalAlign="Right" Width="5%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Extension No." HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="No. Of Extensions" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="5%" ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNoOfExtensions" runat="server" Text='<%# Eval("NoofExtensions") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="5%" />
                                            <ItemStyle HorizontalAlign="Left" Width="5%" />
