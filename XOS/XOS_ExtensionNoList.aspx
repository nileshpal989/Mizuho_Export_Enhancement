<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XOS_ExtensionNoList.aspx.cs"
    Inherits="XOS_XOS_ExtensionNoList" %>
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Extension No" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblExtensionNo" runat="server" Text='<%# Eval("ExtensionNo") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Extension Date" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblExtensionDate" runat="server" Text='<%# Eval("DateOfExtension","{0:dd/MM/yyyy}") %>'
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
