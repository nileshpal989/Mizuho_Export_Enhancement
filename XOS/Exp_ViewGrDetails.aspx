<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exp_ViewGrDetails.aspx.cs"
    Inherits="EXP_Exp_ViewGrDetails" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="bottom">
                                <span class="pageLabel">Updation of GR Details For XOS View</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" style="width: 100%" valign="top" colspan="5">
                                <asp:GridView ID="GridViewEXPbillEntry" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date Received" HeaderStyle-HorizontalAlign="Left"
