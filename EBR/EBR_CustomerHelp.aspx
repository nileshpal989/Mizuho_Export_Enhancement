<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EBR_CustomerHelp.aspx.cs" Inherits="EBR_EBR_CustomerHelp" %>
    ...
    <div>
        <center>
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <ContentTemplate>
                    <table align="left" cellspacing="0" border="0" width="40%">
                        <tr>
                                ...
                                <asp:GridView ID="GridViewCustAcList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Center"
                                         ...
                                         <asp:TemplateField HeaderText="Customer IE Code" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%" ItemStyle-Width="15%" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustID" runat="server" Text='<%# Eval("CUST_IE_CODE") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
