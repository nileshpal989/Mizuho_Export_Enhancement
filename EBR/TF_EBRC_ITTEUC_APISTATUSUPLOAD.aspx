<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_EBRC_ITTEUC_APISTATUSUPLOAD.aspx.cs" Inherits="EBR_TF_EBRC_ITTEUC_APISTATUSUPLOAD" %>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    <asp:Label ID="pgLabel" runat="server" CssClass="pageLabel" Style="font-weight: bold">ITT API Status File Upload</asp:Label>
                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:DropDownList ID="ddlBranch" CssClass="dropdownList" AutoPostBack="true" runat="server"
                                                    OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged" TabIndex="1" style="visibility:hidden">
