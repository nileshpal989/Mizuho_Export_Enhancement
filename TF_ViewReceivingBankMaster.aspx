<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewReceivingBankMaster.aspx.cs"
    Inherits="TF_ViewReceivingBankMaster" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel">Receiving Bank Master View</span>
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewCurrencyReceivingBank" runat="server" AutoGenerateColumns="False"
                                    Width="100%" GridLines="Both" AllowPaging="true" OnRowCommand="GridViewCurrencyReceivingBank_RowCommand"
                                    OnRowDataBound="GridViewCurrencyReceivingBank_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Currency ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCurrencyCode" runat="server" Text='<%#Eval("CurrencyCode")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Abbreviation" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="15%" ItemStyle-Width="15%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAbbr" runat="server" Text='<%#Eval("Abbreviation")%>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
