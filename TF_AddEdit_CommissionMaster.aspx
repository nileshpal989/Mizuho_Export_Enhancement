<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_AddEdit_CommissionMaster.aspx.cs" Inherits="TF_AddEdit_CommissionMaster" %>
                            ...
                            <td align="left" style="width: 100%; border: 1px solid #49A3FF" valign="top" colspan="2">
                                ...
                                <td align=left>
                                 ...
                                 <span class="elementLabel">Maximum Rs. :</span>
                                    ...
                                    <td>
                                        &nbsp;<asp:TextBox runat="server" ID="txt_maxrs" CssClass="textBoxRight" Width=100px TabIndex="6" style="text-align:right"/>
                                    </td>
                                    ...
                                    <tr>
                                    <td align=right>
                                      <span class="elementLabel">Flat :</span>
                                    </td>
                                    <td align=left>
                                    &nbsp;<asp:TextBox runat="server" ID="txt_flat" CssClass="textBoxRight" Width=100px TabIndex="6" style="text-align:right"/>
                                    </td>
                                    </tr>
