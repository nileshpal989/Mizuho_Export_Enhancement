<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RET_RBITextFileAtHeadOffice.aspx.cs"
    Inherits="RRETURN_RET_RBITextFileAtHeadOffice" %>
...
<body>
    <form id="form1" runat="server" autocomplete="off" unselectable="off">
        ...
        <br />
        <div align="left">
             <span class="pageLabel" style="font-weight: bold">RBI Text File Creation At Head Office</span>
            <hr />
            <table>
                <tr>
                    <td align="right">
