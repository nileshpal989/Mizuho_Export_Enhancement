<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RET_helpPurposeCode.aspx.cs"
    Inherits="RRETURN_RET_helpPurposeCode" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                <asp:GridView ID="GridViewPurCodeList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    OnRowDataBound="GridViewPurCodeList_RowDataBound" OnRowCreated="GridViewPurCodeList_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Purpose ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblpurposeID" runat="server" Text='<%# Eval("purposeID") %>' Style="text-align: center"
                                                    CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="85%" ItemStyle-Width="85%">
                                            <ItemTemplate>
