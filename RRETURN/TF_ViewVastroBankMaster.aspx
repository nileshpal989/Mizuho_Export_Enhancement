<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewVastroBankMaster.aspx.cs"
    Inherits="TF_ViewVastroBankMaster" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <span class="pageLabel"><b>Vastro Bank Master View</b></span>
                            </td>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewVastroBank" runat="server" AutoGenerateColumns="False"
                                    Width="60%" GridLines="Both" AllowPaging="true" OnRowCommand="GridViewPortCodes_RowCommand"
                                    OnRowDataBound="GridViewPortCodes_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Bank Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Bank Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="42%" ItemStyle-Width="42%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%# Eval("COUNTRYCODE")+ ";" +Eval("BANKCODE") %>' Text="Delete" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
