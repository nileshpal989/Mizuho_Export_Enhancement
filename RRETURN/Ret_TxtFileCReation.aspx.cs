...
using System.IO;
using System.Net;
public partial class RRETURN_Ret_TxtFileCReation : System.Web.UI.Page
{
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                _directoryPath = Server.MapPath("~/TF_GeneratedFiles/RRETURN/ERS/BR_Mumbai_RBI_ERS");
            }
            if (Branchname == "New Delhi")
            {
                _directoryPath = Server.MapPath("~/TF_GeneratedFiles/RRETURN/ERS/BR_NewDelhi_RBI_ERS");
            }
            if (Branchname == "Bangalore")
            {
                _directoryPath = Server.MapPath("~/TF_GeneratedFiles/RRETURN/ERS/BR_Bangalore_RBI_ERS");
            }
            if (Branchname == "Chennai")
            {
                _directoryPath = Server.MapPath("~/TF_GeneratedFiles/RRETURN/ERS/BR_Chennai_RBI_ERS");
            }
            ...
            //string _qryQE = "TF_RET_COVERPAGE";
...
swSCH3TO6.Dispose();*/
            ...
            if (Branchname == "Mumbai")
            {
                path = "file://" + _serverName + "/TF_GeneratedFiles/RRETURN/ERS/BR_Mumbai_RBI_ERS";
                link = "/TF_GeneratedFiles/RRETURN/ERS/BR_Mumbai_RBI_ERS";
            }
            if (Branchname == "New Delhi")
            {
                path = "file://" + _serverName + "/TF_GeneratedFiles/RRETURN/ERS/BR_NewDelhi_RBI_ERS";
                link = "/TF_GeneratedFiles/RRETURN/ERS/BR_NewDelhi_RBI_ERS";
            }
            if (Branchname == "Bangalore")
            {
                path = "file://" + _serverName + "/TF_GeneratedFiles/RRETURN/ERS/BR_Bangalore_RBI_ERS";
                link = "/TF_GeneratedFiles/RRETURN/ERS/BR_Bangalore_RBI_ERS";
            }
            if (Branchname == "Chennai")
            {
                path = "file://" + _serverName + "/TF_GeneratedFiles/RRETURN/ERS/BR_Chennai_RBI_ERS";
                link = "/TF_GeneratedFiles/RRETURN/ERS/BR_Chennai_RBI_ERS";
            }
    ...
    {
        string Branchname = ddlBranch.SelectedItem.ToString().Trim();
        string filePath = "~/TF_GeneratedFiles/RRETURN/ERS/BR_" + Branchname.Replace(" ", "") + "_RBI_ERS/677_QE.txt";
    ...
    {
        string Branchname = ddlBranch.SelectedItem.ToString().Trim();
        string filePath1 = "~/TF_GeneratedFiles/RRETURN/ERS/BR_" + Branchname.Replace(" ", "") + "_RBI_ERS/677_BOP6.txt";
