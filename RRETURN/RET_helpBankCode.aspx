<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RET_helpBankCode.aspx.cs"
    Inherits="RRETURN_RET_helpBankCode" %>
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewBankList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewBankList_RowCommand"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Bank ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
