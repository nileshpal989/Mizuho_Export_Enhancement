...
public partial class Reports_RRETURNReports_TF_RRETURN_CurrencyHelp_Nostro : System.Web.UI.Page
{
    ...
    protected void fillGrid()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            GridViewCurrencyList.DataSource = dt.DefaultView;
            GridViewCurrencyList.DataBind();
            GridViewCurrencyList.Visible = true;
        ...
        {
            GridViewCurrencyList.Visible = false;
    ...
    protected void GridViewCurrencyList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        // string result = "";
    }
    protected void GridViewCurrencyList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void GridViewCurrencyList_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            e.Row.TabIndex = -1;
