<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_RRETURN_CurrencyHelp_Nostro.aspx.cs"
    Inherits="Reports_RRETURNReports_TF_RRETURN_CurrencyHelp_Nostro" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewCurrencyList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 2%;" valign="middle" nowrap>
                                ...
                                &nbsp;<asp:TextBox ID="txtSearch" runat="server" CssClass="txtenabled" MaxLength="40"
                                    Width="130px"  onblur="GiveFocus='FALSE';CheckFocus();" onclick="Change(this);"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewCurrencyList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewCurrencyList_RowCommand"
                                    OnRowDataBound="GridViewCurrencyList_RowDataBound" 
                                    onrowcreated="GridViewCurrencyList_RowCreated" PageSize=15  onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Currency ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="25%" ItemStyle-Width="25%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCurrID" runat="server" Text='<%# Eval("C_Code") %>' CssClass="elementLabel"></asp:Label>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Currency Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
