<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_View_Commission_Master.aspx.cs" Inherits="TF_View_Commission_Master" %>
                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        <td align="left" style="width: 50%" valign="bottom">
                            <span class="pageLabel">Commission Master View</span>
                        </td>
                            ...
                            <asp:GridView ID="GridViewCommission" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                 <asp:TemplateField HeaderText="Customer A/C No." HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField HeaderText="Commission ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        <ItemTemplate>
