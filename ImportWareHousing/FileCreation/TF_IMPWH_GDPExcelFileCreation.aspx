<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_IMPWH_GDPExcelFileCreation.aspx.cs"
    Inherits="ImportWareHousing_FileCreation_TF_IMPWH_GDPExcelFileCreation" %>
        ...
        <center>
            ...
            <asp:UpdatePanel ID="UpdatePanelMain" runat="server">
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="lnkDownloadUP" />
                </Triggers>
                <ContentTemplate>
                            ...
                            <td align="left" style="width: 100%;" valign="top">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="1300px" style="line-height: 150%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" nowrap style="width: 50%;">
                                            &nbsp;
                                            <asp:Label ID="lblUniqueParty" runat="server" CssClass="pageLabel" Font-Bold="true"></asp:Label>&nbsp;
                                            <asp:LinkButton ID="lnkDownloadUP" runat="server" Visible="false" Text="Download File"
                                                CssClass="buttonDefault" OnClick="lnkDownloadUP_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </td>
