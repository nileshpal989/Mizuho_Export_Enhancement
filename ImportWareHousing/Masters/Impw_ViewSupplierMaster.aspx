                ...
                <table cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td align="right" style="width: 50%">
                            ...
                            <asp:Button ID="btnUpload" runat="server" Text="Upload" CssClass="buttonDefault"
                                ToolTip="Upload Supplier Master File" OnClick="btnUpload_Click" TabIndex="1" Visible="false"/>
                    ...
                    <tr align="left">
                        ...
                        <td align="right" style="width: 100%;" valign="top">
                            <%--onkeypress="return WebForm_FireDefaultButton(event, '<%=btnSearch.ClientID %>')"--%>
                            <span class="elementLabel">Search :</span> &nbsp;<asp:TextBox ID="txtSearch" runat="server"
                                CssClass="textBox" MaxLength="40" Width="180px" TabIndex="3" AutoPostBack="true"
                    ...
                    <tr id="rowGrid" runat="server">
                        <td align="left" style="vertical-align: top" colspan="3">
                            <asp:GridView ID="GridViewCustomerList" runat="server" AutoGenerateColumns="False"
                                Width="80%" AllowPaging="True" OnRowCommand="GridViewCustomerList_RowCommand"
                                CssClass="GridView" OnRowDataBound="GridViewCustomerList_RowDataBound" OnSelectedIndexChanged="GridViewCustomerList_SelectedIndexChanged">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Customer Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCustName" runat="server" CssClass="elementLabel" ToolTip='<%# Eval("CUST_NAME") %>'
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCustACNo" runat="server" CssClass="elementLabel" Text='<%# Eval("Cust_ACNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("Cust_ACNo")+";"+Eval("Supplier_ID") %>'
                                                CommandName="RemoveRecord" Text="Delete" ToolTip="Delete Suuplier ID" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Width="5%" />
                                        <ItemStyle HorizontalAlign="Center" Width="5%" />
                                    </asp:TemplateField>
