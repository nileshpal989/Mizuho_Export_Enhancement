<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_PurposeCodeLookUp2.aspx.cs" Inherits="TF_PurposeCodeLookUp2" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            UpperBound = parseInt('<%= this.GridViewPurCodeList.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;
            return false;
                    ...
                    <table align="left" cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top">
                                ...
                                <asp:GridView ID="GridViewPurCodeList" runat="server" AutoGenerateColumns="False"
                                    Width="100%" AllowPaging="false" OnRowCommand="GridViewPurCodeList_RowCommand"
                                    OnRowDataBound="GridViewPurCodeList_RowDataBound" 
                                    onrowcreated="GridViewPurCodeList_RowCreated" PageSize=15  onblur="GiveFocus='FALSE';CheckFocus();" >
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Purpose ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left"
